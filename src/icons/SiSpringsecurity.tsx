...
export const SiSpringsecurityHex = "6DB33F";
export const SiSpringsecurityTitle = "Spring Security";
export const SiSpringsecuritySlug = "springsecurity";

export function SiSpringsecurity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpringsecurityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpringsecurityTitle}
      {...props}
    >
