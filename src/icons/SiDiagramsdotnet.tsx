...
export const SiDiagramsdotnetHex = "F08705";
export const SiDiagramsdotnetTitle = "diagrams.net";
export const SiDiagramsdotnetSlug = "diagramsdotnet";

export function SiDiagramsdotnet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDiagramsdotnetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDiagramsdotnetTitle}
      {...props}
    >
