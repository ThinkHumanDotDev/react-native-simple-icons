...
export const SiHelpdeskHex = "2FC774";
export const SiHelpdeskTitle = "HelpDesk";
export const SiHelpdeskSlug = "helpdesk";

export function SiHelpdesk({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHelpdeskHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHelpdeskTitle}
      {...props}
    >
