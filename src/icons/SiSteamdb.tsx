...
export const SiSteamdbHex = "000000";
export const SiSteamdbTitle = "SteamDB";
export const SiSteamdbSlug = "steamdb";

export function SiSteamdb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSteamdbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSteamdbTitle}
      {...props}
    >
