...
export const SiWeightsandbiasesHex = "FFBE00";
export const SiWeightsandbiasesTitle = "Weights & Biases";
export const SiWeightsandbiasesSlug = "weightsandbiases";

export function SiWeightsandbiases({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWeightsandbiasesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWeightsandbiasesTitle}
      {...props}
    >
