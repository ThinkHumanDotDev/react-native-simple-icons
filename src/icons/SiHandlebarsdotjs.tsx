...
export const SiHandlebarsdotjsHex = "000000";
export const SiHandlebarsdotjsTitle = "Handlebars.js";
export const SiHandlebarsdotjsSlug = "handlebarsdotjs";

export function SiHandlebarsdotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHandlebarsdotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHandlebarsdotjsTitle}
      {...props}
    >
