...
export const SiMoonrepoHex = "6F53F3";
export const SiMoonrepoTitle = "Moonrepo";
export const SiMoonrepoSlug = "moonrepo";

export function SiMoonrepo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMoonrepoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMoonrepoTitle}
      {...props}
    >
