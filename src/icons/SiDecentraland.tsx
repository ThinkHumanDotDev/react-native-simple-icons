...
export const SiDecentralandHex = "FF2D55";
export const SiDecentralandTitle = "Decentraland";
export const SiDecentralandSlug = "decentraland";

export function SiDecentraland({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDecentralandHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDecentralandTitle}
      {...props}
    >
