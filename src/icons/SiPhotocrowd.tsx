...
export const SiPhotocrowdHex = "3DAD4B";
export const SiPhotocrowdTitle = "Photocrowd";
export const SiPhotocrowdSlug = "photocrowd";

export function SiPhotocrowd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhotocrowdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhotocrowdTitle}
      {...props}
    >
