...
export const SiStudio3THex = "17AF66";
export const SiStudio3TTitle = "Studio 3T";
export const SiStudio3TSlug = "studio3t";

export function SiStudio3T({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStudio3THex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStudio3TTitle}
      {...props}
    >
