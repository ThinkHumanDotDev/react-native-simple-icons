...
export const SiWorkplaceHex = "4526CE";
export const SiWorkplaceTitle = "Workplace";
export const SiWorkplaceSlug = "workplace";

export function SiWorkplace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWorkplaceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWorkplaceTitle}
      {...props}
    >
