...
export const SiThesoundsresourceHex = "39BE6B";
export const SiThesoundsresourceTitle = "The Sounds Resource";
export const SiThesoundsresourceSlug = "thesoundsresource";

export function SiThesoundsresource({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThesoundsresourceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThesoundsresourceTitle}
      {...props}
    >
