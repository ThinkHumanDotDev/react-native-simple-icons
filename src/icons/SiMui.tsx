...
export const SiMuiHex = "007FFF";
export const SiMuiTitle = "MUI";
export const SiMuiSlug = "mui";
...
export function SiMui({
  ...
  const resolvedColor = color === "default" ? `#${SiMuiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMuiTitle}
      {...props}
    >
