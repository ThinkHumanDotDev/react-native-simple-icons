...
export const SiK6Hex = "7D64FF";
export const SiK6Title = "k6";
export const SiK6Slug = "k6";

export function SiK6({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiK6Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiK6Title}
      {...props}
    >
