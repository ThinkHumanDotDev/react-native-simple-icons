...
export const SiWooHex = "873EFF";
export const SiWooTitle = "Woo";
export const SiWooSlug = "woo";

export function SiWoo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWooHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWooTitle}
      {...props}
    >
