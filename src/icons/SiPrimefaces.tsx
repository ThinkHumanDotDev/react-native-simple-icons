...
export const SiPrimefacesHex = "263238";
export const SiPrimefacesTitle = "PrimeFaces";
export const SiPrimefacesSlug = "primefaces";

export function SiPrimefaces({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrimefacesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrimefacesTitle}
      {...props}
    >
