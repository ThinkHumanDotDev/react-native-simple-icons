...
export const SiGooglechromeHex = "4285F4";
export const SiGooglechromeTitle = "Google Chrome";
export const SiGooglechromeSlug = "googlechrome";

export function SiGooglechrome({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglechromeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglechromeTitle}
      {...props}
    >
