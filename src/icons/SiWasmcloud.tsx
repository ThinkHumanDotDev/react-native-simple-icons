...
export const SiWasmcloudHex = "00BC8E";
export const SiWasmcloudTitle = "wasmCloud";
export const SiWasmcloudSlug = "wasmcloud";

export function SiWasmcloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWasmcloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWasmcloudTitle}
      {...props}
    >
