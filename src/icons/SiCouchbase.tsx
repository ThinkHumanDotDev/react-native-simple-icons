...
export const SiCouchbaseHex = "EA2328";
export const SiCouchbaseTitle = "Couchbase";
export const SiCouchbaseSlug = "couchbase";

export function SiCouchbase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCouchbaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCouchbaseTitle}
      {...props}
    >
