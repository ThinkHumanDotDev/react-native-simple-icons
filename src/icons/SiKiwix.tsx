...
export const SiKiwixHex = "000000";
export const SiKiwixTitle = "Kiwix";
export const SiKiwixSlug = "kiwix";

export function SiKiwix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKiwixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKiwixTitle}
      {...props}
    >
