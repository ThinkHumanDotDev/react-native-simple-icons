...
export const SiKredHex = "72BE50";
export const SiKredTitle = "Kred";
export const SiKredSlug = "kred";

export function SiKred({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKredHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKredTitle}
      {...props}
    >
