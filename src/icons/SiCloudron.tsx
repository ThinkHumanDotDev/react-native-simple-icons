...
export const SiCloudronHex = "03A9F4";
export const SiCloudronTitle = "Cloudron";
export const SiCloudronSlug = "cloudron";

export function SiCloudron({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudronHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudronTitle}
      {...props}
    >
