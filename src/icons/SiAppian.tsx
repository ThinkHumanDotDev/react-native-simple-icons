...
export const SiAppianHex = "2322F0";
export const SiAppianTitle = "Appian";
export const SiAppianSlug = "appian";

export function SiAppian({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppianHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppianTitle}
      {...props}
    >
