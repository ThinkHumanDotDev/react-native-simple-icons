...
export const SiChatbotHex = "0066FF";
export const SiChatbotTitle = "ChatBot";
export const SiChatbotSlug = "chatbot";

export function SiChatbot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChatbotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChatbotTitle}
      {...props}
    >
