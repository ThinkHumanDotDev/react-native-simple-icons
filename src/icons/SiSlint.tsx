...
export const SiSlintHex = "2379F4";
export const SiSlintTitle = "Slint";
export const SiSlintSlug = "slint";

export function SiSlint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSlintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSlintTitle}
      {...props}
    >
