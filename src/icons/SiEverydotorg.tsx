...
export const SiEverydotorgHex = "2BD7B0";
export const SiEverydotorgTitle = "Every.org";
export const SiEverydotorgSlug = "everydotorg";

export function SiEverydotorg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEverydotorgHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEverydotorgTitle}
      {...props}
    >
