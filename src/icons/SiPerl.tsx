...
export const SiPerlHex = "0073A1";
export const SiPerlTitle = "Perl";
export const SiPerlSlug = "perl";

export function SiPerl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPerlHex}` : color;
