...
export const SiDiscorddotjsHex = "5865F2";
export const SiDiscorddotjsTitle = "discord.js";
export const SiDiscorddotjsSlug = "discorddotjs";

export function SiDiscorddotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDiscorddotjsHex}` : color;
