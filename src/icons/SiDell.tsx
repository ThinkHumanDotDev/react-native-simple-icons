...
export const SiDellHex = "007DB8";
export const SiDellTitle = "Dell";
export const SiDellSlug = "dell";

export function SiDell({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDellHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDellTitle}
      {...props}
    >
