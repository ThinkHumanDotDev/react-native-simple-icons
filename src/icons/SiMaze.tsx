...
export const SiMazeHex = "000000";
export const SiMazeTitle = "Maze";
export const SiMazeSlug = "maze";

export function SiMaze({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMazeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMazeTitle}
      {...props}
    >
