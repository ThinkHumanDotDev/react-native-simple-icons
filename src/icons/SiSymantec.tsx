...
export const SiSymantecHex = "FDB511";
export const SiSymantecTitle = "Symantec";
export const SiSymantecSlug = "symantec";

export function SiSymantec({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSymantecHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSymantecTitle}
      {...props}
    >
