...
export const SiDisrootHex = "50162D";
export const SiDisrootTitle = "Disroot";
export const SiDisrootSlug = "disroot";

export function SiDisroot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDisrootHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDisrootTitle}
      {...props}
    >
