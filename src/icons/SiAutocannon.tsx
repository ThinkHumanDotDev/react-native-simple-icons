...
export const SiAutocannonHex = "3BA4B7";
export const SiAutocannonTitle = "AutoCannon";
export const SiAutocannonSlug = "autocannon";

export function SiAutocannon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutocannonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutocannonTitle}
      {...props}
    >
