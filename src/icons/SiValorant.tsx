...
export const SiValorantHex = "FA4454";
export const SiValorantTitle = "Valorant";
export const SiValorantSlug = "valorant";

export function SiValorant({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiValorantHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiValorantTitle}
      {...props}
    >
