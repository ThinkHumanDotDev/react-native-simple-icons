...
export const SiNetgearHex = "2C262D";
export const SiNetgearTitle = "NETGEAR";
export const SiNetgearSlug = "netgear";

export function SiNetgear({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNetgearHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNetgearTitle}
      {...props}
    >
