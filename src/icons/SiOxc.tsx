...
export const SiOxcHex = "00F7F1";
export const SiOxcTitle = "Oxc";
export const SiOxcSlug = "oxc";

export function SiOxc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOxcHex}` : color;
