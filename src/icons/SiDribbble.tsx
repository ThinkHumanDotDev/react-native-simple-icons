...
export const SiDribbbleHex = "EA4C89";
export const SiDribbbleTitle = "Dribbble";
export const SiDribbbleSlug = "dribbble";

export function SiDribbble({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDribbbleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDribbbleTitle}
      {...props}
    >
