...
export const SiBunqHex = "3394D7";
export const SiBunqTitle = "bunq";
export const SiBunqSlug = "bunq";

export function SiBunq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBunqHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBunqTitle}
      {...props}
    >
