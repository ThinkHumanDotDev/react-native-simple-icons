...
export const SiClockifyHex = "03A9F4";
export const SiClockifyTitle = "Clockify";
export const SiClockifySlug = "clockify";

export function SiClockify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClockifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClockifyTitle}
      {...props}
    >
