...
export const SiCardmarketHex = "012169";
export const SiCardmarketTitle = "Cardmarket";
export const SiCardmarketSlug = "cardmarket";

export function SiCardmarket({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCardmarketHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCardmarketTitle}
      {...props}
    >
