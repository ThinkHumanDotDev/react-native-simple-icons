...
export const Si9GagHex = "000000";
export const Si9GagTitle = "9GAG";
export const Si9GagSlug = "9gag";

export function Si9Gag({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si9GagHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si9GagTitle}
      {...props}
    >
