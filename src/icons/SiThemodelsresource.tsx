...
export const SiThemodelsresourceHex = "3A75BD";
export const SiThemodelsresourceTitle = "The Models Resource";
export const SiThemodelsresourceSlug = "themodelsresource";

export function SiThemodelsresource({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThemodelsresourceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThemodelsresourceTitle}
      {...props}
    >
