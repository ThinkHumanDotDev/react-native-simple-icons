...
export const SiMediatekHex = "EC9430";
export const SiMediatekTitle = "MediaTek";
export const SiMediatekSlug = "mediatek";

export function SiMediatek({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMediatekHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMediatekTitle}
      {...props}
    >
