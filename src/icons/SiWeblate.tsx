...
export const SiWeblateHex = "2ECCAA";
export const SiWeblateTitle = "Weblate";
export const SiWeblateSlug = "weblate";

export function SiWeblate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWeblateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWeblateTitle}
      {...props}
    >
