...
export const SiConektaHex = "0A1837";
export const SiConektaTitle = "Conekta";
export const SiConektaSlug = "conekta";

export function SiConekta({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiConektaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiConektaTitle}
      {...props}
    >
