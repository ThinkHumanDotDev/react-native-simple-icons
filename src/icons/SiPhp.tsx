...
export const SiPhpHex = "777BB4";
export const SiPhpTitle = "PHP";
export const SiPhpSlug = "php";

export function SiPhp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhpTitle}
      {...props}
    >
