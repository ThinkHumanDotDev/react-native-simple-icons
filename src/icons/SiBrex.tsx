...
export const SiBrexHex = "212121";
export const SiBrexTitle = "Brex";
export const SiBrexSlug = "brex";

export function SiBrex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBrexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBrexTitle}
      {...props}
    >
