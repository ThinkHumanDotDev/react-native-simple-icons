...
export const SiRottentomatoesHex = "FA320A";
export const SiRottentomatoesTitle = "Rotten Tomatoes";
export const SiRottentomatoesSlug = "rottentomatoes";

export function SiRottentomatoes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRottentomatoesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRottentomatoesTitle}
      {...props}
    >
