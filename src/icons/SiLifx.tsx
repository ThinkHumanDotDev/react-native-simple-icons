...
export const SiLifxHex = "000000";
export const SiLifxTitle = "LIFX";
export const SiLifxSlug = "lifx";

export function SiLifx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLifxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLifxTitle}
      {...props}
    >
