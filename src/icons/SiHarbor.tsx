...
export const SiHarborHex = "60B932";
export const SiHarborTitle = "Harbor";
export const SiHarborSlug = "harbor";

export function SiHarbor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHarborHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHarborTitle}
      {...props}
    >
