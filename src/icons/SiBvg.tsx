...
export const SiBvgHex = "F0D722";
export const SiBvgTitle = "BVG";
export const SiBvgSlug = "bvg";

export function SiBvg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBvgHex}` : color;
