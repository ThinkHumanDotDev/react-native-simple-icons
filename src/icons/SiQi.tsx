...
export const SiQiHex = "000000";
export const SiQiTitle = "Qi";
export const SiQiSlug = "qi";

export function SiQi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQiTitle}
      {...props}
    >
