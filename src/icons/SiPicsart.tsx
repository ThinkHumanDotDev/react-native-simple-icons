...
export const SiPicsartHex = "C209C1";
export const SiPicsartTitle = "Picsart";
export const SiPicsartSlug = "picsart";

export function SiPicsart({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPicsartHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPicsartTitle}
      {...props}
    >
