...
export const SiFreetubeHex = "F04242";
export const SiFreetubeTitle = "FreeTube";
export const SiFreetubeSlug = "freetube";

export function SiFreetube({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreetubeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreetubeTitle}
      {...props}
    >
