...
export const SiInkscapeHex = "000000";
export const SiInkscapeTitle = "Inkscape";
export const SiInkscapeSlug = "inkscape";

export function SiInkscape({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInkscapeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInkscapeTitle}
      {...props}
    >
