...
export const SiIndigoHex = "09009B";
export const SiIndigoTitle = "IndiGo";
export const SiIndigoSlug = "indigo";

export function SiIndigo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIndigoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIndigoTitle}
      {...props}
    >
