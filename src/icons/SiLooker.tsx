...
export const SiLookerHex = "4285F4";
export const SiLookerTitle = "Looker";
export const SiLookerSlug = "looker";

export function SiLooker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLookerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLookerTitle}
      {...props}
    >
