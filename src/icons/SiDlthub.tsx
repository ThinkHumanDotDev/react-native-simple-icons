...
export const SiDlthubHex = "59C1D5";
export const SiDlthubTitle = "dlthub";
export const SiDlthubSlug = "dlthub";

export function SiDlthub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDlthubHex}` : color;
