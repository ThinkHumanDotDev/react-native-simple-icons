...
export const SiJitpackHex = "000000";
export const SiJitpackTitle = "JitPack";
export const SiJitpackSlug = "jitpack";

export function SiJitpack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJitpackHex}` : color;
