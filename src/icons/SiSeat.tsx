...
export const SiSeatHex = "33302E";
export const SiSeatTitle = "SEAT";
export const SiSeatSlug = "seat";

export function SiSeat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSeatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSeatTitle}
      {...props}
    >
