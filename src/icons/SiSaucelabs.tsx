...
export const SiSaucelabsHex = "3DDC91";
export const SiSaucelabsTitle = "Sauce Labs";
export const SiSaucelabsSlug = "saucelabs";

export function SiSaucelabs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSaucelabsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSaucelabsTitle}
      {...props}
    >
