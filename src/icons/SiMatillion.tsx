...
export const SiMatillionHex = "19E57F";
export const SiMatillionTitle = "Matillion";
export const SiMatillionSlug = "matillion";

export function SiMatillion({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMatillionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMatillionTitle}
      {...props}
    >
