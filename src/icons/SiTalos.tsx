...
export const SiTalosHex = "FF7300";
export const SiTalosTitle = "Talos";
export const SiTalosSlug = "talos";

export function SiTalos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTalosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTalosTitle}
      {...props}
    >
