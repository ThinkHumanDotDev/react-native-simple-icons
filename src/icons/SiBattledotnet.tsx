...
export const SiBattledotnetHex = "4381C3";
export const SiBattledotnetTitle = "Battle.net";
export const SiBattledotnetSlug = "battledotnet";

export function SiBattledotnet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBattledotnetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBattledotnetTitle}
      {...props}
    >
