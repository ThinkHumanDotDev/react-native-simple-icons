...
export const SiVtexHex = "ED125F";
export const SiVtexTitle = "VTEX";
export const SiVtexSlug = "vtex";

export function SiVtex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVtexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVtexTitle}
      {...props}
    >
