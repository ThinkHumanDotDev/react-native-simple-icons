...
export const SiReweHex = "CC071E";
export const SiReweTitle = "REWE";
export const SiReweSlug = "rewe";

export function SiRewe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReweHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReweTitle}
      {...props}
    >
