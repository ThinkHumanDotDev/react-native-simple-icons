...
export const SiTaichilangHex = "000000";
export const SiTaichilangTitle = "Taichi Lang";
export const SiTaichilangSlug = "taichilang";

export function SiTaichilang({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTaichilangHex}` : color;
