...
export const SiBarmeniaHex = "009FE3";
export const SiBarmeniaTitle = "Barmenia";
export const SiBarmeniaSlug = "barmenia";

export function SiBarmenia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBarmeniaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBarmeniaTitle}
      {...props}
    >
