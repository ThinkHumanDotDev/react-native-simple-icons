...
export const SiWebrtcHex = "333333";
export const SiWebrtcTitle = "WebRTC";
export const SiWebrtcSlug = "webrtc";

export function SiWebrtc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWebrtcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWebrtcTitle}
      {...props}
    >
