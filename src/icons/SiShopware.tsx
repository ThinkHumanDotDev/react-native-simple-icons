...
export const SiShopwareHex = "189EFF";
export const SiShopwareTitle = "Shopware";
export const SiShopwareSlug = "shopware";

export function SiShopware({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShopwareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShopwareTitle}
      {...props}
    >
