...
export const SiRootsHex = "525DDC";
export const SiRootsTitle = "Roots";
export const SiRootsSlug = "roots";

export function SiRoots({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRootsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRootsTitle}
      {...props}
    >
