...
export const SiGooglemessagesHex = "1A73E8";
export const SiGooglemessagesTitle = "Google Messages";
export const SiGooglemessagesSlug = "googlemessages";

export function SiGooglemessages({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglemessagesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglemessagesTitle}
      {...props}
    >
