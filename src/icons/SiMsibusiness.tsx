...
export const SiMsibusinessHex = "9A8555";
export const SiMsibusinessTitle = "MSI Business";
export const SiMsibusinessSlug = "msibusiness";

export function SiMsibusiness({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMsibusinessHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMsibusinessTitle}
      {...props}
    >
