...
export const SiWweHex = "000000";
export const SiWweTitle = "WWE";
export const SiWweSlug = "wwe";

export function SiWwe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWweHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWweTitle}
      {...props}
    >
