...
export const SiNewyorktimesHex = "000000";
export const SiNewyorktimesTitle = "New York Times";
export const SiNewyorktimesSlug = "newyorktimes";

export function SiNewyorktimes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNewyorktimesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNewyorktimesTitle}
      {...props}
    >
