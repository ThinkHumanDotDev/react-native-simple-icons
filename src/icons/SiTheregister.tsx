...
export const SiTheregisterHex = "FF0000";
export const SiTheregisterTitle = "The Register";
export const SiTheregisterSlug = "theregister";

export function SiTheregister({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTheregisterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTheregisterTitle}
      {...props}
    >
