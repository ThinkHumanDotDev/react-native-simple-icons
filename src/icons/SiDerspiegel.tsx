...
export const SiDerspiegelHex = "E64415";
export const SiDerspiegelTitle = "Der Spiegel";
export const SiDerspiegelSlug = "derspiegel";

export function SiDerspiegel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDerspiegelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDerspiegelTitle}
      {...props}
    >
