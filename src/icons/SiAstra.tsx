...
export const SiAstraHex = "5C2EDE";
export const SiAstraTitle = "Astra";
export const SiAstraSlug = "astra";

export function SiAstra({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAstraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAstraTitle}
      {...props}
    >
