...
export const SiKaiosHex = "6F02B5";
export const SiKaiosTitle = "KaiOS";
export const SiKaiosSlug = "kaios";

export function SiKaios({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKaiosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKaiosTitle}
      {...props}
    >
