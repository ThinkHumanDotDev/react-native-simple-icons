...
export const SiFloodHex = "4285F4";
export const SiFloodTitle = "Flood";
export const SiFloodSlug = "flood";

export function SiFlood({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFloodHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFloodTitle}
      {...props}
    >
