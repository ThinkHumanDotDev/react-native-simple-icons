...
export const SiAirchinaHex = "E30E17";
export const SiAirchinaTitle = "Air China";
export const SiAirchinaSlug = "airchina";

export function SiAirchina({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirchinaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirchinaTitle}
      {...props}
    >
