...
export const SiBookstackHex = "0288D1";
export const SiBookstackTitle = "BookStack";
export const SiBookstackSlug = "bookstack";

export function SiBookstack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBookstackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBookstackTitle}
      {...props}
    >
