...
export const SiKarlsruherverkehrsverbundHex = "9B2321";
export const SiKarlsruherverkehrsverbundTitle = "Karlsruher Verkehrsverbund";
export const SiKarlsruherverkehrsverbundSlug = "karlsruherverkehrsverbund";

export function SiKarlsruherverkehrsverbund({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKarlsruherverkehrsverbundHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKarlsruherverkehrsverbundTitle}
      {...props}
    >
