...
export const SiCreativecommonsHex = "ED592F";
export const SiCreativecommonsTitle = "Creative Commons";
export const SiCreativecommonsSlug = "creativecommons";

export function SiCreativecommons({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCreativecommonsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCreativecommonsTitle}
      {...props}
    >
