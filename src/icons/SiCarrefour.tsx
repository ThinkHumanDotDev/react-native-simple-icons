...
export const SiCarrefourHex = "004E9F";
export const SiCarrefourTitle = "Carrefour";
export const SiCarrefourSlug = "carrefour";

export function SiCarrefour({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCarrefourHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCarrefourTitle}
      {...props}
    >
