...
export const SiFilaHex = "002D62";
export const SiFilaTitle = "Fila";
export const SiFilaSlug = "fila";

export function SiFila({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFilaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFilaTitle}
      {...props}
    >
