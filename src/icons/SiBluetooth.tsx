...
export const SiBluetoothHex = "0082FC";
export const SiBluetoothTitle = "Bluetooth";
export const SiBluetoothSlug = "bluetooth";

export function SiBluetooth({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBluetoothHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBluetoothTitle}
      {...props}
    >
