...
export const SiCountingworksproHex = "2E3084";
export const SiCountingworksproTitle = "CountingWorks PRO";
export const SiCountingworksproSlug = "countingworkspro";

export function SiCountingworkspro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCountingworksproHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCountingworksproTitle}
      {...props}
    >
