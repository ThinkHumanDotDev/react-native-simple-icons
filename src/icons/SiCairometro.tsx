...
export const SiCairometroHex = "C10C0C";
export const SiCairometroTitle = "Cairo Metro";
export const SiCairometroSlug = "cairometro";

export function SiCairometro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCairometroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCairometroTitle}
      {...props}
    >
