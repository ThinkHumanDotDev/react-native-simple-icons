...
export const SiTeespringHex = "ED2761";
export const SiTeespringTitle = "Teespring";
export const SiTeespringSlug = "teespring";

export function SiTeespring({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTeespringHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTeespringTitle}
      {...props}
    >
