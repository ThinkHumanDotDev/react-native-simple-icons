...
export const SiPinetworkHex = "F4AF47";
export const SiPinetworkTitle = "Pi Network";
export const SiPinetworkSlug = "pinetwork";

export function SiPinetwork({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPinetworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPinetworkTitle}
      {...props}
    >
