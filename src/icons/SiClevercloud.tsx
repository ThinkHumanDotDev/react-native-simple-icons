...
export const SiClevercloudHex = "171C36";
export const SiClevercloudTitle = "Clever Cloud";
export const SiClevercloudSlug = "clevercloud";

export function SiClevercloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClevercloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClevercloudTitle}
      {...props}
    >
