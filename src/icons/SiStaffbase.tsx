...
export const SiStaffbaseHex = "00A4FD";
export const SiStaffbaseTitle = "Staffbase";
export const SiStaffbaseSlug = "staffbase";

export function SiStaffbase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStaffbaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStaffbaseTitle}
      {...props}
    >
