...
export const SiSnapdragonHex = "C33139";
export const SiSnapdragonTitle = "Snapdragon";
export const SiSnapdragonSlug = "snapdragon";

export function SiSnapdragon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSnapdragonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSnapdragonTitle}
      {...props}
    >
