...
export const SiLuauHex = "00A2FF";
export const SiLuauTitle = "Luau";
export const SiLuauSlug = "luau";

export function SiLuau({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLuauHex}` : color;
