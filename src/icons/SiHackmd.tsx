...
export const SiHackmdHex = "453AFF";
export const SiHackmdTitle = "HackMD";
export const SiHackmdSlug = "hackmd";

export function SiHackmd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHackmdHex}` : color;
