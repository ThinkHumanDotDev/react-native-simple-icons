...
export const SiLivechatHex = "FF5100";
export const SiLivechatTitle = "LiveChat";
export const SiLivechatSlug = "livechat";

export function SiLivechat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLivechatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLivechatTitle}
      {...props}
    >
