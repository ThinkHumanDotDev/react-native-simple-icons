...
export const SiAsciidoctorHex = "E40046";
export const SiAsciidoctorTitle = "Asciidoctor";
export const SiAsciidoctorSlug = "asciidoctor";

export function SiAsciidoctor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAsciidoctorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAsciidoctorTitle}
      {...props}
    >
