...
export const SiDrupalHex = "0678BE";
export const SiDrupalTitle = "Drupal";
export const SiDrupalSlug = "drupal";

export function SiDrupal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDrupalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDrupalTitle}
      {...props}
    >
