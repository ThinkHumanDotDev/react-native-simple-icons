...
export const SiLeanpubHex = "262425";
export const SiLeanpubTitle = "Leanpub";
export const SiLeanpubSlug = "leanpub";

export function SiLeanpub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLeanpubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLeanpubTitle}
      {...props}
    >
