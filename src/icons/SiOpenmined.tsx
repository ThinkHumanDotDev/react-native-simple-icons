...
export const SiOpenminedHex = "ED986C";
export const SiOpenminedTitle = "OpenMined";
export const SiOpenminedSlug = "openmined";

export function SiOpenmined({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenminedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenminedTitle}
      {...props}
    >
