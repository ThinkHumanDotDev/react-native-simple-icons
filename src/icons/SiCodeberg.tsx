...
export const SiCodebergHex = "2185D0";
export const SiCodebergTitle = "Codeberg";
export const SiCodebergSlug = "codeberg";

export function SiCodeberg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodebergHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodebergTitle}
      {...props}
    >
