...
export const SiTinaHex = "EC4815";
export const SiTinaTitle = "Tina";
export const SiTinaSlug = "tina";

export function SiTina({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTinaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTinaTitle}
      {...props}
    >
