...
export const SiMilvusHex = "00A1EA";
export const SiMilvusTitle = "Milvus";
export const SiMilvusSlug = "milvus";

export function SiMilvus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMilvusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMilvusTitle}
      {...props}
    >
