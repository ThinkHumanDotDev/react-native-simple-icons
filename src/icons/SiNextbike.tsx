...
export const SiNextbikeHex = "0046D7";
export const SiNextbikeTitle = "nextbike";
export const SiNextbikeSlug = "nextbike";

export function SiNextbike({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextbikeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextbikeTitle}
      {...props}
    >
