...
export const SiDoiHex = "FAB70C";
export const SiDoiTitle = "DOI";
export const SiDoiSlug = "doi";

export function SiDoi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDoiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDoiTitle}
      {...props}
    >
