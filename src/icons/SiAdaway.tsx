...
export const SiAdawayHex = "B71C1C";
export const SiAdawayTitle = "AdAway";
export const SiAdawaySlug = "adaway";

export function SiAdaway({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAdawayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAdawayTitle}
      {...props}
    >
