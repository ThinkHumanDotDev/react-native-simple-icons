...
export const SiSuiHex = "4DA2FF";
export const SiSuiTitle = "Sui";
export const SiSuiSlug = "sui";

export function SiSui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSuiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSuiTitle}
      {...props}
    >
