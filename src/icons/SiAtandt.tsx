...
export const SiAtandtHex = "009FDB";
export const SiAtandtTitle = "AT&T";
export const SiAtandtSlug = "atandt";

export function SiAtandt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAtandtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAtandtTitle}
      {...props}
    >
