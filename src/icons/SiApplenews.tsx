...
export const SiApplenewsHex = "FD415E";
export const SiApplenewsTitle = "Apple News";
export const SiApplenewsSlug = "applenews";

export function SiApplenews({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApplenewsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApplenewsTitle}
      {...props}
    >
