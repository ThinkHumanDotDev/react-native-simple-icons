...
export const SiZigbeeHex = "EB0443";
export const SiZigbeeTitle = "Zigbee";
export const SiZigbeeSlug = "zigbee";

export function SiZigbee({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZigbeeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZigbeeTitle}
      {...props}
    >
