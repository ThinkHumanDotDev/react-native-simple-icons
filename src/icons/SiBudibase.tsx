...
export const SiBudibaseHex = "000000";
export const SiBudibaseTitle = "Budibase";
export const SiBudibaseSlug = "budibase";

export function SiBudibase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBudibaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBudibaseTitle}
      {...props}
    >
