...
export const SiSwrHex = "000000";
export const SiSwrTitle = "SWR";
export const SiSwrSlug = "swr";

export function SiSwr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSwrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSwrTitle}
      {...props}
    >
