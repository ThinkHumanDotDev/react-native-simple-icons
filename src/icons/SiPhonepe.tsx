...
export const SiPhonepeHex = "5F259F";
export const SiPhonepeTitle = "PhonePe";
export const SiPhonepeSlug = "phonepe";

export function SiPhonepe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhonepeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhonepeTitle}
      {...props}
    >
