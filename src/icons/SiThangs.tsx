...
export const SiThangsHex = "FFBC00";
export const SiThangsTitle = "Thangs";
export const SiThangsSlug = "thangs";

export function SiThangs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThangsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThangsTitle}
      {...props}
    >
