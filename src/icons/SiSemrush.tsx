...
export const SiSemrushHex = "FF642D";
export const SiSemrushTitle = "Semrush";
export const SiSemrushSlug = "semrush";

export function SiSemrush({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSemrushHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSemrushTitle}
      {...props}
    >
