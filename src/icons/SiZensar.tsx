...
export const SiZensarHex = "000000";
export const SiZensarTitle = "Zensar";
export const SiZensarSlug = "zensar";

export function SiZensar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZensarHex}` : color;
