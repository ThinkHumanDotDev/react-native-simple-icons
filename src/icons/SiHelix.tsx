...
export const SiHelixHex = "281733";
export const SiHelixTitle = "Helix";
export const SiHelixSlug = "helix";

export function SiHelix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHelixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHelixTitle}
      {...props}
    >
