...
export const SiAsahilinuxHex = "A61200";
export const SiAsahilinuxTitle = "Asahi Linux";
export const SiAsahilinuxSlug = "asahilinux";

export function SiAsahilinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAsahilinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAsahilinuxTitle}
      {...props}
    >
