...
export const SiMintlifyHex = "18E299";
export const SiMintlifyTitle = "Mintlify";
export const SiMintlifySlug = "mintlify";

export function SiMintlify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMintlifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMintlifyTitle}
      {...props}
    >
