...
export const SiDistrokidHex = "231F20";
export const SiDistrokidTitle = "Distrokid";
export const SiDistrokidSlug = "distrokid";

export function SiDistrokid({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDistrokidHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDistrokidTitle}
      {...props}
    >
