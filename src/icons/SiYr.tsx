...
export const SiYrHex = "00B9F1";
export const SiYrTitle = "Yr";
export const SiYrSlug = "yr";

export function SiYr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYrTitle}
      {...props}
    >
