...
export const SiFreecodecampHex = "0A0A23";
export const SiFreecodecampTitle = "freeCodeCamp";
export const SiFreecodecampSlug = "freecodecamp";

export function SiFreecodecamp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreecodecampHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreecodecampTitle}
      {...props}
    >
