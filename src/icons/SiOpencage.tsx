...
export const SiOpencageHex = "1A8865";
export const SiOpencageTitle = "OpenCage";
export const SiOpencageSlug = "opencage";

export function SiOpencage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpencageHex}` : color;
