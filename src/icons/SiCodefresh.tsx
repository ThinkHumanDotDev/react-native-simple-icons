...
export const SiCodefreshHex = "08B1AB";
export const SiCodefreshTitle = "Codefresh";
export const SiCodefreshSlug = "codefresh";

export function SiCodefresh({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodefreshHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodefreshTitle}
      {...props}
    >
