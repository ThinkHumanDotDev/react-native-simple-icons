...
export const SiApollographqlHex = "311C87";
export const SiApollographqlTitle = "Apollo GraphQL";
export const SiApollographqlSlug = "apollographql";

export function SiApollographql({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApollographqlHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApollographqlTitle}
      {...props}
    >
