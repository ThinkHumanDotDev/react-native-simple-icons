...
export const SiOreillyHex = "D3002D";
export const SiOreillyTitle = "O'Reilly";
export const SiOreillySlug = "oreilly";

export function SiOreilly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOreillyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOreillyTitle}
      {...props}
    >
