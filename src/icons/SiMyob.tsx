...
export const SiMyobHex = "7B14EF";
export const SiMyobTitle = "MYOB";
export const SiMyobSlug = "myob";

export function SiMyob({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMyobHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMyobTitle}
      {...props}
    >
