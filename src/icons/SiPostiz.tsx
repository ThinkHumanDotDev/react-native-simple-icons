...
export const SiPostizHex = "612BD3";
export const SiPostizTitle = "Postiz";
export const SiPostizSlug = "postiz";

export function SiPostiz({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPostizHex}` : color;
