...
export const SiPdmHex = "AC75D7";
export const SiPdmTitle = "PDM";
export const SiPdmSlug = "pdm";

export function SiPdm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPdmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPdmTitle}
      {...props}
    >
