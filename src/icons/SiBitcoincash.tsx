...
export const SiBitcoincashHex = "0AC18E";
export const SiBitcoincashTitle = "Bitcoin Cash";
export const SiBitcoincashSlug = "bitcoincash";

export function SiBitcoincash({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBitcoincashHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBitcoincashTitle}
      {...props}
    >
