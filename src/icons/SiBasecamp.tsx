...
export const SiBasecampHex = "1D2D35";
export const SiBasecampTitle = "Basecamp";
export const SiBasecampSlug = "basecamp";

export function SiBasecamp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBasecampHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBasecampTitle}
      {...props}
    >
