...
export const SiPlexHex = "EBAF00";
export const SiPlexTitle = "Plex";
export const SiPlexSlug = "plex";

export function SiPlex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlexTitle}
      {...props}
    >
