...
export const SiTroveHex = "2D004B";
export const SiTroveTitle = "Trove";
export const SiTroveSlug = "trove";

export function SiTrove({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTroveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTroveTitle}
      {...props}
    >
