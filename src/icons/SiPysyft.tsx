...
export const SiPysyftHex = "F1BF7A";
export const SiPysyftTitle = "PySyft";
export const SiPysyftSlug = "pysyft";

export function SiPysyft({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPysyftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPysyftTitle}
      {...props}
    >
