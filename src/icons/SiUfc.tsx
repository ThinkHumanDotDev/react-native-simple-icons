...
export const SiUfcHex = "D20A0A";
export const SiUfcTitle = "UFC";
export const SiUfcSlug = "ufc";

export function SiUfc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUfcHex}` : color;
