...
export const SiResharperHex = "000000";
export const SiResharperTitle = "ReSharper";
export const SiResharperSlug = "resharper";

export function SiResharper({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiResharperHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiResharperTitle}
      {...props}
    >
