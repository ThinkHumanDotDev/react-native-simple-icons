...
export const SiLegacygamesHex = "144B9E";
export const SiLegacygamesTitle = "Legacy Games";
export const SiLegacygamesSlug = "legacygames";

export function SiLegacygames({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLegacygamesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLegacygamesTitle}
      {...props}
    >
