...
export const SiAppmanagerHex = "DCAF74";
export const SiAppmanagerTitle = "AppManager";
export const SiAppmanagerSlug = "appmanager";

export function SiAppmanager({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppmanagerHex}` : color;
