...
export const SiTetherHex = "50AF95";
export const SiTetherTitle = "Tether";
export const SiTetherSlug = "tether";

export function SiTether({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTetherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTetherTitle}
      {...props}
    >
