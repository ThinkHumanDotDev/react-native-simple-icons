...
export const SiIterm2Hex = "000000";
export const SiIterm2Title = "iTerm2";
export const SiIterm2Slug = "iterm2";

export function SiIterm2({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIterm2Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIterm2Title}
      {...props}
    >
