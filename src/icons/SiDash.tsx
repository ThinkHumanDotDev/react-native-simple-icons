...
export const SiDashHex = "008DE4";
export const SiDashTitle = "Dash";
export const SiDashSlug = "dash";

export function SiDash({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDashHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDashTitle}
      {...props}
    >
