...
export const SiSingaporeairlinesHex = "F99F1C";
export const SiSingaporeairlinesTitle = "Singapore Airlines";
export const SiSingaporeairlinesSlug = "singaporeairlines";

export function SiSingaporeairlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSingaporeairlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSingaporeairlinesTitle}
      {...props}
    >
