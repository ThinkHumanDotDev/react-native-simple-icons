...
export const SiAlliedmoddersHex = "1578D3";
export const SiAlliedmoddersTitle = "AlliedModders";
export const SiAlliedmoddersSlug = "alliedmodders";

export function SiAlliedmodders({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlliedmoddersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlliedmoddersTitle}
      {...props}
    >
