...
export const SiHerouiHex = "000000";
export const SiHerouiTitle = "HeroUI";
export const SiHerouiSlug = "heroui";

export function SiHeroui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHerouiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHerouiTitle}
      {...props}
    >
