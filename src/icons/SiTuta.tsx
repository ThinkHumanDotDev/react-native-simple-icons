...
export const SiTutaHex = "850122";
export const SiTutaTitle = "Tuta";
export const SiTutaSlug = "tuta";

export function SiTuta({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTutaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTutaTitle}
      {...props}
    >
