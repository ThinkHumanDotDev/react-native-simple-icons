...
export const SiFilezillaHex = "BF0000";
export const SiFilezillaTitle = "FileZilla";
export const SiFilezillaSlug = "filezilla";

export function SiFilezilla({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFilezillaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFilezillaTitle}
      {...props}
    >
