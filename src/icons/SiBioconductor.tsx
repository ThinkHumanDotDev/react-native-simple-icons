...
export const SiBioconductorHex = "1A81C2";
export const SiBioconductorTitle = "Bioconductor";
export const SiBioconductorSlug = "bioconductor";

export function SiBioconductor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBioconductorHex}` : color;
