...
export const SiUtorrentHex = "76B83F";
export const SiUtorrentTitle = "uTorrent";
export const SiUtorrentSlug = "utorrent";

export function SiUtorrent({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUtorrentHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUtorrentTitle}
      {...props}
    >
