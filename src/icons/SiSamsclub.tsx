...
export const SiSamsclubHex = "0067A0";
export const SiSamsclubTitle = "Sam's Club";
export const SiSamsclubSlug = "samsclub";

export function SiSamsclub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSamsclubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSamsclubTitle}
      {...props}
    >
