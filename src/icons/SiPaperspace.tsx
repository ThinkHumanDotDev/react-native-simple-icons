...
export const SiPaperspaceHex = "000000";
export const SiPaperspaceTitle = "Paperspace";
export const SiPaperspaceSlug = "paperspace";

export function SiPaperspace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPaperspaceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPaperspaceTitle}
      {...props}
    >
