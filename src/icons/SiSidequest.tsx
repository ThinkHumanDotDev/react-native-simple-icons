...
export const SiSidequestHex = "101227";
export const SiSidequestTitle = "SideQuest";
export const SiSidequestSlug = "sidequest";

export function SiSidequest({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSidequestHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSidequestTitle}
      {...props}
    >
