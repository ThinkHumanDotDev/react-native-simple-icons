...
export const SiRobinhoodHex = "CCFF00";
export const SiRobinhoodTitle = "Robinhood";
export const SiRobinhoodSlug = "robinhood";

export function SiRobinhood({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRobinhoodHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRobinhoodTitle}
      {...props}
    >
