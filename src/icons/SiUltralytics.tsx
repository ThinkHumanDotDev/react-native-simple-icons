...
export const SiUltralyticsHex = "111F68";
export const SiUltralyticsTitle = "Ultralytics";
export const SiUltralyticsSlug = "ultralytics";

export function SiUltralytics({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUltralyticsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUltralyticsTitle}
      {...props}
    >
