...
export const SiCoverallsHex = "3F5767";
export const SiCoverallsTitle = "Coveralls";
export const SiCoverallsSlug = "coveralls";

export function SiCoveralls({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoverallsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoverallsTitle}
      {...props}
    >
