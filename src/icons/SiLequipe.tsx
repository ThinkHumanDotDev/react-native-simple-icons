...
export const SiLequipeHex = "E42829";
export const SiLequipeTitle = "L'Équipe";
export const SiLequipeSlug = "lequipe";

export function SiLequipe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLequipeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLequipeTitle}
      {...props}
    >
