...
export const SiBoeingHex = "1D439C";
export const SiBoeingTitle = "Boeing";
export const SiBoeingSlug = "boeing";

export function SiBoeing({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBoeingHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBoeingTitle}
      {...props}
    >
