...
export const SiDeliverooHex = "00CCBC";
export const SiDeliverooTitle = "Deliveroo";
export const SiDeliverooSlug = "deliveroo";

export function SiDeliveroo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeliverooHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeliverooTitle}
      {...props}
    >
