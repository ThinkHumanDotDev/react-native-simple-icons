...
export const SiWagmiHex = "000000";
export const SiWagmiTitle = "Wagmi";
export const SiWagmiSlug = "wagmi";

export function SiWagmi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWagmiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWagmiTitle}
      {...props}
    >
