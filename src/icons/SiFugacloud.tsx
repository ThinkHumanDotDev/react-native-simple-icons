...
export const SiFugacloudHex = "242F4B";
export const SiFugacloudTitle = "Fuga Cloud";
export const SiFugacloudSlug = "fugacloud";

export function SiFugacloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFugacloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFugacloudTitle}
      {...props}
    >
