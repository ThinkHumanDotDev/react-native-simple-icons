...
export const SiBlackberryHex = "000000";
export const SiBlackberryTitle = "Blackberry";
export const SiBlackberrySlug = "blackberry";

export function SiBlackberry({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBlackberryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBlackberryTitle}
      {...props}
    >
