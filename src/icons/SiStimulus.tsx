...
export const SiStimulusHex = "77E8B9";
export const SiStimulusTitle = "Stimulus";
export const SiStimulusSlug = "stimulus";

export function SiStimulus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStimulusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStimulusTitle}
      {...props}
    >
