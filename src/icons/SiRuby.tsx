...
export const SiRubyHex = "CC342D";
export const SiRubyTitle = "Ruby";
export const SiRubySlug = "ruby";

export function SiRuby({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRubyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRubyTitle}
      {...props}
    >
