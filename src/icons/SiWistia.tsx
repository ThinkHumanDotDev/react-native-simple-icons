...
export const SiWistiaHex = "58B7FE";
export const SiWistiaTitle = "Wistia";
export const SiWistiaSlug = "wistia";

export function SiWistia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWistiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWistiaTitle}
      {...props}
    >
