...
export const SiArtifacthubHex = "417598";
export const SiArtifacthubTitle = "Artifact Hub";
export const SiArtifacthubSlug = "artifacthub";

export function SiArtifacthub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArtifacthubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArtifacthubTitle}
      {...props}
    >
