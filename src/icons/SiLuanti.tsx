...
export const SiLuantiHex = "53AC56";
export const SiLuantiTitle = "Luanti";
export const SiLuantiSlug = "luanti";

export function SiLuanti({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLuantiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLuantiTitle}
      {...props}
    >
