...
export const SiIcicibankHex = "AE282E";
export const SiIcicibankTitle = "ICICI Bank";
export const SiIcicibankSlug = "icicibank";

export function SiIcicibank({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIcicibankHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIcicibankTitle}
      {...props}
    >
