...
export const SiBritishairwaysHex = "2E5C99";
export const SiBritishairwaysTitle = "British Airways";
export const SiBritishairwaysSlug = "britishairways";

export function SiBritishairways({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBritishairwaysHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBritishairwaysTitle}
      {...props}
    >
