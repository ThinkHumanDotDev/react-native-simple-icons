...
export const SiNginxHex = "009639";
export const SiNginxTitle = "NGINX";
export const SiNginxSlug = "nginx";

export function SiNginx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNginxHex}` : color;
