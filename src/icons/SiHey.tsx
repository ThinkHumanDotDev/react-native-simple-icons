...
export const SiHeyHex = "5522FA";
export const SiHeyTitle = "HEY";
export const SiHeySlug = "hey";

export function SiHey({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHeyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHeyTitle}
      {...props}
    >
