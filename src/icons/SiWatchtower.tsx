...
export const SiWatchtowerHex = "416271";
export const SiWatchtowerTitle = "Watchtower";
export const SiWatchtowerSlug = "watchtower";

export function SiWatchtower({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWatchtowerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWatchtowerTitle}
      {...props}
    >
