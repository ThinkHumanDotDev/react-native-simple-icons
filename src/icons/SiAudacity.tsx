...
export const SiAudacityHex = "0000CC";
export const SiAudacityTitle = "Audacity";
export const SiAudacitySlug = "audacity";

export function SiAudacity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAudacityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAudacityTitle}
      {...props}
    >
