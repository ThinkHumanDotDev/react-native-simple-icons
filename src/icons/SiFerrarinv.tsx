...
export const SiFerrarinvHex = "EB2E2C";
export const SiFerrarinvTitle = "Ferrari N.V.";
export const SiFerrarinvSlug = "ferrarinv";

export function SiFerrarinv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFerrarinvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFerrarinvTitle}
      {...props}
    >
