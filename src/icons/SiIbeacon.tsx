...
export const SiIbeaconHex = "3D7EBB";
export const SiIbeaconTitle = "iBeacon";
export const SiIbeaconSlug = "ibeacon";

export function SiIbeacon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIbeaconHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIbeaconTitle}
      {...props}
    >
