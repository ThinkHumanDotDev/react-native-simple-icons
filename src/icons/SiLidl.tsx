...
export const SiLidlHex = "0050AA";
export const SiLidlTitle = "Lidl";
export const SiLidlSlug = "lidl";

export function SiLidl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLidlHex}` : color;
