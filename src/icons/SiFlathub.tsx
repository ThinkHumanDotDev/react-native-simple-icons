...
export const SiFlathubHex = "000000";
export const SiFlathubTitle = "Flathub";
export const SiFlathubSlug = "flathub";

export function SiFlathub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFlathubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFlathubTitle}
      {...props}
    >
