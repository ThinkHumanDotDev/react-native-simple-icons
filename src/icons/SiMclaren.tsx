...
export const SiMclarenHex = "FF0000";
export const SiMclarenTitle = "McLaren";
export const SiMclarenSlug = "mclaren";

export function SiMclaren({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMclarenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMclarenTitle}
      {...props}
    >
