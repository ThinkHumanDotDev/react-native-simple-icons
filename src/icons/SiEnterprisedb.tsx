...
export const SiEnterprisedbHex = "FF3E00";
export const SiEnterprisedbTitle = "EnterpriseDB";
export const SiEnterprisedbSlug = "enterprisedb";

export function SiEnterprisedb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEnterprisedbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEnterprisedbTitle}
      {...props}
    >
