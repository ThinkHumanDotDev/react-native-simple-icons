...
export const SiBuiltbybitHex = "2D87C3";
export const SiBuiltbybitTitle = "BuiltByBit";
export const SiBuiltbybitSlug = "builtbybit";

export function SiBuiltbybit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBuiltbybitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBuiltbybitTitle}
      {...props}
    >
