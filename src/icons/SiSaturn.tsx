...
export const SiSaturnHex = "EB680B";
export const SiSaturnTitle = "Saturn";
export const SiSaturnSlug = "saturn";

export function SiSaturn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSaturnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSaturnTitle}
      {...props}
    >
