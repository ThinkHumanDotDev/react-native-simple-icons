...
export const SiQuarkusHex = "4695EB";
export const SiQuarkusTitle = "Quarkus";
export const SiQuarkusSlug = "quarkus";

export function SiQuarkus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQuarkusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQuarkusTitle}
      {...props}
    >
