...
export const SiFccHex = "1C3664";
export const SiFccTitle = "FCC";
export const SiFccSlug = "fcc";

export function SiFcc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFccHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFccTitle}
      {...props}
    >
