...
export const SiImagetoolboxHex = "60EA78";
export const SiImagetoolboxTitle = "Image Toolbox";
export const SiImagetoolboxSlug = "imagetoolbox";

export function SiImagetoolbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiImagetoolboxHex}` : color;
