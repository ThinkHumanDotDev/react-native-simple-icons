...
export const SiConvexHex = "EE342F";
export const SiConvexTitle = "Convex";
export const SiConvexSlug = "convex";

export function SiConvex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiConvexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiConvexTitle}
      {...props}
    >
