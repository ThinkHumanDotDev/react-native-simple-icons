...
export const SiDtsHex = "F98B2B";
export const SiDtsTitle = "DTS";
export const SiDtsSlug = "dts";

export function SiDts({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDtsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDtsTitle}
      {...props}
    >
