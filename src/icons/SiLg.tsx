...
export const SiLgHex = "A50034";
export const SiLgTitle = "LG";
export const SiLgSlug = "lg";

export function SiLg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLgHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLgTitle}
      {...props}
    >
