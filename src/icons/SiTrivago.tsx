...
export const SiTrivagoHex = "E32851";
export const SiTrivagoTitle = "trivago";
export const SiTrivagoSlug = "trivago";

export function SiTrivago({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrivagoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrivagoTitle}
      {...props}
    >
