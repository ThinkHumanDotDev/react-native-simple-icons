...
export const SiUplabsHex = "3930D8";
export const SiUplabsTitle = "UpLabs";
export const SiUplabsSlug = "uplabs";

export function SiUplabs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUplabsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUplabsTitle}
      {...props}
    >
