...
export const SiValaHex = "7239B3";
export const SiValaTitle = "Vala";
export const SiValaSlug = "vala";

export function SiVala({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiValaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiValaTitle}
      {...props}
    >
