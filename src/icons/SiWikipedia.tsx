...
export const SiWikipediaHex = "000000";
export const SiWikipediaTitle = "Wikipedia";
export const SiWikipediaSlug = "wikipedia";

export function SiWikipedia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikipediaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikipediaTitle}
      {...props}
    >
