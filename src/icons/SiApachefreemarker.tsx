...
export const SiApachefreemarkerHex = "326CAC";
export const SiApachefreemarkerTitle = "Apache FreeMarker";
export const SiApachefreemarkerSlug = "apachefreemarker";

export function SiApachefreemarker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachefreemarkerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachefreemarkerTitle}
      {...props}
    >
