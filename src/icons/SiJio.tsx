...
export const SiJioHex = "0A2885";
export const SiJioTitle = "Jio";
export const SiJioSlug = "jio";

export function SiJio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJioTitle}
      {...props}
    >
