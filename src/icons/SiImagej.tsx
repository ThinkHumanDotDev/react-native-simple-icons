...
export const SiImagejHex = "00D8E0";
export const SiImagejTitle = "ImageJ";
export const SiImagejSlug = "imagej";

export function SiImagej({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiImagejHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiImagejTitle}
      {...props}
    >
