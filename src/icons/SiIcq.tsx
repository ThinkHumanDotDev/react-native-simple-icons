...
export const SiIcqHex = "24FF00";
export const SiIcqTitle = "ICQ";
export const SiIcqSlug = "icq";

export function SiIcq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIcqHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIcqTitle}
      {...props}
    >
