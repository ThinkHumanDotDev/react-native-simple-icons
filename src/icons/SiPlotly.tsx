...
export const SiPlotlyHex = "7A76FF";
export const SiPlotlyTitle = "Plotly";
export const SiPlotlySlug = "plotly";

export function SiPlotly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlotlyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlotlyTitle}
      {...props}
    >
