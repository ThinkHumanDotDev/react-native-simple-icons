...
export const SiCommaHex = "51FF00";
export const SiCommaTitle = "comma";
export const SiCommaSlug = "comma";

export function SiComma({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCommaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCommaTitle}
      {...props}
    >
