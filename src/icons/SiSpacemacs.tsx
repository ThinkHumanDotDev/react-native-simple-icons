...
export const SiSpacemacsHex = "9266CC";
export const SiSpacemacsTitle = "Spacemacs";
export const SiSpacemacsSlug = "spacemacs";

export function SiSpacemacs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpacemacsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpacemacsTitle}
      {...props}
    >
