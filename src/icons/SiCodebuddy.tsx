...
export const SiCodebuddyHex = "6C4DFF";
export const SiCodebuddyTitle = "CodeBuddy";
export const SiCodebuddySlug = "codebuddy";

export function SiCodebuddy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodebuddyHex}` : color;
