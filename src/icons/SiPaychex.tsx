...
export const SiPaychexHex = "004B8D";
export const SiPaychexTitle = "Paychex";
export const SiPaychexSlug = "paychex";

export function SiPaychex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPaychexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPaychexTitle}
      {...props}
    >
