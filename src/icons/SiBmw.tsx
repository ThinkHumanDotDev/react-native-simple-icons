...
export const SiBmwHex = "0066B1";
export const SiBmwTitle = "BMW";
export const SiBmwSlug = "bmw";

export function SiBmw({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBmwHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBmwTitle}
      {...props}
    >
