...
export const SiTalendHex = "FF6D70";
export const SiTalendTitle = "Talend";
export const SiTalendSlug = "talend";

export function SiTalend({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTalendHex}` : color;
