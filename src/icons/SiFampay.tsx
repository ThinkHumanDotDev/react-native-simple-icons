...
export const SiFampayHex = "FFAD00";
export const SiFampayTitle = "FamPay";
export const SiFampaySlug = "fampay";

export function SiFampay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFampayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFampayTitle}
      {...props}
    >
