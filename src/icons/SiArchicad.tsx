...
export const SiArchicadHex = "2D50A5";
export const SiArchicadTitle = "Archicad";
export const SiArchicadSlug = "archicad";

export function SiArchicad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArchicadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArchicadTitle}
      {...props}
    >
