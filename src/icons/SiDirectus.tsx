...
export const SiDirectusHex = "263238";
export const SiDirectusTitle = "Directus";
export const SiDirectusSlug = "directus";

export function SiDirectus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDirectusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDirectusTitle}
      {...props}
    >
