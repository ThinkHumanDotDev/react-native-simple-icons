...
export const SiCloudnativebuildHex = "F76945";
export const SiCloudnativebuildTitle = "Cloud Native Build";
export const SiCloudnativebuildSlug = "cloudnativebuild";

export function SiCloudnativebuild({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudnativebuildHex}` : color;
