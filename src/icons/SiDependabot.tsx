...
export const SiDependabotHex = "025E8C";
export const SiDependabotTitle = "Dependabot";
export const SiDependabotSlug = "dependabot";

export function SiDependabot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDependabotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDependabotTitle}
      {...props}
    >
