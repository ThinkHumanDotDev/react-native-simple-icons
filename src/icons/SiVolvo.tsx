...
export const SiVolvoHex = "003057";
export const SiVolvoTitle = "Volvo";
export const SiVolvoSlug = "volvo";

export function SiVolvo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVolvoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVolvoTitle}
      {...props}
    >
