...
export const SiAutodeskrevitHex = "186BFF";
export const SiAutodeskrevitTitle = "Autodesk Revit";
export const SiAutodeskrevitSlug = "autodeskrevit";

export function SiAutodeskrevit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutodeskrevitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutodeskrevitTitle}
      {...props}
    >
