...
export const SiElgatoHex = "101010";
export const SiElgatoTitle = "Elgato";
export const SiElgatoSlug = "elgato";

export function SiElgato({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElgatoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElgatoTitle}
      {...props}
    >
