...
export const SiDenoHex = "000000";
export const SiDenoTitle = "Deno";
export const SiDenoSlug = "deno";

export function SiDeno({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDenoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDenoTitle}
      {...props}
    >
