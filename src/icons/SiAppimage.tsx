...
export const SiAppimageHex = "739FB9";
export const SiAppimageTitle = "AppImage";
export const SiAppimageSlug = "appimage";

export function SiAppimage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppimageHex}` : color;
