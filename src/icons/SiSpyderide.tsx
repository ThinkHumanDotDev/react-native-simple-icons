...
export const SiSpyderideHex = "8C0000";
export const SiSpyderideTitle = "Spyder IDE";
export const SiSpyderideSlug = "spyderide";

export function SiSpyderide({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpyderideHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpyderideTitle}
      {...props}
    >
