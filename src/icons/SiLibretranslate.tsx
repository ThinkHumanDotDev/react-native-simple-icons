...
export const SiLibretranslateHex = "1565C0";
export const SiLibretranslateTitle = "LibreTranslate";
export const SiLibretranslateSlug = "libretranslate";

export function SiLibretranslate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLibretranslateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLibretranslateTitle}
      {...props}
    >
