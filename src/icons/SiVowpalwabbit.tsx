...
export const SiVowpalwabbitHex = "FF81F9";
export const SiVowpalwabbitTitle = "Vowpal Wabbit";
export const SiVowpalwabbitSlug = "vowpalwabbit";

export function SiVowpalwabbit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVowpalwabbitHex}` : color;
