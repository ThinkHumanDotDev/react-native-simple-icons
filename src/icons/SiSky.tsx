...
export const SiSkyHex = "0072C9";
export const SiSkyTitle = "Sky";
export const SiSkySlug = "sky";

export function SiSky({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSkyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSkyTitle}
      {...props}
    >
