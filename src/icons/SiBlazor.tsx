...
export const SiBlazorHex = "512BD4";
export const SiBlazorTitle = "Blazor";
export const SiBlazorSlug = "blazor";

export function SiBlazor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBlazorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBlazorTitle}
      {...props}
    >
