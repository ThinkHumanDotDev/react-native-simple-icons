...
export const SiZolaHex = "EAE7D6";
export const SiZolaTitle = "Zola";
export const SiZolaSlug = "zola";

export function SiZola({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZolaHex}` : color;
