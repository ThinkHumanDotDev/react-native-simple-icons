...
export const SiKarakeepHex = "000000";
export const SiKarakeepTitle = "Karakeep";
export const SiKarakeepSlug = "karakeep";

export function SiKarakeep({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKarakeepHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKarakeepTitle}
      {...props}
    >
