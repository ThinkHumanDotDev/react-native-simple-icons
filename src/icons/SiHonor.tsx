...
export const SiHonorHex = "000000";
export const SiHonorTitle = "Honor";
export const SiHonorSlug = "honor";

export function SiHonor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHonorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHonorTitle}
      {...props}
    >
