...
export const SiHomifyHex = "7DCDA3";
export const SiHomifyTitle = "homify";
export const SiHomifySlug = "homify";

export function SiHomify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHomifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHomifyTitle}
      {...props}
    >
