...
export const SiMaseratiHex = "0C2340";
export const SiMaseratiTitle = "Maserati";
export const SiMaseratiSlug = "maserati";

export function SiMaserati({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMaseratiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMaseratiTitle}
      {...props}
    >
