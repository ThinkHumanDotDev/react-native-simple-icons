...
export const SiDrizzleHex = "C5F74F";
export const SiDrizzleTitle = "Drizzle";
export const SiDrizzleSlug = "drizzle";

export function SiDrizzle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDrizzleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDrizzleTitle}
      {...props}
    >
