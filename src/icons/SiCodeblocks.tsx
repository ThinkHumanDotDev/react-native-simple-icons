...
export const SiCodeblocksHex = "41AD48";
export const SiCodeblocksTitle = "Code::Blocks";
export const SiCodeblocksSlug = "codeblocks";

export function SiCodeblocks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodeblocksHex}` : color;
