...
export const SiGradleHex = "02303A";
export const SiGradleTitle = "Gradle";
export const SiGradleSlug = "gradle";

export function SiGradle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGradleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGradleTitle}
      {...props}
    >
