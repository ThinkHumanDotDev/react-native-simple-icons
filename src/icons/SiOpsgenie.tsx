...
export const SiOpsgenieHex = "172B4D";
export const SiOpsgenieTitle = "Opsgenie";
export const SiOpsgenieSlug = "opsgenie";

export function SiOpsgenie({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpsgenieHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpsgenieTitle}
      {...props}
    >
