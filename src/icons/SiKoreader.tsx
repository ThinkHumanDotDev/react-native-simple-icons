...
export const SiKoreaderHex = "00A89C";
export const SiKoreaderTitle = "KOReader";
export const SiKoreaderSlug = "koreader";

export function SiKoreader({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKoreaderHex}` : color;
