...
export const SiNoderedHex = "8F0000";
export const SiNoderedTitle = "Node-RED";
export const SiNoderedSlug = "nodered";

export function SiNodered({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNoderedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNoderedTitle}
      {...props}
    >
