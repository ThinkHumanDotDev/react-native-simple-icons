...
export const SiFiHex = "00B899";
export const SiFiTitle = "Fi";
export const SiFiSlug = "fi";

export function SiFi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFiTitle}
      {...props}
    >
