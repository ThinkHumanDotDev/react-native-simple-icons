...
export const SiHackernoonHex = "00FE00";
export const SiHackernoonTitle = "Hacker Noon";
export const SiHackernoonSlug = "hackernoon";

export function SiHackernoon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHackernoonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHackernoonTitle}
      {...props}
    >
