...
export const SiOnstarHex = "003D7D";
export const SiOnstarTitle = "OnStar";
export const SiOnstarSlug = "onstar";

export function SiOnstar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOnstarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOnstarTitle}
      {...props}
    >
