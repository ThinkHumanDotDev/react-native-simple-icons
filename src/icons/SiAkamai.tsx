...
export const SiAkamaiHex = "0096D6";
export const SiAkamaiTitle = "Akamai";
export const SiAkamaiSlug = "akamai";

export function SiAkamai({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAkamaiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAkamaiTitle}
      {...props}
    >
