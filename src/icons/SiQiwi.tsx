...
export const SiQiwiHex = "FF8C00";
export const SiQiwiTitle = "QIWI";
export const SiQiwiSlug = "qiwi";

export function SiQiwi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQiwiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQiwiTitle}
      {...props}
    >
