...
export const SiKeepassxcHex = "6CAC4D";
export const SiKeepassxcTitle = "KeePassXC";
export const SiKeepassxcSlug = "keepassxc";

export function SiKeepassxc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKeepassxcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKeepassxcTitle}
      {...props}
    >
