...
export const SiMarvelappHex = "1FB6FF";
export const SiMarvelappTitle = "MarvelApp";
export const SiMarvelappSlug = "marvelapp";

export function SiMarvelapp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMarvelappHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMarvelappTitle}
      {...props}
    >
