...
export const SiRelayHex = "F26B00";
export const SiRelayTitle = "Relay";
export const SiRelaySlug = "relay";

export function SiRelay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRelayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRelayTitle}
      {...props}
    >
