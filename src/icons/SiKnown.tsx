...
export const SiKnownHex = "333333";
export const SiKnownTitle = "Known";
export const SiKnownSlug = "known";

export function SiKnown({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKnownHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKnownTitle}
      {...props}
    >
