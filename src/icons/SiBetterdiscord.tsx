...
export const SiBetterdiscordHex = "3E82E5";
export const SiBetterdiscordTitle = "BetterDiscord";
export const SiBetterdiscordSlug = "betterdiscord";

export function SiBetterdiscord({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBetterdiscordHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBetterdiscordTitle}
      {...props}
    >
