...
export const SiShellHex = "FFD500";
export const SiShellTitle = "Shell";
export const SiShellSlug = "shell";

export function SiShell({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShellHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShellTitle}
      {...props}
    >
