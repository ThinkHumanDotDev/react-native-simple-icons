...
export const SiMobxstatetreeHex = "FF7102";
export const SiMobxstatetreeTitle = "MobX-State-Tree";
export const SiMobxstatetreeSlug = "mobxstatetree";

export function SiMobxstatetree({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMobxstatetreeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMobxstatetreeTitle}
      {...props}
    >
