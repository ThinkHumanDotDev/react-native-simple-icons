...
export const SiMonicaHex = "2C2B29";
export const SiMonicaTitle = "Monica";
export const SiMonicaSlug = "monica";

export function SiMonica({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMonicaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMonicaTitle}
      {...props}
    >
