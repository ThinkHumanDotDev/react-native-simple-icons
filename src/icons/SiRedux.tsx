...
export const SiReduxHex = "764ABC";
export const SiReduxTitle = "Redux";
export const SiReduxSlug = "redux";

export function SiRedux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReduxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReduxTitle}
      {...props}
    >
