...
export const SiIobrokerHex = "3399CC";
export const SiIobrokerTitle = "ioBroker";
export const SiIobrokerSlug = "iobroker";

export function SiIobroker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIobrokerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIobrokerTitle}
      {...props}
    >
