...
export const SiSogouHex = "FB6022";
export const SiSogouTitle = "Sogou";
export const SiSogouSlug = "sogou";

export function SiSogou({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSogouHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSogouTitle}
      {...props}
    >
