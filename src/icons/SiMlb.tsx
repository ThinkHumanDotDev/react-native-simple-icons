...
export const SiMlbHex = "041E42";
export const SiMlbTitle = "MLB";
export const SiMlbSlug = "mlb";

export function SiMlb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMlbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMlbTitle}
      {...props}
    >
