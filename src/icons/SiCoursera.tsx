...
export const SiCourseraHex = "0056D2";
export const SiCourseraTitle = "Coursera";
export const SiCourseraSlug = "coursera";

export function SiCoursera({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCourseraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCourseraTitle}
      {...props}
    >
