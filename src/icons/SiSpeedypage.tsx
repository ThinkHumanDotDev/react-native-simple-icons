...
export const SiSpeedypageHex = "1C71F9";
export const SiSpeedypageTitle = "SpeedyPage";
export const SiSpeedypageSlug = "speedypage";

export function SiSpeedypage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpeedypageHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpeedypageTitle}
      {...props}
    >
