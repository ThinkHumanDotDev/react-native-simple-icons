...
export const SiMariadbHex = "003545";
export const SiMariadbTitle = "MariaDB";
export const SiMariadbSlug = "mariadb";

export function SiMariadb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMariadbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMariadbTitle}
      {...props}
    >
