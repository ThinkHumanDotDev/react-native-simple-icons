...
export const SiVodafoneHex = "E60000";
export const SiVodafoneTitle = "Vodafone";
export const SiVodafoneSlug = "vodafone";

export function SiVodafone({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVodafoneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVodafoneTitle}
      {...props}
    >
