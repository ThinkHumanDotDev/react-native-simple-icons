...
export const SiKikHex = "82BC23";
export const SiKikTitle = "Kik";
export const SiKikSlug = "kik";

export function SiKik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKikTitle}
      {...props}
    >
