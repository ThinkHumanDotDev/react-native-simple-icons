...
export const SiGumroadHex = "FF90E8";
export const SiGumroadTitle = "Gumroad";
export const SiGumroadSlug = "gumroad";

export function SiGumroad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGumroadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGumroadTitle}
      {...props}
    >
