...
export const SiKlmHex = "00A1DE";
export const SiKlmTitle = "KLM";
export const SiKlmSlug = "klm";

export function SiKlm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKlmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKlmTitle}
      {...props}
    >
