...
export const SiHumblebundleHex = "CC2929";
export const SiHumblebundleTitle = "Humble Bundle";
export const SiHumblebundleSlug = "humblebundle";

export function SiHumblebundle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHumblebundleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHumblebundleTitle}
      {...props}
    >
