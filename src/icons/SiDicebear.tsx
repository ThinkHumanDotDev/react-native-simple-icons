...
export const SiDicebearHex = "0284C7";
export const SiDicebearTitle = "DiceBear";
export const SiDicebearSlug = "dicebear";

export function SiDicebear({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDicebearHex}` : color;
