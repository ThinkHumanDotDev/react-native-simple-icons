...
export const SiInfuseHex = "FF8000";
export const SiInfuseTitle = "Infuse";
export const SiInfuseSlug = "infuse";

export function SiInfuse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInfuseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInfuseTitle}
      {...props}
    >
