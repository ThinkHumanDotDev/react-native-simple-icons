...
export const SiWikibooksHex = "006699";
export const SiWikibooksTitle = "Wikibooks";
export const SiWikibooksSlug = "wikibooks";

export function SiWikibooks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikibooksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikibooksTitle}
      {...props}
    >
