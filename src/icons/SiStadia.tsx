...
export const SiStadiaHex = "CD2640";
export const SiStadiaTitle = "Stadia";
export const SiStadiaSlug = "stadia";

export function SiStadia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStadiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStadiaTitle}
      {...props}
    >
