...
export const SiBuildkiteHex = "14CC80";
export const SiBuildkiteTitle = "Buildkite";
export const SiBuildkiteSlug = "buildkite";

export function SiBuildkite({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBuildkiteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBuildkiteTitle}
      {...props}
    >
