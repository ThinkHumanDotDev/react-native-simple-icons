...
export const SiBtHex = "6400AA";
export const SiBtTitle = "BT";
export const SiBtSlug = "bt";

export function SiBt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBtTitle}
      {...props}
    >
