...
export const SiApacheechartsHex = "AA344D";
export const SiApacheechartsTitle = "Apache ECharts";
export const SiApacheechartsSlug = "apacheecharts";

export function SiApacheecharts({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApacheechartsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApacheechartsTitle}
      {...props}
    >
