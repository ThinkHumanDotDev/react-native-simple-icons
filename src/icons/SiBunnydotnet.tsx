...
export const SiBunnydotnetHex = "FFAA49";
export const SiBunnydotnetTitle = "bunny.net";
export const SiBunnydotnetSlug = "bunnydotnet";

export function SiBunnydotnet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBunnydotnetHex}` : color;
