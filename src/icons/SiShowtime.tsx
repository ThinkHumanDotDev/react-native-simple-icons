...
export const SiShowtimeHex = "B10000";
export const SiShowtimeTitle = "Showtime";
export const SiShowtimeSlug = "showtime";

export function SiShowtime({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShowtimeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShowtimeTitle}
      {...props}
    >
