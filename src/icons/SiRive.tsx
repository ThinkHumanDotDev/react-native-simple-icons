...
export const SiRiveHex = "1D1D1D";
export const SiRiveTitle = "Rive";
export const SiRiveSlug = "rive";

export function SiRive({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRiveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRiveTitle}
      {...props}
    >
