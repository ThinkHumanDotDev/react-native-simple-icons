...
export const SiBlueskyHex = "1185FE";
export const SiBlueskyTitle = "Bluesky";
export const SiBlueskySlug = "bluesky";

export function SiBluesky({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBlueskyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBlueskyTitle}
      {...props}
    >
