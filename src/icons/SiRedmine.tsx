...
export const SiRedmineHex = "B32024";
export const SiRedmineTitle = "Redmine";
export const SiRedmineSlug = "redmine";

export function SiRedmine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedmineHex}` : color;
