...
export const SiKamailioHex = "506365";
export const SiKamailioTitle = "Kamailio";
export const SiKamailioSlug = "kamailio";

export function SiKamailio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKamailioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKamailioTitle}
      {...props}
    >
