...
export const SiReadthedocsHex = "000000";
export const SiReadthedocsTitle = "Read the Docs";
export const SiReadthedocsSlug = "readthedocs";

export function SiReadthedocs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReadthedocsHex}` : color;
