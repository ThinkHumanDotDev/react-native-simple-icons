...
export const SiUkcaHex = "000000";
export const SiUkcaTitle = "UKCA";
export const SiUkcaSlug = "ukca";

export function SiUkca({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUkcaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUkcaTitle}
      {...props}
    >
