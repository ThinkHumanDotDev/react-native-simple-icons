...
export const SiCodaHex = "F46A54";
export const SiCodaTitle = "Coda";
export const SiCodaSlug = "coda";

export function SiCoda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodaTitle}
      {...props}
    >
