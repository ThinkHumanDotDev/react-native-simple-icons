...
export const SiFireflyiiiHex = "CD5029";
export const SiFireflyiiiTitle = "Firefly III";
export const SiFireflyiiiSlug = "fireflyiii";

export function SiFireflyiii({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFireflyiiiHex}` : color;
