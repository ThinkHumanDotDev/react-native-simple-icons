...
export const SiEagleHex = "0072EF";
export const SiEagleTitle = "Eagle";
export const SiEagleSlug = "eagle";

export function SiEagle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEagleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEagleTitle}
      {...props}
    >
