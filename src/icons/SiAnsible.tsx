...
export const SiAnsibleHex = "EE0000";
export const SiAnsibleTitle = "Ansible";
export const SiAnsibleSlug = "ansible";

export function SiAnsible({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAnsibleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAnsibleTitle}
      {...props}
    >
