...
export const SiAudioboomHex = "007CE2";
export const SiAudioboomTitle = "Audioboom";
export const SiAudioboomSlug = "audioboom";

export function SiAudioboom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAudioboomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAudioboomTitle}
      {...props}
    >
