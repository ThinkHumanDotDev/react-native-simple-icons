...
export const SiCccHex = "000000";
export const SiCccTitle = "CCC";
export const SiCccSlug = "ccc";

export function SiCcc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCccHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCccTitle}
      {...props}
    >
