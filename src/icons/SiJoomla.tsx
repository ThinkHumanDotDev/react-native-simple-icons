...
export const SiJoomlaHex = "5091CD";
export const SiJoomlaTitle = "Joomla";
export const SiJoomlaSlug = "joomla";

export function SiJoomla({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJoomlaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJoomlaTitle}
      {...props}
    >
