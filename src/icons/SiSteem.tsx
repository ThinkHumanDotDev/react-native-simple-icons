...
export const SiSteemHex = "171FC9";
export const SiSteemTitle = "Steem";
export const SiSteemSlug = "steem";

export function SiSteem({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSteemHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSteemTitle}
      {...props}
    >
