...
export const SiLevelsdotfyiHex = "788B95";
export const SiLevelsdotfyiTitle = "levels.fyi";
export const SiLevelsdotfyiSlug = "levelsdotfyi";

export function SiLevelsdotfyi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLevelsdotfyiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLevelsdotfyiTitle}
      {...props}
    >
