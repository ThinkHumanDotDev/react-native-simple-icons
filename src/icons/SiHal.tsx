...
export const SiHalHex = "B03532";
export const SiHalTitle = "HAL";
export const SiHalSlug = "hal";

export function SiHal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHalTitle}
      {...props}
    >
