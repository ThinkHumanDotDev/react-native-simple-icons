...
export const SiFireshipHex = "EB844E";
export const SiFireshipTitle = "Fireship";
export const SiFireshipSlug = "fireship";

export function SiFireship({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFireshipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFireshipTitle}
      {...props}
    >
