...
export const SiG2AHex = "F05F00";
export const SiG2ATitle = "G2A";
export const SiG2ASlug = "g2a";

export function SiG2A({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiG2AHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiG2ATitle}
      {...props}
    >
