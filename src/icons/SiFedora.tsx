...
export const SiFedoraHex = "51A2DA";
export const SiFedoraTitle = "Fedora";
export const SiFedoraSlug = "fedora";

export function SiFedora({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFedoraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFedoraTitle}
      {...props}
    >
