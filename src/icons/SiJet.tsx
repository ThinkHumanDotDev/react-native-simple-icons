...
export const SiJetHex = "FBBA00";
export const SiJetTitle = "JET";
export const SiJetSlug = "jet";

export function SiJet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJetTitle}
      {...props}
    >
