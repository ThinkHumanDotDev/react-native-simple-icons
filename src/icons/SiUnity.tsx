...
export const SiUnityHex = "FFFFFF";
export const SiUnityTitle = "Unity";
export const SiUnitySlug = "unity";

export function SiUnity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnityTitle}
      {...props}
    >
