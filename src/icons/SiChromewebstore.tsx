...
export const SiChromewebstoreHex = "4285F4";
export const SiChromewebstoreTitle = "Chrome Web Store";
export const SiChromewebstoreSlug = "chromewebstore";

export function SiChromewebstore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChromewebstoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChromewebstoreTitle}
      {...props}
    >
