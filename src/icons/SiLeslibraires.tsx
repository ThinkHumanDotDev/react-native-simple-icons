...
export const SiLeslibrairesHex = "CF4A0C";
export const SiLeslibrairesTitle = "Les libraires";
export const SiLeslibrairesSlug = "leslibraires";

export function SiLeslibraires({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLeslibrairesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLeslibrairesTitle}
      {...props}
    >
