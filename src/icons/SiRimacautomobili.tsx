...
export const SiRimacautomobiliHex = "0A222E";
export const SiRimacautomobiliTitle = "Rimac Automobili";
export const SiRimacautomobiliSlug = "rimacautomobili";

export function SiRimacautomobili({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRimacautomobiliHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRimacautomobiliTitle}
      {...props}
    >
