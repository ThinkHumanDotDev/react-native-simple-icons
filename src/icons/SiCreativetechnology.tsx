...
export const SiCreativetechnologyHex = "000000";
export const SiCreativetechnologyTitle = "Creative Technology";
export const SiCreativetechnologySlug = "creativetechnology";

export function SiCreativetechnology({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCreativetechnologyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCreativetechnologyTitle}
      {...props}
    >
