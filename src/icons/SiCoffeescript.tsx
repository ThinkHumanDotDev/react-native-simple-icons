...
export const SiCoffeescriptHex = "2F2625";
export const SiCoffeescriptTitle = "CoffeeScript";
export const SiCoffeescriptSlug = "coffeescript";

export function SiCoffeescript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoffeescriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoffeescriptTitle}
      {...props}
    >
