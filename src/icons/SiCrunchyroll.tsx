...
export const SiCrunchyrollHex = "FF5E00";
export const SiCrunchyrollTitle = "Crunchyroll";
export const SiCrunchyrollSlug = "crunchyroll";

export function SiCrunchyroll({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCrunchyrollHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCrunchyrollTitle}
      {...props}
    >
