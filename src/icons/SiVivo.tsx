...
export const SiVivoHex = "415FFF";
export const SiVivoTitle = "vivo";
export const SiVivoSlug = "vivo";

export function SiVivo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVivoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVivoTitle}
      {...props}
    >
