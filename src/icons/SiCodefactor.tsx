...
export const SiCodefactorHex = "F44A6A";
export const SiCodefactorTitle = "CodeFactor";
export const SiCodefactorSlug = "codefactor";

export function SiCodefactor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodefactorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodefactorTitle}
      {...props}
    >
