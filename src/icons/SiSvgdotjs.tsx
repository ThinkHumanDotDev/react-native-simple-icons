...
export const SiSvgdotjsHex = "FF0066";
export const SiSvgdotjsTitle = "SVG.js";
export const SiSvgdotjsSlug = "svgdotjs";

export function SiSvgdotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSvgdotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSvgdotjsTitle}
      {...props}
    >
