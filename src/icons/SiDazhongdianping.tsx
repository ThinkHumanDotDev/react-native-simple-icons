...
export const SiDazhongdianpingHex = "FF6633";
export const SiDazhongdianpingTitle = "Dazhong Dianping";
export const SiDazhongdianpingSlug = "dazhongdianping";

export function SiDazhongdianping({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDazhongdianpingHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDazhongdianpingTitle}
      {...props}
    >
