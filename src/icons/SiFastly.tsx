...
export const SiFastlyHex = "FF282D";
export const SiFastlyTitle = "Fastly";
export const SiFastlySlug = "fastly";

export function SiFastly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFastlyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFastlyTitle}
      {...props}
    >
