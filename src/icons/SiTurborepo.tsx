...
export const SiTurborepoHex = "FF1E56";
export const SiTurborepoTitle = "Turborepo";
export const SiTurborepoSlug = "turborepo";

export function SiTurborepo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTurborepoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTurborepoTitle}
      {...props}
    >
