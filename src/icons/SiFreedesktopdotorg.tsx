...
export const SiFreedesktopdotorgHex = "3B80AE";
export const SiFreedesktopdotorgTitle = "freedesktop.org";
export const SiFreedesktopdotorgSlug = "freedesktopdotorg";

export function SiFreedesktopdotorg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreedesktopdotorgHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreedesktopdotorgTitle}
      {...props}
    >
