...
export const SiPagespeedinsightsHex = "4285F4";
export const SiPagespeedinsightsTitle = "PageSpeed Insights";
export const SiPagespeedinsightsSlug = "pagespeedinsights";

export function SiPagespeedinsights({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPagespeedinsightsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPagespeedinsightsTitle}
      {...props}
    >
