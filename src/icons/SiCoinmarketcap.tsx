...
export const SiCoinmarketcapHex = "17181B";
export const SiCoinmarketcapTitle = "CoinMarketCap";
export const SiCoinmarketcapSlug = "coinmarketcap";

export function SiCoinmarketcap({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoinmarketcapHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoinmarketcapTitle}
      {...props}
    >
