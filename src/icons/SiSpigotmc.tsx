...
export const SiSpigotmcHex = "ED8106";
export const SiSpigotmcTitle = "SpigotMC";
export const SiSpigotmcSlug = "spigotmc";

export function SiSpigotmc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpigotmcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpigotmcTitle}
      {...props}
    >
