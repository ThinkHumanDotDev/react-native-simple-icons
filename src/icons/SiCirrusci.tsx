...
export const SiCirrusciHex = "4051B5";
export const SiCirrusciTitle = "Cirrus CI";
export const SiCirrusciSlug = "cirrusci";

export function SiCirrusci({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCirrusciHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCirrusciTitle}
      {...props}
    >
