...
export const SiRecoilHex = "3578E5";
export const SiRecoilTitle = "Recoil";
export const SiRecoilSlug = "recoil";

export function SiRecoil({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRecoilHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRecoilTitle}
      {...props}
    >
