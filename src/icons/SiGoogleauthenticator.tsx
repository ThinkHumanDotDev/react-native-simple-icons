...
export const SiGoogleauthenticatorHex = "4285F4";
export const SiGoogleauthenticatorTitle = "Google Authenticator";
export const SiGoogleauthenticatorSlug = "googleauthenticator";

export function SiGoogleauthenticator({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleauthenticatorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleauthenticatorTitle}
      {...props}
    >
