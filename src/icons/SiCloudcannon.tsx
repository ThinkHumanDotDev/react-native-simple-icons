...
export const SiCloudcannonHex = "407AFC";
export const SiCloudcannonTitle = "CloudCannon";
export const SiCloudcannonSlug = "cloudcannon";

export function SiCloudcannon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudcannonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudcannonTitle}
      {...props}
    >
