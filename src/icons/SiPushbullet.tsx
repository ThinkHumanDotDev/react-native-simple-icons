...
export const SiPushbulletHex = "4AB367";
export const SiPushbulletTitle = "Pushbullet";
export const SiPushbulletSlug = "pushbullet";

export function SiPushbullet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPushbulletHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPushbulletTitle}
      {...props}
    >
