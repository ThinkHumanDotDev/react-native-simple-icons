...
export const SiWprocketHex = "F56640";
export const SiWprocketTitle = "WP Rocket";
export const SiWprocketSlug = "wprocket";

export function SiWprocket({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWprocketHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWprocketTitle}
      {...props}
    >
