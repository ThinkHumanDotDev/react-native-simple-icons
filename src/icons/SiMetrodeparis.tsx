...
export const SiMetrodeparisHex = "003E95";
export const SiMetrodeparisTitle = "Métro de Paris";
export const SiMetrodeparisSlug = "metrodeparis";

export function SiMetrodeparis({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMetrodeparisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMetrodeparisTitle}
      {...props}
    >
