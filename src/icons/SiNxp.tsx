...
export const SiNxpHex = "000000";
export const SiNxpTitle = "NXP";
export const SiNxpSlug = "nxp";

export function SiNxp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNxpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNxpTitle}
      {...props}
    >
