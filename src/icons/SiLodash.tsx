...
export const SiLodashHex = "3492FF";
export const SiLodashTitle = "Lodash";
export const SiLodashSlug = "lodash";

export function SiLodash({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLodashHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLodashTitle}
      {...props}
    >
