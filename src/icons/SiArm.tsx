...
export const SiArmHex = "0091BD";
export const SiArmTitle = "Arm";
export const SiArmSlug = "arm";

export function SiArm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArmTitle}
      {...props}
    >
