...
export const SiSpondHex = "EE4353";
export const SiSpondTitle = "Spond";
export const SiSpondSlug = "spond";

export function SiSpond({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpondHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpondTitle}
      {...props}
    >
