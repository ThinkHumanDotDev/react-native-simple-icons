...
export const SiThunderstoreHex = "23FFB0";
export const SiThunderstoreTitle = "Thunderstore";
export const SiThunderstoreSlug = "thunderstore";

export function SiThunderstore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThunderstoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThunderstoreTitle}
      {...props}
    >
