...
export const SiKumaHex = "290B53";
export const SiKumaTitle = "Kuma";
export const SiKumaSlug = "kuma";

export function SiKuma({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKumaHex}` : color;
