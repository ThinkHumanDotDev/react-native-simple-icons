...
export const SiAppiumHex = "EE376D";
export const SiAppiumTitle = "Appium";
export const SiAppiumSlug = "appium";

export function SiAppium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppiumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppiumTitle}
      {...props}
    >
