...
export const SiPterodactylHex = "10539F";
export const SiPterodactylTitle = "Pterodactyl";
export const SiPterodactylSlug = "pterodactyl";

export function SiPterodactyl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPterodactylHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPterodactylTitle}
      {...props}
    >
