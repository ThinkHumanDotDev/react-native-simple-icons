...
export const SiMyspaceHex = "030303";
export const SiMyspaceTitle = "Myspace";
export const SiMyspaceSlug = "myspace";

export function SiMyspace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMyspaceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMyspaceTitle}
      {...props}
    >
