...
export const SiBrandfetchHex = "0084FF";
export const SiBrandfetchTitle = "Brandfetch";
export const SiBrandfetchSlug = "brandfetch";

export function SiBrandfetch({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBrandfetchHex}` : color;
