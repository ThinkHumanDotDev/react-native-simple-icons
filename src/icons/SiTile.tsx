...
export const SiTileHex = "000000";
export const SiTileTitle = "Tile";
export const SiTileSlug = "tile";

export function SiTile({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTileHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTileTitle}
      {...props}
    >
