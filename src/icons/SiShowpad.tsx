...
export const SiShowpadHex = "2D2E83";
export const SiShowpadTitle = "Showpad";
export const SiShowpadSlug = "showpad";

export function SiShowpad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShowpadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShowpadTitle}
      {...props}
    >
