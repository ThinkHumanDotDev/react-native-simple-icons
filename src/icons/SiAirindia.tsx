...
export const SiAirindiaHex = "DA0E29";
export const SiAirindiaTitle = "Air India";
export const SiAirindiaSlug = "airindia";

export function SiAirindia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirindiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirindiaTitle}
      {...props}
    >
