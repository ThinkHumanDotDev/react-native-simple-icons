...
export const SiAssemblyscriptHex = "007ACC";
export const SiAssemblyscriptTitle = "AssemblyScript";
export const SiAssemblyscriptSlug = "assemblyscript";

export function SiAssemblyscript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAssemblyscriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAssemblyscriptTitle}
      {...props}
    >
