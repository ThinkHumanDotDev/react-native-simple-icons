...
export const SiDlibHex = "008000";
export const SiDlibTitle = "Dlib";
export const SiDlibSlug = "dlib";

export function SiDlib({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDlibHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDlibTitle}
      {...props}
    >
