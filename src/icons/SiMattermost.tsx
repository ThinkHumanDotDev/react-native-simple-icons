...
export const SiMattermostHex = "0058CC";
export const SiMattermostTitle = "Mattermost";
export const SiMattermostSlug = "mattermost";

export function SiMattermost({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMattermostHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMattermostTitle}
      {...props}
    >
