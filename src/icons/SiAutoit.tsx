...
export const SiAutoitHex = "5D83AC";
export const SiAutoitTitle = "AutoIt";
export const SiAutoitSlug = "autoit";

export function SiAutoit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutoitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutoitTitle}
      {...props}
    >
