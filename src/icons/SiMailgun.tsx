...
export const SiMailgunHex = "F06B66";
export const SiMailgunTitle = "Mailgun";
export const SiMailgunSlug = "mailgun";

export function SiMailgun({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMailgunHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMailgunTitle}
      {...props}
    >
