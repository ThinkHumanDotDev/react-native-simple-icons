...
export const SiAbbHex = "FF000F";
export const SiAbbTitle = "ABB";
export const SiAbbSlug = "abb";

export function SiAbb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAbbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAbbTitle}
      {...props}
    >
