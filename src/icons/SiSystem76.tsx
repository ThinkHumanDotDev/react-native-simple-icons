...
export const SiSystem76Hex = "585048";
export const SiSystem76Title = "System76";
export const SiSystem76Slug = "system76";

export function SiSystem76({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSystem76Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSystem76Title}
      {...props}
    >
