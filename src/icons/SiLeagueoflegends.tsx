...
export const SiLeagueoflegendsHex = "C28F2C";
export const SiLeagueoflegendsTitle = "League of Legends";
export const SiLeagueoflegendsSlug = "leagueoflegends";

export function SiLeagueoflegends({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLeagueoflegendsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLeagueoflegendsTitle}
      {...props}
    >
