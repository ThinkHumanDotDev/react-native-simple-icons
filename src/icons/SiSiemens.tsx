...
export const SiSiemensHex = "009999";
export const SiSiemensTitle = "Siemens";
export const SiSiemensSlug = "siemens";

export function SiSiemens({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSiemensHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSiemensTitle}
      {...props}
    >
