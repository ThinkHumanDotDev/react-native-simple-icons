...
export const SiBandrautomationHex = "FF8800";
export const SiBandrautomationTitle = "B&R Automation";
export const SiBandrautomationSlug = "bandrautomation";

export function SiBandrautomation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBandrautomationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBandrautomationTitle}
      {...props}
    >
