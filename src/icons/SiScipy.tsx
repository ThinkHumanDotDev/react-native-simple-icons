...
export const SiScipyHex = "8CAAE6";
export const SiScipyTitle = "SciPy";
export const SiScipySlug = "scipy";

export function SiScipy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScipyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScipyTitle}
      {...props}
    >
