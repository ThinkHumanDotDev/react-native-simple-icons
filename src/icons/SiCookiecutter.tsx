...
export const SiCookiecutterHex = "D4AA00";
export const SiCookiecutterTitle = "Cookiecutter";
export const SiCookiecutterSlug = "cookiecutter";

export function SiCookiecutter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCookiecutterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCookiecutterTitle}
      {...props}
    >
