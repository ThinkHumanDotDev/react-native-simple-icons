...
export const SiBasicattentiontokenHex = "80247B";
export const SiBasicattentiontokenTitle = "Basic Attention Token";
export const SiBasicattentiontokenSlug = "basicattentiontoken";

export function SiBasicattentiontoken({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBasicattentiontokenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBasicattentiontokenTitle}
      {...props}
    >
