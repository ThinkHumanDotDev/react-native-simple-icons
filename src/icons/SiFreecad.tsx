...
export const SiFreecadHex = "418FDE";
export const SiFreecadTitle = "FreeCAD";
export const SiFreecadSlug = "freecad";

export function SiFreecad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreecadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreecadTitle}
      {...props}
    >
