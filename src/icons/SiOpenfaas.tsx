...
export const SiOpenfaasHex = "3B5EE9";
export const SiOpenfaasTitle = "OpenFaaS";
export const SiOpenfaasSlug = "openfaas";

export function SiOpenfaas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenfaasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenfaasTitle}
      {...props}
    >
