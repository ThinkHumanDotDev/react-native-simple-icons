...
export const Si1PanelHex = "0854C1";
export const Si1PanelTitle = "1Panel";
export const Si1PanelSlug = "1panel";

export function Si1Panel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si1PanelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si1PanelTitle}
      {...props}
    >
