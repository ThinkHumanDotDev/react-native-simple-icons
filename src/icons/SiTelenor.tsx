...
export const SiTelenorHex = "00C8FF";
export const SiTelenorTitle = "Telenor";
export const SiTelenorSlug = "telenor";

export function SiTelenor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTelenorHex}` : color;
