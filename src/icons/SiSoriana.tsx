...
export const SiSorianaHex = "D52B1E";
export const SiSorianaTitle = "Soriana";
export const SiSorianaSlug = "soriana";

export function SiSoriana({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSorianaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSorianaTitle}
      {...props}
    >
