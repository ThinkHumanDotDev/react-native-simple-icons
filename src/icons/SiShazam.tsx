...
export const SiShazamHex = "0088FF";
export const SiShazamTitle = "Shazam";
export const SiShazamSlug = "shazam";

export function SiShazam({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShazamHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShazamTitle}
      {...props}
    >
