...
export const SiRezgoHex = "F76C00";
export const SiRezgoTitle = "Rezgo";
export const SiRezgoSlug = "rezgo";

export function SiRezgo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRezgoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRezgoTitle}
      {...props}
    >
