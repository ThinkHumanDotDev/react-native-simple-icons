...
export const SiFedexHex = "4D148C";
export const SiFedexTitle = "FedEx";
export const SiFedexSlug = "fedex";

export function SiFedex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFedexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFedexTitle}
      {...props}
    >
