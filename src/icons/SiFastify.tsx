...
export const SiFastifyHex = "000000";
export const SiFastifyTitle = "Fastify";
export const SiFastifySlug = "fastify";

export function SiFastify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFastifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFastifyTitle}
      {...props}
    >
