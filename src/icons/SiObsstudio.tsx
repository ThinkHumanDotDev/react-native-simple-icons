...
export const SiObsstudioHex = "302E31";
export const SiObsstudioTitle = "OBS Studio";
export const SiObsstudioSlug = "obsstudio";

export function SiObsstudio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiObsstudioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiObsstudioTitle}
      {...props}
    >
