...
export const SiScalarHex = "1A1A1A";
export const SiScalarTitle = "Scalar";
export const SiScalarSlug = "scalar";

export function SiScalar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScalarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScalarTitle}
      {...props}
    >
