...
export const SiMobxHex = "FF9955";
export const SiMobxTitle = "MobX";
export const SiMobxSlug = "mobx";

export function SiMobx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMobxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMobxTitle}
      {...props}
    >
