...
export const SiGitextensionsHex = "212121";
export const SiGitextensionsTitle = "Git Extensions";
export const SiGitextensionsSlug = "gitextensions";

export function SiGitextensions({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitextensionsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitextensionsTitle}
      {...props}
    >
