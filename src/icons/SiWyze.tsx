...
export const SiWyzeHex = "1DF0BB";
export const SiWyzeTitle = "Wyze";
export const SiWyzeSlug = "wyze";

export function SiWyze({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWyzeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWyzeTitle}
      {...props}
    >
