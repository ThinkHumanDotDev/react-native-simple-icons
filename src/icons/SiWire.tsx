...
export const SiWireHex = "000000";
export const SiWireTitle = "Wire";
export const SiWireSlug = "wire";

export function SiWire({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWireHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWireTitle}
      {...props}
    >
