...
export const SiAppletvHex = "000000";
export const SiAppletvTitle = "Apple TV";
export const SiAppletvSlug = "appletv";

export function SiAppletv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppletvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppletvTitle}
      {...props}
    >
