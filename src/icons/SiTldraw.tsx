...
export const SiTldrawHex = "FAFAFA";
export const SiTldrawTitle = "tldraw";
export const SiTldrawSlug = "tldraw";

export function SiTldraw({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTldrawHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTldrawTitle}
      {...props}
    >
