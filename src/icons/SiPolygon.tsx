...
export const SiPolygonHex = "7B3FE4";
export const SiPolygonTitle = "Polygon";
export const SiPolygonSlug = "polygon";

export function SiPolygon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPolygonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPolygonTitle}
      {...props}
    >
