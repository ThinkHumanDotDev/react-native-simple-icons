...
export const SiZazzleHex = "212121";
export const SiZazzleTitle = "Zazzle";
export const SiZazzleSlug = "zazzle";

export function SiZazzle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZazzleHex}` : color;
