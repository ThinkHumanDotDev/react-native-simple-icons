...
export const SiGlassdoorHex = "00A162";
export const SiGlassdoorTitle = "Glassdoor";
export const SiGlassdoorSlug = "glassdoor";

export function SiGlassdoor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGlassdoorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGlassdoorTitle}
      {...props}
    >
