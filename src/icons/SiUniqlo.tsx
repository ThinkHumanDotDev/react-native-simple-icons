...
export const SiUniqloHex = "FF0000";
export const SiUniqloTitle = "Uniqlo";
export const SiUniqloSlug = "uniqlo";

export function SiUniqlo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUniqloHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUniqloTitle}
      {...props}
    >
