...
export const SiIrisHex = "25313C";
export const SiIrisTitle = "IRIS";
export const SiIrisSlug = "iris";

export function SiIris({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIrisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIrisTitle}
      {...props}
    >
