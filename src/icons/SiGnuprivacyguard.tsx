...
export const SiGnuprivacyguardHex = "0093DD";
export const SiGnuprivacyguardTitle = "GNU Privacy Guard";
export const SiGnuprivacyguardSlug = "gnuprivacyguard";

export function SiGnuprivacyguard({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGnuprivacyguardHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGnuprivacyguardTitle}
      {...props}
    >
