...
export const SiBazelHex = "43A047";
export const SiBazelTitle = "Bazel";
export const SiBazelSlug = "bazel";

export function SiBazel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBazelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBazelTitle}
      {...props}
    >
