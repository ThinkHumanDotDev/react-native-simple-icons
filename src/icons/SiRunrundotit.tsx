...
export const SiRunrundotitHex = "DB3729";
export const SiRunrundotitTitle = "Runrun.it";
export const SiRunrundotitSlug = "runrundotit";

export function SiRunrundotit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRunrundotitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRunrundotitTitle}
      {...props}
    >
