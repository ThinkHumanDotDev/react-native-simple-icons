...
export const SiAndelaHex = "173B3F";
export const SiAndelaTitle = "Andela";
export const SiAndelaSlug = "andela";

export function SiAndela({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAndelaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAndelaTitle}
      {...props}
    >
