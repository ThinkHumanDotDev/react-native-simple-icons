...
export const SiFloorpHex = "5309E8";
export const SiFloorpTitle = "Floorp";
export const SiFloorpSlug = "floorp";

export function SiFloorp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFloorpHex}` : color;
