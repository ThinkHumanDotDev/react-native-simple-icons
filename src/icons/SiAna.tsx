...
export const SiAnaHex = "13448F";
export const SiAnaTitle = "ANA";
export const SiAnaSlug = "ana";

export function SiAna({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAnaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAnaTitle}
      {...props}
    >
