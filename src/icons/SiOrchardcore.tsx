...
export const SiOrchardcoreHex = "41B670";
export const SiOrchardcoreTitle = "Orchard Core";
export const SiOrchardcoreSlug = "orchardcore";

export function SiOrchardcore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOrchardcoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOrchardcoreTitle}
      {...props}
    >
