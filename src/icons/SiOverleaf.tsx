...
export const SiOverleafHex = "47A141";
export const SiOverleafTitle = "Overleaf";
export const SiOverleafSlug = "overleaf";

export function SiOverleaf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOverleafHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOverleafTitle}
      {...props}
    >
