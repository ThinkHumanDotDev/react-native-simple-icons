...
export const SiCbcHex = "E60505";
export const SiCbcTitle = "CBC";
export const SiCbcSlug = "cbc";

export function SiCbc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCbcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCbcTitle}
      {...props}
    >
