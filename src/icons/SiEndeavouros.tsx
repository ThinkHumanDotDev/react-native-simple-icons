...
export const SiEndeavourosHex = "7F7FFF";
export const SiEndeavourosTitle = "EndeavourOS";
export const SiEndeavourosSlug = "endeavouros";

export function SiEndeavouros({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEndeavourosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEndeavourosTitle}
      {...props}
    >
