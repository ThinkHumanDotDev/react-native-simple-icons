...
export const SiR3Hex = "EC1D24";
export const SiR3Title = "R3";
export const SiR3Slug = "r3";

export function SiR3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiR3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiR3Title}
      {...props}
    >
