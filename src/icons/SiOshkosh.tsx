...
export const SiOshkoshHex = "E6830F";
export const SiOshkoshTitle = "Oshkosh";
export const SiOshkoshSlug = "oshkosh";

export function SiOshkosh({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOshkoshHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOshkoshTitle}
      {...props}
    >
