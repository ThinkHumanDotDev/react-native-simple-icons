...
export const SiOctaveHex = "0790C0";
export const SiOctaveTitle = "Octave";
export const SiOctaveSlug = "octave";

export function SiOctave({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOctaveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOctaveTitle}
      {...props}
    >
