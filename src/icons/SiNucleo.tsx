...
export const SiNucleoHex = "252B2D";
export const SiNucleoTitle = "Nucleo";
export const SiNucleoSlug = "nucleo";

export function SiNucleo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNucleoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNucleoTitle}
      {...props}
    >
