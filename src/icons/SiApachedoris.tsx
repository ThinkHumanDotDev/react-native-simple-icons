...
export const SiApachedorisHex = "444FD9";
export const SiApachedorisTitle = "Apache Doris";
export const SiApachedorisSlug = "apachedoris";

export function SiApachedoris({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachedorisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachedorisTitle}
      {...props}
    >
