...
export const SiVaultHex = "FFEC6E";
export const SiVaultTitle = "Vault";
export const SiVaultSlug = "vault";

export function SiVault({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVaultHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVaultTitle}
      {...props}
    >
