...
export const SiCentosHex = "262577";
export const SiCentosTitle = "CentOS";
export const SiCentosSlug = "centos";

export function SiCentos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCentosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCentosTitle}
      {...props}
    >
