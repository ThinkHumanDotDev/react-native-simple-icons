...
export const SiConfluenceHex = "172B4D";
export const SiConfluenceTitle = "Confluence";
export const SiConfluenceSlug = "confluence";

export function SiConfluence({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiConfluenceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiConfluenceTitle}
      {...props}
    >
