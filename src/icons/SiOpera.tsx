...
export const SiOperaHex = "FF1B2D";
export const SiOperaTitle = "Opera";
export const SiOperaSlug = "opera";

export function SiOpera({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOperaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOperaTitle}
      {...props}
    >
