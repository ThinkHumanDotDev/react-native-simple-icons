...
export const SiFontbaseHex = "3D03A7";
export const SiFontbaseTitle = "FontBase";
export const SiFontbaseSlug = "fontbase";

export function SiFontbase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFontbaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFontbaseTitle}
      {...props}
    >
