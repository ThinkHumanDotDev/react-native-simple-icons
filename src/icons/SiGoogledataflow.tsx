...
export const SiGoogledataflowHex = "AECBFA";
export const SiGoogledataflowTitle = "Google Dataflow";
export const SiGoogledataflowSlug = "googledataflow";

export function SiGoogledataflow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogledataflowHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogledataflowTitle}
      {...props}
    >
