...
export const SiAirasiaHex = "FF0000";
export const SiAirasiaTitle = "AirAsia";
export const SiAirasiaSlug = "airasia";

export function SiAirasia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirasiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirasiaTitle}
      {...props}
    >
