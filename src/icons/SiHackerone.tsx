...
export const SiHackeroneHex = "494649";
export const SiHackeroneTitle = "HackerOne";
export const SiHackeroneSlug = "hackerone";

export function SiHackerone({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHackeroneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHackeroneTitle}
      {...props}
    >
