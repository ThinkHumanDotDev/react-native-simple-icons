...
export const SiGameloftHex = "000000";
export const SiGameloftTitle = "Gameloft";
export const SiGameloftSlug = "gameloft";

export function SiGameloft({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGameloftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGameloftTitle}
      {...props}
    >
