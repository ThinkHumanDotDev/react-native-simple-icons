...
export const SiWebassemblyHex = "654FF0";
export const SiWebassemblyTitle = "WebAssembly";
export const SiWebassemblySlug = "webassembly";

export function SiWebassembly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWebassemblyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWebassemblyTitle}
      {...props}
    >
