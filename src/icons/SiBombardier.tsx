...
export const SiBombardierHex = "000000";
export const SiBombardierTitle = "Bombardier";
export const SiBombardierSlug = "bombardier";

export function SiBombardier({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBombardierHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBombardierTitle}
      {...props}
    >
