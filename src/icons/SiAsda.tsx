...
export const SiAsdaHex = "68A51C";
export const SiAsdaTitle = "ASDA";
export const SiAsdaSlug = "asda";

export function SiAsda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAsdaHex}` : color;
