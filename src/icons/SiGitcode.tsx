...
export const SiGitcodeHex = "DA203E";
export const SiGitcodeTitle = "GitCode";
export const SiGitcodeSlug = "gitcode";

export function SiGitcode({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitcodeHex}` : color;
