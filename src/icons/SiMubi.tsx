...
export const SiMubiHex = "000000";
export const SiMubiTitle = "MUBI";
export const SiMubiSlug = "mubi";

export function SiMubi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMubiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMubiTitle}
      {...props}
    >
