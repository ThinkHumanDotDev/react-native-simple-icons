...
export const SiLottiefilesHex = "00DDB3";
export const SiLottiefilesTitle = "LottieFiles";
export const SiLottiefilesSlug = "lottiefiles";

export function SiLottiefiles({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLottiefilesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLottiefilesTitle}
      {...props}
    >
