...
export const SiSimplenoteHex = "3361CC";
export const SiSimplenoteTitle = "Simplenote";
export const SiSimplenoteSlug = "simplenote";

export function SiSimplenote({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSimplenoteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSimplenoteTitle}
      {...props}
    >
