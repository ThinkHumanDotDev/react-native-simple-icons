...
export const SiFreelancermapHex = "00CFD6";
export const SiFreelancermapTitle = "freelancermap";
export const SiFreelancermapSlug = "freelancermap";

export function SiFreelancermap({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreelancermapHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreelancermapTitle}
      {...props}
    >
