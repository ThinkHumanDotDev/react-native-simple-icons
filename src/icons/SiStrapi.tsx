...
export const SiStrapiHex = "4945FF";
export const SiStrapiTitle = "Strapi";
export const SiStrapiSlug = "strapi";

export function SiStrapi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStrapiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStrapiTitle}
      {...props}
    >
