...
export const SiKtmHex = "FF6600";
export const SiKtmTitle = "KTM";
export const SiKtmSlug = "ktm";

export function SiKtm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKtmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKtmTitle}
      {...props}
    >
