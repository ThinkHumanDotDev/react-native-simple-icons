...
export const SiPrivateinternetaccessHex = "1E811F";
export const SiPrivateinternetaccessTitle = "Private Internet Access";
export const SiPrivateinternetaccessSlug = "privateinternetaccess";

export function SiPrivateinternetaccess({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrivateinternetaccessHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrivateinternetaccessTitle}
      {...props}
    >
