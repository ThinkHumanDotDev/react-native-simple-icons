...
export const SiXmppHex = "002B5C";
export const SiXmppTitle = "XMPP";
export const SiXmppSlug = "xmpp";

export function SiXmpp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiXmppHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiXmppTitle}
      {...props}
    >
