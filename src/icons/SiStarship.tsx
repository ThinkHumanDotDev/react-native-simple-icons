...
export const SiStarshipHex = "DD0B78";
export const SiStarshipTitle = "Starship";
export const SiStarshipSlug = "starship";

export function SiStarship({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStarshipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStarshipTitle}
      {...props}
    >
