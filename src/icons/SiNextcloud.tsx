...
export const SiNextcloudHex = "0082C9";
export const SiNextcloudTitle = "Nextcloud";
export const SiNextcloudSlug = "nextcloud";

export function SiNextcloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextcloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextcloudTitle}
      {...props}
    >
