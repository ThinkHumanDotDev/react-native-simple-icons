...
export const SiAudibleHex = "F8991C";
export const SiAudibleTitle = "Audible";
export const SiAudibleSlug = "audible";

export function SiAudible({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAudibleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAudibleTitle}
      {...props}
    >
