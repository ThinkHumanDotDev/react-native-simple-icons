...
export const SiMongoosedotwsHex = "F04D35";
export const SiMongoosedotwsTitle = "Mongoose";
export const SiMongoosedotwsSlug = "mongoosedotws";

export function SiMongoosedotws({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMongoosedotwsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMongoosedotwsTitle}
      {...props}
    >
