...
export const SiOnestreamHex = "000000";
export const SiOnestreamTitle = "OneStream";
export const SiOnestreamSlug = "onestream";

export function SiOnestream({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOnestreamHex}` : color;
