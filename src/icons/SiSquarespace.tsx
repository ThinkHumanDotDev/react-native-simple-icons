...
export const SiSquarespaceHex = "000000";
export const SiSquarespaceTitle = "Squarespace";
export const SiSquarespaceSlug = "squarespace";

export function SiSquarespace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSquarespaceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSquarespaceTitle}
      {...props}
    >
