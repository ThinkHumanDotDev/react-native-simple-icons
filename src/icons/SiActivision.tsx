...
export const SiActivisionHex = "000000";
export const SiActivisionTitle = "Activision";
export const SiActivisionSlug = "activision";

export function SiActivision({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiActivisionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiActivisionTitle}
      {...props}
    >
