...
export const SiLaravelnovaHex = "252D37";
export const SiLaravelnovaTitle = "Laravel Nova";
export const SiLaravelnovaSlug = "laravelnova";

export function SiLaravelnova({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLaravelnovaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLaravelnovaTitle}
      {...props}
    >
