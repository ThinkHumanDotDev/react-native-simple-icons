...
export const SiKlookHex = "FF5722";
export const SiKlookTitle = "Klook";
export const SiKlookSlug = "klook";

export function SiKlook({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKlookHex}` : color;
