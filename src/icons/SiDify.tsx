...
export const SiDifyHex = "0033FF";
export const SiDifyTitle = "Dify";
export const SiDifySlug = "dify";

export function SiDify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDifyTitle}
      {...props}
    >
