...
export const SiLeaderpriceHex = "E50005";
export const SiLeaderpriceTitle = "Leader Price";
export const SiLeaderpriceSlug = "leaderprice";

export function SiLeaderprice({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLeaderpriceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLeaderpriceTitle}
      {...props}
    >
