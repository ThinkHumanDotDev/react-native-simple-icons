...
export const SiHtcviveHex = "00B2E3";
export const SiHtcviveTitle = "HTC Vive";
export const SiHtcviveSlug = "htcvive";

export function SiHtcvive({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHtcviveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHtcviveTitle}
      {...props}
    >
