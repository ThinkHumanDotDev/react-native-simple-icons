...
export const SiSolidHex = "2C4F7C";
export const SiSolidTitle = "Solid";
export const SiSolidSlug = "solid";

export function SiSolid({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSolidHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSolidTitle}
      {...props}
    >
