...
export const SiLenovoHex = "E2231A";
export const SiLenovoTitle = "Lenovo";
export const SiLenovoSlug = "lenovo";

export function SiLenovo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLenovoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLenovoTitle}
      {...props}
    >
