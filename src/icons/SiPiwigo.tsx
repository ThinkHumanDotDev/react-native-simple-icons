...
export const SiPiwigoHex = "FF7700";
export const SiPiwigoTitle = "Piwigo";
export const SiPiwigoSlug = "piwigo";

export function SiPiwigo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPiwigoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPiwigoTitle}
      {...props}
    >
