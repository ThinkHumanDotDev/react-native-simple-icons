...
export const SiUnjsHex = "ECDC5A";
export const SiUnjsTitle = "UnJS";
export const SiUnjsSlug = "unjs";

export function SiUnjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnjsTitle}
      {...props}
    >
