...
export const SiQubesosHex = "3874D8";
export const SiQubesosTitle = "Qubes OS";
export const SiQubesosSlug = "qubesos";

export function SiQubesos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQubesosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQubesosTitle}
      {...props}
    >
