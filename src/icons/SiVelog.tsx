...
export const SiVelogHex = "20C997";
export const SiVelogTitle = "Velog";
export const SiVelogSlug = "velog";

export function SiVelog({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVelogHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVelogTitle}
      {...props}
    >
