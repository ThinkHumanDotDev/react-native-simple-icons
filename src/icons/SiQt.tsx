...
export const SiQtHex = "41CD52";
export const SiQtTitle = "Qt";
export const SiQtSlug = "qt";

export function SiQt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQtTitle}
      {...props}
    >
