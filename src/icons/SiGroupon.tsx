...
export const SiGrouponHex = "53A318";
export const SiGrouponTitle = "Groupon";
export const SiGrouponSlug = "groupon";

export function SiGroupon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGrouponHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGrouponTitle}
      {...props}
    >
