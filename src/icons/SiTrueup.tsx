...
export const SiTrueupHex = "4E71DA";
export const SiTrueupTitle = "TrueUp";
export const SiTrueupSlug = "trueup";

export function SiTrueup({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrueupHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrueupTitle}
      {...props}
    >
