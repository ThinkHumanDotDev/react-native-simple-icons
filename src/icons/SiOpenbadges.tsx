...
export const SiOpenbadgesHex = "073B5A";
export const SiOpenbadgesTitle = "Open Badges";
export const SiOpenbadgesSlug = "openbadges";

export function SiOpenbadges({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenbadgesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenbadgesTitle}
      {...props}
    >
