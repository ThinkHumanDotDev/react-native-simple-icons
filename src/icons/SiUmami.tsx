...
export const SiUmamiHex = "000000";
export const SiUmamiTitle = "Umami";
export const SiUmamiSlug = "umami";

export function SiUmami({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUmamiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUmamiTitle}
      {...props}
    >
