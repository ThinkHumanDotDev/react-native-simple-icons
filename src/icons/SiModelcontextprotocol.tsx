...
export const SiModelcontextprotocolHex = "000000";
export const SiModelcontextprotocolTitle = "Model Context Protocol";
export const SiModelcontextprotocolSlug = "modelcontextprotocol";

export function SiModelcontextprotocol({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiModelcontextprotocolHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiModelcontextprotocolTitle}
      {...props}
    >
