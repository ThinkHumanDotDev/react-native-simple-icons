...
export const SiRatatuiHex = "000000";
export const SiRatatuiTitle = "Ratatui";
export const SiRatatuiSlug = "ratatui";

export function SiRatatui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRatatuiHex}` : color;
