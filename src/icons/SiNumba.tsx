...
export const SiNumbaHex = "00A3E0";
export const SiNumbaTitle = "Numba";
export const SiNumbaSlug = "numba";

export function SiNumba({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNumbaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNumbaTitle}
      {...props}
    >
