...
export const SiMixpanelHex = "7856FF";
export const SiMixpanelTitle = "Mixpanel";
export const SiMixpanelSlug = "mixpanel";

export function SiMixpanel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMixpanelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMixpanelTitle}
      {...props}
    >
