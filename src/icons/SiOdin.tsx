...
export const SiOdinHex = "3882D2";
export const SiOdinTitle = "Odin";
export const SiOdinSlug = "odin";

export function SiOdin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOdinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOdinTitle}
      {...props}
    >
