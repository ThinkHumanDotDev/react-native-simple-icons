...
export const SiRoboflowHex = "6706CE";
export const SiRoboflowTitle = "Roboflow";
export const SiRoboflowSlug = "roboflow";

export function SiRoboflow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRoboflowHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRoboflowTitle}
      {...props}
    >
