...
export const SiTinyletterHex = "ED1C24";
export const SiTinyletterTitle = "TinyLetter";
export const SiTinyletterSlug = "tinyletter";

export function SiTinyletter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTinyletterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTinyletterTitle}
      {...props}
    >
