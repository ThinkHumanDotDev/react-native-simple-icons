...
export const SiYewHex = "009A5B";
export const SiYewTitle = "Yew";
export const SiYewSlug = "yew";

export function SiYew({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYewHex}` : color;
