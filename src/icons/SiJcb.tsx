...
export const SiJcbHex = "0B4EA2";
export const SiJcbTitle = "JCB";
export const SiJcbSlug = "jcb";

export function SiJcb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJcbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJcbTitle}
      {...props}
    >
