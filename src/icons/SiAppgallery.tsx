...
export const SiAppgalleryHex = "FF0000";
export const SiAppgalleryTitle = "AppGallery";
export const SiAppgallerySlug = "appgallery";

export function SiAppgallery({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppgalleryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppgalleryTitle}
      {...props}
    >
