...
export const SiFlowerHex = "F2B705";
export const SiFlowerTitle = "Flower";
export const SiFlowerSlug = "flower";

export function SiFlower({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFlowerHex}` : color;
