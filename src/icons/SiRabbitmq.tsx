...
export const SiRabbitmqHex = "FF6600";
export const SiRabbitmqTitle = "RabbitMQ";
export const SiRabbitmqSlug = "rabbitmq";

export function SiRabbitmq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRabbitmqHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRabbitmqTitle}
      {...props}
    >
