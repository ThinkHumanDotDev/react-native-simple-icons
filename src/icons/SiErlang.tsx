...
export const SiErlangHex = "A90533";
export const SiErlangTitle = "Erlang";
export const SiErlangSlug = "erlang";

export function SiErlang({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiErlangHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiErlangTitle}
      {...props}
    >
