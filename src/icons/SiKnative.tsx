...
export const SiKnativeHex = "0865AD";
export const SiKnativeTitle = "Knative";
export const SiKnativeSlug = "knative";

export function SiKnative({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKnativeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKnativeTitle}
      {...props}
    >
