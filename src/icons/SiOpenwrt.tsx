...
export const SiOpenwrtHex = "00B5E2";
export const SiOpenwrtTitle = "OpenWrt";
export const SiOpenwrtSlug = "openwrt";

export function SiOpenwrt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenwrtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenwrtTitle}
      {...props}
    >
