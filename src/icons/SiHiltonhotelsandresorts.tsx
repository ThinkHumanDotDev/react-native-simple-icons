...
export const SiHiltonhotelsandresortsHex = "1E4380";
export const SiHiltonhotelsandresortsTitle = "Hilton Hotels & Resorts";
export const SiHiltonhotelsandresortsSlug = "hiltonhotelsandresorts";

export function SiHiltonhotelsandresorts({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHiltonhotelsandresortsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHiltonhotelsandresortsTitle}
      {...props}
    >
