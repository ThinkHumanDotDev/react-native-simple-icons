...
export const SiHivemqHex = "FFC000";
export const SiHivemqTitle = "HiveMQ";
export const SiHivemqSlug = "hivemq";

export function SiHivemq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHivemqHex}` : color;
