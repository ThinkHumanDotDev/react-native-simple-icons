...
export const SiWheniworkHex = "51A33D";
export const SiWheniworkTitle = "When I Work";
export const SiWheniworkSlug = "wheniwork";

export function SiWheniwork({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWheniworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWheniworkTitle}
      {...props}
    >
