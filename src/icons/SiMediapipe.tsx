...
export const SiMediapipeHex = "0097A7";
export const SiMediapipeTitle = "MediaPipe";
export const SiMediapipeSlug = "mediapipe";

export function SiMediapipe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMediapipeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMediapipeTitle}
      {...props}
    >
