...
export const SiRelianceindustrieslimitedHex = "D1AB66";
export const SiRelianceindustrieslimitedTitle = "Reliance Industries Limited";
export const SiRelianceindustrieslimitedSlug = "relianceindustrieslimited";

export function SiRelianceindustrieslimited({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRelianceindustrieslimitedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRelianceindustrieslimitedTitle}
      {...props}
    >
