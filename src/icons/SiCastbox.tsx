...
export const SiCastboxHex = "F55B23";
export const SiCastboxTitle = "Castbox";
export const SiCastboxSlug = "castbox";

export function SiCastbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCastboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCastboxTitle}
      {...props}
    >
