...
export const SiMezmoHex = "E9FF92";
export const SiMezmoTitle = "Mezmo";
export const SiMezmoSlug = "mezmo";

export function SiMezmo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMezmoHex}` : color;
