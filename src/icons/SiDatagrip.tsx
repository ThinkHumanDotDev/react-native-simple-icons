...
export const SiDatagripHex = "000000";
export const SiDatagripTitle = "DataGrip";
export const SiDatagripSlug = "datagrip";

export function SiDatagrip({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDatagripHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDatagripTitle}
      {...props}
    >
