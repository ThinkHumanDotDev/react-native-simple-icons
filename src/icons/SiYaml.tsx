...
export const SiYamlHex = "CB171E";
export const SiYamlTitle = "YAML";
export const SiYamlSlug = "yaml";

export function SiYaml({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYamlHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYamlTitle}
      {...props}
    >
