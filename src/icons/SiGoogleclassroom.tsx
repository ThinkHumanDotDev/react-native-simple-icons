...
export const SiGoogleclassroomHex = "0F9D58";
export const SiGoogleclassroomTitle = "Google Classroom";
export const SiGoogleclassroomSlug = "googleclassroom";

export function SiGoogleclassroom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleclassroomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleclassroomTitle}
      {...props}
    >
