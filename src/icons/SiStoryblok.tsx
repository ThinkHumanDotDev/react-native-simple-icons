...
export const SiStoryblokHex = "09B3AF";
export const SiStoryblokTitle = "Storyblok";
export const SiStoryblokSlug = "storyblok";

export function SiStoryblok({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStoryblokHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStoryblokTitle}
      {...props}
    >
