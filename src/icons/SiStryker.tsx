...
export const SiStrykerHex = "E74C3C";
export const SiStrykerTitle = "Stryker";
export const SiStrykerSlug = "stryker";

export function SiStryker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStrykerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStrykerTitle}
      {...props}
    >
