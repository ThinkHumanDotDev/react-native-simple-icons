...
export const SiCesiumHex = "6CADDF";
export const SiCesiumTitle = "Cesium";
export const SiCesiumSlug = "cesium";

export function SiCesium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCesiumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCesiumTitle}
      {...props}
    >
