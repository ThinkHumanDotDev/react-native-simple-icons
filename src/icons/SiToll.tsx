...
export const SiTollHex = "007A68";
export const SiTollTitle = "Toll";
export const SiTollSlug = "toll";

export function SiToll({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTollHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTollTitle}
      {...props}
    >
