...
export const SiDblpHex = "004F9F";
export const SiDblpTitle = "dblp";
export const SiDblpSlug = "dblp";

export function SiDblp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDblpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDblpTitle}
      {...props}
    >
