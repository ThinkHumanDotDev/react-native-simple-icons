...
export const SiMaasHex = "E95420";
export const SiMaasTitle = "MAAS";
export const SiMaasSlug = "maas";

export function SiMaas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMaasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMaasTitle}
      {...props}
    >
