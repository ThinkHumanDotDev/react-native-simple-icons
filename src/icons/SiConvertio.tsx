...
export const SiConvertioHex = "FF3333";
export const SiConvertioTitle = "Convertio";
export const SiConvertioSlug = "convertio";

export function SiConvertio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiConvertioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiConvertioTitle}
      {...props}
    >
