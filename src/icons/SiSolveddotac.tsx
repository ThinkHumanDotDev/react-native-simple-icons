...
export const SiSolveddotacHex = "17CE3A";
export const SiSolveddotacTitle = "solved.ac";
export const SiSolveddotacSlug = "solveddotac";

export function SiSolveddotac({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSolveddotacHex}` : color;
