...
export const Si2FasHex = "EC1C24";
export const Si2FasTitle = "2FAS";
export const Si2FasSlug = "2fas";

export function Si2Fas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si2FasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si2FasTitle}
      {...props}
    >
