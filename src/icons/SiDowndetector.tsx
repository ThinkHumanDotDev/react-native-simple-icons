...
export const SiDowndetectorHex = "FF160A";
export const SiDowndetectorTitle = "Downdetector";
export const SiDowndetectorSlug = "downdetector";

export function SiDowndetector({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDowndetectorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDowndetectorTitle}
      {...props}
    >
