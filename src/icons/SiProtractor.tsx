...
export const SiProtractorHex = "ED163A";
export const SiProtractorTitle = "Protractor";
export const SiProtractorSlug = "protractor";

export function SiProtractor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtractorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtractorTitle}
      {...props}
    >
