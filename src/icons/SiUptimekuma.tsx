...
export const SiUptimekumaHex = "5CDD8B";
export const SiUptimekumaTitle = "Uptime Kuma";
export const SiUptimekumaSlug = "uptimekuma";

export function SiUptimekuma({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUptimekumaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUptimekumaTitle}
      {...props}
    >
