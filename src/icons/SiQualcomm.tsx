...
export const SiQualcommHex = "3253DC";
export const SiQualcommTitle = "Qualcomm";
export const SiQualcommSlug = "qualcomm";

export function SiQualcomm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQualcommHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQualcommTitle}
      {...props}
    >
