...
export const SiLinuxcontainersHex = "333333";
export const SiLinuxcontainersTitle = "Linux Containers";
export const SiLinuxcontainersSlug = "linuxcontainers";

export function SiLinuxcontainers({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinuxcontainersHex}` : color;
