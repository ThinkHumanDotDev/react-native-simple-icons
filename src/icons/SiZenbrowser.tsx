...
export const SiZenbrowserHex = "F76F53";
export const SiZenbrowserTitle = "Zen Browser";
export const SiZenbrowserSlug = "zenbrowser";

export function SiZenbrowser({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZenbrowserHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZenbrowserTitle}
      {...props}
    >
