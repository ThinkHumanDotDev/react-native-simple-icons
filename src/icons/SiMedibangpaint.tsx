...
export const SiMedibangpaintHex = "00DBDE";
export const SiMedibangpaintTitle = "MediBang Paint";
export const SiMedibangpaintSlug = "medibangpaint";

export function SiMedibangpaint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMedibangpaintHex}` : color;
