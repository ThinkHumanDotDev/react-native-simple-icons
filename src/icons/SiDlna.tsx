...
export const SiDlnaHex = "48A842";
export const SiDlnaTitle = "DLNA";
export const SiDlnaSlug = "dlna";

export function SiDlna({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDlnaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDlnaTitle}
      {...props}
    >
