...
export const SiChevroletHex = "CD9834";
export const SiChevroletTitle = "Chevrolet";
export const SiChevroletSlug = "chevrolet";

export function SiChevrolet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChevroletHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChevroletTitle}
      {...props}
    >
