...
export const SiTestrailHex = "65C179";
export const SiTestrailTitle = "TestRail";
export const SiTestrailSlug = "testrail";

export function SiTestrail({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTestrailHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTestrailTitle}
      {...props}
    >
