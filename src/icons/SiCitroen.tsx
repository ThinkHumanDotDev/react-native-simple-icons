...
export const SiCitroenHex = "DA291C";
export const SiCitroenTitle = "Citroën";
export const SiCitroenSlug = "citroen";

export function SiCitroen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCitroenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCitroenTitle}
      {...props}
    >
