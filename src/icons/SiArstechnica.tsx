...
export const SiArstechnicaHex = "FF4E00";
export const SiArstechnicaTitle = "Ars Technica";
export const SiArstechnicaSlug = "arstechnica";

export function SiArstechnica({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArstechnicaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArstechnicaTitle}
      {...props}
    >
