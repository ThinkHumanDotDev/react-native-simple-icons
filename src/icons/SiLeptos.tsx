...
export const SiLeptosHex = "EF3939";
export const SiLeptosTitle = "Leptos";
export const SiLeptosSlug = "leptos";

export function SiLeptos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLeptosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLeptosTitle}
      {...props}
    >
