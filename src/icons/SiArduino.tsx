...
export const SiArduinoHex = "00878F";
export const SiArduinoTitle = "Arduino";
export const SiArduinoSlug = "arduino";

export function SiArduino({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArduinoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArduinoTitle}
      {...props}
    >
