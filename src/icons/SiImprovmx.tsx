...
export const SiImprovmxHex = "2FBEFF";
export const SiImprovmxTitle = "ImprovMX";
export const SiImprovmxSlug = "improvmx";

export function SiImprovmx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiImprovmxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiImprovmxTitle}
      {...props}
    >
