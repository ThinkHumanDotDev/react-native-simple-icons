...
export const SiEvernoteHex = "00A82D";
export const SiEvernoteTitle = "Evernote";
export const SiEvernoteSlug = "evernote";

export function SiEvernote({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEvernoteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEvernoteTitle}
      {...props}
    >
