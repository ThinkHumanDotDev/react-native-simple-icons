...
export const SiShenzhenmetroHex = "009943";
export const SiShenzhenmetroTitle = "Shenzhen Metro";
export const SiShenzhenmetroSlug = "shenzhenmetro";

export function SiShenzhenmetro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShenzhenmetroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShenzhenmetroTitle}
      {...props}
    >
