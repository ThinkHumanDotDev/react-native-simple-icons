...
export const SiStatuspalHex = "4934BF";
export const SiStatuspalTitle = "Statuspal";
export const SiStatuspalSlug = "statuspal";

export function SiStatuspal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStatuspalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStatuspalTitle}
      {...props}
    >
