...
export const SiTurkishairlinesHex = "C70A0C";
export const SiTurkishairlinesTitle = "Turkish Airlines";
export const SiTurkishairlinesSlug = "turkishairlines";

export function SiTurkishairlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTurkishairlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTurkishairlinesTitle}
      {...props}
    >
