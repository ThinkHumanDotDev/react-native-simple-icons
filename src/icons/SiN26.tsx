...
export const SiN26Hex = "48AC98";
export const SiN26Title = "N26";
export const SiN26Slug = "n26";

export function SiN26({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiN26Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiN26Title}
      {...props}
    >
