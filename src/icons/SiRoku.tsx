...
export const SiRokuHex = "662D91";
export const SiRokuTitle = "Roku";
export const SiRokuSlug = "roku";

export function SiRoku({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRokuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRokuTitle}
      {...props}
    >
