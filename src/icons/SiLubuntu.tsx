...
export const SiLubuntuHex = "0068C8";
export const SiLubuntuTitle = "Lubuntu";
export const SiLubuntuSlug = "lubuntu";

export function SiLubuntu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLubuntuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLubuntuTitle}
      {...props}
    >
