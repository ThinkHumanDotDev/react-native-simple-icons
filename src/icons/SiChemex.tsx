...
export const SiChemexHex = "4D2B1A";
export const SiChemexTitle = "Chemex";
export const SiChemexSlug = "chemex";

export function SiChemex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChemexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChemexTitle}
      {...props}
    >
