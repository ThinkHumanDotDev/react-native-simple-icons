...
export const SiDwavesystemsHex = "008CD7";
export const SiDwavesystemsTitle = "D-Wave Systems";
export const SiDwavesystemsSlug = "dwavesystems";

export function SiDwavesystems({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDwavesystemsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDwavesystemsTitle}
      {...props}
    >
