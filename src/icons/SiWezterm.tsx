...
export const SiWeztermHex = "4E49EE";
export const SiWeztermTitle = "WezTerm";
export const SiWeztermSlug = "wezterm";

export function SiWezterm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWeztermHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWeztermTitle}
      {...props}
    >
