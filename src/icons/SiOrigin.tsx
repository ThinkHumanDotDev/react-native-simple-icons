...
export const SiOriginHex = "F56C2D";
export const SiOriginTitle = "Origin";
export const SiOriginSlug = "origin";

export function SiOrigin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOriginHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOriginTitle}
      {...props}
    >
