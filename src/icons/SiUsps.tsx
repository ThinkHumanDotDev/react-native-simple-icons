...
export const SiUspsHex = "333366";
export const SiUspsTitle = "USPS";
export const SiUspsSlug = "usps";

export function SiUsps({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUspsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUspsTitle}
      {...props}
    >
