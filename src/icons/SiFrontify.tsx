...
export const SiFrontifyHex = "2D3232";
export const SiFrontifyTitle = "Frontify";
export const SiFrontifySlug = "frontify";

export function SiFrontify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFrontifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFrontifyTitle}
      {...props}
    >
