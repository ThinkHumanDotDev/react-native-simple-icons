...
export const SiThewashingtonpostHex = "231F20";
export const SiThewashingtonpostTitle = "The Washington Post";
export const SiThewashingtonpostSlug = "thewashingtonpost";

export function SiThewashingtonpost({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThewashingtonpostHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThewashingtonpostTitle}
      {...props}
    >
