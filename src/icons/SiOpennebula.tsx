...
export const SiOpennebulaHex = "0097C2";
export const SiOpennebulaTitle = "OpenNebula";
export const SiOpennebulaSlug = "opennebula";

export function SiOpennebula({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpennebulaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpennebulaTitle}
      {...props}
    >
