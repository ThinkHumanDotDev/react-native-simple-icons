...
export const SiSanfranciscomunicipalrailwayHex = "BA0C2F";
export const SiSanfranciscomunicipalrailwayTitle = "San Francisco Municipal Railway";
export const SiSanfranciscomunicipalrailwaySlug = "sanfranciscomunicipalrailway";

export function SiSanfranciscomunicipalrailway({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSanfranciscomunicipalrailwayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSanfranciscomunicipalrailwayTitle}
      {...props}
    >
