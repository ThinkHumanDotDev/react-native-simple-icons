...
export const SiKdenliveHex = "527EB2";
export const SiKdenliveTitle = "Kdenlive";
export const SiKdenliveSlug = "kdenlive";

export function SiKdenlive({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKdenliveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKdenliveTitle}
      {...props}
    >
