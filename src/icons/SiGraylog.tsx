...
export const SiGraylogHex = "FF3633";
export const SiGraylogTitle = "Graylog";
export const SiGraylogSlug = "graylog";

export function SiGraylog({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGraylogHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGraylogTitle}
      {...props}
    >
