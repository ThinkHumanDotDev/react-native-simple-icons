...
export const SiMigaduHex = "0043CE";
export const SiMigaduTitle = "Migadu";
export const SiMigaduSlug = "migadu";

export function SiMigadu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMigaduHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMigaduTitle}
      {...props}
    >
