...
export const SiLibrariesdotioHex = "337AB7";
export const SiLibrariesdotioTitle = "Libraries.io";
export const SiLibrariesdotioSlug = "librariesdotio";

export function SiLibrariesdotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLibrariesdotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLibrariesdotioTitle}
      {...props}
    >
