...
export const SiFirefoxHex = "FF7139";
export const SiFirefoxTitle = "Firefox";
export const SiFirefoxSlug = "firefox";

export function SiFirefox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFirefoxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFirefoxTitle}
      {...props}
    >
