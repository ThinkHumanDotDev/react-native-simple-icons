...
export const SiExpressdotcomHex = "000000";
export const SiExpressdotcomTitle = "Express.com";
export const SiExpressdotcomSlug = "expressdotcom";

export function SiExpressdotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiExpressdotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiExpressdotcomTitle}
      {...props}
    >
