...
export const SiTraktHex = "9F42C6";
export const SiTraktTitle = "Trakt";
export const SiTraktSlug = "trakt";

export function SiTrakt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTraktHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTraktTitle}
      {...props}
    >
