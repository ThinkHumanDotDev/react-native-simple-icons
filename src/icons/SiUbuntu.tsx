...
export const SiUbuntuHex = "E95420";
export const SiUbuntuTitle = "Ubuntu";
export const SiUbuntuSlug = "ubuntu";

export function SiUbuntu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUbuntuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUbuntuTitle}
      {...props}
    >
