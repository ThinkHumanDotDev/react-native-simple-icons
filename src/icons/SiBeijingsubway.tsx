...
export const SiBeijingsubwayHex = "004A9D";
export const SiBeijingsubwayTitle = "Beijing Subway";
export const SiBeijingsubwaySlug = "beijingsubway";

export function SiBeijingsubway({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBeijingsubwayHex}` : color;
