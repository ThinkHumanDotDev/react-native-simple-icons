...
export const SiAdblockplusHex = "C70D2C";
export const SiAdblockplusTitle = "Adblock Plus";
export const SiAdblockplusSlug = "adblockplus";

export function SiAdblockplus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAdblockplusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAdblockplusTitle}
      {...props}
    >
