...
export const SiAccuweatherHex = "FF6600";
export const SiAccuweatherTitle = "AccuWeather";
export const SiAccuweatherSlug = "accuweather";

export function SiAccuweather({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAccuweatherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAccuweatherTitle}
      {...props}
    >
