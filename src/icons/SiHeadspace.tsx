...
export const SiHeadspaceHex = "F47D31";
export const SiHeadspaceTitle = "Headspace";
export const SiHeadspaceSlug = "headspace";

export function SiHeadspace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHeadspaceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHeadspaceTitle}
      {...props}
    >
