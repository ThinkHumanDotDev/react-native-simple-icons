...
export const SiTraefikproxyHex = "24A1C1";
export const SiTraefikproxyTitle = "Traefik Proxy";
export const SiTraefikproxySlug = "traefikproxy";

export function SiTraefikproxy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTraefikproxyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTraefikproxyTitle}
      {...props}
    >
