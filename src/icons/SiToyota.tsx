...
export const SiToyotaHex = "EB0A1E";
export const SiToyotaTitle = "Toyota";
export const SiToyotaSlug = "toyota";

export function SiToyota({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiToyotaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiToyotaTitle}
      {...props}
    >
