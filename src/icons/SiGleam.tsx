...
export const SiGleamHex = "FFAFF3";
export const SiGleamTitle = "Gleam";
export const SiGleamSlug = "gleam";

export function SiGleam({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGleamHex}` : color;
