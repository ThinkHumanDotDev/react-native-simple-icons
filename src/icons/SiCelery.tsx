...
export const SiCeleryHex = "37814A";
export const SiCeleryTitle = "Celery";
export const SiCelerySlug = "celery";

export function SiCelery({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCeleryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCeleryTitle}
      {...props}
    >
