...
export const SiGooglephotosHex = "4285F4";
export const SiGooglephotosTitle = "Google Photos";
export const SiGooglephotosSlug = "googlephotos";

export function SiGooglephotos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglephotosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglephotosTitle}
      {...props}
    >
