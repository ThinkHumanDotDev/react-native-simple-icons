...
export const SiSahibindenHex = "FFE800";
export const SiSahibindenTitle = "Sahibinden";
export const SiSahibindenSlug = "sahibinden";

export function SiSahibinden({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSahibindenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSahibindenTitle}
      {...props}
    >
