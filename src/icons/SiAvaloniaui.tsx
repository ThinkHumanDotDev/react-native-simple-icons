...
export const SiAvaloniauiHex = "165BFF";
export const SiAvaloniauiTitle = "AvaloniaUI";
export const SiAvaloniauiSlug = "avaloniaui";

export function SiAvaloniaui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAvaloniauiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAvaloniauiTitle}
      {...props}
    >
