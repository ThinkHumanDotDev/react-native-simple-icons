...
export const SiConstruct3Hex = "00FFDA";
export const SiConstruct3Title = "Construct 3";
export const SiConstruct3Slug = "construct3";

export function SiConstruct3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiConstruct3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiConstruct3Title}
      {...props}
    >
