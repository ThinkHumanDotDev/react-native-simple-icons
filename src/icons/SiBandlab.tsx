...
export const SiBandlabHex = "F12C18";
export const SiBandlabTitle = "BandLab";
export const SiBandlabSlug = "bandlab";

export function SiBandlab({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBandlabHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBandlabTitle}
      {...props}
    >
