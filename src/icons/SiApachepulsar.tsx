...
export const SiApachepulsarHex = "188FFF";
export const SiApachepulsarTitle = "Apache Pulsar";
export const SiApachepulsarSlug = "apachepulsar";

export function SiApachepulsar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachepulsarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachepulsarTitle}
      {...props}
    >
