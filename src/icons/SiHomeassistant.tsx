...
export const SiHomeassistantHex = "18BCF2";
export const SiHomeassistantTitle = "Home Assistant";
export const SiHomeassistantSlug = "homeassistant";

export function SiHomeassistant({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHomeassistantHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHomeassistantTitle}
      {...props}
    >
