...
export const SiPaloaltosoftwareHex = "83DA77";
export const SiPaloaltosoftwareTitle = "Palo Alto Software";
export const SiPaloaltosoftwareSlug = "paloaltosoftware";

export function SiPaloaltosoftware({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPaloaltosoftwareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPaloaltosoftwareTitle}
      {...props}
    >
