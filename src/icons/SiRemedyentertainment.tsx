...
export const SiRemedyentertainmentHex = "D6001C";
export const SiRemedyentertainmentTitle = "Remedy Entertainment";
export const SiRemedyentertainmentSlug = "remedyentertainment";

export function SiRemedyentertainment({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRemedyentertainmentHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRemedyentertainmentTitle}
      {...props}
    >
