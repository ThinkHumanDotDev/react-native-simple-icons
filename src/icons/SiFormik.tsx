...
export const SiFormikHex = "2563EB";
export const SiFormikTitle = "Formik";
export const SiFormikSlug = "formik";

export function SiFormik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFormikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFormikTitle}
      {...props}
    >
