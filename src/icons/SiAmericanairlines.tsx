...
export const SiAmericanairlinesHex = "0078D2";
export const SiAmericanairlinesTitle = "American Airlines";
export const SiAmericanairlinesSlug = "americanairlines";

export function SiAmericanairlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAmericanairlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAmericanairlinesTitle}
      {...props}
    >
