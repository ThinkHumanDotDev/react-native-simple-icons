...
export const SiDpdHex = "DC0032";
export const SiDpdTitle = "DPD";
export const SiDpdSlug = "dpd";

export function SiDpd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDpdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDpdTitle}
      {...props}
    >
