...
export const SiQuizletHex = "4255FF";
export const SiQuizletTitle = "Quizlet";
export const SiQuizletSlug = "quizlet";

export function SiQuizlet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQuizletHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQuizletTitle}
      {...props}
    >
