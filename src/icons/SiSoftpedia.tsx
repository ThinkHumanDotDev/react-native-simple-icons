...
export const SiSoftpediaHex = "002873";
export const SiSoftpediaTitle = "Softpedia";
export const SiSoftpediaSlug = "softpedia";

export function SiSoftpedia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSoftpediaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSoftpediaTitle}
      {...props}
    >
