...
export const SiApachenifiHex = "728E9B";
export const SiApachenifiTitle = "Apache NiFi";
export const SiApachenifiSlug = "apachenifi";

export function SiApachenifi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachenifiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachenifiTitle}
      {...props}
    >
