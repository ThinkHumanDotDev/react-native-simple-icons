...
export const SiChromaticHex = "FC521F";
export const SiChromaticTitle = "Chromatic";
export const SiChromaticSlug = "chromatic";

export function SiChromatic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChromaticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChromaticTitle}
      {...props}
    >
