...
export const SiSubtitleeditHex = "CC2424";
export const SiSubtitleeditTitle = "Subtitle Edit";
export const SiSubtitleeditSlug = "subtitleedit";

export function SiSubtitleedit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSubtitleeditHex}` : color;
