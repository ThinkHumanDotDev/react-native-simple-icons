...
export const SiFreebsdHex = "AB2B28";
export const SiFreebsdTitle = "FreeBSD";
export const SiFreebsdSlug = "freebsd";

export function SiFreebsd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreebsdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreebsdTitle}
      {...props}
    >
