...
export const SiKomootHex = "6AA127";
export const SiKomootTitle = "Komoot";
export const SiKomootSlug = "komoot";

export function SiKomoot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKomootHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKomootTitle}
      {...props}
    >
