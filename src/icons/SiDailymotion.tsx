...
export const SiDailymotionHex = "0A0A0A";
export const SiDailymotionTitle = "Dailymotion";
export const SiDailymotionSlug = "dailymotion";

export function SiDailymotion({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDailymotionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDailymotionTitle}
      {...props}
    >
