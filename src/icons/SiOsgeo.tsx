...
export const SiOsgeoHex = "4CB05B";
export const SiOsgeoTitle = "OSGeo";
export const SiOsgeoSlug = "osgeo";

export function SiOsgeo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOsgeoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOsgeoTitle}
      {...props}
    >
