...
export const SiSstHex = "E27152";
export const SiSstTitle = "SST";
export const SiSstSlug = "sst";

export function SiSst({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSstHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSstTitle}
      {...props}
    >
