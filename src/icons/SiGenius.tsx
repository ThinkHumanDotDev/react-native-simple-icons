...
export const SiGeniusHex = "FFFF64";
export const SiGeniusTitle = "Genius";
export const SiGeniusSlug = "genius";

export function SiGenius({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGeniusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGeniusTitle}
      {...props}
    >
