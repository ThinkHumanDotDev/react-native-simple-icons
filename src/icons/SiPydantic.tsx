...
export const SiPydanticHex = "E92063";
export const SiPydanticTitle = "Pydantic";
export const SiPydanticSlug = "pydantic";

export function SiPydantic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPydanticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPydanticTitle}
      {...props}
    >
