...
export const SiSlackwareHex = "000000";
export const SiSlackwareTitle = "Slackware";
export const SiSlackwareSlug = "slackware";

export function SiSlackware({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSlackwareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSlackwareTitle}
      {...props}
    >
