...
export const SiCloudbeesHex = "1997B5";
export const SiCloudbeesTitle = "CloudBees";
export const SiCloudbeesSlug = "cloudbees";

export function SiCloudbees({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudbeesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudbeesTitle}
      {...props}
    >
