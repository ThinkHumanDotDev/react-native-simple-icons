...
export const SiFirewallaHex = "C8332D";
export const SiFirewallaTitle = "Firewalla";
export const SiFirewallaSlug = "firewalla";

export function SiFirewalla({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFirewallaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFirewallaTitle}
      {...props}
    >
