...
export const SiBentomlHex = "000000";
export const SiBentomlTitle = "BentoML";
export const SiBentomlSlug = "bentoml";

export function SiBentoml({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBentomlHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBentomlTitle}
      {...props}
    >
