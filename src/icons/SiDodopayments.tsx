...
export const SiDodopaymentsHex = "C6FE1E";
export const SiDodopaymentsTitle = "Dodo Payments";
export const SiDodopaymentsSlug = "dodopayments";

export function SiDodopayments({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDodopaymentsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDodopaymentsTitle}
      {...props}
    >
