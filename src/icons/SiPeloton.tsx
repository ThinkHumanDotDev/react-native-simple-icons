...
export const SiPelotonHex = "181A1D";
export const SiPelotonTitle = "Peloton";
export const SiPelotonSlug = "peloton";

export function SiPeloton({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPelotonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPelotonTitle}
      {...props}
    >
