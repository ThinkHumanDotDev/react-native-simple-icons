...
export const SiEslintHex = "4B32C3";
export const SiEslintTitle = "ESLint";
export const SiEslintSlug = "eslint";

export function SiEslint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEslintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEslintTitle}
      {...props}
    >
