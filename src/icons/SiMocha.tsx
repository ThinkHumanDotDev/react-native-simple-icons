...
export const SiMochaHex = "8D6748";
export const SiMochaTitle = "Mocha";
export const SiMochaSlug = "mocha";

export function SiMocha({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMochaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMochaTitle}
      {...props}
    >
