...
export const SiBigcommerceHex = "121118";
export const SiBigcommerceTitle = "BigCommerce";
export const SiBigcommerceSlug = "bigcommerce";

export function SiBigcommerce({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBigcommerceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBigcommerceTitle}
      {...props}
    >
