...
export const SiNovuHex = "000000";
export const SiNovuTitle = "Novu";
export const SiNovuSlug = "novu";

export function SiNovu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNovuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNovuTitle}
      {...props}
    >
