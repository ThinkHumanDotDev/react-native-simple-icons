...
export const SiSteelseriesHex = "FF5200";
export const SiSteelseriesTitle = "Steelseries";
export const SiSteelseriesSlug = "steelseries";

export function SiSteelseries({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSteelseriesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSteelseriesTitle}
      {...props}
    >
