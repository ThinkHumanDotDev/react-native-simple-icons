...
export const SiOpenbaoHex = "336D5C";
export const SiOpenbaoTitle = "OpenBao";
export const SiOpenbaoSlug = "openbao";

export function SiOpenbao({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenbaoHex}` : color;
