...
export const SiSlideshareHex = "008ED2";
export const SiSlideshareTitle = "SlideShare";
export const SiSlideshareSlug = "slideshare";

export function SiSlideshare({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSlideshareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSlideshareTitle}
      {...props}
    >
