...
export const SiAvastHex = "FF7800";
export const SiAvastTitle = "Avast";
export const SiAvastSlug = "avast";

export function SiAvast({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAvastHex}` : color;
