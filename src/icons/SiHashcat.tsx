...
export const SiHashcatHex = "FFFFFF";
export const SiHashcatTitle = "Hashcat";
export const SiHashcatSlug = "hashcat";

export function SiHashcat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHashcatHex}` : color;
