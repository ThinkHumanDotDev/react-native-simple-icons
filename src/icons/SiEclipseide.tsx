...
export const SiEclipseideHex = "2C2255";
export const SiEclipseideTitle = "Eclipse IDE";
export const SiEclipseideSlug = "eclipseide";

export function SiEclipseide({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEclipseideHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEclipseideTitle}
      {...props}
    >
