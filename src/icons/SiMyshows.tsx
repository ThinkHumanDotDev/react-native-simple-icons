...
export const SiMyshowsHex = "CC0000";
export const SiMyshowsTitle = "MyShows";
export const SiMyshowsSlug = "myshows";

export function SiMyshows({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMyshowsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMyshowsTitle}
      {...props}
    >
