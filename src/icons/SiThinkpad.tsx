...
export const SiThinkpadHex = "EE2624";
export const SiThinkpadTitle = "ThinkPad";
export const SiThinkpadSlug = "thinkpad";

export function SiThinkpad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThinkpadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThinkpadTitle}
      {...props}
    >
