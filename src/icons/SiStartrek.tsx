...
export const SiStartrekHex = "FFE200";
export const SiStartrekTitle = "Star Trek";
export const SiStartrekSlug = "startrek";

export function SiStartrek({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStartrekHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStartrekTitle}
      {...props}
    >
