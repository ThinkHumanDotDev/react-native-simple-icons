...
export const SiMockserviceworkerHex = "FF6A33";
export const SiMockserviceworkerTitle = "Mock Service Worker";
export const SiMockserviceworkerSlug = "mockserviceworker";

export function SiMockserviceworker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMockserviceworkerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMockserviceworkerTitle}
      {...props}
    >
