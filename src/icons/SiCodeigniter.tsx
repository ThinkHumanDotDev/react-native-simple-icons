...
export const SiCodeigniterHex = "EF4223";
export const SiCodeigniterTitle = "CodeIgniter";
export const SiCodeigniterSlug = "codeigniter";

export function SiCodeigniter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodeigniterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodeigniterTitle}
      {...props}
    >
