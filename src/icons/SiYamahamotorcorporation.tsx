...
export const SiYamahamotorcorporationHex = "E60012";
export const SiYamahamotorcorporationTitle = "Yamaha Motor Corporation";
export const SiYamahamotorcorporationSlug = "yamahamotorcorporation";

export function SiYamahamotorcorporation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYamahamotorcorporationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYamahamotorcorporationTitle}
      {...props}
    >
