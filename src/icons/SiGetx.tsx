...
export const SiGetxHex = "8A2BE2";
export const SiGetxTitle = "GetX";
export const SiGetxSlug = "getx";

export function SiGetx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGetxHex}` : color;
