...
export const SiSongkickHex = "F80046";
export const SiSongkickTitle = "Songkick";
export const SiSongkickSlug = "songkick";

export function SiSongkick({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSongkickHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSongkickTitle}
      {...props}
    >
