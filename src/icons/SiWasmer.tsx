...
export const SiWasmerHex = "4946DD";
export const SiWasmerTitle = "Wasmer";
export const SiWasmerSlug = "wasmer";

export function SiWasmer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWasmerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWasmerTitle}
      {...props}
    >
