...
export const SiAirbnbHex = "FF5A5F";
export const SiAirbnbTitle = "Airbnb";
export const SiAirbnbSlug = "airbnb";

export function SiAirbnb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirbnbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirbnbTitle}
      {...props}
    >
