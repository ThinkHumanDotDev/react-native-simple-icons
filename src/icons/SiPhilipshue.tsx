...
export const SiPhilipshueHex = "0065D3";
export const SiPhilipshueTitle = "Philips Hue";
export const SiPhilipshueSlug = "philipshue";

export function SiPhilipshue({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhilipshueHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhilipshueTitle}
      {...props}
    >
