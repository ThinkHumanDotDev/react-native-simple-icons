...
export const SiAntena3Hex = "FF7328";
export const SiAntena3Title = "Antena 3";
export const SiAntena3Slug = "antena3";

export function SiAntena3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAntena3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAntena3Title}
      {...props}
    >
