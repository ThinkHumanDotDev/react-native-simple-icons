...
export const SiFuelerHex = "09C9E3";
export const SiFuelerTitle = "Fueler";
export const SiFuelerSlug = "fueler";

export function SiFueler({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFuelerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFuelerTitle}
      {...props}
    >
