...
export const SiDtubeHex = "F01A30";
export const SiDtubeTitle = "DTube";
export const SiDtubeSlug = "dtube";

export function SiDtube({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDtubeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDtubeTitle}
      {...props}
    >
