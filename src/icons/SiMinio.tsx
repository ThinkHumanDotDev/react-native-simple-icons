...
export const SiMinioHex = "C72E49";
export const SiMinioTitle = "MinIO";
export const SiMinioSlug = "minio";

export function SiMinio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMinioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMinioTitle}
      {...props}
    >
