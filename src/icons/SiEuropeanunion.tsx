...
export const SiEuropeanunionHex = "003399";
export const SiEuropeanunionTitle = "European Union";
export const SiEuropeanunionSlug = "europeanunion";

export function SiEuropeanunion({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEuropeanunionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEuropeanunionTitle}
      {...props}
    >
