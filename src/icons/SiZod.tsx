...
export const SiZodHex = "408AFF";
export const SiZodTitle = "Zod";
export const SiZodSlug = "zod";

export function SiZod({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZodHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZodTitle}
      {...props}
    >
