...
export const SiNeteasecloudmusicHex = "D43C33";
export const SiNeteasecloudmusicTitle = "NetEase Cloud Music";
export const SiNeteasecloudmusicSlug = "neteasecloudmusic";

export function SiNeteasecloudmusic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNeteasecloudmusicHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNeteasecloudmusicTitle}
      {...props}
    >
