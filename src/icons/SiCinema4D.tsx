...
export const SiCinema4DHex = "011A6A";
export const SiCinema4DTitle = "Cinema 4D";
export const SiCinema4DSlug = "cinema4d";

export function SiCinema4D({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCinema4DHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCinema4DTitle}
      {...props}
    >
