...
export const SiAppveyorHex = "00B3E0";
export const SiAppveyorTitle = "AppVeyor";
export const SiAppveyorSlug = "appveyor";

export function SiAppveyor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppveyorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppveyorTitle}
      {...props}
    >
