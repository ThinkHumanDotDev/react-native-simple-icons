...
export const SiBluesoundHex = "0F131E";
export const SiBluesoundTitle = "Bluesound";
export const SiBluesoundSlug = "bluesound";

export function SiBluesound({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBluesoundHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBluesoundTitle}
      {...props}
    >
