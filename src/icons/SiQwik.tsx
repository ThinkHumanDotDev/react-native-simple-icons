...
export const SiQwikHex = "AC7EF4";
export const SiQwikTitle = "Qwik";
export const SiQwikSlug = "qwik";

export function SiQwik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQwikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQwikTitle}
      {...props}
    >
