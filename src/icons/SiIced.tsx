...
export const SiIcedHex = "3645FF";
export const SiIcedTitle = "Iced";
export const SiIcedSlug = "iced";

export function SiIced({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIcedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIcedTitle}
      {...props}
    >
