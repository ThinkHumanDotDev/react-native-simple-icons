...
export const SiHtmlacademyHex = "302683";
export const SiHtmlacademyTitle = "HTML Academy";
export const SiHtmlacademySlug = "htmlacademy";

export function SiHtmlacademy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHtmlacademyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHtmlacademyTitle}
      {...props}
    >
