...
export const SiBorgbackupHex = "00DD00";
export const SiBorgbackupTitle = "BorgBackup";
export const SiBorgbackupSlug = "borgbackup";

export function SiBorgbackup({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBorgbackupHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBorgbackupTitle}
      {...props}
    >
