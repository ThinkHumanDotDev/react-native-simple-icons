...
export const SiKofaxHex = "00558C";
export const SiKofaxTitle = "Kofax";
export const SiKofaxSlug = "kofax";

export function SiKofax({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKofaxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKofaxTitle}
      {...props}
    >
