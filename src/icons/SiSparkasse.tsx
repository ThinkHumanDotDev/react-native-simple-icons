...
export const SiSparkasseHex = "FF0000";
export const SiSparkasseTitle = "Sparkasse";
export const SiSparkasseSlug = "sparkasse";

export function SiSparkasse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSparkasseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSparkasseTitle}
      {...props}
    >
