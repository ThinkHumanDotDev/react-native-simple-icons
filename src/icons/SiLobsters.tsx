...
export const SiLobstersHex = "AC130D";
export const SiLobstersTitle = "Lobsters";
export const SiLobstersSlug = "lobsters";

export function SiLobsters({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLobstersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLobstersTitle}
      {...props}
    >
