...
export const SiAirtransatHex = "172B54";
export const SiAirtransatTitle = "Air Transat";
export const SiAirtransatSlug = "airtransat";

export function SiAirtransat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirtransatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirtransatTitle}
      {...props}
    >
