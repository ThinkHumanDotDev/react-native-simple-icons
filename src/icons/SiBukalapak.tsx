...
export const SiBukalapakHex = "E31E52";
export const SiBukalapakTitle = "Bukalapak";
export const SiBukalapakSlug = "bukalapak";

export function SiBukalapak({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBukalapakHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBukalapakTitle}
      {...props}
    >
