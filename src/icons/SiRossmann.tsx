...
export const SiRossmannHex = "C3002D";
export const SiRossmannTitle = "Rossmann";
export const SiRossmannSlug = "rossmann";

export function SiRossmann({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRossmannHex}` : color;
