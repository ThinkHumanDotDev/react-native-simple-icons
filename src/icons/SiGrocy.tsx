...
export const SiGrocyHex = "337AB7";
export const SiGrocyTitle = "Grocy";
export const SiGrocySlug = "grocy";

export function SiGrocy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGrocyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGrocyTitle}
      {...props}
    >
