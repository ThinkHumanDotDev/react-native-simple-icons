...
export const SiTcsHex = "EE3984";
export const SiTcsTitle = "Tata Consultancy Services";
export const SiTcsSlug = "tcs";

export function SiTcs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTcsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTcsTitle}
      {...props}
    >
