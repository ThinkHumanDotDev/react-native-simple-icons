...
export const SiGooglebigtableHex = "669DF6";
export const SiGooglebigtableTitle = "Google Bigtable";
export const SiGooglebigtableSlug = "googlebigtable";

export function SiGooglebigtable({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglebigtableHex}` : color;
