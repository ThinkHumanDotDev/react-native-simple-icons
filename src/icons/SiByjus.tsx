...
export const SiByjusHex = "813588";
export const SiByjusTitle = "Byju's";
export const SiByjusSlug = "byjus";

export function SiByjus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiByjusHex}` : color;
