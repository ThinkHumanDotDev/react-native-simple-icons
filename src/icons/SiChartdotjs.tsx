...
export const SiChartdotjsHex = "FF6384";
export const SiChartdotjsTitle = "Chart.js";
export const SiChartdotjsSlug = "chartdotjs";

export function SiChartdotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChartdotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChartdotjsTitle}
      {...props}
    >
