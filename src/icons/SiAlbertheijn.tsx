...
export const SiAlbertheijnHex = "04ACE6";
export const SiAlbertheijnTitle = "Albert Heijn";
export const SiAlbertheijnSlug = "albertheijn";

export function SiAlbertheijn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlbertheijnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlbertheijnTitle}
      {...props}
    >
