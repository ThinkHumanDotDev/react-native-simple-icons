...
export const SiHiltonHex = "231F20";
export const SiHiltonTitle = "Hilton";
export const SiHiltonSlug = "hilton";

export function SiHilton({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHiltonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHiltonTitle}
      {...props}
    >
