...
export const SiBaremetricsHex = "6078FF";
export const SiBaremetricsTitle = "Baremetrics";
export const SiBaremetricsSlug = "baremetrics";

export function SiBaremetrics({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBaremetricsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBaremetricsTitle}
      {...props}
    >
