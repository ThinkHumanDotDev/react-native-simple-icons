...
export const SiGhosteryHex = "00AEF0";
export const SiGhosteryTitle = "Ghostery";
export const SiGhosterySlug = "ghostery";

export function SiGhostery({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGhosteryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGhosteryTitle}
      {...props}
    >
