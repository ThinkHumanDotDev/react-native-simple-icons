...
export const SiHboHex = "000000";
export const SiHboTitle = "HBO";
export const SiHboSlug = "hbo";

export function SiHbo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHboHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHboTitle}
      {...props}
    >
