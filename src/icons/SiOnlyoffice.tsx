...
export const SiOnlyofficeHex = "444444";
export const SiOnlyofficeTitle = "ONLYOFFICE";
export const SiOnlyofficeSlug = "onlyoffice";

export function SiOnlyoffice({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOnlyofficeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOnlyofficeTitle}
      {...props}
    >
