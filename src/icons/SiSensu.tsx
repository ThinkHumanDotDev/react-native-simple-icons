...
export const SiSensuHex = "89C967";
export const SiSensuTitle = "Sensu";
export const SiSensuSlug = "sensu";

export function SiSensu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSensuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSensuTitle}
      {...props}
    >
