...
export const SiRenovateHex = "308BE3";
export const SiRenovateTitle = "Renovate";
export const SiRenovateSlug = "renovate";

export function SiRenovate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRenovateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRenovateTitle}
      {...props}
    >
