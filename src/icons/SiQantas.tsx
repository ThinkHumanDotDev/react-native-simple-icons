...
export const SiQantasHex = "E40000";
export const SiQantasTitle = "Qantas";
export const SiQantasSlug = "qantas";

export function SiQantas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQantasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQantasTitle}
      {...props}
    >
