...
export const SiPositHex = "447099";
export const SiPositTitle = "Posit";
export const SiPositSlug = "posit";

export function SiPosit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPositHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPositTitle}
      {...props}
    >
