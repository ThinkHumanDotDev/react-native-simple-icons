...
export const SiTheplanetarysocietyHex = "000000";
export const SiTheplanetarysocietyTitle = "The Planetary Society";
export const SiTheplanetarysocietySlug = "theplanetarysociety";

export function SiTheplanetarysociety({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTheplanetarysocietyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTheplanetarysocietyTitle}
      {...props}
    >
