...
export const SiIconjarHex = "16A5F3";
export const SiIconjarTitle = "IconJar";
export const SiIconjarSlug = "iconjar";

export function SiIconjar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIconjarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIconjarTitle}
      {...props}
    >
