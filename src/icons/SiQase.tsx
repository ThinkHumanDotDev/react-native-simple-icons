...
export const SiQaseHex = "4F46DC";
export const SiQaseTitle = "Qase";
export const SiQaseSlug = "qase";

export function SiQase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQaseTitle}
      {...props}
    >
