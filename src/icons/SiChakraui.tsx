...
export const SiChakrauiHex = "1BB2A9";
export const SiChakrauiTitle = "Chakra UI";
export const SiChakrauiSlug = "chakraui";

export function SiChakraui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChakrauiHex}` : color;
