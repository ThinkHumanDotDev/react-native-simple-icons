...
export const SiTheirishtimesHex = "000000";
export const SiTheirishtimesTitle = "The Irish Times";
export const SiTheirishtimesSlug = "theirishtimes";

export function SiTheirishtimes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTheirishtimesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTheirishtimesTitle}
      {...props}
    >
