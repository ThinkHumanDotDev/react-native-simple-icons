...
export const SiMyanimelistHex = "2E51A2";
export const SiMyanimelistTitle = "MyAnimeList";
export const SiMyanimelistSlug = "myanimelist";

export function SiMyanimelist({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMyanimelistHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMyanimelistTitle}
      {...props}
    >
