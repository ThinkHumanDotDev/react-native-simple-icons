...
export const SiContentstackHex = "E74C3D";
export const SiContentstackTitle = "Contentstack";
export const SiContentstackSlug = "contentstack";

export function SiContentstack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiContentstackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiContentstackTitle}
      {...props}
    >
