...
export const SiKalilinuxHex = "557C94";
export const SiKalilinuxTitle = "Kali Linux";
export const SiKalilinuxSlug = "kalilinux";

export function SiKalilinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKalilinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKalilinuxTitle}
      {...props}
    >
