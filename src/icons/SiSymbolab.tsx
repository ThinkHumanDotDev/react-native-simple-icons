...
export const SiSymbolabHex = "DB3F59";
export const SiSymbolabTitle = "Symbolab";
export const SiSymbolabSlug = "symbolab";

export function SiSymbolab({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSymbolabHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSymbolabTitle}
      {...props}
    >
