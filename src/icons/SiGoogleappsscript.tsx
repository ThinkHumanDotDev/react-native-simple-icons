...
export const SiGoogleappsscriptHex = "4285F4";
export const SiGoogleappsscriptTitle = "Google Apps Script";
export const SiGoogleappsscriptSlug = "googleappsscript";

export function SiGoogleappsscript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleappsscriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleappsscriptTitle}
      {...props}
    >
