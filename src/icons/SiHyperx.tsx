...
export const SiHyperxHex = "E21836";
export const SiHyperxTitle = "HyperX";
export const SiHyperxSlug = "hyperx";

export function SiHyperx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHyperxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHyperxTitle}
      {...props}
    >
