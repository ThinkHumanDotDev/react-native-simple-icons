...
export const SiHasuraHex = "1EB4D4";
export const SiHasuraTitle = "Hasura";
export const SiHasuraSlug = "hasura";

export function SiHasura({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHasuraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHasuraTitle}
      {...props}
    >
