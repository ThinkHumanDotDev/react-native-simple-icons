...
export const SiDeltaHex = "003366";
export const SiDeltaTitle = "Delta";
export const SiDeltaSlug = "delta";

export function SiDelta({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeltaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeltaTitle}
      {...props}
    >
