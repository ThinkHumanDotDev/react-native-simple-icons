...
export const SiGreenhouseHex = "24A47F";
export const SiGreenhouseTitle = "Greenhouse";
export const SiGreenhouseSlug = "greenhouse";

export function SiGreenhouse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGreenhouseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGreenhouseTitle}
      {...props}
    >
