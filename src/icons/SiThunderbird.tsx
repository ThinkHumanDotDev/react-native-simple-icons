...
export const SiThunderbirdHex = "0A84FF";
export const SiThunderbirdTitle = "Thunderbird";
export const SiThunderbirdSlug = "thunderbird";

export function SiThunderbird({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThunderbirdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThunderbirdTitle}
      {...props}
    >
