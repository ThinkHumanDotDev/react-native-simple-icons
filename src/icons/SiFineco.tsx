...
export const SiFinecoHex = "00549F";
export const SiFinecoTitle = "Fineco";
export const SiFinecoSlug = "fineco";

export function SiFineco({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFinecoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFinecoTitle}
      {...props}
    >
