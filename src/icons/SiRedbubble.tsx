...
export const SiRedbubbleHex = "E41321";
export const SiRedbubbleTitle = "Redbubble";
export const SiRedbubbleSlug = "redbubble";

export function SiRedbubble({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedbubbleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedbubbleTitle}
      {...props}
    >
