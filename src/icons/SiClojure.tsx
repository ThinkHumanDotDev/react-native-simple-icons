...
export const SiClojureHex = "5881D8";
export const SiClojureTitle = "Clojure";
export const SiClojureSlug = "clojure";

export function SiClojure({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClojureHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClojureTitle}
      {...props}
    >
