...
export const SiSefariaHex = "212E50";
export const SiSefariaTitle = "Sefaria";
export const SiSefariaSlug = "sefaria";

export function SiSefaria({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSefariaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSefariaTitle}
      {...props}
    >
