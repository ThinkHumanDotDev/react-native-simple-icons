...
export const SiZalandoHex = "FF6900";
export const SiZalandoTitle = "Zalando";
export const SiZalandoSlug = "zalando";

export function SiZalando({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZalandoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZalandoTitle}
      {...props}
    >
