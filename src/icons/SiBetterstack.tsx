...
export const SiBetterstackHex = "000000";
export const SiBetterstackTitle = "Better Stack";
export const SiBetterstackSlug = "betterstack";

export function SiBetterstack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBetterstackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBetterstackTitle}
      {...props}
    >
