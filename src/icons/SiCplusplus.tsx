...
export const SiCplusplusHex = "00599C";
export const SiCplusplusTitle = "C++";
export const SiCplusplusSlug = "cplusplus";

export function SiCplusplus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCplusplusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCplusplusTitle}
      {...props}
    >
