...
export const SiBankofamericaHex = "012169";
export const SiBankofamericaTitle = "Bank of America";
export const SiBankofamericaSlug = "bankofamerica";

export function SiBankofamerica({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBankofamericaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBankofamericaTitle}
      {...props}
    >
