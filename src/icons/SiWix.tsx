...
export const SiWixHex = "0C6EFC";
export const SiWixTitle = "Wix";
export const SiWixSlug = "wix";

export function SiWix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWixTitle}
      {...props}
    >
