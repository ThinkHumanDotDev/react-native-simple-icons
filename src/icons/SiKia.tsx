...
export const SiKiaHex = "05141F";
export const SiKiaTitle = "Kia";
export const SiKiaSlug = "kia";

export function SiKia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKiaTitle}
      {...props}
    >
