...
export const SiEcosiaHex = "008009";
export const SiEcosiaTitle = "Ecosia";
export const SiEcosiaSlug = "ecosia";

export function SiEcosia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEcosiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEcosiaTitle}
      {...props}
    >
