...
export const SiCryptpadHex = "0087FF";
export const SiCryptpadTitle = "CryptPad";
export const SiCryptpadSlug = "cryptpad";

export function SiCryptpad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCryptpadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCryptpadTitle}
      {...props}
    >
