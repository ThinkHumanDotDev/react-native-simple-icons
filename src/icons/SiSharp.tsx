...
export const SiSharpHex = "99CC00";
export const SiSharpTitle = "sharp";
export const SiSharpSlug = "sharp";

export function SiSharp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSharpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSharpTitle}
      {...props}
    >
