...
export const SiServerfaultHex = "E7282D";
export const SiServerfaultTitle = "Server Fault";
export const SiServerfaultSlug = "serverfault";

export function SiServerfault({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiServerfaultHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiServerfaultTitle}
      {...props}
    >
