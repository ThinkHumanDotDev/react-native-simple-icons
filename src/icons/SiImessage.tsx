...
export const SiImessageHex = "34DA50";
export const SiImessageTitle = "iMessage";
export const SiImessageSlug = "imessage";

export function SiImessage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiImessageHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiImessageTitle}
      {...props}
    >
