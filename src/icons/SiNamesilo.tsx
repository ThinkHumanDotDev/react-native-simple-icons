...
export const SiNamesiloHex = "031B4E";
export const SiNamesiloTitle = "NameSilo";
export const SiNamesiloSlug = "namesilo";

export function SiNamesilo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNamesiloHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNamesiloTitle}
      {...props}
    >
