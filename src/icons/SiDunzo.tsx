...
export const SiDunzoHex = "00D290";
export const SiDunzoTitle = "Dunzo";
export const SiDunzoSlug = "dunzo";

export function SiDunzo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDunzoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDunzoTitle}
      {...props}
    >
