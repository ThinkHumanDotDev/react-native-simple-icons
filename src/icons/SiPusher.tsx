...
export const SiPusherHex = "300D4F";
export const SiPusherTitle = "Pusher";
export const SiPusherSlug = "pusher";

export function SiPusher({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPusherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPusherTitle}
      {...props}
    >
