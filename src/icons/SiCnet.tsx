...
export const SiCnetHex = "E71D1D";
export const SiCnetTitle = "CNET";
export const SiCnetSlug = "cnet";

export function SiCnet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCnetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCnetTitle}
      {...props}
    >
