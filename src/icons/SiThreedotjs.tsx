...
export const SiThreedotjsHex = "000000";
export const SiThreedotjsTitle = "Three.js";
export const SiThreedotjsSlug = "threedotjs";

export function SiThreedotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThreedotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThreedotjsTitle}
      {...props}
    >
