...
export const SiBookmyshowHex = "C4242B";
export const SiBookmyshowTitle = "BookMyShow";
export const SiBookmyshowSlug = "bookmyshow";

export function SiBookmyshow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBookmyshowHex}` : color;
