...
export const SiPrimengHex = "DD0031";
export const SiPrimengTitle = "PrimeNG";
export const SiPrimengSlug = "primeng";

export function SiPrimeng({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrimengHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrimengTitle}
      {...props}
    >
