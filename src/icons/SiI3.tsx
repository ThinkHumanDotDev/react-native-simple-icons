...
export const SiI3Hex = "52C0FF";
export const SiI3Title = "i3";
export const SiI3Slug = "i3";

export function SiI3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiI3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiI3Title}
      {...props}
    >
