...
export const SiPolyworkHex = "543DE0";
export const SiPolyworkTitle = "Polywork";
export const SiPolyworkSlug = "polywork";

export function SiPolywork({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPolyworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPolyworkTitle}
      {...props}
    >
