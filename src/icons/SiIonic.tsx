...
export const SiIonicHex = "3880FF";
export const SiIonicTitle = "Ionic";
export const SiIonicSlug = "ionic";

export function SiIonic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIonicHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIonicTitle}
      {...props}
    >
