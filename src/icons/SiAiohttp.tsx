...
export const SiAiohttpHex = "2C5BB4";
export const SiAiohttpTitle = "AIOHTTP";
export const SiAiohttpSlug = "aiohttp";

export function SiAiohttp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAiohttpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAiohttpTitle}
      {...props}
    >
