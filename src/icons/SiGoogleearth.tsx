...
export const SiGoogleearthHex = "4285F4";
export const SiGoogleearthTitle = "Google Earth";
export const SiGoogleearthSlug = "googleearth";

export function SiGoogleearth({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleearthHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleearthTitle}
      {...props}
    >
