...
export const SiJunit5Hex = "25A162";
export const SiJunit5Title = "JUnit5";
export const SiJunit5Slug = "junit5";

export function SiJunit5({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJunit5Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJunit5Title}
      {...props}
    >
