...
export const SiScrutinizerciHex = "8A9296";
export const SiScrutinizerciTitle = "Scrutinizer CI";
export const SiScrutinizerciSlug = "scrutinizerci";

export function SiScrutinizerci({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScrutinizerciHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScrutinizerciTitle}
      {...props}
    >
