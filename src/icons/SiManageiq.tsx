...
export const SiManageiqHex = "EF2929";
export const SiManageiqTitle = "ManageIQ";
export const SiManageiqSlug = "manageiq";

export function SiManageiq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiManageiqHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiManageiqTitle}
      {...props}
    >
