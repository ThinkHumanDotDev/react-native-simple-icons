...
export const SiDependencycheckHex = "F78D0A";
export const SiDependencycheckTitle = "OWASP Dependency-Check";
export const SiDependencycheckSlug = "dependencycheck";

export function SiDependencycheck({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDependencycheckHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDependencycheckTitle}
      {...props}
    >
