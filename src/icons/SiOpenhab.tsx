...
export const SiOpenhabHex = "E64A19";
export const SiOpenhabTitle = "openHAB";
export const SiOpenhabSlug = "openhab";

export function SiOpenhab({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenhabHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenhabTitle}
      {...props}
    >
