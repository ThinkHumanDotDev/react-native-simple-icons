...
export const SiCloudflarepagesHex = "F38020";
export const SiCloudflarepagesTitle = "Cloudflare Pages";
export const SiCloudflarepagesSlug = "cloudflarepages";

export function SiCloudflarepages({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudflarepagesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudflarepagesTitle}
      {...props}
    >
