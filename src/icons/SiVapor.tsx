...
export const SiVaporHex = "0D0D0D";
export const SiVaporTitle = "Vapor";
export const SiVaporSlug = "vapor";

export function SiVapor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVaporHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVaporTitle}
      {...props}
    >
