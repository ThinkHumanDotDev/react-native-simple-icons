...
export const SiGmxHex = "1C449B";
export const SiGmxTitle = "GMX";
export const SiGmxSlug = "gmx";

export function SiGmx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGmxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGmxTitle}
      {...props}
    >
