...
export const SiKanikoHex = "FFA600";
export const SiKanikoTitle = "Kaniko";
export const SiKanikoSlug = "kaniko";

export function SiKaniko({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKanikoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKanikoTitle}
      {...props}
    >
