...
export const SiSpaceshipHex = "394EFF";
export const SiSpaceshipTitle = "Spaceship";
export const SiSpaceshipSlug = "spaceship";

export function SiSpaceship({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpaceshipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpaceshipTitle}
      {...props}
    >
