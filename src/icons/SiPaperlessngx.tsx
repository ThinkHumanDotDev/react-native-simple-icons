...
export const SiPaperlessngxHex = "17541F";
export const SiPaperlessngxTitle = "Paperless-ngx";
export const SiPaperlessngxSlug = "paperlessngx";

export function SiPaperlessngx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPaperlessngxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPaperlessngxTitle}
      {...props}
    >
