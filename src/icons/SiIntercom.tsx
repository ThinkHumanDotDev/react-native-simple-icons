...
export const SiIntercomHex = "6AFDEF";
export const SiIntercomTitle = "Intercom";
export const SiIntercomSlug = "intercom";

export function SiIntercom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIntercomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIntercomTitle}
      {...props}
    >
