...
export const SiFlaskHex = "3BABC3";
export const SiFlaskTitle = "Flask";
export const SiFlaskSlug = "flask";

export function SiFlask({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFlaskHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFlaskTitle}
      {...props}
    >
