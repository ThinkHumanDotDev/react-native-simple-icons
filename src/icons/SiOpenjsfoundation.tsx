...
export const SiOpenjsfoundationHex = "0075C9";
export const SiOpenjsfoundationTitle = "OpenJS Foundation";
export const SiOpenjsfoundationSlug = "openjsfoundation";

export function SiOpenjsfoundation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenjsfoundationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenjsfoundationTitle}
      {...props}
    >
