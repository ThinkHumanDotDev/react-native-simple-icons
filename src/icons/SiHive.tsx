...
export const SiHiveHex = "FF7A00";
export const SiHiveTitle = "Hive";
export const SiHiveSlug = "hive";

export function SiHive({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHiveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHiveTitle}
      {...props}
    >
