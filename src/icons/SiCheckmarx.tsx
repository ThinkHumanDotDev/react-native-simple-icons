...
export const SiCheckmarxHex = "54B848";
export const SiCheckmarxTitle = "Checkmarx";
export const SiCheckmarxSlug = "checkmarx";

export function SiCheckmarx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCheckmarxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCheckmarxTitle}
      {...props}
    >
