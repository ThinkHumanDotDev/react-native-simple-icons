...
export const SiDevrantHex = "F99A66";
export const SiDevrantTitle = "devRant";
export const SiDevrantSlug = "devrant";

export function SiDevrant({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDevrantHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDevrantTitle}
      {...props}
    >
