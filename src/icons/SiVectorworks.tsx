...
export const SiVectorworksHex = "000000";
export const SiVectorworksTitle = "Vectorworks";
export const SiVectorworksSlug = "vectorworks";

export function SiVectorworks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVectorworksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVectorworksTitle}
      {...props}
    >
