...
export const SiSecurityscorecardHex = "7033FD";
export const SiSecurityscorecardTitle = "SecurityScorecard";
export const SiSecurityscorecardSlug = "securityscorecard";

export function SiSecurityscorecard({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSecurityscorecardHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSecurityscorecardTitle}
      {...props}
    >
