...
export const SiGoogledisplayandvideo360Hex = "34A853";
export const SiGoogledisplayandvideo360Title = "Google Display & Video 360";
export const SiGoogledisplayandvideo360Slug = "googledisplayandvideo360";

export function SiGoogledisplayandvideo360({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogledisplayandvideo360Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogledisplayandvideo360Title}
      {...props}
    >
