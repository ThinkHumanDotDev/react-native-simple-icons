...
export const SiPayoneerHex = "FF4800";
export const SiPayoneerTitle = "Payoneer";
export const SiPayoneerSlug = "payoneer";

export function SiPayoneer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPayoneerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPayoneerTitle}
      {...props}
    >
