...
export const SiNodemonHex = "76D04B";
export const SiNodemonTitle = "Nodemon";
export const SiNodemonSlug = "nodemon";

export function SiNodemon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNodemonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNodemonTitle}
      {...props}
    >
