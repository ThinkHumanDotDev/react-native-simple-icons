...
export const SiSmugmugHex = "6DB944";
export const SiSmugmugTitle = "SmugMug";
export const SiSmugmugSlug = "smugmug";

export function SiSmugmug({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSmugmugHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSmugmugTitle}
      {...props}
    >
