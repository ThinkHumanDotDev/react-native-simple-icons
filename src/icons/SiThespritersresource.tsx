...
export const SiThespritersresourceHex = "BE3939";
export const SiThespritersresourceTitle = "The Spriters Resource";
export const SiThespritersresourceSlug = "thespritersresource";

export function SiThespritersresource({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThespritersresourceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThespritersresourceTitle}
      {...props}
    >
