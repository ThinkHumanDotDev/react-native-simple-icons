...
export const SiWikiversityHex = "00649A";
export const SiWikiversityTitle = "Wikiversity";
export const SiWikiversitySlug = "wikiversity";

export function SiWikiversity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikiversityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikiversityTitle}
      {...props}
    >
