...
export const SiGsmaHex = "DC002B";
export const SiGsmaTitle = "GSMA";
export const SiGsmaSlug = "gsma";

export function SiGsma({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGsmaHex}` : color;
