...
export const SiWolframmathematicaHex = "DD1100";
export const SiWolframmathematicaTitle = "Wolfram Mathematica";
export const SiWolframmathematicaSlug = "wolframmathematica";

export function SiWolframmathematica({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWolframmathematicaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWolframmathematicaTitle}
      {...props}
    >
