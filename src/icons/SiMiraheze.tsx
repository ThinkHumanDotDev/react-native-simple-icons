...
export const SiMirahezeHex = "FFFC00";
export const SiMirahezeTitle = "Miraheze";
export const SiMirahezeSlug = "miraheze";

export function SiMiraheze({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMirahezeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMirahezeTitle}
      {...props}
    >
