...
export const Si30SecondsofcodeHex = "5395FD";
export const Si30SecondsofcodeTitle = "30 seconds of code";
export const Si30SecondsofcodeSlug = "30secondsofcode";

export function Si30Secondsofcode({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si30SecondsofcodeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si30SecondsofcodeTitle}
      {...props}
    >
