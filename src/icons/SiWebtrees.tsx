...
export const SiWebtreesHex = "2694E8";
export const SiWebtreesTitle = "webtrees";
export const SiWebtreesSlug = "webtrees";

export function SiWebtrees({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWebtreesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWebtreesTitle}
      {...props}
    >
