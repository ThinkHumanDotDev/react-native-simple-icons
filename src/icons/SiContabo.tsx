...
export const SiContaboHex = "00AAEB";
export const SiContaboTitle = "Contabo";
export const SiContaboSlug = "contabo";

export function SiContabo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiContaboHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiContaboTitle}
      {...props}
    >
