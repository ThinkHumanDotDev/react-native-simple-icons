...
export const SiFrontendmentorHex = "3F54A3";
export const SiFrontendmentorTitle = "Frontend Mentor";
export const SiFrontendmentorSlug = "frontendmentor";

export function SiFrontendmentor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFrontendmentorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFrontendmentorTitle}
      {...props}
    >
