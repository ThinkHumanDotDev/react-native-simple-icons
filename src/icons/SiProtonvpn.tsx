...
export const SiProtonvpnHex = "66DEB1";
export const SiProtonvpnTitle = "Proton VPN";
export const SiProtonvpnSlug = "protonvpn";

export function SiProtonvpn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtonvpnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtonvpnTitle}
      {...props}
    >
