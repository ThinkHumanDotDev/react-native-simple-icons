...
export const SiLinkerdHex = "2BEDA7";
export const SiLinkerdTitle = "Linkerd";
export const SiLinkerdSlug = "linkerd";

export function SiLinkerd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinkerdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLinkerdTitle}
      {...props}
    >
