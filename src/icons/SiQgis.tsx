...
export const SiQgisHex = "589632";
export const SiQgisTitle = "QGIS";
export const SiQgisSlug = "qgis";

export function SiQgis({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQgisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQgisTitle}
      {...props}
    >
