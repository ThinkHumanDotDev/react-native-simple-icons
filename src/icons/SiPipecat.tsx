...
export const SiPipecatHex = "000000";
export const SiPipecatTitle = "Pipecat";
export const SiPipecatSlug = "pipecat";

export function SiPipecat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPipecatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPipecatTitle}
      {...props}
    >
