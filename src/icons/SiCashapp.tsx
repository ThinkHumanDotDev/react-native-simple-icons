...
export const SiCashappHex = "00C244";
export const SiCashappTitle = "Cash App";
export const SiCashappSlug = "cashapp";

export function SiCashapp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCashappHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCashappTitle}
      {...props}
    >
