...
export const SiPantheonHex = "FFDC28";
export const SiPantheonTitle = "Pantheon";
export const SiPantheonSlug = "pantheon";

export function SiPantheon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPantheonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPantheonTitle}
      {...props}
    >
