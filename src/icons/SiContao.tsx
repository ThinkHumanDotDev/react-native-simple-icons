...
export const SiContaoHex = "F47C00";
export const SiContaoTitle = "Contao";
export const SiContaoSlug = "contao";

export function SiContao({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiContaoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiContaoTitle}
      {...props}
    >
