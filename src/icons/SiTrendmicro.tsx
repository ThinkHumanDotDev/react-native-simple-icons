...
export const SiTrendmicroHex = "D71921";
export const SiTrendmicroTitle = "Trend Micro";
export const SiTrendmicroSlug = "trendmicro";

export function SiTrendmicro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrendmicroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrendmicroTitle}
      {...props}
    >
