...
export const SiDeepinHex = "007CFF";
export const SiDeepinTitle = "deepin";
export const SiDeepinSlug = "deepin";

export function SiDeepin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeepinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeepinTitle}
      {...props}
    >
