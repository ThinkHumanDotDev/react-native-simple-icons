...
export const SiBigbluebuttonHex = "283274";
export const SiBigbluebuttonTitle = "BigBlueButton";
export const SiBigbluebuttonSlug = "bigbluebutton";

export function SiBigbluebutton({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBigbluebuttonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBigbluebuttonTitle}
      {...props}
    >
