...
export const SiNextflowHex = "0DC09D";
export const SiNextflowTitle = "Nextflow";
export const SiNextflowSlug = "nextflow";

export function SiNextflow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextflowHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextflowTitle}
      {...props}
    >
