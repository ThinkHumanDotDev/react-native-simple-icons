...
export const SiContinenteHex = "E31E24";
export const SiContinenteTitle = "Continente";
export const SiContinenteSlug = "continente";

export function SiContinente({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiContinenteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiContinenteTitle}
      {...props}
    >
