...
export const SiElkHex = "EA9E44";
export const SiElkTitle = "Elk";
export const SiElkSlug = "elk";

export function SiElk({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElkHex}` : color;
