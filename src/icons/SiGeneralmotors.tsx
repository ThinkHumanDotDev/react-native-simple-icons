...
export const SiGeneralmotorsHex = "0170CE";
export const SiGeneralmotorsTitle = "General Motors";
export const SiGeneralmotorsSlug = "generalmotors";

export function SiGeneralmotors({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGeneralmotorsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGeneralmotorsTitle}
      {...props}
    >
