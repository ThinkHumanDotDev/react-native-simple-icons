...
export const SiLinphoneHex = "FF5E00";
export const SiLinphoneTitle = "Linphone";
export const SiLinphoneSlug = "linphone";

export function SiLinphone({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinphoneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLinphoneTitle}
      {...props}
    >
