...
export const SiMonzoHex = "14233C";
export const SiMonzoTitle = "Monzo";
export const SiMonzoSlug = "monzo";

export function SiMonzo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMonzoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMonzoTitle}
      {...props}
    >
