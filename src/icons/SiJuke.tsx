...
export const SiJukeHex = "6CD74A";
export const SiJukeTitle = "JUKE";
export const SiJukeSlug = "juke";

export function SiJuke({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJukeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJukeTitle}
      {...props}
    >
