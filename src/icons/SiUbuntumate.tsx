...
export const SiUbuntumateHex = "84A454";
export const SiUbuntumateTitle = "Ubuntu MATE";
export const SiUbuntumateSlug = "ubuntumate";

export function SiUbuntumate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUbuntumateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUbuntumateTitle}
      {...props}
    >
