...
export const SiKickstarterHex = "05CE78";
export const SiKickstarterTitle = "Kickstarter";
export const SiKickstarterSlug = "kickstarter";

export function SiKickstarter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKickstarterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKickstarterTitle}
      {...props}
    >
