...
export const SiAdonisjsHex = "5A45FF";
export const SiAdonisjsTitle = "AdonisJS";
export const SiAdonisjsSlug = "adonisjs";

export function SiAdonisjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAdonisjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAdonisjsTitle}
      {...props}
    >
