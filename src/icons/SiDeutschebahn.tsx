...
export const SiDeutschebahnHex = "F01414";
export const SiDeutschebahnTitle = "Deutsche Bahn";
export const SiDeutschebahnSlug = "deutschebahn";

export function SiDeutschebahn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeutschebahnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeutschebahnTitle}
      {...props}
    >
