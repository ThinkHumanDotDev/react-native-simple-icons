...
export const SiVolkswagenHex = "151F5D";
export const SiVolkswagenTitle = "Volkswagen";
export const SiVolkswagenSlug = "volkswagen";

export function SiVolkswagen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVolkswagenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVolkswagenTitle}
      {...props}
    >
