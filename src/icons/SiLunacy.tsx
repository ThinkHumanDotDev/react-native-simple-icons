...
export const SiLunacyHex = "179DE3";
export const SiLunacyTitle = "Lunacy";
export const SiLunacySlug = "lunacy";

export function SiLunacy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLunacyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLunacyTitle}
      {...props}
    >
