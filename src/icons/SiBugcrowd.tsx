...
export const SiBugcrowdHex = "F26822";
export const SiBugcrowdTitle = "Bugcrowd";
export const SiBugcrowdSlug = "bugcrowd";

export function SiBugcrowd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBugcrowdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBugcrowdTitle}
      {...props}
    >
