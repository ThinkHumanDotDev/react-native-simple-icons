...
export const SiMaptilerHex = "323357";
export const SiMaptilerTitle = "MapTiler";
export const SiMaptilerSlug = "maptiler";

export function SiMaptiler({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMaptilerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMaptilerTitle}
      {...props}
    >
