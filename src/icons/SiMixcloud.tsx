...
export const SiMixcloudHex = "5000FF";
export const SiMixcloudTitle = "Mixcloud";
export const SiMixcloudSlug = "mixcloud";

export function SiMixcloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMixcloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMixcloudTitle}
      {...props}
    >
