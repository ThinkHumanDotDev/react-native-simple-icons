...
export const Si99DesignsHex = "FE5F50";
export const Si99DesignsTitle = "99designs";
export const Si99DesignsSlug = "99designs";

export function Si99Designs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si99DesignsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si99DesignsTitle}
      {...props}
    >
