...
export const SiQuickbooksHex = "2CA01C";
export const SiQuickbooksTitle = "QuickBooks";
export const SiQuickbooksSlug = "quickbooks";

export function SiQuickbooks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQuickbooksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQuickbooksTitle}
      {...props}
    >
