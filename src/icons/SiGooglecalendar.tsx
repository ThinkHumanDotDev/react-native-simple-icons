...
export const SiGooglecalendarHex = "4285F4";
export const SiGooglecalendarTitle = "Google Calendar";
export const SiGooglecalendarSlug = "googlecalendar";

export function SiGooglecalendar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglecalendarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglecalendarTitle}
      {...props}
    >
