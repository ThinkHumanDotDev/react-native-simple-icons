...
export const SiBakalariHex = "00A2E2";
export const SiBakalariTitle = "Bakaláři";
export const SiBakalariSlug = "bakalari";

export function SiBakalari({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBakalariHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBakalariTitle}
      {...props}
    >
