...
export const SiJsonwebtokensHex = "000000";
export const SiJsonwebtokensTitle = "JSON Web Tokens";
export const SiJsonwebtokensSlug = "jsonwebtokens";

export function SiJsonwebtokens({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJsonwebtokensHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJsonwebtokensTitle}
      {...props}
    >
