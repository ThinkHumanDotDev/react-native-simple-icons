...
export const SiBotblecmsHex = "205081";
export const SiBotblecmsTitle = "Botble CMS";
export const SiBotblecmsSlug = "botblecms";

export function SiBotblecms({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBotblecmsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBotblecmsTitle}
      {...props}
    >
