...
export const SiMahindraHex = "DD052B";
export const SiMahindraTitle = "Mahindra";
export const SiMahindraSlug = "mahindra";

export function SiMahindra({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMahindraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMahindraTitle}
      {...props}
    >
