...
export const SiNextraHex = "000000";
export const SiNextraTitle = "Nextra";
export const SiNextraSlug = "nextra";

export function SiNextra({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextraTitle}
      {...props}
    >
