...
export const SiFacepunchHex = "EC1C24";
export const SiFacepunchTitle = "Facepunch";
export const SiFacepunchSlug = "facepunch";

export function SiFacepunch({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFacepunchHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFacepunchTitle}
      {...props}
    >
