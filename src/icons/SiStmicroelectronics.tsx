...
export const SiStmicroelectronicsHex = "03234B";
export const SiStmicroelectronicsTitle = "STMicroelectronics";
export const SiStmicroelectronicsSlug = "stmicroelectronics";

export function SiStmicroelectronics({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStmicroelectronicsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStmicroelectronicsTitle}
      {...props}
    >
