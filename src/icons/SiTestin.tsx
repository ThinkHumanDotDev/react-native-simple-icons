...
export const SiTestinHex = "007DD7";
export const SiTestinTitle = "Testin";
export const SiTestinSlug = "testin";

export function SiTestin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTestinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTestinTitle}
      {...props}
    >
