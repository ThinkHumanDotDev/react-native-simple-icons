...
export const SiRiderHex = "000000";
export const SiRiderTitle = "Rider";
export const SiRiderSlug = "rider";

export function SiRider({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRiderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRiderTitle}
      {...props}
    >
