...
export const SiSmashingmagazineHex = "E85C33";
export const SiSmashingmagazineTitle = "Smashing Magazine";
export const SiSmashingmagazineSlug = "smashingmagazine";

export function SiSmashingmagazine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSmashingmagazineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSmashingmagazineTitle}
      {...props}
    >
