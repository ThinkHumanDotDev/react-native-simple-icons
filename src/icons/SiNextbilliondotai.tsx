...
export const SiNextbilliondotaiHex = "8D5A9E";
export const SiNextbilliondotaiTitle = "NextBillion.ai";
export const SiNextbilliondotaiSlug = "nextbilliondotai";

export function SiNextbilliondotai({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextbilliondotaiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextbilliondotaiTitle}
      {...props}
    >
