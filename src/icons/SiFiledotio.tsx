...
export const SiFiledotioHex = "3D3C9D";
export const SiFiledotioTitle = "File.io";
export const SiFiledotioSlug = "filedotio";

export function SiFiledotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFiledotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFiledotioTitle}
      {...props}
    >
