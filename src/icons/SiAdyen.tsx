...
export const SiAdyenHex = "0ABF53";
export const SiAdyenTitle = "Adyen";
export const SiAdyenSlug = "adyen";

export function SiAdyen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAdyenHex}` : color;
