...
export const SiAeroflotHex = "02458D";
export const SiAeroflotTitle = "Aeroflot";
export const SiAeroflotSlug = "aeroflot";

export function SiAeroflot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAeroflotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAeroflotTitle}
      {...props}
    >
