...
export const SiGsmarenadotcomHex = "D50000";
export const SiGsmarenadotcomTitle = "GSMArena.com";
export const SiGsmarenadotcomSlug = "gsmarenadotcom";

export function SiGsmarenadotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGsmarenadotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGsmarenadotcomTitle}
      {...props}
    >
