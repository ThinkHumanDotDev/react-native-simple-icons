...
export const SiMikrotikHex = "293239";
export const SiMikrotikTitle = "MikroTik";
export const SiMikrotikSlug = "mikrotik";

export function SiMikrotik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMikrotikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMikrotikTitle}
      {...props}
    >
