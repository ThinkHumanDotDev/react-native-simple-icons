...
export const SiTripdotcomHex = "287DFA";
export const SiTripdotcomTitle = "Trip.com";
export const SiTripdotcomSlug = "tripdotcom";

export function SiTripdotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTripdotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTripdotcomTitle}
      {...props}
    >
