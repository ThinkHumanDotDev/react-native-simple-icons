...
export const SiSpeakerdeckHex = "009287";
export const SiSpeakerdeckTitle = "Speaker Deck";
export const SiSpeakerdeckSlug = "speakerdeck";

export function SiSpeakerdeck({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpeakerdeckHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpeakerdeckTitle}
      {...props}
    >
