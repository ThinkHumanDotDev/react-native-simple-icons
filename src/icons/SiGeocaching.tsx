...
export const SiGeocachingHex = "00874D";
export const SiGeocachingTitle = "Geocaching";
export const SiGeocachingSlug = "geocaching";

export function SiGeocaching({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGeocachingHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGeocachingTitle}
      {...props}
    >
