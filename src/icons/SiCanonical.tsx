...
export const SiCanonicalHex = "E95420";
export const SiCanonicalTitle = "Canonical";
export const SiCanonicalSlug = "canonical";

export function SiCanonical({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCanonicalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCanonicalTitle}
      {...props}
    >
