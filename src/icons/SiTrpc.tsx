...
export const SiTrpcHex = "2596BE";
export const SiTrpcTitle = "tRPC";
export const SiTrpcSlug = "trpc";

export function SiTrpc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrpcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrpcTitle}
      {...props}
    >
