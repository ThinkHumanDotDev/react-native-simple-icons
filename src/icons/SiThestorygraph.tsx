...
export const SiThestorygraphHex = "000000";
export const SiThestorygraphTitle = "The StoryGraph";
export const SiThestorygraphSlug = "thestorygraph";

export function SiThestorygraph({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThestorygraphHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThestorygraphTitle}
      {...props}
    >
