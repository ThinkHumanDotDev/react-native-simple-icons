...
export const SiPlaneHex = "121212";
export const SiPlaneTitle = "Plane";
export const SiPlaneSlug = "plane";

export function SiPlane({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlaneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlaneTitle}
      {...props}
    >
