...
export const SiNushellHex = "4E9A06";
export const SiNushellTitle = "Nushell";
export const SiNushellSlug = "nushell";

export function SiNushell({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNushellHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNushellTitle}
      {...props}
    >
