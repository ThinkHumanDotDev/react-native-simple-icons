...
export const SiStackeditHex = "606060";
export const SiStackeditTitle = "StackEdit";
export const SiStackeditSlug = "stackedit";

export function SiStackedit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStackeditHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStackeditTitle}
      {...props}
    >
