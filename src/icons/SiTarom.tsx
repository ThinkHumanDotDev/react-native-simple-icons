...
export const SiTaromHex = "003366";
export const SiTaromTitle = "TAROM";
export const SiTaromSlug = "tarom";

export function SiTarom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTaromHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTaromTitle}
      {...props}
    >
