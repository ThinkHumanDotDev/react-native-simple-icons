...
export const SiMetroHex = "EF4242";
export const SiMetroTitle = "Metro";
export const SiMetroSlug = "metro";

export function SiMetro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMetroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMetroTitle}
      {...props}
    >
