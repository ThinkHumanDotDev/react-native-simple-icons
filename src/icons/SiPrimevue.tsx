...
export const SiPrimevueHex = "41B883";
export const SiPrimevueTitle = "PrimeVue";
export const SiPrimevueSlug = "primevue";

export function SiPrimevue({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrimevueHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrimevueTitle}
      {...props}
    >
