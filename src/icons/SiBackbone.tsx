...
export const SiBackboneHex = "000000";
export const SiBackboneTitle = "Backbone";
export const SiBackboneSlug = "backbone";

export function SiBackbone({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBackboneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBackboneTitle}
      {...props}
    >
