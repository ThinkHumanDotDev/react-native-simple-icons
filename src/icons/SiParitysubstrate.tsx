...
export const SiParitysubstrateHex = "282828";
export const SiParitysubstrateTitle = "Parity Substrate";
export const SiParitysubstrateSlug = "paritysubstrate";

export function SiParitysubstrate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiParitysubstrateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiParitysubstrateTitle}
      {...props}
    >
