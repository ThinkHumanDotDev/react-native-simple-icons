...
export const SiSkodaHex = "0E3A2F";
export const SiSkodaTitle = "ŠKODA";
export const SiSkodaSlug = "skoda";

export function SiSkoda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSkodaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSkodaTitle}
      {...props}
    >
