...
export const SiFrigateHex = "000000";
export const SiFrigateTitle = "Frigate";
export const SiFrigateSlug = "frigate";

export function SiFrigate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFrigateHex}` : color;
