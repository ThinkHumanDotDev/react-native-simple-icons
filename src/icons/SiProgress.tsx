...
export const SiProgressHex = "5CE500";
export const SiProgressTitle = "Progress";
export const SiProgressSlug = "progress";

export function SiProgress({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProgressHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProgressTitle}
      {...props}
    >
