...
export const SiRubymineHex = "000000";
export const SiRubymineTitle = "RubyMine";
export const SiRubymineSlug = "rubymine";

export function SiRubymine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRubymineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRubymineTitle}
      {...props}
    >
