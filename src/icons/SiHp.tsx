...
export const SiHpHex = "0096D6";
export const SiHpTitle = "HP";
export const SiHpSlug = "hp";

export function SiHp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHpTitle}
      {...props}
    >
