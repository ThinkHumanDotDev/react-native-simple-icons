...
export const SiBitdefenderHex = "ED1C24";
export const SiBitdefenderTitle = "Bitdefender";
export const SiBitdefenderSlug = "bitdefender";

export function SiBitdefender({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBitdefenderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBitdefenderTitle}
      {...props}
    >
