...
export const SiEtcdHex = "419EDA";
export const SiEtcdTitle = "etcd";
export const SiEtcdSlug = "etcd";

export function SiEtcd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEtcdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEtcdTitle}
      {...props}
    >
