...
export const SiUbisoftHex = "000000";
export const SiUbisoftTitle = "Ubisoft";
export const SiUbisoftSlug = "ubisoft";

export function SiUbisoft({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUbisoftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUbisoftTitle}
      {...props}
    >
