...
export const SiPowersHex = "E74536";
export const SiPowersTitle = "POWERS";
export const SiPowersSlug = "powers";

export function SiPowers({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPowersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPowersTitle}
      {...props}
    >
