...
export const SiPrometheusHex = "E6522C";
export const SiPrometheusTitle = "Prometheus";
export const SiPrometheusSlug = "prometheus";

export function SiPrometheus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrometheusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrometheusTitle}
      {...props}
    >
