...
export const SiTelequebecHex = "1343FB";
export const SiTelequebecTitle = "Télé-Québec";
export const SiTelequebecSlug = "telequebec";

export function SiTelequebec({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTelequebecHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTelequebecTitle}
      {...props}
    >
