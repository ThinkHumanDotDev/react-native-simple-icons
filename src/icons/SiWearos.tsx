...
export const SiWearosHex = "4285F4";
export const SiWearosTitle = "Wear OS";
export const SiWearosSlug = "wearos";

export function SiWearos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWearosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWearosTitle}
      {...props}
    >
