...
export const SiSurveymonkeyHex = "00BF6F";
export const SiSurveymonkeyTitle = "SurveyMonkey";
export const SiSurveymonkeySlug = "surveymonkey";

export function SiSurveymonkey({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSurveymonkeyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSurveymonkeyTitle}
      {...props}
    >
