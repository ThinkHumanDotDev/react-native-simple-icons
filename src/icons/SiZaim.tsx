...
export const SiZaimHex = "50A135";
export const SiZaimTitle = "Zaim";
export const SiZaimSlug = "zaim";

export function SiZaim({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZaimHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZaimTitle}
      {...props}
    >
