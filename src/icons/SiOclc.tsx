...
export const SiOclcHex = "007DBA";
export const SiOclcTitle = "OCLC";
export const SiOclcSlug = "oclc";

export function SiOclc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOclcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOclcTitle}
      {...props}
    >
