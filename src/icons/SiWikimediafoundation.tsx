...
export const SiWikimediafoundationHex = "000000";
export const SiWikimediafoundationTitle = "Wikimedia Foundation";
export const SiWikimediafoundationSlug = "wikimediafoundation";

export function SiWikimediafoundation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikimediafoundationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikimediafoundationTitle}
      {...props}
    >
