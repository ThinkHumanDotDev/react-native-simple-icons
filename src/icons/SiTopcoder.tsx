...
export const SiTopcoderHex = "29A7DF";
export const SiTopcoderTitle = "Topcoder";
export const SiTopcoderSlug = "topcoder";

export function SiTopcoder({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTopcoderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTopcoderTitle}
      {...props}
    >
