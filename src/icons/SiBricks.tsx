...
export const SiBricksHex = "FFD54D";
export const SiBricksTitle = "Bricks";
export const SiBricksSlug = "bricks";

export function SiBricks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBricksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBricksTitle}
      {...props}
    >
