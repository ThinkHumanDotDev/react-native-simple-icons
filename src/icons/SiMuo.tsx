...
export const SiMuoHex = "C60D0D";
export const SiMuoTitle = "MUO";
export const SiMuoSlug = "muo";

export function SiMuo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMuoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMuoTitle}
      {...props}
    >
