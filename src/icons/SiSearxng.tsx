...
export const SiSearxngHex = "3050FF";
export const SiSearxngTitle = "SearXNG";
export const SiSearxngSlug = "searxng";

export function SiSearxng({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSearxngHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSearxngTitle}
      {...props}
    >
