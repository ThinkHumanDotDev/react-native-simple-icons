...
export const SiContensisHex = "37BFA7";
export const SiContensisTitle = "Contensis";
export const SiContensisSlug = "contensis";

export function SiContensis({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiContensisHex}` : color;
