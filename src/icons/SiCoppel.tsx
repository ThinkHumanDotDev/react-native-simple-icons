...
export const SiCoppelHex = "0266AE";
export const SiCoppelTitle = "Coppel";
export const SiCoppelSlug = "coppel";

export function SiCoppel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoppelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoppelTitle}
      {...props}
    >
