...
export const SiMicrostationHex = "62BB47";
export const SiMicrostationTitle = "Microstation";
export const SiMicrostationSlug = "microstation";

export function SiMicrostation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMicrostationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMicrostationTitle}
      {...props}
    >
