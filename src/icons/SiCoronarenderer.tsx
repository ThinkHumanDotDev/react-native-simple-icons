...
export const SiCoronarendererHex = "E6502A";
export const SiCoronarendererTitle = "Corona Renderer";
export const SiCoronarendererSlug = "coronarenderer";

export function SiCoronarenderer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoronarendererHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoronarendererTitle}
      {...props}
    >
