...
export const SiGooglecardboardHex = "FF7143";
export const SiGooglecardboardTitle = "Google Cardboard";
export const SiGooglecardboardSlug = "googlecardboard";

export function SiGooglecardboard({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglecardboardHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglecardboardTitle}
      {...props}
    >
