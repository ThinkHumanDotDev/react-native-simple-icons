...
export const SiValveHex = "F74843";
export const SiValveTitle = "Valve";
export const SiValveSlug = "valve";

export function SiValve({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiValveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiValveTitle}
      {...props}
    >
