...
export const SiJfrogpipelinesHex = "40BE46";
export const SiJfrogpipelinesTitle = "JFrog Pipelines";
export const SiJfrogpipelinesSlug = "jfrogpipelines";

export function SiJfrogpipelines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJfrogpipelinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJfrogpipelinesTitle}
      {...props}
    >
