...
export const SiExpressvpnHex = "DA3940";
export const SiExpressvpnTitle = "ExpressVPN";
export const SiExpressvpnSlug = "expressvpn";

export function SiExpressvpn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiExpressvpnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiExpressvpnTitle}
      {...props}
    >
