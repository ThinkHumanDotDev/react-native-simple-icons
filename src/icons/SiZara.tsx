...
export const SiZaraHex = "000000";
export const SiZaraTitle = "Zara";
export const SiZaraSlug = "zara";

export function SiZara({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZaraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZaraTitle}
      {...props}
    >
