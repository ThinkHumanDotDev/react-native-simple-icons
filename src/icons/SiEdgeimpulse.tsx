...
export const SiEdgeimpulseHex = "3B47C2";
export const SiEdgeimpulseTitle = "Edge Impulse";
export const SiEdgeimpulseSlug = "edgeimpulse";

export function SiEdgeimpulse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEdgeimpulseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEdgeimpulseTitle}
      {...props}
    >
