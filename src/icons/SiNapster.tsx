...
export const SiNapsterHex = "2259FF";
export const SiNapsterTitle = "Napster";
export const SiNapsterSlug = "napster";

export function SiNapster({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNapsterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNapsterTitle}
      {...props}
    >
