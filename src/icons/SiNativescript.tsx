...
export const SiNativescriptHex = "65ADF1";
export const SiNativescriptTitle = "NativeScript";
export const SiNativescriptSlug = "nativescript";

export function SiNativescript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNativescriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNativescriptTitle}
      {...props}
    >
