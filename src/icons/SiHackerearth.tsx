...
export const SiHackerearthHex = "2C3454";
export const SiHackerearthTitle = "HackerEarth";
export const SiHackerearthSlug = "hackerearth";

export function SiHackerearth({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHackerearthHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHackerearthTitle}
      {...props}
    >
