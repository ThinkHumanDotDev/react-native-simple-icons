...
export const SiApachecouchdbHex = "E42528";
export const SiApachecouchdbTitle = "Apache CouchDB";
export const SiApachecouchdbSlug = "apachecouchdb";

export function SiApachecouchdb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachecouchdbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachecouchdbTitle}
      {...props}
    >
