...
export const SiHotelsdotcomHex = "EF3346";
export const SiHotelsdotcomTitle = "Hotels.com";
export const SiHotelsdotcomSlug = "hotelsdotcom";

export function SiHotelsdotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHotelsdotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHotelsdotcomTitle}
      {...props}
    >
