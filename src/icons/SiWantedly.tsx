...
export const SiWantedlyHex = "21BDDB";
export const SiWantedlyTitle = "Wantedly";
export const SiWantedlySlug = "wantedly";

export function SiWantedly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWantedlyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWantedlyTitle}
      {...props}
    >
