...
export const SiCodecraftersHex = "171920";
export const SiCodecraftersTitle = "CodeCrafters";
export const SiCodecraftersSlug = "codecrafters";

export function SiCodecrafters({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodecraftersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodecraftersTitle}
      {...props}
    >
