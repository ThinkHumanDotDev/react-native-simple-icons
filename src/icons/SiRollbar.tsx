...
export const SiRollbarHex = "3569F3";
export const SiRollbarTitle = "Rollbar";
export const SiRollbarSlug = "rollbar";

export function SiRollbar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRollbarHex}` : color;
