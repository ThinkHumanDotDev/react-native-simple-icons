...
export const SiRadarrHex = "FFCB3D";
export const SiRadarrTitle = "radarr";
export const SiRadarrSlug = "radarr";

export function SiRadarr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRadarrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRadarrTitle}
      {...props}
    >
