...
export const SiLanguagetoolHex = "45A1FC";
export const SiLanguagetoolTitle = "LanguageTool";
export const SiLanguagetoolSlug = "languagetool";

export function SiLanguagetool({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLanguagetoolHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLanguagetoolTitle}
      {...props}
    >
