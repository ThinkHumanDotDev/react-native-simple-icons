...
export const SiSwarmHex = "FFA633";
export const SiSwarmTitle = "Swarm";
export const SiSwarmSlug = "swarm";

export function SiSwarm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSwarmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSwarmTitle}
      {...props}
    >
