...
export const SiClarivateHex = "93FF9E";
export const SiClarivateTitle = "Clarivate";
export const SiClarivateSlug = "clarivate";

export function SiClarivate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClarivateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClarivateTitle}
      {...props}
    >
