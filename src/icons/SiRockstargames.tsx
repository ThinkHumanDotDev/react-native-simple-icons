...
export const SiRockstargamesHex = "FCAF17";
export const SiRockstargamesTitle = "Rockstar Games";
export const SiRockstargamesSlug = "rockstargames";

export function SiRockstargames({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRockstargamesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRockstargamesTitle}
      {...props}
    >
