...
export const SiPerforceHex = "4C00FF";
export const SiPerforceTitle = "Perforce";
export const SiPerforceSlug = "perforce";

export function SiPerforce({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPerforceHex}` : color;
