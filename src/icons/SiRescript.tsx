...
export const SiRescriptHex = "E6484F";
export const SiRescriptTitle = "ReScript";
export const SiRescriptSlug = "rescript";

export function SiRescript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRescriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRescriptTitle}
      {...props}
    >
