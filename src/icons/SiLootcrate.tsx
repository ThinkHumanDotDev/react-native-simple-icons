...
export const SiLootcrateHex = "1E1E1E";
export const SiLootcrateTitle = "Loot Crate";
export const SiLootcrateSlug = "lootcrate";

export function SiLootcrate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLootcrateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLootcrateTitle}
      {...props}
    >
