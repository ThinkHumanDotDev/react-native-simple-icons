...
export const SiGuitarproHex = "569FFF";
export const SiGuitarproTitle = "Guitar Pro";
export const SiGuitarproSlug = "guitarpro";

export function SiGuitarpro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGuitarproHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGuitarproTitle}
      {...props}
    >
