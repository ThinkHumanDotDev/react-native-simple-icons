...
export const SiSabanciHex = "004B93";
export const SiSabanciTitle = "Sabanci";
export const SiSabanciSlug = "sabanci";

export function SiSabanci({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSabanciHex}` : color;
