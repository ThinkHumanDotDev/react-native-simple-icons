...
export const SiAlgoliaHex = "003DFF";
export const SiAlgoliaTitle = "Algolia";
export const SiAlgoliaSlug = "algolia";

export function SiAlgolia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlgoliaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlgoliaTitle}
      {...props}
    >
