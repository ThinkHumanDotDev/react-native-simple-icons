...
export const SiHaxeHex = "EA8220";
export const SiHaxeTitle = "Haxe";
export const SiHaxeSlug = "haxe";

export function SiHaxe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHaxeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHaxeTitle}
      {...props}
    >
