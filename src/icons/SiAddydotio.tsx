...
export const SiAddydotioHex = "19216C";
export const SiAddydotioTitle = "addy.io";
export const SiAddydotioSlug = "addydotio";

export function SiAddydotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAddydotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAddydotioTitle}
      {...props}
    >
