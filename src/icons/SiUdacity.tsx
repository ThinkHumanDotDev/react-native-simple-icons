...
export const SiUdacityHex = "02B3E4";
export const SiUdacityTitle = "Udacity";
export const SiUdacitySlug = "udacity";

export function SiUdacity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUdacityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUdacityTitle}
      {...props}
    >
