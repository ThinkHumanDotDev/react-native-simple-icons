...
export const SiKucoinHex = "01BC8D";
export const SiKucoinTitle = "KuCoin";
export const SiKucoinSlug = "kucoin";

export function SiKucoin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKucoinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKucoinTitle}
      {...props}
    >
