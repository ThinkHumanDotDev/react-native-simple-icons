...
export const SiTampermonkeyHex = "00485B";
export const SiTampermonkeyTitle = "Tampermonkey";
export const SiTampermonkeySlug = "tampermonkey";

export function SiTampermonkey({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTampermonkeyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTampermonkeyTitle}
      {...props}
    >
