...
export const SiLetterboxdHex = "202830";
export const SiLetterboxdTitle = "Letterboxd";
export const SiLetterboxdSlug = "letterboxd";

export function SiLetterboxd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLetterboxdHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLetterboxdTitle}
      {...props}
    >
