...
export const SiRtmHex = "36474F";
export const SiRtmTitle = "RTM";
export const SiRtmSlug = "rtm";

export function SiRtm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRtmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRtmTitle}
      {...props}
    >
