...
export const SiMoscowmetroHex = "D9232E";
export const SiMoscowmetroTitle = "Moscow Metro";
export const SiMoscowmetroSlug = "moscowmetro";

export function SiMoscowmetro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMoscowmetroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMoscowmetroTitle}
      {...props}
    >
