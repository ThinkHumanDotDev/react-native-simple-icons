...
export const SiRedwoodjsHex = "BF4722";
export const SiRedwoodjsTitle = "RedwoodJS";
export const SiRedwoodjsSlug = "redwoodjs";

export function SiRedwoodjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedwoodjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedwoodjsTitle}
      {...props}
    >
