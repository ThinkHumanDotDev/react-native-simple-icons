...
export const SiPipedHex = "F84330";
export const SiPipedTitle = "Piped";
export const SiPipedSlug = "piped";

export function SiPiped({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPipedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPipedTitle}
      {...props}
    >
