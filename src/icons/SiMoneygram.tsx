...
export const SiMoneygramHex = "DA291C";
export const SiMoneygramTitle = "MoneyGram";
export const SiMoneygramSlug = "moneygram";

export function SiMoneygram({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMoneygramHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMoneygramTitle}
      {...props}
    >
