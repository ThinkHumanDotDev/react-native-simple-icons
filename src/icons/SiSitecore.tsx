...
export const SiSitecoreHex = "EB1F1F";
export const SiSitecoreTitle = "Sitecore";
export const SiSitecoreSlug = "sitecore";

export function SiSitecore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSitecoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSitecoreTitle}
      {...props}
    >
