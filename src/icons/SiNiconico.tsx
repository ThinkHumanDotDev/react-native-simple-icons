...
export const SiNiconicoHex = "231815";
export const SiNiconicoTitle = "niconico";
export const SiNiconicoSlug = "niconico";

export function SiNiconico({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNiconicoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNiconicoTitle}
      {...props}
    >
