...
export const SiJinjaHex = "7E0C1B";
export const SiJinjaTitle = "Jinja";
export const SiJinjaSlug = "jinja";

export function SiJinja({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJinjaHex}` : color;
