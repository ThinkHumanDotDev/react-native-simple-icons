...
export const SiElasticHex = "005571";
export const SiElasticTitle = "Elastic";
export const SiElasticSlug = "elastic";

export function SiElastic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElasticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElasticTitle}
      {...props}
    >
