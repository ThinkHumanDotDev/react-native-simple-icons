...
export const SiTodoistHex = "E44332";
export const SiTodoistTitle = "Todoist";
export const SiTodoistSlug = "todoist";

export function SiTodoist({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTodoistHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTodoistTitle}
      {...props}
    >
