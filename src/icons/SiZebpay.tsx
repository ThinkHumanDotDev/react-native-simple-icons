...
export const SiZebpayHex = "2072EF";
export const SiZebpayTitle = "ZebPay";
export const SiZebpaySlug = "zebpay";

export function SiZebpay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZebpayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZebpayTitle}
      {...props}
    >
