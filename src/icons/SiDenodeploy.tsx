...
export const SiDenodeployHex = "002633";
export const SiDenodeployTitle = "Deno Deploy";
export const SiDenodeploySlug = "denodeploy";

export function SiDenodeploy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDenodeployHex}` : color;
