...
export const SiDassaultsystemesHex = "005386";
export const SiDassaultsystemesTitle = "Dassault Systèmes";
export const SiDassaultsystemesSlug = "dassaultsystemes";

export function SiDassaultsystemes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDassaultsystemesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDassaultsystemesTitle}
      {...props}
    >
