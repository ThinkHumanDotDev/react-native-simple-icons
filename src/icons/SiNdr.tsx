...
export const SiNdrHex = "0C1754";
export const SiNdrTitle = "NDR";
export const SiNdrSlug = "ndr";

export function SiNdr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNdrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNdrTitle}
      {...props}
    >
