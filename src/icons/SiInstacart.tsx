...
export const SiInstacartHex = "43B02A";
export const SiInstacartTitle = "Instacart";
export const SiInstacartSlug = "instacart";

export function SiInstacart({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInstacartHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInstacartTitle}
      {...props}
    >
