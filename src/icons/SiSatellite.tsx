...
export const SiSatelliteHex = "000000";
export const SiSatelliteTitle = "Satellite";
export const SiSatelliteSlug = "satellite";

export function SiSatellite({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSatelliteHex}` : color;
