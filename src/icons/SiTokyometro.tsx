...
export const SiTokyometroHex = "149DD3";
export const SiTokyometroTitle = "Tokyo Metro";
export const SiTokyometroSlug = "tokyometro";

export function SiTokyometro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTokyometroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTokyometroTitle}
      {...props}
    >
