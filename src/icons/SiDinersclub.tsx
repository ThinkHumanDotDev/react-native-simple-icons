...
export const SiDinersclubHex = "004C97";
export const SiDinersclubTitle = "Diners Club";
export const SiDinersclubSlug = "dinersclub";

export function SiDinersclub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDinersclubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDinersclubTitle}
      {...props}
    >
