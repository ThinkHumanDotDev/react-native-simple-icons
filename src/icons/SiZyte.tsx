...
export const SiZyteHex = "B02CCE";
export const SiZyteTitle = "Zyte";
export const SiZyteSlug = "zyte";

export function SiZyte({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZyteHex}` : color;
