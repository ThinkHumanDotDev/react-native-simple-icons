...
export const SiNumpyHex = "013243";
export const SiNumpyTitle = "NumPy";
export const SiNumpySlug = "numpy";

export function SiNumpy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNumpyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNumpyTitle}
      {...props}
    >
