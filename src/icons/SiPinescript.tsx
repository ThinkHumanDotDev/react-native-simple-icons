...
export const SiPinescriptHex = "00B453";
export const SiPinescriptTitle = "Pine Script";
export const SiPinescriptSlug = "pinescript";

export function SiPinescript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPinescriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPinescriptTitle}
      {...props}
    >
