...
export const SiOpensearchHex = "005EB8";
export const SiOpensearchTitle = "OpenSearch";
export const SiOpensearchSlug = "opensearch";

export function SiOpensearch({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpensearchHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpensearchTitle}
      {...props}
    >
