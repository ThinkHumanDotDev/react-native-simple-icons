...
export const SiKodakHex = "ED0000";
export const SiKodakTitle = "Kodak";
export const SiKodakSlug = "kodak";

export function SiKodak({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKodakHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKodakTitle}
      {...props}
    >
