...
export const SiScanHex = "004C97";
export const SiScanTitle = "Scan";
export const SiScanSlug = "scan";

export function SiScan({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScanHex}` : color;
