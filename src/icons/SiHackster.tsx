...
export const SiHacksterHex = "2E9FE6";
export const SiHacksterTitle = "Hackster";
export const SiHacksterSlug = "hackster";

export function SiHackster({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHacksterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHacksterTitle}
      {...props}
    >
