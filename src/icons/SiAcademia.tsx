...
export const SiAcademiaHex = "41454A";
export const SiAcademiaTitle = "Academia";
export const SiAcademiaSlug = "academia";

export function SiAcademia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAcademiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAcademiaTitle}
      {...props}
    >
