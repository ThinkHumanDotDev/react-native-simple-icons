...
export const SiFortranHex = "734F96";
export const SiFortranTitle = "Fortran";
export const SiFortranSlug = "fortran";

export function SiFortran({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFortranHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFortranTitle}
      {...props}
    >
