...
export const SiGojekHex = "00AA13";
export const SiGojekTitle = "Gojek";
export const SiGojekSlug = "gojek";

export function SiGojek({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGojekHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGojekTitle}
      {...props}
    >
