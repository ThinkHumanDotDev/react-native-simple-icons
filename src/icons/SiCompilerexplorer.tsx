...
export const SiCompilerexplorerHex = "67C52A";
export const SiCompilerexplorerTitle = "Compiler Explorer";
export const SiCompilerexplorerSlug = "compilerexplorer";

export function SiCompilerexplorer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCompilerexplorerHex}` : color;
