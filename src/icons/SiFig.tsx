...
export const SiFigHex = "000000";
export const SiFigTitle = "Fig";
export const SiFigSlug = "fig";

export function SiFig({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFigHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFigTitle}
      {...props}
    >
