...
export const SiWakatimeHex = "000000";
export const SiWakatimeTitle = "WakaTime";
export const SiWakatimeSlug = "wakatime";

export function SiWakatime({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWakatimeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWakatimeTitle}
      {...props}
    >
