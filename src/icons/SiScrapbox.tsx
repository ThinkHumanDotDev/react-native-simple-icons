...
export const SiScrapboxHex = "06B632";
export const SiScrapboxTitle = "Scrapbox";
export const SiScrapboxSlug = "scrapbox";

export function SiScrapbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScrapboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScrapboxTitle}
      {...props}
    >
