...
export const SiSpineHex = "FF4000";
export const SiSpineTitle = "Spine";
export const SiSpineSlug = "spine";

export function SiSpine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpineTitle}
      {...props}
    >
