...
export const SiGnomeHex = "4A86CF";
export const SiGnomeTitle = "GNOME";
export const SiGnomeSlug = "gnome";

export function SiGnome({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGnomeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGnomeTitle}
      {...props}
    >
