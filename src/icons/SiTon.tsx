...
export const SiTonHex = "0098EA";
export const SiTonTitle = "TON";
export const SiTonSlug = "ton";
...
export function SiTon({
  ...
  const resolvedColor = color === "default" ? `#${SiTonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTonTitle}
      {...props}
    >
