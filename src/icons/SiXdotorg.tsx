...
export const SiXdotorgHex = "F28834";
export const SiXdotorgTitle = "X.Org";
export const SiXdotorgSlug = "xdotorg";

export function SiXdotorg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiXdotorgHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiXdotorgTitle}
      {...props}
    >
