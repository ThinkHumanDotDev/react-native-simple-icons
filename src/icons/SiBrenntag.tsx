...
export const SiBrenntagHex = "1A0033";
export const SiBrenntagTitle = "Brenntag";
export const SiBrenntagSlug = "brenntag";

export function SiBrenntag({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBrenntagHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBrenntagTitle}
      {...props}
    >
