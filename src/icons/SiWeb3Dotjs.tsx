...
export const SiWeb3DotjsHex = "F16822";
export const SiWeb3DotjsTitle = "Web3.js";
export const SiWeb3DotjsSlug = "web3dotjs";

export function SiWeb3Dotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWeb3DotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWeb3DotjsTitle}
      {...props}
    >
