...
export const SiChannel4Hex = "AAFF89";
export const SiChannel4Title = "Channel 4";
export const SiChannel4Slug = "channel4";

export function SiChannel4({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChannel4Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChannel4Title}
      {...props}
    >
