...
export const SiInductiveautomationHex = "445C6D";
export const SiInductiveautomationTitle = "Inductive Automation";
export const SiInductiveautomationSlug = "inductiveautomation";

export function SiInductiveautomation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInductiveautomationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInductiveautomationTitle}
      {...props}
    >
