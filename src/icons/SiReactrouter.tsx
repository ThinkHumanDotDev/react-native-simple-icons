...
export const SiReactrouterHex = "CA4245";
export const SiReactrouterTitle = "React Router";
export const SiReactrouterSlug = "reactrouter";

export function SiReactrouter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReactrouterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReactrouterTitle}
      {...props}
    >
