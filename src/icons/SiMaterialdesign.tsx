...
export const SiMaterialdesignHex = "6750A4";
export const SiMaterialdesignTitle = "Material Design";
export const SiMaterialdesignSlug = "materialdesign";

export function SiMaterialdesign({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMaterialdesignHex}` : color;
