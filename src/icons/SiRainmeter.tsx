...
export const SiRainmeterHex = "19519B";
export const SiRainmeterTitle = "Rainmeter";
export const SiRainmeterSlug = "rainmeter";

export function SiRainmeter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRainmeterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRainmeterTitle}
      {...props}
    >
