...
export const SiNeo4JHex = "4581C3";
export const SiNeo4JTitle = "Neo4j";
export const SiNeo4JSlug = "neo4j";

export function SiNeo4J({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNeo4JHex}` : color;
