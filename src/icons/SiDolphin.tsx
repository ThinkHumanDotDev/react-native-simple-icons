...
export const SiDolphinHex = "00AAFF";
export const SiDolphinTitle = "Dolphin";
export const SiDolphinSlug = "dolphin";

export function SiDolphin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDolphinHex}` : color;
