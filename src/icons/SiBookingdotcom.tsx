...
export const SiBookingdotcomHex = "003A9A";
export const SiBookingdotcomTitle = "Booking.com";
export const SiBookingdotcomSlug = "bookingdotcom";

export function SiBookingdotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBookingdotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBookingdotcomTitle}
      {...props}
    >
