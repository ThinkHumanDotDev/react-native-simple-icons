...
export const SiThreemaHex = "3FE669";
export const SiThreemaTitle = "Threema";
export const SiThreemaSlug = "threema";

export function SiThreema({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThreemaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThreemaTitle}
      {...props}
    >
