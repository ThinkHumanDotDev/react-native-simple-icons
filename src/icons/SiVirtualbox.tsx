...
export const SiVirtualboxHex = "2F61B4";
export const SiVirtualboxTitle = "VirtualBox";
export const SiVirtualboxSlug = "virtualbox";

export function SiVirtualbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVirtualboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVirtualboxTitle}
      {...props}
    >
