...
export const SiXoHex = "5ED9C7";
export const SiXoTitle = "XO";
export const SiXoSlug = "xo";

export function SiXo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiXoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiXoTitle}
      {...props}
    >
