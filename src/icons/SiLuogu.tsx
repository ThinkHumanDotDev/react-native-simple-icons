...
export const SiLuoguHex = "5B9BD5";
export const SiLuoguTitle = "Luogu";
export const SiLuoguSlug = "luogu";

export function SiLuogu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLuoguHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLuoguTitle}
      {...props}
    >
