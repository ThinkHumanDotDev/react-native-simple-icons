...
export const SiOculusHex = "1C1E20";
export const SiOculusTitle = "Oculus";
export const SiOculusSlug = "oculus";

export function SiOculus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOculusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOculusTitle}
      {...props}
    >
