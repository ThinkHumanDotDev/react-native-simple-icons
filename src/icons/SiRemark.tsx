...
export const SiRemarkHex = "000000";
export const SiRemarkTitle = "remark";
export const SiRemarkSlug = "remark";

export function SiRemark({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRemarkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRemarkTitle}
      {...props}
    >
