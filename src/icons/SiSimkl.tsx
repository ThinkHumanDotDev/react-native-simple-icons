...
export const SiSimklHex = "000000";
export const SiSimklTitle = "Simkl";
export const SiSimklSlug = "simkl";

export function SiSimkl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSimklHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSimklTitle}
      {...props}
    >
