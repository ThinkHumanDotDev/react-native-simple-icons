...
export const SiNutanixHex = "024DA1";
export const SiNutanixTitle = "Nutanix";
export const SiNutanixSlug = "nutanix";

export function SiNutanix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNutanixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNutanixTitle}
      {...props}
    >
