...
export const SiTrustedshopsHex = "FFDC0F";
export const SiTrustedshopsTitle = "Trusted Shops";
export const SiTrustedshopsSlug = "trustedshops";

export function SiTrustedshops({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrustedshopsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrustedshopsTitle}
      {...props}
    >
