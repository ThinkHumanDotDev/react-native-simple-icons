...
export const SiSonosHex = "000000";
export const SiSonosTitle = "Sonos";
export const SiSonosSlug = "sonos";

export function SiSonos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSonosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSonosTitle}
      {...props}
    >
