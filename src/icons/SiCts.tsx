...
export const SiCtsHex = "E53236";
export const SiCtsTitle = "CTS";
export const SiCtsSlug = "cts";

export function SiCts({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCtsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCtsTitle}
      {...props}
    >
