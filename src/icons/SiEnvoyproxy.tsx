...
export const SiEnvoyproxyHex = "AC6199";
export const SiEnvoyproxyTitle = "Envoy Proxy";
export const SiEnvoyproxySlug = "envoyproxy";

export function SiEnvoyproxy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEnvoyproxyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEnvoyproxyTitle}
      {...props}
    >
