...
export const SiHclHex = "006BB6";
export const SiHclTitle = "HCL";
export const SiHclSlug = "hcl";

export function SiHcl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHclHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHclTitle}
      {...props}
    >
