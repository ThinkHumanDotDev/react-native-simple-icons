...
export const SiMatternetHex = "261C29";
export const SiMatternetTitle = "Matternet";
export const SiMatternetSlug = "matternet";

export function SiMatternet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMatternetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMatternetTitle}
      {...props}
    >
