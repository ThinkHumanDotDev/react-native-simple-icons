...
export const SiMastercomfigHex = "009688";
export const SiMastercomfigTitle = "mastercomfig";
export const SiMastercomfigSlug = "mastercomfig";

export function SiMastercomfig({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMastercomfigHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMastercomfigTitle}
      {...props}
    >
