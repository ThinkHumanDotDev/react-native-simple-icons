...
export const SiGeopandasHex = "139C5A";
export const SiGeopandasTitle = "GeoPandas";
export const SiGeopandasSlug = "geopandas";

export function SiGeopandas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGeopandasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGeopandasTitle}
      {...props}
    >
