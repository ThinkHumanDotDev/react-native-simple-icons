...
export const SiHoneybadgerHex = "EA5937";
export const SiHoneybadgerTitle = "Honeybadger";
export const SiHoneybadgerSlug = "honeybadger";

export function SiHoneybadger({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHoneybadgerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHoneybadgerTitle}
      {...props}
    >
