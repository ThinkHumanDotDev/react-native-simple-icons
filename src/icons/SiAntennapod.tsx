...
export const SiAntennapodHex = "364FF3";
export const SiAntennapodTitle = "AntennaPod";
export const SiAntennapodSlug = "antennapod";

export function SiAntennapod({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAntennapodHex}` : color;
