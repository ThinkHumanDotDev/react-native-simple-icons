...
export const SiItvxHex = "DEEB52";
export const SiItvxTitle = "ITVx";
export const SiItvxSlug = "itvx";

export function SiItvx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiItvxHex}` : color;
