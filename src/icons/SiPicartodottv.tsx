...
export const SiPicartodottvHex = "1DA456";
export const SiPicartodottvTitle = "Picarto.TV";
export const SiPicartodottvSlug = "picartodottv";

export function SiPicartodottv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPicartodottvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPicartodottvTitle}
      {...props}
    >
