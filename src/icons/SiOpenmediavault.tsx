...
export const SiOpenmediavaultHex = "5DACDF";
export const SiOpenmediavaultTitle = "openmediavault";
export const SiOpenmediavaultSlug = "openmediavault";

export function SiOpenmediavault({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenmediavaultHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenmediavaultTitle}
      {...props}
    >
