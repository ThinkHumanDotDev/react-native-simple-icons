...
export const SiProtonmailHex = "6D4AFF";
export const SiProtonmailTitle = "Proton Mail";
export const SiProtonmailSlug = "protonmail";

export function SiProtonmail({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtonmailHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtonmailTitle}
      {...props}
    >
