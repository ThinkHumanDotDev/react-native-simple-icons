...
export const SiFrameworkHex = "000000";
export const SiFrameworkTitle = "Framework";
export const SiFrameworkSlug = "framework";

export function SiFramework({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFrameworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFrameworkTitle}
      {...props}
    >
