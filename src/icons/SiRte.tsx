...
export const SiRteHex = "00A7B3";
export const SiRteTitle = "RTÉ";
export const SiRteSlug = "rte";

export function SiRte({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRteTitle}
      {...props}
    >
