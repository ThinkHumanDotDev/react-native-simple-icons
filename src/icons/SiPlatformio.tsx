...
export const SiPlatformioHex = "F5822A";
export const SiPlatformioTitle = "PlatformIO";
export const SiPlatformioSlug = "platformio";

export function SiPlatformio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlatformioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlatformioTitle}
      {...props}
    >
