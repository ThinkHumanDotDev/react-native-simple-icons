...
export const SiSanityHex = "0D0E12";
export const SiSanityTitle = "Sanity";
export const SiSanitySlug = "sanity";

export function SiSanity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSanityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSanityTitle}
      {...props}
    >
