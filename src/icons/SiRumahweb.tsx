...
export const SiRumahwebHex = "2EB4E3";
export const SiRumahwebTitle = "Rumahweb";
export const SiRumahwebSlug = "rumahweb";

export function SiRumahweb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRumahwebHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRumahwebTitle}
      {...props}
    >
