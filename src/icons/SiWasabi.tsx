...
export const SiWasabiHex = "01CD3E";
export const SiWasabiTitle = "Wasabi";
export const SiWasabiSlug = "wasabi";

export function SiWasabi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWasabiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWasabiTitle}
      {...props}
    >
