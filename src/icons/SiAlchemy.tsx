...
export const SiAlchemyHex = "0C0C0E";
export const SiAlchemyTitle = "Alchemy";
export const SiAlchemySlug = "alchemy";

export function SiAlchemy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlchemyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlchemyTitle}
      {...props}
    >
