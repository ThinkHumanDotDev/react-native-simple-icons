...
export const SiCodemagicHex = "F45E3F";
export const SiCodemagicTitle = "Codemagic";
export const SiCodemagicSlug = "codemagic";

export function SiCodemagic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodemagicHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodemagicTitle}
      {...props}
    >
