...
export const SiFoursquareHex = "3333FF";
export const SiFoursquareTitle = "Foursquare";
export const SiFoursquareSlug = "foursquare";

export function SiFoursquare({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFoursquareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFoursquareTitle}
      {...props}
    >
