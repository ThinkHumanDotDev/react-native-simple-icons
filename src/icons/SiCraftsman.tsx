...
export const SiCraftsmanHex = "D6001C";
export const SiCraftsmanTitle = "Craftsman";
export const SiCraftsmanSlug = "craftsman";

export function SiCraftsman({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCraftsmanHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCraftsmanTitle}
      {...props}
    >
