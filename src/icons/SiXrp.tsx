...
export const SiXrpHex = "25A768";
export const SiXrpTitle = "XRP";
export const SiXrpSlug = "xrp";

export function SiXrp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiXrpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiXrpTitle}
      {...props}
    >
