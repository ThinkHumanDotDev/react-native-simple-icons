...
export const SiDaskHex = "FC6E6B";
export const SiDaskTitle = "Dask";
export const SiDaskSlug = "dask";

export function SiDask({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDaskHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDaskTitle}
      {...props}
    >
