...
export const SiAkasaairHex = "FF6300";
export const SiAkasaairTitle = "Akasa Air";
export const SiAkasaairSlug = "akasaair";

export function SiAkasaair({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAkasaairHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAkasaairTitle}
      {...props}
    >
