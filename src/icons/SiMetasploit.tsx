...
export const SiMetasploitHex = "2596CD";
export const SiMetasploitTitle = "Metasploit";
export const SiMetasploitSlug = "metasploit";

export function SiMetasploit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMetasploitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMetasploitTitle}
      {...props}
    >
