...
export const SiFirefishHex = "F07A5B";
export const SiFirefishTitle = "Firefish";
export const SiFirefishSlug = "firefish";

export function SiFirefish({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFirefishHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFirefishTitle}
      {...props}
    >
