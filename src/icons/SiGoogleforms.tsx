...
export const SiGoogleformsHex = "7248B9";
export const SiGoogleformsTitle = "Google Forms";
export const SiGoogleformsSlug = "googleforms";

export function SiGoogleforms({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleformsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleformsTitle}
      {...props}
    >
