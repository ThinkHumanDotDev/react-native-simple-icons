...
export const SiAirbyteHex = "615EFF";
export const SiAirbyteTitle = "Airbyte";
export const SiAirbyteSlug = "airbyte";

export function SiAirbyte({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirbyteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirbyteTitle}
      {...props}
    >
