...
export const SiBitcoinsvHex = "EAB300";
export const SiBitcoinsvTitle = "Bitcoin SV";
export const SiBitcoinsvSlug = "bitcoinsv";

export function SiBitcoinsv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBitcoinsvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBitcoinsvTitle}
      {...props}
    >
