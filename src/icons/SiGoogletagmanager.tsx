...
export const SiGoogletagmanagerHex = "246FDB";
export const SiGoogletagmanagerTitle = "Google Tag Manager";
export const SiGoogletagmanagerSlug = "googletagmanager";

export function SiGoogletagmanager({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogletagmanagerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogletagmanagerTitle}
      {...props}
    >
