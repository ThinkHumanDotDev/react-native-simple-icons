...
export const SiEclipsemosquittoHex = "3C5280";
export const SiEclipsemosquittoTitle = "Eclipse Mosquitto";
export const SiEclipsemosquittoSlug = "eclipsemosquitto";

export function SiEclipsemosquitto({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEclipsemosquittoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEclipsemosquittoTitle}
      {...props}
    >
