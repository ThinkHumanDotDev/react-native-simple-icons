...
export const SiGoogleadsenseHex = "4285F4";
export const SiGoogleadsenseTitle = "Google AdSense";
export const SiGoogleadsenseSlug = "googleadsense";

export function SiGoogleadsense({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleadsenseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleadsenseTitle}
      {...props}
    >
