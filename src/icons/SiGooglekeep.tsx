...
export const SiGooglekeepHex = "FFBB00";
export const SiGooglekeepTitle = "Google Keep";
export const SiGooglekeepSlug = "googlekeep";

export function SiGooglekeep({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglekeepHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglekeepTitle}
      {...props}
    >
