...
export const SiVivaldiHex = "EF3939";
export const SiVivaldiTitle = "Vivaldi";
export const SiVivaldiSlug = "vivaldi";

export function SiVivaldi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVivaldiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVivaldiTitle}
      {...props}
    >
