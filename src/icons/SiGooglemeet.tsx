...
export const SiGooglemeetHex = "00897B";
export const SiGooglemeetTitle = "Google Meet";
export const SiGooglemeetSlug = "googlemeet";

export function SiGooglemeet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglemeetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglemeetTitle}
      {...props}
    >
