...
export const SiGhosttyHex = "3551F3";
export const SiGhosttyTitle = "Ghostty";
export const SiGhosttySlug = "ghostty";

export function SiGhostty({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGhosttyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGhosttyTitle}
      {...props}
    >
