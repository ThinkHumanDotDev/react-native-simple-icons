...
export const SiMetacriticHex = "000000";
export const SiMetacriticTitle = "Metacritic";
export const SiMetacriticSlug = "metacritic";

export function SiMetacritic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMetacriticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMetacriticTitle}
      {...props}
    >
