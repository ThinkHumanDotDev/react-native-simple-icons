...
export const SiPhosphoriconsHex = "3C402B";
export const SiPhosphoriconsTitle = "Phosphor Icons";
export const SiPhosphoriconsSlug = "phosphoricons";

export function SiPhosphoricons({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhosphoriconsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhosphoriconsTitle}
      {...props}
    >
