...
export const SiApachesolrHex = "D9411E";
export const SiApachesolrTitle = "Apache Solr";
export const SiApachesolrSlug = "apachesolr";

export function SiApachesolr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachesolrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachesolrTitle}
      {...props}
    >
