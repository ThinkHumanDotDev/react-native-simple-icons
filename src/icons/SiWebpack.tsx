...
export const SiWebpackHex = "8DD6F9";
export const SiWebpackTitle = "Webpack";
export const SiWebpackSlug = "webpack";

export function SiWebpack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWebpackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWebpackTitle}
      {...props}
    >
