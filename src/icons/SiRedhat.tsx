...
export const SiRedhatHex = "EE0000";
export const SiRedhatTitle = "Red Hat";
export const SiRedhatSlug = "redhat";

export function SiRedhat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedhatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedhatTitle}
      {...props}
    >
