...
export const SiEpsonHex = "003399";
export const SiEpsonTitle = "Epson";
export const SiEpsonSlug = "epson";

export function SiEpson({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEpsonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEpsonTitle}
      {...props}
    >
