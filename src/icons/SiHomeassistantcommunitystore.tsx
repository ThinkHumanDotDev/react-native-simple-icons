...
export const SiHomeassistantcommunitystoreHex = "41BDF5";
export const SiHomeassistantcommunitystoreTitle = "Home Assistant Community Store";
export const SiHomeassistantcommunitystoreSlug = "homeassistantcommunitystore";

export function SiHomeassistantcommunitystore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHomeassistantcommunitystoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHomeassistantcommunitystoreTitle}
      {...props}
    >
