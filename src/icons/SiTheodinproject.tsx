...
export const SiTheodinprojectHex = "A9792B";
export const SiTheodinprojectTitle = "The Odin Project";
export const SiTheodinprojectSlug = "theodinproject";

export function SiTheodinproject({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTheodinprojectHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTheodinprojectTitle}
      {...props}
    >
