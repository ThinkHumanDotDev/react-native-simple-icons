...
export const SiBrevoHex = "0B996E";
export const SiBrevoTitle = "Brevo";
export const SiBrevoSlug = "brevo";

export function SiBrevo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBrevoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBrevoTitle}
      {...props}
    >
