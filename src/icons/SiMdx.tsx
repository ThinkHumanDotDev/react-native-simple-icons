...
export const SiMdxHex = "1B1F24";
export const SiMdxTitle = "MDX";
export const SiMdxSlug = "mdx";

export function SiMdx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMdxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMdxTitle}
      {...props}
    >
