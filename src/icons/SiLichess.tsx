...
export const SiLichessHex = "000000";
export const SiLichessTitle = "Lichess";
export const SiLichessSlug = "lichess";

export function SiLichess({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLichessHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLichessTitle}
      {...props}
    >
