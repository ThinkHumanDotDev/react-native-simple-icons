...
export const SiExpediaHex = "191E3B";
export const SiExpediaTitle = "Expedia";
export const SiExpediaSlug = "expedia";

export function SiExpedia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiExpediaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiExpediaTitle}
      {...props}
    >
