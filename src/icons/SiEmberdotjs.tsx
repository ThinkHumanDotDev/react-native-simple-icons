...
export const SiEmberdotjsHex = "E04E39";
export const SiEmberdotjsTitle = "Ember.js";
export const SiEmberdotjsSlug = "emberdotjs";

export function SiEmberdotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEmberdotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEmberdotjsTitle}
      {...props}
    >
