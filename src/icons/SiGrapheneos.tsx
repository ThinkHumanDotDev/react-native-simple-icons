...
export const SiGrapheneosHex = "0053A3";
export const SiGrapheneosTitle = "GrapheneOS";
export const SiGrapheneosSlug = "grapheneos";

export function SiGrapheneos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGrapheneosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGrapheneosTitle}
      {...props}
    >
