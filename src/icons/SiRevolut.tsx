...
export const SiRevolutHex = "191C1F";
export const SiRevolutTitle = "Revolut";
export const SiRevolutSlug = "revolut";

export function SiRevolut({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRevolutHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRevolutTitle}
      {...props}
    >
