...
export const SiGuildedHex = "F5C400";
export const SiGuildedTitle = "Guilded";
export const SiGuildedSlug = "guilded";

export function SiGuilded({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGuildedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGuildedTitle}
      {...props}
    >
