...
export const SiRescuetimeHex = "161A3B";
export const SiRescuetimeTitle = "RescueTime";
export const SiRescuetimeSlug = "rescuetime";

export function SiRescuetime({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRescuetimeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRescuetimeTitle}
      {...props}
    >
