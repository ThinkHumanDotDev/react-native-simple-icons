...
export const SiMeituanHex = "FFD100";
export const SiMeituanTitle = "Meituan";
export const SiMeituanSlug = "meituan";

export function SiMeituan({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMeituanHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMeituanTitle}
      {...props}
    >
