...
export const SiApachecordovaHex = "E8E8E8";
export const SiApachecordovaTitle = "Apache Cordova";
export const SiApachecordovaSlug = "apachecordova";

export function SiApachecordova({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachecordovaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachecordovaTitle}
      {...props}
    >
