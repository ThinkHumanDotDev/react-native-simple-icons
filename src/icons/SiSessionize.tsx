...
export const SiSessionizeHex = "1AB394";
export const SiSessionizeTitle = "Sessionize";
export const SiSessionizeSlug = "sessionize";

export function SiSessionize({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSessionizeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSessionizeTitle}
      {...props}
    >
