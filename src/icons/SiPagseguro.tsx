...
export const SiPagseguroHex = "FFC801";
export const SiPagseguroTitle = "PagSeguro";
export const SiPagseguroSlug = "pagseguro";

export function SiPagseguro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPagseguroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPagseguroTitle}
      {...props}
    >
