...
export const SiAcuraHex = "000000";
export const SiAcuraTitle = "Acura";
export const SiAcuraSlug = "acura";

export function SiAcura({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAcuraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAcuraTitle}
      {...props}
    >
