...
export const SiGitforwindowsHex = "80B3FF";
export const SiGitforwindowsTitle = "Git for Windows";
export const SiGitforwindowsSlug = "gitforwindows";

export function SiGitforwindows({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitforwindowsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitforwindowsTitle}
      {...props}
    >
