...
export const SiReactiveresumeHex = "000000";
export const SiReactiveresumeTitle = "Reactive Resume";
export const SiReactiveresumeSlug = "reactiveresume";

export function SiReactiveresume({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReactiveresumeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReactiveresumeTitle}
      {...props}
    >
