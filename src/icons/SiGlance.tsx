...
export const SiGlanceHex = "D9C38C";
export const SiGlanceTitle = "Glance";
export const SiGlanceSlug = "glance";

export function SiGlance({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGlanceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGlanceTitle}
      {...props}
    >
