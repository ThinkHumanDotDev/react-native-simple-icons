...
export const SiGooglepayHex = "4285F4";
export const SiGooglepayTitle = "Google Pay";
export const SiGooglepaySlug = "googlepay";

export function SiGooglepay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglepayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglepayTitle}
      {...props}
    >
