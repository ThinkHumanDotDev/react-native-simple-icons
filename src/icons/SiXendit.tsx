...
export const SiXenditHex = "4573FF";
export const SiXenditTitle = "Xendit";
export const SiXenditSlug = "xendit";

export function SiXendit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiXenditHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiXenditTitle}
      {...props}
    >
