...
export const SiRedhatopenshiftHex = "EE0000";
export const SiRedhatopenshiftTitle = "Red Hat Open Shift";
export const SiRedhatopenshiftSlug = "redhatopenshift";

export function SiRedhatopenshift({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedhatopenshiftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedhatopenshiftTitle}
      {...props}
    >
