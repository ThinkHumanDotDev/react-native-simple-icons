...
export const SiInspireHex = "00E5FF";
export const SiInspireTitle = "INSPIRE";
export const SiInspireSlug = "inspire";

export function SiInspire({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInspireHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInspireTitle}
      {...props}
    >
