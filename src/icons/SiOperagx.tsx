...
export const SiOperagxHex = "EE2950";
export const SiOperagxTitle = "Opera GX";
export const SiOperagxSlug = "operagx";

export function SiOperagx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOperagxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOperagxTitle}
      {...props}
    >
