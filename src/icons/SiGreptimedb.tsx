...
export const SiGreptimedbHex = "8322FF";
export const SiGreptimedbTitle = "GreptimeDB";
export const SiGreptimedbSlug = "greptimedb";

export function SiGreptimedb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGreptimedbHex}` : color;
