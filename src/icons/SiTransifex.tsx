...
export const SiTransifexHex = "0064AB";
export const SiTransifexTitle = "Transifex";
export const SiTransifexSlug = "transifex";

export function SiTransifex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTransifexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTransifexTitle}
      {...props}
    >
