...
export const SiBastyonHex = "00A4FF";
export const SiBastyonTitle = "Bastyon";
export const SiBastyonSlug = "bastyon";

export function SiBastyon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBastyonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBastyonTitle}
      {...props}
    >
