...
export const SiEasyedaHex = "1765F6";
export const SiEasyedaTitle = "EasyEDA";
export const SiEasyedaSlug = "easyeda";

export function SiEasyeda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEasyedaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEasyedaTitle}
      {...props}
    >
