...
export const SiSemaphoreciHex = "19A974";
export const SiSemaphoreciTitle = "Semaphore CI";
export const SiSemaphoreciSlug = "semaphoreci";

export function SiSemaphoreci({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSemaphoreciHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSemaphoreciTitle}
      {...props}
    >
