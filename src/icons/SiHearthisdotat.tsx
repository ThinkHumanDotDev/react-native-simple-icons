...
export const SiHearthisdotatHex = "000000";
export const SiHearthisdotatTitle = "hearthis.at";
export const SiHearthisdotatSlug = "hearthisdotat";

export function SiHearthisdotat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHearthisdotatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHearthisdotatTitle}
      {...props}
    >
