...
export const SiStackbitHex = "207BEA";
export const SiStackbitTitle = "Stackbit";
export const SiStackbitSlug = "stackbit";

export function SiStackbit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStackbitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStackbitTitle}
      {...props}
    >
