...
export const SiNubankHex = "820AD1";
export const SiNubankTitle = "Nubank";
export const SiNubankSlug = "nubank";

export function SiNubank({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNubankHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNubankTitle}
      {...props}
    >
