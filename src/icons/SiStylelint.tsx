...
export const SiStylelintHex = "263238";
export const SiStylelintTitle = "stylelint";
export const SiStylelintSlug = "stylelint";

export function SiStylelint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStylelintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStylelintTitle}
      {...props}
    >
