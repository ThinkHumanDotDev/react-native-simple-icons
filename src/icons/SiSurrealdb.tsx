...
export const SiSurrealdbHex = "FF00A0";
export const SiSurrealdbTitle = "SurrealDB";
export const SiSurrealdbSlug = "surrealdb";

export function SiSurrealdb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSurrealdbHex}` : color;
