...
export const SiAbdownloadmanagerHex = "897BFF";
export const SiAbdownloadmanagerTitle = "AB Download Manager";
export const SiAbdownloadmanagerSlug = "abdownloadmanager";

export function SiAbdownloadmanager({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAbdownloadmanagerHex}` : color;
