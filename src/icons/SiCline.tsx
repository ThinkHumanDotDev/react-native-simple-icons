...
export const SiClineHex = "18181B";
export const SiClineTitle = "Cline";
export const SiClineSlug = "cline";

export function SiCline({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClineTitle}
      {...props}
    >
