...
export const SiHiveBlockchainHex = "E31337";
export const SiHiveBlockchainTitle = "Hive";
export const SiHiveBlockchainSlug = "hive_blockchain";

export function SiHiveBlockchain({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHiveBlockchainHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHiveBlockchainTitle}
      {...props}
    >
