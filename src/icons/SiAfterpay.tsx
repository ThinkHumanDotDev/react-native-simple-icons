...
export const SiAfterpayHex = "B2FCE4";
export const SiAfterpayTitle = "Afterpay";
export const SiAfterpaySlug = "afterpay";

export function SiAfterpay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAfterpayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAfterpayTitle}
      {...props}
    >
