...
export const SiCodeshipHex = "004466";
export const SiCodeshipTitle = "Codeship";
export const SiCodeshipSlug = "codeship";

export function SiCodeship({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodeshipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodeshipTitle}
      {...props}
    >
