...
export const SiFreshrssHex = "0062BE";
export const SiFreshrssTitle = "FreshRSS";
export const SiFreshrssSlug = "freshrss";

export function SiFreshrss({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreshrssHex}` : color;
