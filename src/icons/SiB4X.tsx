...
export const SiB4XHex = "14AECB";
export const SiB4XTitle = "B4X";
export const SiB4XSlug = "b4x";

export function SiB4X({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiB4XHex}` : color;
