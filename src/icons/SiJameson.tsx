...
export const SiJamesonHex = "004027";
export const SiJamesonTitle = "Jameson";
export const SiJamesonSlug = "jameson";

export function SiJameson({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJamesonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJamesonTitle}
      {...props}
    >
