...
export const SiZebratechnologiesHex = "000000";
export const SiZebratechnologiesTitle = "Zebra Technologies";
export const SiZebratechnologiesSlug = "zebratechnologies";

export function SiZebratechnologies({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZebratechnologiesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZebratechnologiesTitle}
      {...props}
    >
