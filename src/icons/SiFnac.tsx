...
export const SiFnacHex = "E1A925";
export const SiFnacTitle = "Fnac";
export const SiFnacSlug = "fnac";

export function SiFnac({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFnacHex}` : color;
