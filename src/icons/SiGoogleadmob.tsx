...
export const SiGoogleadmobHex = "EA4335";
export const SiGoogleadmobTitle = "Google AdMob";
export const SiGoogleadmobSlug = "googleadmob";

export function SiGoogleadmob({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleadmobHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleadmobTitle}
      {...props}
    >
