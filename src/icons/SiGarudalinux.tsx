...
export const SiGarudalinuxHex = "8839EF";
export const SiGarudalinuxTitle = "Garuda Linux";
export const SiGarudalinuxSlug = "garudalinux";

export function SiGarudalinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGarudalinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGarudalinuxTitle}
      {...props}
    >
