...
export const SiLyftHex = "FF00BF";
export const SiLyftTitle = "Lyft";
export const SiLyftSlug = "lyft";

export function SiLyft({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLyftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLyftTitle}
      {...props}
    >
