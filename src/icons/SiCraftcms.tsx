...
export const SiCraftcmsHex = "E5422B";
export const SiCraftcmsTitle = "Craft CMS";
export const SiCraftcmsSlug = "craftcms";

export function SiCraftcms({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCraftcmsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCraftcmsTitle}
      {...props}
    >
