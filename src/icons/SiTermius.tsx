...
export const SiTermiusHex = "000000";
export const SiTermiusTitle = "Termius";
export const SiTermiusSlug = "termius";

export function SiTermius({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTermiusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTermiusTitle}
      {...props}
    >
