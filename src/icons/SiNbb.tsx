...
export const SiNbbHex = "FF7100";
export const SiNbbTitle = "NBB";
export const SiNbbSlug = "nbb";

export function SiNbb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNbbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNbbTitle}
      {...props}
    >
