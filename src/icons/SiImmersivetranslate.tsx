...
export const SiImmersivetranslateHex = "EA4C89";
export const SiImmersivetranslateTitle = "Immersive Translate";
export const SiImmersivetranslateSlug = "immersivetranslate";

export function SiImmersivetranslate({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiImmersivetranslateHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiImmersivetranslateTitle}
      {...props}
    >
