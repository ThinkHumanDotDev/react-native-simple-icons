...
export const SiRocketdotchatHex = "F5455C";
export const SiRocketdotchatTitle = "Rocket.Chat";
export const SiRocketdotchatSlug = "rocketdotchat";

export function SiRocketdotchat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRocketdotchatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRocketdotchatTitle}
      {...props}
    >
