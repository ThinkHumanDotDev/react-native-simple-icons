...
export const SiPenpotHex = "000000";
export const SiPenpotTitle = "Penpot";
export const SiPenpotSlug = "penpot";

export function SiPenpot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPenpotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPenpotTitle}
      {...props}
    >
