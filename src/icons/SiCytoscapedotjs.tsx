...
export const SiCytoscapedotjsHex = "F7DF1E";
export const SiCytoscapedotjsTitle = "Cytoscape.js";
export const SiCytoscapedotjsSlug = "cytoscapedotjs";

export function SiCytoscapedotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCytoscapedotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCytoscapedotjsTitle}
      {...props}
    >
