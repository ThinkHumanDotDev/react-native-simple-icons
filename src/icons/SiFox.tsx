...
export const SiFoxHex = "000000";
export const SiFoxTitle = "FOX";
export const SiFoxSlug = "fox";

export function SiFox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFoxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFoxTitle}
      {...props}
    >
