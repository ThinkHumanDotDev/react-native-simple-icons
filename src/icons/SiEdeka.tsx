...
export const SiEdekaHex = "1B66B3";
export const SiEdekaTitle = "EDEKA";
export const SiEdekaSlug = "edeka";

export function SiEdeka({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEdekaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEdekaTitle}
      {...props}
    >
