...
export const SiOhdearHex = "FF3900";
export const SiOhdearTitle = "Oh Dear";
export const SiOhdearSlug = "ohdear";

export function SiOhdear({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOhdearHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOhdearTitle}
      {...props}
    >
