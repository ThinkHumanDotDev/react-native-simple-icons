...
export const SiOpentelemetryHex = "000000";
export const SiOpentelemetryTitle = "OpenTelemetry";
export const SiOpentelemetrySlug = "opentelemetry";

export function SiOpentelemetry({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpentelemetryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpentelemetryTitle}
      {...props}
    >
