...
export const SiPodcastaddictHex = "F4842D";
export const SiPodcastaddictTitle = "Podcast Addict";
export const SiPodcastaddictSlug = "podcastaddict";

export function SiPodcastaddict({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPodcastaddictHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPodcastaddictTitle}
      {...props}
    >
