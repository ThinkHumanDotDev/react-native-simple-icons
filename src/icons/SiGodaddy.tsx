...
export const SiGodaddyHex = "1BDBDB";
export const SiGodaddyTitle = "GoDaddy";
export const SiGodaddySlug = "godaddy";

export function SiGodaddy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGodaddyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGodaddyTitle}
      {...props}
    >
