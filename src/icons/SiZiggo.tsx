...
export const SiZiggoHex = "F48C00";
export const SiZiggoTitle = "Ziggo";
export const SiZiggoSlug = "ziggo";

export function SiZiggo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZiggoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZiggoTitle}
      {...props}
    >
