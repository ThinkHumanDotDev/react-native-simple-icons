...
export const SiRemixHex = "000000";
export const SiRemixTitle = "Remix";
export const SiRemixSlug = "remix";

export function SiRemix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRemixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRemixTitle}
      {...props}
    >
