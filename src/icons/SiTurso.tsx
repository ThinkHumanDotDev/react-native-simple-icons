...
export const SiTursoHex = "4FF8D2";
export const SiTursoTitle = "Turso";
export const SiTursoSlug = "turso";

export function SiTurso({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTursoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTursoTitle}
      {...props}
    >
