...
export const SiPivotaltrackerHex = "517A9E";
export const SiPivotaltrackerTitle = "Pivotal Tracker";
export const SiPivotaltrackerSlug = "pivotaltracker";

export function SiPivotaltracker({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPivotaltrackerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPivotaltrackerTitle}
      {...props}
    >
