...
export const SiQuicklookHex = "0078D3";
export const SiQuicklookTitle = "QuickLook";
export const SiQuicklookSlug = "quicklook";

export function SiQuicklook({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQuicklookHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQuicklookTitle}
      {...props}
    >
