...
export const SiClypHex = "3CBDB1";
export const SiClypTitle = "Clyp";
export const SiClypSlug = "clyp";

export function SiClyp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClypHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClypTitle}
      {...props}
    >
