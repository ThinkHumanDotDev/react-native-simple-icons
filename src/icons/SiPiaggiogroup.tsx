...
export const SiPiaggiogroupHex = "000000";
export const SiPiaggiogroupTitle = "Piaggio Group";
export const SiPiaggiogroupSlug = "piaggiogroup";

export function SiPiaggiogroup({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPiaggiogroupHex}` : color;
