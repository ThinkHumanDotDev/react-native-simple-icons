...
export const SiToshibaHex = "FF0000";
export const SiToshibaTitle = "Toshiba";
export const SiToshibaSlug = "toshiba";

export function SiToshiba({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiToshibaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiToshibaTitle}
      {...props}
    >
