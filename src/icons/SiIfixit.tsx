...
export const SiIfixitHex = "0071CE";
export const SiIfixitTitle = "iFixit";
export const SiIfixitSlug = "ifixit";

export function SiIfixit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIfixitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIfixitTitle}
      {...props}
    >
