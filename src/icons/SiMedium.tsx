...
export const SiMediumHex = "000000";
export const SiMediumTitle = "Medium";
export const SiMediumSlug = "medium";

export function SiMedium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMediumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMediumTitle}
      {...props}
    >
