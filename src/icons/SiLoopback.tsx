...
export const SiLoopbackHex = "3F5DFF";
export const SiLoopbackTitle = "LoopBack";
export const SiLoopbackSlug = "loopback";

export function SiLoopback({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLoopbackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLoopbackTitle}
      {...props}
    >
