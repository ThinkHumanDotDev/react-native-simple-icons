...
export const SiOpentofuHex = "FFDA18";
export const SiOpentofuTitle = "OpenTofu";
export const SiOpentofuSlug = "opentofu";

export function SiOpentofu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpentofuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpentofuTitle}
      {...props}
    >
