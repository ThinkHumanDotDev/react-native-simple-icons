...
export const SiAirplayaudioHex = "000000";
export const SiAirplayaudioTitle = "AirPlay Audio";
export const SiAirplayaudioSlug = "airplayaudio";

export function SiAirplayaudio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirplayaudioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirplayaudioTitle}
      {...props}
    >
