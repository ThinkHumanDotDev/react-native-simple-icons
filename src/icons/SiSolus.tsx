...
export const SiSolusHex = "5294E2";
export const SiSolusTitle = "Solus";
export const SiSolusSlug = "solus";

export function SiSolus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSolusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSolusTitle}
      {...props}
    >
