...
export const SiHitachiHex = "E60027";
export const SiHitachiTitle = "Hitachi";
export const SiHitachiSlug = "hitachi";

export function SiHitachi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHitachiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHitachiTitle}
      {...props}
    >
