...
export const SiGoodreadsHex = "1E1914";
export const SiGoodreadsTitle = "Goodreads";
export const SiGoodreadsSlug = "goodreads";

export function SiGoodreads({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoodreadsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoodreadsTitle}
      {...props}
    >
