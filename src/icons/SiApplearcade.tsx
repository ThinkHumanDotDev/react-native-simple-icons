...
export const SiApplearcadeHex = "000000";
export const SiApplearcadeTitle = "Apple Arcade";
export const SiApplearcadeSlug = "applearcade";

export function SiApplearcade({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApplearcadeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApplearcadeTitle}
      {...props}
    >
