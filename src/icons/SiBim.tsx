...
export const SiBimHex = "EB1928";
export const SiBimTitle = "BIM";
export const SiBimSlug = "bim";

export function SiBim({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBimHex}` : color;
