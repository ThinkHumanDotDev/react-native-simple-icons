...
export const SiVimeoHex = "1AB7EA";
export const SiVimeoTitle = "Vimeo";
export const SiVimeoSlug = "vimeo";

export function SiVimeo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVimeoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVimeoTitle}
      {...props}
    >
