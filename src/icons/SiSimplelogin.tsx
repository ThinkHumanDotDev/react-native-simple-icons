...
export const SiSimpleloginHex = "EA319F";
export const SiSimpleloginTitle = "SimpleLogin";
export const SiSimpleloginSlug = "simplelogin";

export function SiSimplelogin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSimpleloginHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSimpleloginTitle}
      {...props}
    >
