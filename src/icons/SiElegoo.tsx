...
export const SiElegooHex = "2C3A83";
export const SiElegooTitle = "Elegoo";
export const SiElegooSlug = "elegoo";

export function SiElegoo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElegooHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElegooTitle}
      {...props}
    >
