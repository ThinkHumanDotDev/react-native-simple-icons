...
export const SiYamahacorporationHex = "4B1E78";
export const SiYamahacorporationTitle = "Yamaha Corporation";
export const SiYamahacorporationSlug = "yamahacorporation";

export function SiYamahacorporation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYamahacorporationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYamahacorporationTitle}
      {...props}
    >
