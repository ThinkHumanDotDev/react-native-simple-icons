...
export const SiHootsuiteHex = "FF4C46";
export const SiHootsuiteTitle = "Hootsuite";
export const SiHootsuiteSlug = "hootsuite";

export function SiHootsuite({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHootsuiteHex}` : color;
