...
export const SiAriakitHex = "007ACC";
export const SiAriakitTitle = "Ariakit";
export const SiAriakitSlug = "ariakit";

export function SiAriakit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAriakitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAriakitTitle}
      {...props}
    >
