...
export const SiKfcHex = "F40027";
export const SiKfcTitle = "KFC";
export const SiKfcSlug = "kfc";

export function SiKfc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKfcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKfcTitle}
      {...props}
    >
