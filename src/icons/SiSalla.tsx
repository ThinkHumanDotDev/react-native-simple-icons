...
export const SiSallaHex = "BAF3E6";
export const SiSallaTitle = "Salla";
export const SiSallaSlug = "salla";

export function SiSalla({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSallaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSallaTitle}
      {...props}
    >
