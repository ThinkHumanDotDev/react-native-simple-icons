...
export const SiCachetHex = "7ED321";
export const SiCachetTitle = "Cachet";
export const SiCachetSlug = "cachet";

export function SiCachet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCachetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCachetTitle}
      {...props}
    >
