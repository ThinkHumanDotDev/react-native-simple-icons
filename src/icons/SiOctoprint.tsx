...
export const SiOctoprintHex = "13C100";
export const SiOctoprintTitle = "OctoPrint";
export const SiOctoprintSlug = "octoprint";

export function SiOctoprint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOctoprintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOctoprintTitle}
      {...props}
    >
