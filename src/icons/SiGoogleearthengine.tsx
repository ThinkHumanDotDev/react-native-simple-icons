...
export const SiGoogleearthengineHex = "4285F4";
export const SiGoogleearthengineTitle = "Google Earth Engine";
export const SiGoogleearthengineSlug = "googleearthengine";

export function SiGoogleearthengine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleearthengineHex}` : color;
