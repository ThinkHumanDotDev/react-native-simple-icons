...
export const SiPassboltHex = "D40101";
export const SiPassboltTitle = "Passbolt";
export const SiPassboltSlug = "passbolt";

export function SiPassbolt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPassboltHex}` : color;
