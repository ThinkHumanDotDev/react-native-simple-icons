...
export const SiQualysHex = "ED2E26";
export const SiQualysTitle = "Qualys";
export const SiQualysSlug = "qualys";

export function SiQualys({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQualysHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQualysTitle}
      {...props}
    >
