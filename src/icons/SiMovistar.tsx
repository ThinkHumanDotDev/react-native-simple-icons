...
export const SiMovistarHex = "019DF4";
export const SiMovistarTitle = "Movistar";
export const SiMovistarSlug = "movistar";

export function SiMovistar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMovistarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMovistarTitle}
      {...props}
    >
