...
export const SiPrdotcoHex = "0080FF";
export const SiPrdotcoTitle = "pr.co";
export const SiPrdotcoSlug = "prdotco";

export function SiPrdotco({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrdotcoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrdotcoTitle}
      {...props}
    >
