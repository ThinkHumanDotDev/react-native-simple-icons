...
export const SiFlydotioHex = "24175B";
export const SiFlydotioTitle = "Fly.io";
export const SiFlydotioSlug = "flydotio";

export function SiFlydotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFlydotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFlydotioTitle}
      {...props}
    >
