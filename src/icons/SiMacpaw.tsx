...
export const SiMacpawHex = "000000";
export const SiMacpawTitle = "MacPaw";
export const SiMacpawSlug = "macpaw";

export function SiMacpaw({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMacpawHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMacpawTitle}
      {...props}
    >
