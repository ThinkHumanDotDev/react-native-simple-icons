...
export const SiVectaryHex = "6100FF";
export const SiVectaryTitle = "Vectary";
export const SiVectarySlug = "vectary";

export function SiVectary({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVectaryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVectaryTitle}
      {...props}
    >
