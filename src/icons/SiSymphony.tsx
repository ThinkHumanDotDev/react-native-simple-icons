...
export const SiSymphonyHex = "0098FF";
export const SiSymphonyTitle = "Symphony";
export const SiSymphonySlug = "symphony";

export function SiSymphony({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSymphonyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSymphonyTitle}
      {...props}
    >
