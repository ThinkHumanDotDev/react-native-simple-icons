...
export const SiPhpmyadminHex = "6C78AF";
export const SiPhpmyadminTitle = "phpMyAdmin";
export const SiPhpmyadminSlug = "phpmyadmin";

export function SiPhpmyadmin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhpmyadminHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhpmyadminTitle}
      {...props}
    >
