...
export const SiVirginmediaHex = "ED1A37";
export const SiVirginmediaTitle = "Virgin Media";
export const SiVirginmediaSlug = "virginmedia";

export function SiVirginmedia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVirginmediaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVirginmediaTitle}
      {...props}
    >
