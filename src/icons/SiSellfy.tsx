...
export const SiSellfyHex = "21B352";
export const SiSellfyTitle = "Sellfy";
export const SiSellfySlug = "sellfy";

export function SiSellfy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSellfyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSellfyTitle}
      {...props}
    >
