...
export const SiCoderabbitHex = "FF570A";
export const SiCoderabbitTitle = "CodeRabbit";
export const SiCoderabbitSlug = "coderabbit";

export function SiCoderabbit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoderabbitHex}` : color;
