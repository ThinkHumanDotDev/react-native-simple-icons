...
export const SiMeizuHex = "FF4132";
export const SiMeizuTitle = "Meizu";
export const SiMeizuSlug = "meizu";

export function SiMeizu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMeizuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMeizuTitle}
      {...props}
    >
