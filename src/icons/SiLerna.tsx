...
export const SiLernaHex = "C084FC";
export const SiLernaTitle = "Lerna";
export const SiLernaSlug = "lerna";

export function SiLerna({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLernaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLernaTitle}
      {...props}
    >
