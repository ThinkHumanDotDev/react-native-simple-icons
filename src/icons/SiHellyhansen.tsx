...
export const SiHellyhansenHex = "DA2128";
export const SiHellyhansenTitle = "Helly Hansen";
export const SiHellyhansenSlug = "hellyhansen";

export function SiHellyhansen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHellyhansenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHellyhansenTitle}
      {...props}
    >
