...
export const SiBitwardenHex = "175DDC";
export const SiBitwardenTitle = "Bitwarden";
export const SiBitwardenSlug = "bitwarden";

export function SiBitwarden({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBitwardenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBitwardenTitle}
      {...props}
    >
