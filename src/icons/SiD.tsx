...
export const SiDHex = "B03931";
export const SiDTitle = "D";
export const SiDSlug = "d";
...
export function SiD({
  ...
  const resolvedColor = color === "default" ? `#${SiDHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDTitle}
      {...props}
    >
