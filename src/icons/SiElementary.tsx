...
export const SiElementaryHex = "64BAFF";
export const SiElementaryTitle = "elementary";
export const SiElementarySlug = "elementary";

export function SiElementary({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElementaryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElementaryTitle}
      {...props}
    >
