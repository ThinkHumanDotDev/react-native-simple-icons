...
export const SiCnesHex = "204F8C";
export const SiCnesTitle = "CNES";
export const SiCnesSlug = "cnes";

export function SiCnes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCnesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCnesTitle}
      {...props}
    >
