...
export const SiGnusocialHex = "A22430";
export const SiGnusocialTitle = "GNU social";
export const SiGnusocialSlug = "gnusocial";

export function SiGnusocial({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGnusocialHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGnusocialTitle}
      {...props}
    >
