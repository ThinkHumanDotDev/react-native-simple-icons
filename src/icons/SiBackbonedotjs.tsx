...
export const SiBackbonedotjsHex = "0071B5";
export const SiBackbonedotjsTitle = "Backbone.js";
export const SiBackbonedotjsSlug = "backbonedotjs";

export function SiBackbonedotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBackbonedotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBackbonedotjsTitle}
      {...props}
    >
