...
export const SiWikimediacommonsHex = "006699";
export const SiWikimediacommonsTitle = "Wikimedia Commons";
export const SiWikimediacommonsSlug = "wikimediacommons";

export function SiWikimediacommons({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikimediacommonsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikimediacommonsTitle}
      {...props}
    >
