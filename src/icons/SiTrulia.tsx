...
export const SiTruliaHex = "0A0B09";
export const SiTruliaTitle = "trulia";
export const SiTruliaSlug = "trulia";

export function SiTrulia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTruliaHex}` : color;
