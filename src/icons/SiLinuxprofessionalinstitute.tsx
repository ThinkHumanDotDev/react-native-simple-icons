...
export const SiLinuxprofessionalinstituteHex = "FDC300";
export const SiLinuxprofessionalinstituteTitle = "Linux Professional Institute";
export const SiLinuxprofessionalinstituteSlug = "linuxprofessionalinstitute";

export function SiLinuxprofessionalinstitute({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinuxprofessionalinstituteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLinuxprofessionalinstituteTitle}
      {...props}
    >
