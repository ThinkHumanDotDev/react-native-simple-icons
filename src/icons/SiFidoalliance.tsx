...
export const SiFidoallianceHex = "FFBF3B";
export const SiFidoallianceTitle = "Fido Alliance";
export const SiFidoallianceSlug = "fidoalliance";

export function SiFidoalliance({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFidoallianceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFidoallianceTitle}
      {...props}
    >
