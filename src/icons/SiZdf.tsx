...
export const SiZdfHex = "FA7D19";
export const SiZdfTitle = "ZDF";
export const SiZdfSlug = "zdf";

export function SiZdf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZdfHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZdfTitle}
      {...props}
    >
