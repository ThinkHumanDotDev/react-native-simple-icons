...
export const SiJetbrainsHex = "000000";
export const SiJetbrainsTitle = "JetBrains";
export const SiJetbrainsSlug = "jetbrains";

export function SiJetbrains({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJetbrainsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJetbrainsTitle}
      {...props}
    >
