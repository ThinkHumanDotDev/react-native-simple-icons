...
export const SiRancherHex = "0075A8";
export const SiRancherTitle = "Rancher";
export const SiRancherSlug = "rancher";

export function SiRancher({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRancherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRancherTitle}
      {...props}
    >
