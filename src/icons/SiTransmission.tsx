...
export const SiTransmissionHex = "D70008";
export const SiTransmissionTitle = "Transmission";
export const SiTransmissionSlug = "transmission";

export function SiTransmission({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTransmissionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTransmissionTitle}
      {...props}
    >
