...
export const SiHumhubHex = "1B8291";
export const SiHumhubTitle = "HumHub";
export const SiHumhubSlug = "humhub";

export function SiHumhub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHumhubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHumhubTitle}
      {...props}
    >
