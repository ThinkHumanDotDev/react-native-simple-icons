...
export const SiCiliumHex = "F8C517";
export const SiCiliumTitle = "Cilium";
export const SiCiliumSlug = "cilium";

export function SiCilium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCiliumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCiliumTitle}
      {...props}
    >
