...
export const SiKodiHex = "17B2E7";
export const SiKodiTitle = "Kodi";
export const SiKodiSlug = "kodi";

export function SiKodi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKodiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKodiTitle}
      {...props}
    >
