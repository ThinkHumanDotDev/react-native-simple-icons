...
export const SiGravatarHex = "1E8CBE";
export const SiGravatarTitle = "Gravatar";
export const SiGravatarSlug = "gravatar";

export function SiGravatar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGravatarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGravatarTitle}
      {...props}
    >
