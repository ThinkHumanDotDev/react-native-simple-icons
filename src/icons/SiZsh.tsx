...
export const SiZshHex = "F15A24";
export const SiZshTitle = "Zsh";
export const SiZshSlug = "zsh";

export function SiZsh({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZshHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZshTitle}
      {...props}
    >
