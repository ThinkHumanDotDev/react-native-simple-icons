...
export const SiH2DatabaseHex = "09476B";
export const SiH2DatabaseTitle = "H2 Database";
export const SiH2DatabaseSlug = "h2database";

export function SiH2Database({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiH2DatabaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiH2DatabaseTitle}
      {...props}
    >
