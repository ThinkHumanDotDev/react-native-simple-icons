...
export const SiOpenaccessHex = "F68212";
export const SiOpenaccessTitle = "Open Access";
export const SiOpenaccessSlug = "openaccess";

export function SiOpenaccess({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenaccessHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenaccessTitle}
      {...props}
    >
