...
export const SiMakerbotHex = "FF1E0D";
export const SiMakerbotTitle = "MakerBot";
export const SiMakerbotSlug = "makerbot";

export function SiMakerbot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMakerbotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMakerbotTitle}
      {...props}
    >
