...
export const SiSublimetextHex = "FF9800";
export const SiSublimetextTitle = "Sublime Text";
export const SiSublimetextSlug = "sublimetext";

export function SiSublimetext({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSublimetextHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSublimetextTitle}
      {...props}
    >
