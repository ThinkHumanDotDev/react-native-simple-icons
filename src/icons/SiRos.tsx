...
export const SiRosHex = "22314E";
export const SiRosTitle = "ROS";
export const SiRosSlug = "ros";

export function SiRos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRosTitle}
      {...props}
    >
