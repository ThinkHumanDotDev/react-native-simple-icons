...
export const SiThealgorithmsHex = "00BCB4";
export const SiThealgorithmsTitle = "The Algorithms";
export const SiThealgorithmsSlug = "thealgorithms";

export function SiThealgorithms({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThealgorithmsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThealgorithmsTitle}
      {...props}
    >
