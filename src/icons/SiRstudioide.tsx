...
export const SiRstudioideHex = "75AADB";
export const SiRstudioideTitle = "RStudio IDE";
export const SiRstudioideSlug = "rstudioide";

export function SiRstudioide({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRstudioideHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRstudioideTitle}
      {...props}
    >
