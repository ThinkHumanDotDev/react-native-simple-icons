...
export const SiFishaudioHex = "9B90E8";
export const SiFishaudioTitle = "Fish Audio";
export const SiFishaudioSlug = "fishaudio";

export function SiFishaudio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFishaudioHex}` : color;
