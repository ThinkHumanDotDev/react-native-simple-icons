...
export const SiKeeperHex = "FFC700";
export const SiKeeperTitle = "Keeper";
export const SiKeeperSlug = "keeper";

export function SiKeeper({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKeeperHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKeeperTitle}
      {...props}
    >
