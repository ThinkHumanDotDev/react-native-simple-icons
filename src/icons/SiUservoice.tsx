...
export const SiUservoiceHex = "FF6720";
export const SiUservoiceTitle = "UserVoice";
export const SiUservoiceSlug = "uservoice";

export function SiUservoice({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUservoiceHex}` : color;
