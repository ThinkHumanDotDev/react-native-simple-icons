...
export const SiForgejoHex = "FB923C";
export const SiForgejoTitle = "Forgejo";
export const SiForgejoSlug = "forgejo";

export function SiForgejo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiForgejoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiForgejoTitle}
      {...props}
    >
