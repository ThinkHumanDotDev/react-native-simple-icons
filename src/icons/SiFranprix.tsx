...
export const SiFranprixHex = "EC6237";
export const SiFranprixTitle = "Franprix";
export const SiFranprixSlug = "franprix";

export function SiFranprix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFranprixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFranprixTitle}
      {...props}
    >
