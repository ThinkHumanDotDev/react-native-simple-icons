...
export const SiBigbasketHex = "A5CD39";
export const SiBigbasketTitle = "bigbasket";
export const SiBigbasketSlug = "bigbasket";

export function SiBigbasket({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBigbasketHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBigbasketTitle}
      {...props}
    >
