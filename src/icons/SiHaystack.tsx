...
export const SiHaystackHex = "0EAF9C";
export const SiHaystackTitle = "Haystack";
export const SiHaystackSlug = "haystack";

export function SiHaystack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHaystackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHaystackTitle}
      {...props}
    >
