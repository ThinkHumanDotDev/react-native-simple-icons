...
export const SiRepublicofgamersHex = "FF0029";
export const SiRepublicofgamersTitle = "Republic of Gamers";
export const SiRepublicofgamersSlug = "republicofgamers";

export function SiRepublicofgamers({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRepublicofgamersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRepublicofgamersTitle}
      {...props}
    >
