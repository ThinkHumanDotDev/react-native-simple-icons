...
export const SiCodingninjasHex = "DD6620";
export const SiCodingninjasTitle = "Coding Ninjas";
export const SiCodingninjasSlug = "codingninjas";

export function SiCodingninjas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodingninjasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodingninjasTitle}
      {...props}
    >
