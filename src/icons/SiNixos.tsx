...
export const SiNixosHex = "5277C3";
export const SiNixosTitle = "NixOS";
export const SiNixosSlug = "nixos";

export function SiNixos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNixosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNixosTitle}
      {...props}
    >
