...
export const SiAutomatticHex = "3499CD";
export const SiAutomatticTitle = "Automattic";
export const SiAutomatticSlug = "automattic";

export function SiAutomattic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutomatticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutomatticTitle}
      {...props}
    >
