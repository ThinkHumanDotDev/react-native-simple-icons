...
export const SiCommitlintHex = "000000";
export const SiCommitlintTitle = "commitlint";
export const SiCommitlintSlug = "commitlint";

export function SiCommitlint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCommitlintHex}` : color;
