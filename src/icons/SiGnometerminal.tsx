...
export const SiGnometerminalHex = "241F31";
export const SiGnometerminalTitle = "GNOME Terminal";
export const SiGnometerminalSlug = "gnometerminal";

export function SiGnometerminal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGnometerminalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGnometerminalTitle}
      {...props}
    >
