...
export const SiManHex = "E40045";
export const SiManTitle = "MAN";
export const SiManSlug = "man";

export function SiMan({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiManHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiManTitle}
      {...props}
    >
