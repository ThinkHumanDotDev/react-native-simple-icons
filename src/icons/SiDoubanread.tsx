...
export const SiDoubanreadHex = "24D2C8";
export const SiDoubanreadTitle = "Douban Read";
export const SiDoubanreadSlug = "doubanread";

export function SiDoubanread({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDoubanreadHex}` : color;
