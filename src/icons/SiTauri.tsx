...
export const SiTauriHex = "24C8D8";
export const SiTauriTitle = "Tauri";
export const SiTauriSlug = "tauri";

export function SiTauri({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTauriHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTauriTitle}
      {...props}
    >
