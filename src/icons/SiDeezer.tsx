...
export const SiDeezerHex = "A238FF";
export const SiDeezerTitle = "Deezer";
export const SiDeezerSlug = "deezer";

export function SiDeezer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeezerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeezerTitle}
      {...props}
    >
