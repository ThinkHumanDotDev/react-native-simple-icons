...
export const SiAutodeskmayaHex = "37A5CC";
export const SiAutodeskmayaTitle = "Autodesk Maya";
export const SiAutodeskmayaSlug = "autodeskmaya";

export function SiAutodeskmaya({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutodeskmayaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutodeskmayaTitle}
      {...props}
    >
