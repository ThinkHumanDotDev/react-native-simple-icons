...
export const SiYoloHex = "111F68";
export const SiYoloTitle = "YOLO";
export const SiYoloSlug = "yolo";

export function SiYolo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYoloHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYoloTitle}
      {...props}
    >
