...
export const SiWalletconnectHex = "3B99FC";
export const SiWalletconnectTitle = "WalletConnect";
export const SiWalletconnectSlug = "walletconnect";

export function SiWalletconnect({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWalletconnectHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWalletconnectTitle}
      {...props}
    >
