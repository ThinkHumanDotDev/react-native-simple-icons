...
export const SiDynatraceHex = "1496FF";
export const SiDynatraceTitle = "Dynatrace";
export const SiDynatraceSlug = "dynatrace";

export function SiDynatrace({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDynatraceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDynatraceTitle}
      {...props}
    >
