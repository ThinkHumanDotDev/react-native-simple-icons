...
export const SiEdotleclercHex = "0066CC";
export const SiEdotleclercTitle = "E.Leclerc";
export const SiEdotleclercSlug = "edotleclerc";

export function SiEdotleclerc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEdotleclercHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEdotleclercTitle}
      {...props}
    >
