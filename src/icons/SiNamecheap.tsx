...
export const SiNamecheapHex = "DE3723";
export const SiNamecheapTitle = "Namecheap";
export const SiNamecheapSlug = "namecheap";

export function SiNamecheap({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNamecheapHex}` : color;
