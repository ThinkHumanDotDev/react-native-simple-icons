...
export const SiFraunhofergesellschaftHex = "179C7D";
export const SiFraunhofergesellschaftTitle = "Fraunhofer-Gesellschaft";
export const SiFraunhofergesellschaftSlug = "fraunhofergesellschaft";

export function SiFraunhofergesellschaft({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFraunhofergesellschaftHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFraunhofergesellschaftTitle}
      {...props}
    >
