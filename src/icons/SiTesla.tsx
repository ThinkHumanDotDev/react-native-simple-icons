...
export const SiTeslaHex = "CC0000";
export const SiTeslaTitle = "Tesla";
export const SiTeslaSlug = "tesla";
...
export function SiTesla({
  ...
  const resolvedColor = color === "default" ? `#${SiTeslaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTeslaTitle}
      {...props}
    >
