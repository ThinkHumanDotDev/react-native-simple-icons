...
export const SiGooglepubsubHex = "AECBFA";
export const SiGooglepubsubTitle = "Google Pub/Sub";
export const SiGooglepubsubSlug = "googlepubsub";

export function SiGooglepubsub({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglepubsubHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglepubsubTitle}
      {...props}
    >
