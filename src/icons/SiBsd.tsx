...
export const SiBsdHex = "AB2B28";
export const SiBsdTitle = "BSD";
export const SiBsdSlug = "bsd";

export function SiBsd({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBsdHex}` : color;
