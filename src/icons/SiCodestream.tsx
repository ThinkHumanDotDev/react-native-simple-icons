...
export const SiCodestreamHex = "008C99";
export const SiCodestreamTitle = "CodeStream";
export const SiCodestreamSlug = "codestream";

export function SiCodestream({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodestreamHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodestreamTitle}
      {...props}
    >
