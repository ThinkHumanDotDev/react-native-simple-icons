...
export const SiThingiverseHex = "248BFB";
export const SiThingiverseTitle = "Thingiverse";
export const SiThingiverseSlug = "thingiverse";

export function SiThingiverse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThingiverseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThingiverseTitle}
      {...props}
    >
