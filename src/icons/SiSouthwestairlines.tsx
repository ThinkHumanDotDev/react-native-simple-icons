...
export const SiSouthwestairlinesHex = "304CB2";
export const SiSouthwestairlinesTitle = "Southwest Airlines";
export const SiSouthwestairlinesSlug = "southwestairlines";

export function SiSouthwestairlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSouthwestairlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSouthwestairlinesTitle}
      {...props}
    >
