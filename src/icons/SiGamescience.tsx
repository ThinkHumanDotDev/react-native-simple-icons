...
export const SiGamescienceHex = "000000";
export const SiGamescienceTitle = "Game Science";
export const SiGamescienceSlug = "gamescience";

export function SiGamescience({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGamescienceHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGamescienceTitle}
      {...props}
    >
