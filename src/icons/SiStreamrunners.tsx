...
export const SiStreamrunnersHex = "6644F8";
export const SiStreamrunnersTitle = "StreamRunners";
export const SiStreamrunnersSlug = "streamrunners";

export function SiStreamrunners({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStreamrunnersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStreamrunnersTitle}
      {...props}
    >
