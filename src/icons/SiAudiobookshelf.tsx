...
export const SiAudiobookshelfHex = "82612C";
export const SiAudiobookshelfTitle = "Audiobookshelf";
export const SiAudiobookshelfSlug = "audiobookshelf";

export function SiAudiobookshelf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAudiobookshelfHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAudiobookshelfTitle}
      {...props}
    >
