...
export const SiLiningHex = "C5242C";
export const SiLiningTitle = "Li-Ning";
export const SiLiningSlug = "lining";

export function SiLining({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLiningHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLiningTitle}
      {...props}
    >
