...
export const SiMetrodemadridHex = "255E9C";
export const SiMetrodemadridTitle = "Metro de Madrid";
export const SiMetrodemadridSlug = "metrodemadrid";

export function SiMetrodemadrid({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMetrodemadridHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMetrodemadridTitle}
      {...props}
    >
