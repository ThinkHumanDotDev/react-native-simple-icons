...
export const SiAircanadaHex = "F01428";
export const SiAircanadaTitle = "Air Canada";
export const SiAircanadaSlug = "aircanada";

export function SiAircanada({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAircanadaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAircanadaTitle}
      {...props}
    >
