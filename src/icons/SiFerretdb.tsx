...
export const SiFerretdbHex = "042133";
export const SiFerretdbTitle = "FerretDB";
export const SiFerretdbSlug = "ferretdb";

export function SiFerretdb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFerretdbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFerretdbTitle}
      {...props}
    >
