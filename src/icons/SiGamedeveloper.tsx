...
export const SiGamedeveloperHex = "E60012";
export const SiGamedeveloperTitle = "Game Developer";
export const SiGamedeveloperSlug = "gamedeveloper";

export function SiGamedeveloper({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGamedeveloperHex}` : color;
