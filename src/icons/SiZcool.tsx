...
export const SiZcoolHex = "FFF200";
export const SiZcoolTitle = "ZCOOL";
export const SiZcoolSlug = "zcool";

export function SiZcool({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZcoolHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZcoolTitle}
      {...props}
    >
