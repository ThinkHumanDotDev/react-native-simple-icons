...
export const SiEducativeHex = "4951F5";
export const SiEducativeTitle = "Educative";
export const SiEducativeSlug = "educative";

export function SiEducative({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEducativeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEducativeTitle}
      {...props}
    >
