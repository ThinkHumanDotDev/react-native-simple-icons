...
export const SiFishshellHex = "34C534";
export const SiFishshellTitle = "fish shell";
export const SiFishshellSlug = "fishshell";

export function SiFishshell({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFishshellHex}` : color;
