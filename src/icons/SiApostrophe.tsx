...
export const SiApostropheHex = "6236FF";
export const SiApostropheTitle = "Apostrophe";
export const SiApostropheSlug = "apostrophe";

export function SiApostrophe({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApostropheHex}` : color;
