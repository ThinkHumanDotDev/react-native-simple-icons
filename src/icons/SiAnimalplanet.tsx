...
export const SiAnimalplanetHex = "0073FF";
export const SiAnimalplanetTitle = "Animal Planet";
export const SiAnimalplanetSlug = "animalplanet";

export function SiAnimalplanet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAnimalplanetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAnimalplanetTitle}
      {...props}
    >
