...
export const SiOppoHex = "2D683D";
export const SiOppoTitle = "OPPO";
export const SiOppoSlug = "oppo";

export function SiOppo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOppoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOppoTitle}
      {...props}
    >
