...
export const SiGooglestreetviewHex = "FEC111";
export const SiGooglestreetviewTitle = "Google Street View";
export const SiGooglestreetviewSlug = "googlestreetview";

export function SiGooglestreetview({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglestreetviewHex}` : color;
