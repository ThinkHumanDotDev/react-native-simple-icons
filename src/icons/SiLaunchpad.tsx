...
export const SiLaunchpadHex = "E95420";
export const SiLaunchpadTitle = "Launchpad";
export const SiLaunchpadSlug = "launchpad";

export function SiLaunchpad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLaunchpadHex}` : color;
