...
export const SiNissanHex = "C3002F";
export const SiNissanTitle = "Nissan";
export const SiNissanSlug = "nissan";

export function SiNissan({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNissanHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNissanTitle}
      {...props}
    >
