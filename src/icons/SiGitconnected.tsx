...
export const SiGitconnectedHex = "2E69AE";
export const SiGitconnectedTitle = "Gitconnected";
export const SiGitconnectedSlug = "gitconnected";

export function SiGitconnected({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitconnectedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitconnectedTitle}
      {...props}
    >
