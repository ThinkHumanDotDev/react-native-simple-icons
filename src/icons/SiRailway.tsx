...
export const SiRailwayHex = "0B0D0E";
export const SiRailwayTitle = "Railway";
export const SiRailwaySlug = "railway";

export function SiRailway({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRailwayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRailwayTitle}
      {...props}
    >
