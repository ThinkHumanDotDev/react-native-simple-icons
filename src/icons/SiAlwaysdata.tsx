...
export const SiAlwaysdataHex = "E9568E";
export const SiAlwaysdataTitle = "Alwaysdata";
export const SiAlwaysdataSlug = "alwaysdata";

export function SiAlwaysdata({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlwaysdataHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlwaysdataTitle}
      {...props}
    >
