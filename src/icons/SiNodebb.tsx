...
export const SiNodebbHex = "1E5EBC";
export const SiNodebbTitle = "NodeBB";
export const SiNodebbSlug = "nodebb";

export function SiNodebb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNodebbHex}` : color;
