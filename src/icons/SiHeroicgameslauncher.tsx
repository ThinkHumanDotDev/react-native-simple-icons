...
export const SiHeroicgameslauncherHex = "4B93FF";
export const SiHeroicgameslauncherTitle = "Heroic Games Launcher";
export const SiHeroicgameslauncherSlug = "heroicgameslauncher";

export function SiHeroicgameslauncher({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHeroicgameslauncherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHeroicgameslauncherTitle}
      {...props}
    >
