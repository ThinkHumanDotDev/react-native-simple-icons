...
export const SiPlaystation5Hex = "003791";
export const SiPlaystation5Title = "PlayStation 5";
export const SiPlaystation5Slug = "playstation5";

export function SiPlaystation5({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlaystation5Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlaystation5Title}
      {...props}
    >
