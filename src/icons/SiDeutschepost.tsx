...
export const SiDeutschepostHex = "FFCC00";
export const SiDeutschepostTitle = "Deutsche Post";
export const SiDeutschepostSlug = "deutschepost";

export function SiDeutschepost({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeutschepostHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeutschepostTitle}
      {...props}
    >
