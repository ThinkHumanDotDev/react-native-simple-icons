...
export const SiHtopHex = "009020";
export const SiHtopTitle = "htop";
export const SiHtopSlug = "htop";

export function SiHtop({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHtopHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHtopTitle}
      {...props}
    >
