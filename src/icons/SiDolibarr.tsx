...
export const SiDolibarrHex = "263C5C";
export const SiDolibarrTitle = "Dolibarr";
export const SiDolibarrSlug = "dolibarr";

export function SiDolibarr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDolibarrHex}` : color;
