...
export const SiOpenlayersHex = "1F6B75";
export const SiOpenlayersTitle = "Openlayers";
export const SiOpenlayersSlug = "openlayers";

export function SiOpenlayers({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenlayersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenlayersTitle}
      {...props}
    >
