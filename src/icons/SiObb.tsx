...
export const SiObbHex = "E40327";
export const SiObbTitle = "ÖBB";
export const SiObbSlug = "obb";

export function SiObb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiObbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiObbTitle}
      {...props}
    >
