...
export const SiCakephpHex = "D33C43";
export const SiCakephpTitle = "CakePHP";
export const SiCakephpSlug = "cakephp";

export function SiCakephp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCakephpHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCakephpTitle}
      {...props}
    >
