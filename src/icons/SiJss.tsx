...
export const SiJssHex = "F7DF1E";
export const SiJssTitle = "JSS";
export const SiJssSlug = "jss";

export function SiJss({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJssHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJssTitle}
      {...props}
    >
