...
export const SiBaserowHex = "5190EF";
export const SiBaserowTitle = "Baserow";
export const SiBaserowSlug = "baserow";

export function SiBaserow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBaserowHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBaserowTitle}
      {...props}
    >
