...
export const SiPlausibleanalyticsHex = "5850EC";
export const SiPlausibleanalyticsTitle = "Plausible Analytics";
export const SiPlausibleanalyticsSlug = "plausibleanalytics";

export function SiPlausibleanalytics({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlausibleanalyticsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlausibleanalyticsTitle}
      {...props}
    >
