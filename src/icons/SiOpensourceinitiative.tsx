...
export const SiOpensourceinitiativeHex = "3DA639";
export const SiOpensourceinitiativeTitle = "Open Source Initiative";
export const SiOpensourceinitiativeSlug = "opensourceinitiative";

export function SiOpensourceinitiative({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpensourceinitiativeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpensourceinitiativeTitle}
      {...props}
    >
