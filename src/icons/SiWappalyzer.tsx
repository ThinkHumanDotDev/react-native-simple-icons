...
export const SiWappalyzerHex = "4608AD";
export const SiWappalyzerTitle = "Wappalyzer";
export const SiWappalyzerSlug = "wappalyzer";

export function SiWappalyzer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWappalyzerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWappalyzerTitle}
      {...props}
    >
