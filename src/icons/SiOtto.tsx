...
export const SiOttoHex = "D4021D";
export const SiOttoTitle = "Otto";
export const SiOttoSlug = "otto";

export function SiOtto({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOttoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOttoTitle}
      {...props}
    >
