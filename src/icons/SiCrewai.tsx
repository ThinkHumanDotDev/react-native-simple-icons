...
export const SiCrewaiHex = "FF5A50";
export const SiCrewaiTitle = "CrewAI";
export const SiCrewaiSlug = "crewai";

export function SiCrewai({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCrewaiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCrewaiTitle}
      {...props}
    >
