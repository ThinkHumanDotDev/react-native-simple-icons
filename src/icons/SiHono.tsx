...
export const SiHonoHex = "E36002";
export const SiHonoTitle = "Hono";
export const SiHonoSlug = "hono";

export function SiHono({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHonoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHonoTitle}
      {...props}
    >
