...
export const SiDedgeHex = "432975";
export const SiDedgeTitle = "D-EDGE";
export const SiDedgeSlug = "dedge";

export function SiDedge({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDedgeHex}` : color;
