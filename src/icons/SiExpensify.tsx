...
export const SiExpensifyHex = "0185FF";
export const SiExpensifyTitle = "Expensify";
export const SiExpensifySlug = "expensify";

export function SiExpensify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiExpensifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiExpensifyTitle}
      {...props}
    >
