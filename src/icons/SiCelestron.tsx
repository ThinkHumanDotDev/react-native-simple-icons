...
export const SiCelestronHex = "F47216";
export const SiCelestronTitle = "Celestron";
export const SiCelestronSlug = "celestron";

export function SiCelestron({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCelestronHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCelestronTitle}
      {...props}
    >
