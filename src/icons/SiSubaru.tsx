...
export const SiSubaruHex = "013C74";
export const SiSubaruTitle = "Subaru";
export const SiSubaruSlug = "subaru";

export function SiSubaru({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSubaruHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSubaruTitle}
      {...props}
    >
