...
export const SiTokioHex = "000000";
export const SiTokioTitle = "Tokio";
export const SiTokioSlug = "tokio";

export function SiTokio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTokioHex}` : color;
