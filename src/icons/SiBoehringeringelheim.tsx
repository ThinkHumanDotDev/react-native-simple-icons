...
export const SiBoehringeringelheimHex = "00E47C";
export const SiBoehringeringelheimTitle = "Boehringer Ingelheim";
export const SiBoehringeringelheimSlug = "boehringeringelheim";

export function SiBoehringeringelheim({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBoehringeringelheimHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBoehringeringelheimTitle}
      {...props}
    >
