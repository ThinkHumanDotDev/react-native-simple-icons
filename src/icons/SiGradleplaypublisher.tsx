...
export const SiGradleplaypublisherHex = "82B816";
export const SiGradleplaypublisherTitle = "Gradle Play Publisher";
export const SiGradleplaypublisherSlug = "gradleplaypublisher";

export function SiGradleplaypublisher({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGradleplaypublisherHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGradleplaypublisherTitle}
      {...props}
    >
