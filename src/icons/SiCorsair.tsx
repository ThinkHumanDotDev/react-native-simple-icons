...
export const SiCorsairHex = "231F20";
export const SiCorsairTitle = "Corsair";
export const SiCorsairSlug = "corsair";

export function SiCorsair({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCorsairHex}` : color;
