...
export const SiEbayHex = "E53238";
export const SiEbayTitle = "eBay";
export const SiEbaySlug = "ebay";

export function SiEbay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEbayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEbayTitle}
      {...props}
    >
