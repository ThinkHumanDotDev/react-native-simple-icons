...
export const SiHoudiniHex = "FF4713";
export const SiHoudiniTitle = "Houdini";
export const SiHoudiniSlug = "houdini";

export function SiHoudini({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHoudiniHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHoudiniTitle}
      {...props}
    >
