...
export const SiPoposHex = "48B9C7";
export const SiPoposTitle = "Pop!_OS";
export const SiPoposSlug = "popos";

export function SiPopos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPoposHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPoposTitle}
      {...props}
    >
