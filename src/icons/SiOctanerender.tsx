...
export const SiOctanerenderHex = "000000";
export const SiOctanerenderTitle = "Octane Render";
export const SiOctanerenderSlug = "octanerender";

export function SiOctanerender({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOctanerenderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOctanerenderTitle}
      {...props}
    >
