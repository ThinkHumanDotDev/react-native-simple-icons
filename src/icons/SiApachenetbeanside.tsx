...
export const SiApachenetbeansideHex = "1B6AC6";
export const SiApachenetbeansideTitle = "Apache NetBeans IDE";
export const SiApachenetbeansideSlug = "apachenetbeanside";

export function SiApachenetbeanside({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachenetbeansideHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachenetbeansideTitle}
      {...props}
    >
