...
export const SiKuaishouHex = "FF4906";
export const SiKuaishouTitle = "Kuaishou";
export const SiKuaishouSlug = "kuaishou";

export function SiKuaishou({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKuaishouHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKuaishouTitle}
      {...props}
    >
