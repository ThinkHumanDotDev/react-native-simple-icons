...
export const SiJblHex = "FF3300";
export const SiJblTitle = "JBL";
export const SiJblSlug = "jbl";

export function SiJbl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJblHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJblTitle}
      {...props}
    >
