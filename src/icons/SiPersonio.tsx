...
export const SiPersonioHex = "000000";
export const SiPersonioTitle = "Personio";
export const SiPersonioSlug = "personio";

export function SiPersonio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPersonioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPersonioTitle}
      {...props}
    >
