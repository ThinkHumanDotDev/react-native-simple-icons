...
export const SiTrimbleHex = "0063A3";
export const SiTrimbleTitle = "Trimble";
export const SiTrimbleSlug = "trimble";

export function SiTrimble({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrimbleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrimbleTitle}
      {...props}
    >
