...
export const SiRocketHex = "D33847";
export const SiRocketTitle = "Rocket";
export const SiRocketSlug = "rocket";

export function SiRocket({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRocketHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRocketTitle}
      {...props}
    >
