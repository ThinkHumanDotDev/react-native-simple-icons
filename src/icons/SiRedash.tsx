...
export const SiRedashHex = "FF7964";
export const SiRedashTitle = "Redash";
export const SiRedashSlug = "redash";

export function SiRedash({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedashHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedashTitle}
      {...props}
    >
