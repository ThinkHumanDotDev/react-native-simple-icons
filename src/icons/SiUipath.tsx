...
export const SiUipathHex = "FA4616";
export const SiUipathTitle = "UiPath";
export const SiUipathSlug = "uipath";

export function SiUipath({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUipathHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUipathTitle}
      {...props}
    >
