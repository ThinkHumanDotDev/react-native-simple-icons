...
export const SiKongHex = "003459";
export const SiKongTitle = "Kong";
export const SiKongSlug = "kong";

export function SiKong({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKongHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKongTitle}
      {...props}
    >
