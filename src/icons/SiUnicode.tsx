...
export const SiUnicodeHex = "5455FE";
export const SiUnicodeTitle = "Unicode";
export const SiUnicodeSlug = "unicode";

export function SiUnicode({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnicodeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnicodeTitle}
      {...props}
    >
