...
export const SiSimilarwebHex = "092540";
export const SiSimilarwebTitle = "Similarweb";
export const SiSimilarwebSlug = "similarweb";

export function SiSimilarweb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSimilarwebHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSimilarwebTitle}
      {...props}
    >
