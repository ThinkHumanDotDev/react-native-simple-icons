...
export const SiBemHex = "000000";
export const SiBemTitle = "BEM";
export const SiBemSlug = "bem";

export function SiBem({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBemHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBemTitle}
      {...props}
    >
