...
export const SiHbomaxHex = "000000";
export const SiHbomaxTitle = "HBO Max";
export const SiHbomaxSlug = "hbomax";

export function SiHbomax({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHbomaxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHbomaxTitle}
      {...props}
    >
