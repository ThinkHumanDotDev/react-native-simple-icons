...
export const SiPortainerHex = "13BEF9";
export const SiPortainerTitle = "Portainer";
export const SiPortainerSlug = "portainer";

export function SiPortainer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPortainerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPortainerTitle}
      {...props}
    >
