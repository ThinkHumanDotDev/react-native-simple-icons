...
export const SiMxlinuxHex = "000000";
export const SiMxlinuxTitle = "MX Linux";
export const SiMxlinuxSlug = "mxlinux";

export function SiMxlinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMxlinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMxlinuxTitle}
      {...props}
    >
