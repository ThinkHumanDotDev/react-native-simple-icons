...
export const SiIpfsHex = "65C2CB";
export const SiIpfsTitle = "IPFS";
export const SiIpfsSlug = "ipfs";

export function SiIpfs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIpfsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIpfsTitle}
      {...props}
    >
