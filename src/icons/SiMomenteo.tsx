...
export const SiMomenteoHex = "5A6AB1";
export const SiMomenteoTitle = "Momenteo";
export const SiMomenteoSlug = "momenteo";

export function SiMomenteo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMomenteoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMomenteoTitle}
      {...props}
    >
