...
export const SiLadaHex = "ED6B21";
export const SiLadaTitle = "LADA";
export const SiLadaSlug = "lada";

export function SiLada({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLadaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLadaTitle}
      {...props}
    >
