...
export const SiAtomgitHex = "DA203E";
export const SiAtomgitTitle = "AtomGit";
export const SiAtomgitSlug = "atomgit";

export function SiAtomgit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAtomgitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAtomgitTitle}
      {...props}
    >
