...
export const SiSncfHex = "CA0939";
export const SiSncfTitle = "SNCF";
export const SiSncfSlug = "sncf";

export function SiSncf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSncfHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSncfTitle}
      {...props}
    >
