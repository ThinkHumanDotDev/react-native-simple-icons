...
export const SiMapillaryHex = "00AF66";
export const SiMapillaryTitle = "Mapillary";
export const SiMapillarySlug = "mapillary";

export function SiMapillary({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMapillaryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMapillaryTitle}
      {...props}
    >
