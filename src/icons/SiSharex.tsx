...
export const SiSharexHex = "2885F1";
export const SiSharexTitle = "ShareX";
export const SiSharexSlug = "sharex";

export function SiSharex({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSharexHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSharexTitle}
      {...props}
    >
