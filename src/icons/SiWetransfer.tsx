...
export const SiWetransferHex = "409FFF";
export const SiWetransferTitle = "WeTransfer";
export const SiWetransferSlug = "wetransfer";

export function SiWetransfer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWetransferHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWetransferTitle}
      {...props}
    >
