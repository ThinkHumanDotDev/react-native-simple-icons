...
export const SiCitrixHex = "452170";
export const SiCitrixTitle = "Citrix";
export const SiCitrixSlug = "citrix";

export function SiCitrix({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCitrixHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCitrixTitle}
      {...props}
    >
