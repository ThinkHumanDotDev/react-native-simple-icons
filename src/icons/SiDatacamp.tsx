...
export const SiDatacampHex = "03EF62";
export const SiDatacampTitle = "DataCamp";
export const SiDatacampSlug = "datacamp";

export function SiDatacamp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDatacampHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDatacampTitle}
      {...props}
    >
