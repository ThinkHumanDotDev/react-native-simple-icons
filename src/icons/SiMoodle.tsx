...
export const SiMoodleHex = "F98012";
export const SiMoodleTitle = "Moodle";
export const SiMoodleSlug = "moodle";

export function SiMoodle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMoodleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMoodleTitle}
      {...props}
    >
