...
export const SiWxtHex = "67D55E";
export const SiWxtTitle = "WXT";
export const SiWxtSlug = "wxt";

export function SiWxt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWxtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWxtTitle}
      {...props}
    >
