...
export const SiSolanaHex = "9945FF";
export const SiSolanaTitle = "Solana";
export const SiSolanaSlug = "solana";

export function SiSolana({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSolanaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSolanaTitle}
      {...props}
    >
