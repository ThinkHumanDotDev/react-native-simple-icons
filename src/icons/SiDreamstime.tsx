...
export const SiDreamstimeHex = "50A901";
export const SiDreamstimeTitle = "Dreamstime";
export const SiDreamstimeSlug = "dreamstime";

export function SiDreamstime({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDreamstimeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDreamstimeTitle}
      {...props}
    >
