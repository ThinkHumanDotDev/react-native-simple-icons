...
export const SiKritaHex = "3BABFF";
export const SiKritaTitle = "Krita";
export const SiKritaSlug = "krita";

export function SiKrita({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKritaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKritaTitle}
      {...props}
    >
