...
export const SiPrecommitHex = "FAB040";
export const SiPrecommitTitle = "pre-commit";
export const SiPrecommitSlug = "precommit";

export function SiPrecommit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrecommitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrecommitTitle}
      {...props}
    >
