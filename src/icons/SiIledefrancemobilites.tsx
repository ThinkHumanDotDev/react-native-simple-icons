...
export const SiIledefrancemobilitesHex = "67B4E7";
export const SiIledefrancemobilitesTitle = "Île-de-France Mobilités";
export const SiIledefrancemobilitesSlug = "iledefrancemobilites";

export function SiIledefrancemobilites({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIledefrancemobilitesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIledefrancemobilitesTitle}
      {...props}
    >
