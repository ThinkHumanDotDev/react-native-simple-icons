...
export const SiKununuHex = "FFC62E";
export const SiKununuTitle = "Kununu";
export const SiKununuSlug = "kununu";

export function SiKununu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKununuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKununuTitle}
      {...props}
    >
