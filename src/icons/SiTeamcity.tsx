...
export const SiTeamcityHex = "000000";
export const SiTeamcityTitle = "TeamCity";
export const SiTeamcitySlug = "teamcity";

export function SiTeamcity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTeamcityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTeamcityTitle}
      {...props}
    >
