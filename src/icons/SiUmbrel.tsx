...
export const SiUmbrelHex = "5351FB";
export const SiUmbrelTitle = "Umbrel";
export const SiUmbrelSlug = "umbrel";

export function SiUmbrel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUmbrelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUmbrelTitle}
      {...props}
    >
