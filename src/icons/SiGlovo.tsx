...
export const SiGlovoHex = "F2CC38";
export const SiGlovoTitle = "Glovo";
export const SiGlovoSlug = "glovo";

export function SiGlovo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGlovoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGlovoTitle}
      {...props}
    >
