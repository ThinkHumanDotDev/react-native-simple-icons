...
export const SiGooglemarketingplatformHex = "4285F4";
export const SiGooglemarketingplatformTitle = "Google Marketing Platform";
export const SiGooglemarketingplatformSlug = "googlemarketingplatform";

export function SiGooglemarketingplatform({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglemarketingplatformHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglemarketingplatformTitle}
      {...props}
    >
