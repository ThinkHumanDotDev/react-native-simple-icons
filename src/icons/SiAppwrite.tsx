...
export const SiAppwriteHex = "FD366E";
export const SiAppwriteTitle = "Appwrite";
export const SiAppwriteSlug = "appwrite";

export function SiAppwrite({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppwriteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppwriteTitle}
      {...props}
    >
