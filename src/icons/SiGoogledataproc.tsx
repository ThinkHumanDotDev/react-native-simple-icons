...
export const SiGoogledataprocHex = "AECBFA";
export const SiGoogledataprocTitle = "Google Dataproc";
export const SiGoogledataprocSlug = "googledataproc";

export function SiGoogledataproc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogledataprocHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogledataprocTitle}
      {...props}
    >
