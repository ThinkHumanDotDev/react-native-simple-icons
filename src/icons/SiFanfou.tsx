...
export const SiFanfouHex = "00CCFF";
export const SiFanfouTitle = "Fanfou";
export const SiFanfouSlug = "fanfou";

export function SiFanfou({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFanfouHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFanfouTitle}
      {...props}
    >
