...
export const SiJasmineHex = "8A4182";
export const SiJasmineTitle = "Jasmine";
export const SiJasmineSlug = "jasmine";

export function SiJasmine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJasmineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJasmineTitle}
      {...props}
    >
