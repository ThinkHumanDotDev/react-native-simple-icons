...
export const SiG2Hex = "FF492C";
export const SiG2Title = "G2";
export const SiG2Slug = "g2";

export function SiG2({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiG2Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiG2Title}
      {...props}
    >
