...
export const SiTraefikmeshHex = "9D0FB0";
export const SiTraefikmeshTitle = "Traefik Mesh";
export const SiTraefikmeshSlug = "traefikmesh";

export function SiTraefikmesh({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTraefikmeshHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTraefikmeshTitle}
      {...props}
    >
