...
export const SiGolandHex = "000000";
export const SiGolandTitle = "GoLand";
export const SiGolandSlug = "goland";

export function SiGoland({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGolandHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGolandTitle}
      {...props}
    >
