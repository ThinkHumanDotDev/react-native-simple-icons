...
export const SiChocolateyHex = "80B5E3";
export const SiChocolateyTitle = "Chocolatey";
export const SiChocolateySlug = "chocolatey";

export function SiChocolatey({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChocolateyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChocolateyTitle}
      {...props}
    >
