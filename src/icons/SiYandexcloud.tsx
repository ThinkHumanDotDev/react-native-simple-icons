...
export const SiYandexcloudHex = "5282FF";
export const SiYandexcloudTitle = "Yandex Cloud";
export const SiYandexcloudSlug = "yandexcloud";

export function SiYandexcloud({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYandexcloudHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYandexcloudTitle}
      {...props}
    >
