...
export const SiOctobercmsHex = "DB6A26";
export const SiOctobercmsTitle = "October CMS";
export const SiOctobercmsSlug = "octobercms";

export function SiOctobercms({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOctobercmsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOctobercmsTitle}
      {...props}
    >
