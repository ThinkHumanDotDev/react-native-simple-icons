...
export const SiDotnetHex = "512BD4";
export const SiDotnetTitle = ".NET";
export const SiDotnetSlug = "dotnet";

export function SiDotnet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDotnetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDotnetTitle}
      {...props}
    >
