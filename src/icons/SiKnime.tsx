...
export const SiKnimeHex = "FDD800";
export const SiKnimeTitle = "KNIME";
export const SiKnimeSlug = "knime";

export function SiKnime({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKnimeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKnimeTitle}
      {...props}
    >
