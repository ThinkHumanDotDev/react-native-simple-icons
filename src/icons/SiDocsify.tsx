...
export const SiDocsifyHex = "2ECE53";
export const SiDocsifyTitle = "Docsify";
export const SiDocsifySlug = "docsify";

export function SiDocsify({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDocsifyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDocsifyTitle}
      {...props}
    >
