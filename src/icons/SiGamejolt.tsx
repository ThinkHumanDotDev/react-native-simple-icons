...
export const SiGamejoltHex = "CCFF00";
export const SiGamejoltTitle = "Game Jolt";
export const SiGamejoltSlug = "gamejolt";

export function SiGamejolt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGamejoltHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGamejoltTitle}
      {...props}
    >
