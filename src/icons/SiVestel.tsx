...
export const SiVestelHex = "DD052B";
export const SiVestelTitle = "Vestel";
export const SiVestelSlug = "vestel";

export function SiVestel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVestelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVestelTitle}
      {...props}
    >
