...
export const SiTrillertvHex = "E61414";
export const SiTrillertvTitle = "TrillerTV";
export const SiTrillertvSlug = "trillertv";

export function SiTrillertv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrillertvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrillertvTitle}
      {...props}
    >
