...
export const SiSteinbergHex = "C90827";
export const SiSteinbergTitle = "Steinberg";
export const SiSteinbergSlug = "steinberg";

export function SiSteinberg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSteinbergHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSteinbergTitle}
      {...props}
    >
