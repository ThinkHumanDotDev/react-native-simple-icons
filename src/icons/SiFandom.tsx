...
export const SiFandomHex = "FA005A";
export const SiFandomTitle = "Fandom";
export const SiFandomSlug = "fandom";

export function SiFandom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFandomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFandomTitle}
      {...props}
    >
