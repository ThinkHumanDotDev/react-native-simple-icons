...
export const SiTinderHex = "FF6B6B";
export const SiTinderTitle = "Tinder";
export const SiTinderSlug = "tinder";

export function SiTinder({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTinderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTinderTitle}
      {...props}
    >
