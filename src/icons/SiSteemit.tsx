...
export const SiSteemitHex = "06D6A9";
export const SiSteemitTitle = "Steemit";
export const SiSteemitSlug = "steemit";

export function SiSteemit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSteemitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSteemitTitle}
      {...props}
    >
