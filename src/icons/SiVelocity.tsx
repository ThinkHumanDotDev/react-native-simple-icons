...
export const SiVelocityHex = "1BBAE0";
export const SiVelocityTitle = "Velocity";
export const SiVelocitySlug = "velocity";

export function SiVelocity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVelocityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVelocityTitle}
      {...props}
    >
