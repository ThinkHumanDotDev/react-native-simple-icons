...
export const SiMicrobitHex = "00ED00";
export const SiMicrobitTitle = "micro:bit";
export const SiMicrobitSlug = "microbit";

export function SiMicrobit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMicrobitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMicrobitTitle}
      {...props}
    >
