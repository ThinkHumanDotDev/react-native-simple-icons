...
export const SiKandoHex = "EACFCF";
export const SiKandoTitle = "Kando";
export const SiKandoSlug = "kando";

export function SiKando({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKandoHex}` : color;
