...
export const SiMatomoHex = "3152A0";
export const SiMatomoTitle = "Matomo";
export const SiMatomoSlug = "matomo";

export function SiMatomo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMatomoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMatomoTitle}
      {...props}
    >
