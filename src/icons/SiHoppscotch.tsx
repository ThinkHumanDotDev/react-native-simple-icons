...
export const SiHoppscotchHex = "09090B";
export const SiHoppscotchTitle = "Hoppscotch";
export const SiHoppscotchSlug = "hoppscotch";

export function SiHoppscotch({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHoppscotchHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHoppscotchTitle}
      {...props}
    >
