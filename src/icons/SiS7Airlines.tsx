...
export const SiS7AirlinesHex = "C4D600";
export const SiS7AirlinesTitle = "S7 Airlines";
export const SiS7AirlinesSlug = "s7airlines";

export function SiS7Airlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiS7AirlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiS7AirlinesTitle}
      {...props}
    >
