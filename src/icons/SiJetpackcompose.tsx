...
export const SiJetpackcomposeHex = "4285F4";
export const SiJetpackcomposeTitle = "Jetpack Compose";
export const SiJetpackcomposeSlug = "jetpackcompose";

export function SiJetpackcompose({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJetpackcomposeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJetpackcomposeTitle}
      {...props}
    >
