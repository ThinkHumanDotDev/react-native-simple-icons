...
export const SiSuperuserHex = "38A1CE";
export const SiSuperuserTitle = "Super User";
export const SiSuperuserSlug = "superuser";

export function SiSuperuser({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSuperuserHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSuperuserTitle}
      {...props}
    >
