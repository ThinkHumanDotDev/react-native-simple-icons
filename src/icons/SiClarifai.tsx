...
export const SiClarifaiHex = "1955FF";
export const SiClarifaiTitle = "Clarifai";
export const SiClarifaiSlug = "clarifai";

export function SiClarifai({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiClarifaiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiClarifaiTitle}
      {...props}
    >
