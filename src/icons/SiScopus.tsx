...
export const SiScopusHex = "E9711C";
export const SiScopusTitle = "Scopus";
export const SiScopusSlug = "scopus";

export function SiScopus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScopusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScopusTitle}
      {...props}
    >
