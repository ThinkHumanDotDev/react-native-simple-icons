...
export const SiSwiperHex = "6332F6";
export const SiSwiperTitle = "Swiper";
export const SiSwiperSlug = "swiper";

export function SiSwiper({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSwiperHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSwiperTitle}
      {...props}
    >
