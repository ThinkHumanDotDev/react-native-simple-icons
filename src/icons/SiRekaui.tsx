...
export const SiRekauiHex = "16A353";
export const SiRekauiTitle = "Reka UI";
export const SiRekauiSlug = "rekaui";

export function SiRekaui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRekauiHex}` : color;
