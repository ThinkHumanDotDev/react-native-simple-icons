...
export const SiVivawalletHex = "1F263A";
export const SiVivawalletTitle = "Viva Wallet";
export const SiVivawalletSlug = "vivawallet";

export function SiVivawallet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVivawalletHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVivawalletTitle}
      {...props}
    >
