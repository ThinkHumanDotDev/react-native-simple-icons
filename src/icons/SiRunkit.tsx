...
export const SiRunkitHex = "491757";
export const SiRunkitTitle = "RunKit";
export const SiRunkitSlug = "runkit";

export function SiRunkit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRunkitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRunkitTitle}
      {...props}
    >
