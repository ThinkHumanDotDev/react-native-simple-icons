...
export const SiSnapchatHex = "FFFC00";
export const SiSnapchatTitle = "Snapchat";
export const SiSnapchatSlug = "snapchat";

export function SiSnapchat({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSnapchatHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSnapchatTitle}
      {...props}
    >
