...
export const SiWellfoundHex = "000000";
export const SiWellfoundTitle = "Wellfound";
export const SiWellfoundSlug = "wellfound";

export function SiWellfound({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWellfoundHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWellfoundTitle}
      {...props}
    >
