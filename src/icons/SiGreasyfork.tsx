...
export const SiGreasyforkHex = "670000";
export const SiGreasyforkTitle = "Greasy Fork";
export const SiGreasyforkSlug = "greasyfork";

export function SiGreasyfork({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGreasyforkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGreasyforkTitle}
      {...props}
    >
