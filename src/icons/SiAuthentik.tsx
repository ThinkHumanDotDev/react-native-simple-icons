...
export const SiAuthentikHex = "FD4B2D";
export const SiAuthentikTitle = "Authentik";
export const SiAuthentikSlug = "authentik";

export function SiAuthentik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAuthentikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAuthentikTitle}
      {...props}
    >
