...
export const SiSkypackHex = "3167FF";
export const SiSkypackTitle = "Skypack";
export const SiSkypackSlug = "skypack";

export function SiSkypack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSkypackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSkypackTitle}
      {...props}
    >
