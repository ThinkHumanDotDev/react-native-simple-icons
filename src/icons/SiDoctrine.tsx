...
export const SiDoctrineHex = "FC6A31";
export const SiDoctrineTitle = "Doctrine";
export const SiDoctrineSlug = "doctrine";

export function SiDoctrine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDoctrineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDoctrineTitle}
      {...props}
    >
