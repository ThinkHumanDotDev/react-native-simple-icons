...
export const SiSmoothcompHex = "000000";
export const SiSmoothcompTitle = "Smoothcomp";
export const SiSmoothcompSlug = "smoothcomp";

export function SiSmoothcomp({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSmoothcompHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSmoothcompTitle}
      {...props}
    >
