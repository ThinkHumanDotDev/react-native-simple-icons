...
export const SiOutlineHex = "000000";
export const SiOutlineTitle = "Outline";
export const SiOutlineSlug = "outline";

export function SiOutline({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOutlineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOutlineTitle}
      {...props}
    >
