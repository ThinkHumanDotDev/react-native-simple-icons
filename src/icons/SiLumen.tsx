...
export const SiLumenHex = "E74430";
export const SiLumenTitle = "Lumen";
export const SiLumenSlug = "lumen";

export function SiLumen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLumenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLumenTitle}
      {...props}
    >
