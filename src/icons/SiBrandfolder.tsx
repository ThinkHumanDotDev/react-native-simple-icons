...
export const SiBrandfolderHex = "40D1F5";
export const SiBrandfolderTitle = "Brandfolder";
export const SiBrandfolderSlug = "brandfolder";

export function SiBrandfolder({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBrandfolderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBrandfolderTitle}
      {...props}
    >
