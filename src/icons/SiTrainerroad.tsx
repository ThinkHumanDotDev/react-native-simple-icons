...
export const SiTrainerroadHex = "DA291C";
export const SiTrainerroadTitle = "TrainerRoad";
export const SiTrainerroadSlug = "trainerroad";

export function SiTrainerroad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTrainerroadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTrainerroadTitle}
      {...props}
    >
