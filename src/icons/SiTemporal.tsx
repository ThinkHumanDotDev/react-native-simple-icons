...
export const SiTemporalHex = "000000";
export const SiTemporalTitle = "Temporal";
export const SiTemporalSlug = "temporal";

export function SiTemporal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTemporalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTemporalTitle}
      {...props}
    >
