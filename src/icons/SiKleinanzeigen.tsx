...
export const SiKleinanzeigenHex = "1D4B00";
export const SiKleinanzeigenTitle = "Kleinanzeigen";
export const SiKleinanzeigenSlug = "kleinanzeigen";

export function SiKleinanzeigen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKleinanzeigenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKleinanzeigenTitle}
      {...props}
    >
