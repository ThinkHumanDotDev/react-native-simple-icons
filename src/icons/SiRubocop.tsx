...
export const SiRubocopHex = "000000";
export const SiRubocopTitle = "RuboCop";
export const SiRubocopSlug = "rubocop";

export function SiRubocop({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRubocopHex}` : color;
