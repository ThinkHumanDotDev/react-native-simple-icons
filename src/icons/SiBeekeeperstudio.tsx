...
export const SiBeekeeperstudioHex = "FAD83B";
export const SiBeekeeperstudioTitle = "Beekeeper Studio";
export const SiBeekeeperstudioSlug = "beekeeperstudio";

export function SiBeekeeperstudio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBeekeeperstudioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBeekeeperstudioTitle}
      {...props}
    >
