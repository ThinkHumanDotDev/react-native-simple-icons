...
export const SiAstroHex = "BC52EE";
export const SiAstroTitle = "Astro";
export const SiAstroSlug = "astro";

export function SiAstro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAstroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAstroTitle}
      {...props}
    >
