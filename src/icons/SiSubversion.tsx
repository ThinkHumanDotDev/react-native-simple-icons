...
export const SiSubversionHex = "809CC9";
export const SiSubversionTitle = "Subversion";
export const SiSubversionSlug = "subversion";

export function SiSubversion({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSubversionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSubversionTitle}
      {...props}
    >
