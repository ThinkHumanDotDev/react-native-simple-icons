...
export const SiCadillacHex = "000000";
export const SiCadillacTitle = "Cadillac";
export const SiCadillacSlug = "cadillac";

export function SiCadillac({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCadillacHex}` : color;
