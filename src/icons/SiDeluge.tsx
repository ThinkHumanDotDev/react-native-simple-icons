...
export const SiDelugeHex = "094491";
export const SiDelugeTitle = "Deluge";
export const SiDelugeSlug = "deluge";

export function SiDeluge({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDelugeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDelugeTitle}
      {...props}
    >
