...
export const SiFivemHex = "F40552";
export const SiFivemTitle = "FiveM";
export const SiFivemSlug = "fivem";

export function SiFivem({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFivemHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFivemTitle}
      {...props}
    >
