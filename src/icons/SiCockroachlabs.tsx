...
export const SiCockroachlabsHex = "6933FF";
export const SiCockroachlabsTitle = "Cockroach Labs";
export const SiCockroachlabsSlug = "cockroachlabs";

export function SiCockroachlabs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCockroachlabsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCockroachlabsTitle}
      {...props}
    >
