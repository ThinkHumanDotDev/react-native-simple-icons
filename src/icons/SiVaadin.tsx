...
export const SiVaadinHex = "00B4F0";
export const SiVaadinTitle = "Vaadin";
export const SiVaadinSlug = "vaadin";

export function SiVaadin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVaadinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVaadinTitle}
      {...props}
    >
