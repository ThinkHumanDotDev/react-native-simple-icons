...
export const SiTv4PlayHex = "E0001C";
export const SiTv4PlayTitle = "TV4 Play";
export const SiTv4PlaySlug = "tv4play";

export function SiTv4Play({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTv4PlayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTv4PlayTitle}
      {...props}
    >
