...
export const SiRaycastHex = "FF6363";
export const SiRaycastTitle = "Raycast";
export const SiRaycastSlug = "raycast";

export function SiRaycast({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRaycastHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRaycastTitle}
      {...props}
    >
