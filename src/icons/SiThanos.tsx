...
export const SiThanosHex = "6D41FF";
export const SiThanosTitle = "Thanos";
export const SiThanosSlug = "thanos";

export function SiThanos({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThanosHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThanosTitle}
      {...props}
    >
