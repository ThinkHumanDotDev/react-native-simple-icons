...
export const SiJetblueHex = "001E59";
export const SiJetblueTitle = "JetBlue";
export const SiJetblueSlug = "jetblue";

export function SiJetblue({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJetblueHex}` : color;
