...
export const SiFreepikHex = "1273EB";
export const SiFreepikTitle = "Freepik";
export const SiFreepikSlug = "freepik";

export function SiFreepik({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFreepikHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFreepikTitle}
      {...props}
    >
