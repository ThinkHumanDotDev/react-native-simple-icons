...
export const SiReebokHex = "E41D1B";
export const SiReebokTitle = "Reebok";
export const SiReebokSlug = "reebok";

export function SiReebok({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReebokHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReebokTitle}
      {...props}
    >
