...
export const SiSurfsharkHex = "1EBFBF";
export const SiSurfsharkTitle = "Surfshark";
export const SiSurfsharkSlug = "surfshark";

export function SiSurfshark({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSurfsharkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSurfsharkTitle}
      {...props}
    >
