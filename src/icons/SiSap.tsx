...
export const SiSapHex = "0FAAFF";
export const SiSapTitle = "SAP";
export const SiSapSlug = "sap";

export function SiSap({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSapHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSapTitle}
      {...props}
    >
