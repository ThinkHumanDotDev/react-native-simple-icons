...
export const SiEclipsevertdotxHex = "782A90";
export const SiEclipsevertdotxTitle = "Eclipse Vert.x";
export const SiEclipsevertdotxSlug = "eclipsevertdotx";

export function SiEclipsevertdotx({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEclipsevertdotxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEclipsevertdotxTitle}
      {...props}
    >
