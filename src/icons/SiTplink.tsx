...
export const SiTplinkHex = "4ACBD6";
export const SiTplinkTitle = "TP-Link";
export const SiTplinkSlug = "tplink";

export function SiTplink({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTplinkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTplinkTitle}
      {...props}
    >
