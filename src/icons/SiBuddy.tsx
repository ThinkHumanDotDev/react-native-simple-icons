...
export const SiBuddyHex = "1A86FD";
export const SiBuddyTitle = "Buddy";
export const SiBuddySlug = "buddy";

export function SiBuddy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBuddyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBuddyTitle}
      {...props}
    >
