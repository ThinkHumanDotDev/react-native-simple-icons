...
export const SiJsfiddleHex = "0084FF";
export const SiJsfiddleTitle = "JSFiddle";
export const SiJsfiddleSlug = "jsfiddle";

export function SiJsfiddle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJsfiddleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJsfiddleTitle}
      {...props}
    >
