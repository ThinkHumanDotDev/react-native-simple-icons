...
export const SiEsotericsoftwareHex = "3FA9F5";
export const SiEsotericsoftwareTitle = "Esoteric Software";
export const SiEsotericsoftwareSlug = "esotericsoftware";

export function SiEsotericsoftware({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEsotericsoftwareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEsotericsoftwareTitle}
      {...props}
    >
