...
export const SiGooglecastHex = "4285F4";
export const SiGooglecastTitle = "Google Cast";
export const SiGooglecastSlug = "googlecast";

export function SiGooglecast({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglecastHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglecastTitle}
      {...props}
    >
