...
export const SiBlazemeterHex = "CA2133";
export const SiBlazemeterTitle = "Blazemeter";
export const SiBlazemeterSlug = "blazemeter";

export function SiBlazemeter({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBlazemeterHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBlazemeterTitle}
      {...props}
    >
