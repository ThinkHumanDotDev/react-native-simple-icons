...
export const SiRefineHex = "14141F";
export const SiRefineTitle = "Refine";
export const SiRefineSlug = "refine";

export function SiRefine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRefineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRefineTitle}
      {...props}
    >
