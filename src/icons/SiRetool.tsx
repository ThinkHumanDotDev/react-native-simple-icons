...
export const SiRetoolHex = "3D3D3D";
export const SiRetoolTitle = "Retool";
export const SiRetoolSlug = "retool";

export function SiRetool({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRetoolHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRetoolTitle}
      {...props}
    >
