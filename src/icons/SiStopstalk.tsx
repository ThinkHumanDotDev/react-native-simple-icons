...
export const SiStopstalkHex = "536DFE";
export const SiStopstalkTitle = "StopStalk";
export const SiStopstalkSlug = "stopstalk";

export function SiStopstalk({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStopstalkHex}` : color;
