...
export const SiCoderwallHex = "3E8DCC";
export const SiCoderwallTitle = "Coderwall";
export const SiCoderwallSlug = "coderwall";

export function SiCoderwall({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoderwallHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoderwallTitle}
      {...props}
    >
