...
export const SiHusqvarnaHex = "273A60";
export const SiHusqvarnaTitle = "Husqvarna";
export const SiHusqvarnaSlug = "husqvarna";

export function SiHusqvarna({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHusqvarnaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHusqvarnaTitle}
      {...props}
    >
