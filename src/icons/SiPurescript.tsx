...
export const SiPurescriptHex = "14161A";
export const SiPurescriptTitle = "PureScript";
export const SiPurescriptSlug = "purescript";

export function SiPurescript({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPurescriptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPurescriptTitle}
      {...props}
    >
