...
export const SiCaterpillarHex = "FFCD11";
export const SiCaterpillarTitle = "Caterpillar";
export const SiCaterpillarSlug = "caterpillar";

export function SiCaterpillar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCaterpillarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCaterpillarTitle}
      {...props}
    >
