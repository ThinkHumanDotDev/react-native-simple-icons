...
export const SiIssuuHex = "F36D5D";
export const SiIssuuTitle = "Issuu";
export const SiIssuuSlug = "issuu";

export function SiIssuu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIssuuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIssuuTitle}
      {...props}
    >
