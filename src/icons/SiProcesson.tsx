...
export const SiProcessonHex = "067BEF";
export const SiProcessonTitle = "ProcessOn";
export const SiProcessonSlug = "processon";

export function SiProcesson({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProcessonHex}` : color;
