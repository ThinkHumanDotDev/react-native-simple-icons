...
export const SiSourceengineHex = "F79A10";
export const SiSourceengineTitle = "Source Engine";
export const SiSourceengineSlug = "sourceengine";

export function SiSourceengine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSourceengineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSourceengineTitle}
      {...props}
    >
