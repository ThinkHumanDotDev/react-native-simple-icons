...
export const SiSemanticscholarHex = "1857B6";
export const SiSemanticscholarTitle = "Semantic Scholar";
export const SiSemanticscholarSlug = "semanticscholar";

export function SiSemanticscholar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSemanticscholarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSemanticscholarTitle}
      {...props}
    >
