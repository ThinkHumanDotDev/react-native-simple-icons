...
export const SiPercyHex = "9E66BF";
export const SiPercyTitle = "Percy";
export const SiPercySlug = "percy";

export function SiPercy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPercyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPercyTitle}
      {...props}
    >
