...
export const SiDistroboxHex = "4F433C";
export const SiDistroboxTitle = "Distrobox";
export const SiDistroboxSlug = "distrobox";

export function SiDistrobox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDistroboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDistroboxTitle}
      {...props}
    >
