...
export const SiVenmoHex = "008CFF";
export const SiVenmoTitle = "Venmo";
export const SiVenmoSlug = "venmo";

export function SiVenmo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVenmoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVenmoTitle}
      {...props}
    >
