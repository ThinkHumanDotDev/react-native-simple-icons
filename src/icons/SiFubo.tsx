...
export const SiFuboHex = "C83D1E";
export const SiFuboTitle = "Fubo";
export const SiFuboSlug = "fubo";

export function SiFubo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFuboHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFuboTitle}
      {...props}
    >
