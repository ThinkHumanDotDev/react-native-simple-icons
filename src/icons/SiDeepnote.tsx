...
export const SiDeepnoteHex = "3793EF";
export const SiDeepnoteTitle = "Deepnote";
export const SiDeepnoteSlug = "deepnote";

export function SiDeepnote({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeepnoteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeepnoteTitle}
      {...props}
    >
