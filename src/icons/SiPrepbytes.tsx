...
export const SiPrepbytesHex = "5A87C6";
export const SiPrepbytesTitle = "PrepBytes";
export const SiPrepbytesSlug = "prepbytes";

export function SiPrepbytes({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPrepbytesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPrepbytesTitle}
      {...props}
    >
