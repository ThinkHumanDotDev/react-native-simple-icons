...
export const SiAsanaHex = "F06A6A";
export const SiAsanaTitle = "Asana";
export const SiAsanaSlug = "asana";

export function SiAsana({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAsanaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAsanaTitle}
      {...props}
    >
