...
export const SiYoutubekidsHex = "FF0000";
export const SiYoutubekidsTitle = "YouTube Kids";
export const SiYoutubekidsSlug = "youtubekids";

export function SiYoutubekids({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYoutubekidsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYoutubekidsTitle}
      {...props}
    >
