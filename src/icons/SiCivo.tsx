...
export const SiCivoHex = "239DFF";
export const SiCivoTitle = "Civo";
export const SiCivoSlug = "civo";

export function SiCivo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCivoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCivoTitle}
      {...props}
    >
