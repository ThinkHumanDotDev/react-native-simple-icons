...
export const SiAntaHex = "D70010";
export const SiAntaTitle = "Anta";
export const SiAntaSlug = "anta";

export function SiAnta({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAntaHex}` : color;
