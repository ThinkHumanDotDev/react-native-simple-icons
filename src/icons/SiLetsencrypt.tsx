...
export const SiLetsencryptHex = "003A70";
export const SiLetsencryptTitle = "Let's Encrypt";
export const SiLetsencryptSlug = "letsencrypt";

export function SiLetsencrypt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLetsencryptHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLetsencryptTitle}
      {...props}
    >
