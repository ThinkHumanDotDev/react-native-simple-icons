...
export const SiOpencriticHex = "FC3E04";
export const SiOpencriticTitle = "OpenCritic";
export const SiOpencriticSlug = "opencritic";

export function SiOpencritic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpencriticHex}` : color;
