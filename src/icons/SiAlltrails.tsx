...
export const SiAlltrailsHex = "142800";
export const SiAlltrailsTitle = "AllTrails";
export const SiAlltrailsSlug = "alltrails";

export function SiAlltrails({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlltrailsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlltrailsTitle}
      {...props}
    >
