...
export const SiDgraphHex = "E50695";
export const SiDgraphTitle = "Dgraph";
export const SiDgraphSlug = "dgraph";

export function SiDgraph({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDgraphHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDgraphTitle}
      {...props}
    >
