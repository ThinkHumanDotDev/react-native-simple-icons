...
export const SiVisaHex = "1A1F71";
export const SiVisaTitle = "Visa";
export const SiVisaSlug = "visa";

export function SiVisa({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVisaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVisaTitle}
      {...props}
    >
