...
export const SiNotebooklmHex = "000000";
export const SiNotebooklmTitle = "NotebookLM";
export const SiNotebooklmSlug = "notebooklm";

export function SiNotebooklm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNotebooklmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNotebooklmTitle}
      {...props}
    >
