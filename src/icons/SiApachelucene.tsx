...
export const SiApacheluceneHex = "019B8F";
export const SiApacheluceneTitle = "Apache Lucene";
export const SiApacheluceneSlug = "apachelucene";

export function SiApachelucene({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApacheluceneHex}` : color;
