...
export const SiUnrealengineHex = "0E1128";
export const SiUnrealengineTitle = "Unreal Engine";
export const SiUnrealengineSlug = "unrealengine";

export function SiUnrealengine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnrealengineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnrealengineTitle}
      {...props}
    >
