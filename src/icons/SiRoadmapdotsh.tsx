...
export const SiRoadmapdotshHex = "000000";
export const SiRoadmapdotshTitle = "roadmap.sh";
export const SiRoadmapdotshSlug = "roadmapdotsh";

export function SiRoadmapdotsh({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRoadmapdotshHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRoadmapdotshTitle}
      {...props}
    >
