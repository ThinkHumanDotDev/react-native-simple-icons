...
export const SiCodementorHex = "003648";
export const SiCodementorTitle = "Codementor";
export const SiCodementorSlug = "codementor";

export function SiCodementor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodementorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodementorTitle}
      {...props}
    >
