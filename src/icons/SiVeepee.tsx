...
export const SiVeepeeHex = "EC008C";
export const SiVeepeeTitle = "Veepee";
export const SiVeepeeSlug = "veepee";

export function SiVeepee({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVeepeeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVeepeeTitle}
      {...props}
    >
