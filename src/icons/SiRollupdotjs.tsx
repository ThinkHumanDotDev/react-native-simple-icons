...
export const SiRollupdotjsHex = "EC4A3F";
export const SiRollupdotjsTitle = "rollup.js";
export const SiRollupdotjsSlug = "rollupdotjs";

export function SiRollupdotjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRollupdotjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRollupdotjsTitle}
      {...props}
    >
