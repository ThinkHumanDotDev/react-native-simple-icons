...
export const SiNzxtHex = "000000";
export const SiNzxtTitle = "NZXT";
export const SiNzxtSlug = "nzxt";

export function SiNzxt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNzxtHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNzxtTitle}
      {...props}
    >
