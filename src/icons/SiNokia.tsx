...
export const SiNokiaHex = "005AFF";
export const SiNokiaTitle = "Nokia";
export const SiNokiaSlug = "nokia";

export function SiNokia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNokiaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNokiaTitle}
      {...props}
    >
