...
export const SiRedisHex = "FF4438";
export const SiRedisTitle = "Redis";
export const SiRedisSlug = "redis";

export function SiRedis({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedisTitle}
      {...props}
    >
