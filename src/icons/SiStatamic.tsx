...
export const SiStatamicHex = "FF269E";
export const SiStatamicTitle = "Statamic";
export const SiStatamicSlug = "statamic";

export function SiStatamic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStatamicHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStatamicTitle}
      {...props}
    >
