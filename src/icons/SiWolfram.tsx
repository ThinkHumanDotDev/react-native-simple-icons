...
export const SiWolframHex = "DD1100";
export const SiWolframTitle = "Wolfram";
export const SiWolframSlug = "wolfram";

export function SiWolfram({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWolframHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWolframTitle}
      {...props}
    >
