...
export const SiBraintreeHex = "000000";
export const SiBraintreeTitle = "Braintree";
export const SiBraintreeSlug = "braintree";

export function SiBraintree({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBraintreeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBraintreeTitle}
      {...props}
    >
