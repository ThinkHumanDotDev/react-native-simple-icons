...
export const SiUnpkgHex = "000000";
export const SiUnpkgTitle = "unpkg";
export const SiUnpkgSlug = "unpkg";

export function SiUnpkg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnpkgHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnpkgTitle}
      {...props}
    >
