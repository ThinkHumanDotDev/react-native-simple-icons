...
export const SiUpstashHex = "00E9A3";
export const SiUpstashTitle = "Upstash";
export const SiUpstashSlug = "upstash";

export function SiUpstash({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUpstashHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUpstashTitle}
      {...props}
    >
