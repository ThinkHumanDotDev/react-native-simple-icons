...
export const SiBackendlessHex = "1D77BD";
export const SiBackendlessTitle = "Backendless";
export const SiBackendlessSlug = "backendless";

export function SiBackendless({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBackendlessHex}` : color;
