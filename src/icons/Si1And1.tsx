...
export const Si1And1Hex = "003D8F";
export const Si1And1Title = "1&1";
export const Si1And1Slug = "1and1";

export function Si1And1({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si1And1Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si1And1Title}
      {...props}
    >
