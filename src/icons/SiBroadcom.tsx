...
export const SiBroadcomHex = "E31837";
export const SiBroadcomTitle = "Broadcom";
export const SiBroadcomSlug = "broadcom";

export function SiBroadcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBroadcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBroadcomTitle}
      {...props}
    >
