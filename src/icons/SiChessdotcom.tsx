...
export const SiChessdotcomHex = "81B64C";
export const SiChessdotcomTitle = "Chess.com";
export const SiChessdotcomSlug = "chessdotcom";

export function SiChessdotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChessdotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChessdotcomTitle}
      {...props}
    >
