...
export const SiKnowledgebaseHex = "9146FF";
export const SiKnowledgebaseTitle = "KnowledgeBase";
export const SiKnowledgebaseSlug = "knowledgebase";

export function SiKnowledgebase({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKnowledgebaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKnowledgebaseTitle}
      {...props}
    >
