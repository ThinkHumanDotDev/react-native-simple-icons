...
export const SiOpelHex = "F7FF14";
export const SiOpelTitle = "Opel";
export const SiOpelSlug = "opel";

export function SiOpel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpelTitle}
      {...props}
    >
