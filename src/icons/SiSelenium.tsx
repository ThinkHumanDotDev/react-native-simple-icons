...
export const SiSeleniumHex = "43B02A";
export const SiSeleniumTitle = "Selenium";
export const SiSeleniumSlug = "selenium";

export function SiSelenium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSeleniumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSeleniumTitle}
      {...props}
    >
