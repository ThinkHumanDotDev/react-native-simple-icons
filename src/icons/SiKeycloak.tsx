...
export const SiKeycloakHex = "4D4D4D";
export const SiKeycloakTitle = "Keycloak";
export const SiKeycloakSlug = "keycloak";

export function SiKeycloak({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKeycloakHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKeycloakTitle}
      {...props}
    >
