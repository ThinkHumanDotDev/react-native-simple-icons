...
export const SiEtsyHex = "F16521";
export const SiEtsyTitle = "Etsy";
export const SiEtsySlug = "etsy";

export function SiEtsy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEtsyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEtsyTitle}
      {...props}
    >
