...
export const SiFoxtelHex = "EB5205";
export const SiFoxtelTitle = "Foxtel";
export const SiFoxtelSlug = "foxtel";

export function SiFoxtel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFoxtelHex}` : color;
