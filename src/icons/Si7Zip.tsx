...
export const Si7ZipHex = "000000";
export const Si7ZipTitle = "7Zip";
export const Si7ZipSlug = "7zip";

export function Si7Zip({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si7ZipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si7ZipTitle}
      {...props}
    >
