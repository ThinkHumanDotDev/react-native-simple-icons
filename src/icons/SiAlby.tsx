...
export const SiAlbyHex = "FFDF6F";
export const SiAlbyTitle = "Alby";
export const SiAlbySlug = "alby";

export function SiAlby({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlbyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlbyTitle}
      {...props}
    >
