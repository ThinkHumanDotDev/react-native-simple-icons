...
export const SiInvoiceninjaHex = "000000";
export const SiInvoiceninjaTitle = "Invoice Ninja";
export const SiInvoiceninjaSlug = "invoiceninja";

export function SiInvoiceninja({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInvoiceninjaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInvoiceninjaTitle}
      {...props}
    >
