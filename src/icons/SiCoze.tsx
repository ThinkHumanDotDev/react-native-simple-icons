...
export const SiCozeHex = "4D53E8";
export const SiCozeTitle = "Coze";
export const SiCozeSlug = "coze";

export function SiCoze({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCozeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCozeTitle}
      {...props}
    >
