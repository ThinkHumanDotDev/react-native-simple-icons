...
export const SiUnlicenseHex = "808080";
export const SiUnlicenseTitle = "Unlicense";
export const SiUnlicenseSlug = "unlicense";

export function SiUnlicense({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUnlicenseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUnlicenseTitle}
      {...props}
    >
