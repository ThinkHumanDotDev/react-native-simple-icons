...
export const SiWeasylHex = "990000";
export const SiWeasylTitle = "Weasyl";
export const SiWeasylSlug = "weasyl";

export function SiWeasyl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWeasylHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWeasylTitle}
      {...props}
    >
