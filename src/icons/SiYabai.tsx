...
export const SiYabaiHex = "00364B";
export const SiYabaiTitle = "yabai";
export const SiYabaiSlug = "yabai";

export function SiYabai({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYabaiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYabaiTitle}
      {...props}
    >
