...
export const SiPlaystationvitaHex = "003791";
export const SiPlaystationvitaTitle = "PlayStation Vita";
export const SiPlaystationvitaSlug = "playstationvita";

export function SiPlaystationvita({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlaystationvitaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlaystationvitaTitle}
      {...props}
    >
