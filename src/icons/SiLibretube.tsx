...
export const SiLibretubeHex = "FF9699";
export const SiLibretubeTitle = "LibreTube";
export const SiLibretubeSlug = "libretube";

export function SiLibretube({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLibretubeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLibretubeTitle}
      {...props}
    >
