...
export const SiGitignoredotioHex = "204ECF";
export const SiGitignoredotioTitle = "gitignore.io";
export const SiGitignoredotioSlug = "gitignoredotio";

export function SiGitignoredotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitignoredotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitignoredotioTitle}
      {...props}
    >
