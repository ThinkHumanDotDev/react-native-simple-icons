...
export const SiSennheiserHex = "000000";
export const SiSennheiserTitle = "Sennheiser";
export const SiSennheiserSlug = "sennheiser";

export function SiSennheiser({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSennheiserHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSennheiserTitle}
      {...props}
    >
