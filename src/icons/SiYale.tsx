...
export const SiYaleHex = "FFD900";
export const SiYaleTitle = "Yale";
export const SiYaleSlug = "yale";

export function SiYale({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYaleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYaleTitle}
      {...props}
    >
