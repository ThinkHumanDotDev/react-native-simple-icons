...
export const SiTorizonHex = "FAAF00";
export const SiTorizonTitle = "Torizon";
export const SiTorizonSlug = "torizon";

export function SiTorizon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTorizonHex}` : color;
