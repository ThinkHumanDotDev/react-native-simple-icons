...
export const SiNbcHex = "222222";
export const SiNbcTitle = "NBC";
export const SiNbcSlug = "nbc";

export function SiNbc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNbcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNbcTitle}
      {...props}
    >
