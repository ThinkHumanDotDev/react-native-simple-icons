...
export const SiGrammarlyHex = "027E6F";
export const SiGrammarlyTitle = "Grammarly";
export const SiGrammarlySlug = "grammarly";

export function SiGrammarly({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGrammarlyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGrammarlyTitle}
      {...props}
    >
