...
export const SiSymfonyHex = "000000";
export const SiSymfonyTitle = "Symfony";
export const SiSymfonySlug = "symfony";

export function SiSymfony({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSymfonyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSymfonyTitle}
      {...props}
    >
