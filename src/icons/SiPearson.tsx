...
export const SiPearsonHex = "000000";
export const SiPearsonTitle = "Pearson";
export const SiPearsonSlug = "pearson";

export function SiPearson({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPearsonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPearsonTitle}
      {...props}
    >
