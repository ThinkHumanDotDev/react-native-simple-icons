...
export const SiArloHex = "49B48A";
export const SiArloTitle = "Arlo";
export const SiArloSlug = "arlo";

export function SiArlo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArloHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArloTitle}
      {...props}
    >
