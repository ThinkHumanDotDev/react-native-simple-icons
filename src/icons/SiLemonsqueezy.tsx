...
export const SiLemonsqueezyHex = "FFC233";
export const SiLemonsqueezyTitle = "Lemon Squeezy";
export const SiLemonsqueezySlug = "lemonsqueezy";

export function SiLemonsqueezy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLemonsqueezyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLemonsqueezyTitle}
      {...props}
    >
