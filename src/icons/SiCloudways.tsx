...
export const SiCloudwaysHex = "2C39BD";
export const SiCloudwaysTitle = "Cloudways";
export const SiCloudwaysSlug = "cloudways";

export function SiCloudways({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudwaysHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudwaysTitle}
      {...props}
    >
