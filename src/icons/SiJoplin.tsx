...
export const SiJoplinHex = "1071D3";
export const SiJoplinTitle = "Joplin";
export const SiJoplinSlug = "joplin";

export function SiJoplin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJoplinHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJoplinTitle}
      {...props}
    >
