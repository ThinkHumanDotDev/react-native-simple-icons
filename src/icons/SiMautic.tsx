...
export const SiMauticHex = "4E5E9E";
export const SiMauticTitle = "Mautic";
export const SiMauticSlug = "mautic";

export function SiMautic({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMauticHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMauticTitle}
      {...props}
    >
