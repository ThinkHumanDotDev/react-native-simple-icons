...
export const SiNobaralinuxHex = "000000";
export const SiNobaralinuxTitle = "Nobara Linux";
export const SiNobaralinuxSlug = "nobaralinux";

export function SiNobaralinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNobaralinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNobaralinuxTitle}
      {...props}
    >
