...
export const SiPagerdutyHex = "06AC38";
export const SiPagerdutyTitle = "PagerDuty";
export const SiPagerdutySlug = "pagerduty";

export function SiPagerduty({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPagerdutyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPagerdutyTitle}
      {...props}
    >
