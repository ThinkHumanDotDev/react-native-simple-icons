...
export const SiVeedHex = "B6FF60";
export const SiVeedTitle = "VEED";
export const SiVeedSlug = "veed";

export function SiVeed({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVeedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVeedTitle}
      {...props}
    >
