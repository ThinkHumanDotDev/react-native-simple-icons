...
export const SiPhpstormHex = "000000";
export const SiPhpstormTitle = "PhpStorm";
export const SiPhpstormSlug = "phpstorm";

export function SiPhpstorm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhpstormHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhpstormTitle}
      {...props}
    >
