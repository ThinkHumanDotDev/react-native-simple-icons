...
export const SiAbbottHex = "008FC7";
export const SiAbbottTitle = "Abbott";
export const SiAbbottSlug = "abbott";

export function SiAbbott({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAbbottHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAbbottTitle}
      {...props}
    >
