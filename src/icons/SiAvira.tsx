...
export const SiAviraHex = "E02027";
export const SiAviraTitle = "Avira";
export const SiAviraSlug = "avira";

export function SiAvira({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAviraHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAviraTitle}
      {...props}
    >
