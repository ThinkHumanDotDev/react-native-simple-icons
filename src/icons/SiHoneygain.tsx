...
export const SiHoneygainHex = "F9C900";
export const SiHoneygainTitle = "Honeygain";
export const SiHoneygainSlug = "honeygain";

export function SiHoneygain({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHoneygainHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHoneygainTitle}
      {...props}
    >
