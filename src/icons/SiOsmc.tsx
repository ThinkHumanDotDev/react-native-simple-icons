...
export const SiOsmcHex = "17394A";
export const SiOsmcTitle = "OSMC";
export const SiOsmcSlug = "osmc";

export function SiOsmc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOsmcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOsmcTitle}
      {...props}
    >
