...
export const SiGitbookHex = "BBDDE5";
export const SiGitbookTitle = "GitBook";
export const SiGitbookSlug = "gitbook";

export function SiGitbook({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitbookHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitbookTitle}
      {...props}
    >
