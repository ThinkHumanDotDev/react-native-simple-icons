...
export const SiIgnHex = "BF1313";
export const SiIgnTitle = "IGN";
export const SiIgnSlug = "ign";

export function SiIgn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIgnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIgnTitle}
      {...props}
    >
