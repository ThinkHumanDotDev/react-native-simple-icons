...
export const SiSocketdotioHex = "010101";
export const SiSocketdotioTitle = "Socket.io";
export const SiSocketdotioSlug = "socketdotio";

export function SiSocketdotio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSocketdotioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSocketdotioTitle}
      {...props}
    >
