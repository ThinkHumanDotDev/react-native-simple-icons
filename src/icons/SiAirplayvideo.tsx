...
export const SiAirplayvideoHex = "000000";
export const SiAirplayvideoTitle = "AirPlay Video";
export const SiAirplayvideoSlug = "airplayvideo";

export function SiAirplayvideo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirplayvideoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirplayvideoTitle}
      {...props}
    >
