...
export const SiSqliteHex = "003B57";
export const SiSqliteTitle = "SQLite";
export const SiSqliteSlug = "sqlite";

export function SiSqlite({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSqliteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSqliteTitle}
      {...props}
    >
