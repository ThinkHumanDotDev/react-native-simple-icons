...
export const SiAeromexicoHex = "0B2343";
export const SiAeromexicoTitle = "Aeroméxico";
export const SiAeromexicoSlug = "aeromexico";

export function SiAeromexico({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAeromexicoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAeromexicoTitle}
      {...props}
    >
