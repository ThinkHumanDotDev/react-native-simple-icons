...
export const SiEmbyHex = "52B54B";
export const SiEmbyTitle = "Emby";
export const SiEmbySlug = "emby";

export function SiEmby({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEmbyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEmbyTitle}
      {...props}
    >
