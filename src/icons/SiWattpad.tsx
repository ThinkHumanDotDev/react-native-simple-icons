...
export const SiWattpadHex = "FF500A";
export const SiWattpadTitle = "Wattpad";
export const SiWattpadSlug = "wattpad";

export function SiWattpad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWattpadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWattpadTitle}
      {...props}
    >
