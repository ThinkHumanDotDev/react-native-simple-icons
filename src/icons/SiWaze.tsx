...
export const SiWazeHex = "33CCFF";
export const SiWazeTitle = "Waze";
export const SiWazeSlug = "waze";

export function SiWaze({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWazeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWazeTitle}
      {...props}
    >
