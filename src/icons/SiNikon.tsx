...
export const SiNikonHex = "FFE100";
export const SiNikonTitle = "Nikon";
export const SiNikonSlug = "nikon";

export function SiNikon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNikonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNikonTitle}
      {...props}
    >
