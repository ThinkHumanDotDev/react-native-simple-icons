...
export const SiProbotHex = "00B0D8";
export const SiProbotTitle = "Probot";
export const SiProbotSlug = "probot";

export function SiProbot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProbotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProbotTitle}
      {...props}
    >
