...
export const SiDartyHex = "EB1B23";
export const SiDartyTitle = "Darty";
export const SiDartySlug = "darty";

export function SiDarty({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDartyHex}` : color;
