...
export const SiTailscaleHex = "242424";
export const SiTailscaleTitle = "Tailscale";
export const SiTailscaleSlug = "tailscale";

export function SiTailscale({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTailscaleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTailscaleTitle}
      {...props}
    >
