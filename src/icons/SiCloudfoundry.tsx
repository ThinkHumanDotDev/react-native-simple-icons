...
export const SiCloudfoundryHex = "0C9ED5";
export const SiCloudfoundryTitle = "Cloud Foundry";
export const SiCloudfoundrySlug = "cloudfoundry";

export function SiCloudfoundry({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCloudfoundryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCloudfoundryTitle}
      {...props}
    >
