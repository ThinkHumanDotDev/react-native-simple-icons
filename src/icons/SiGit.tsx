...
export const SiGitHex = "F03C2E";
export const SiGitTitle = "Git";
export const SiGitSlug = "git";

export function SiGit({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGitHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGitTitle}
      {...props}
    >
