...
export const SiSololearnHex = "149EF2";
export const SiSololearnTitle = "Sololearn";
export const SiSololearnSlug = "sololearn";

export function SiSololearn({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSololearnHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSololearnTitle}
      {...props}
    >
