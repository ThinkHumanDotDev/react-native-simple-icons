...
export const SiPlaystation3Hex = "003791";
export const SiPlaystation3Title = "PlayStation 3";
export const SiPlaystation3Slug = "playstation3";

export function SiPlaystation3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlaystation3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlaystation3Title}
      {...props}
    >
