...
export const SiAdaHex = "000000";
export const SiAdaTitle = "Ada";
export const SiAdaSlug = "ada";

export function SiAda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAdaHex}` : color;
