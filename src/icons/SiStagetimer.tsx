...
export const SiStagetimerHex = "00A66C";
export const SiStagetimerTitle = "Stagetimer";
export const SiStagetimerSlug = "stagetimer";

export function SiStagetimer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStagetimerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStagetimerTitle}
      {...props}
    >
