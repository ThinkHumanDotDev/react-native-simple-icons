...
export const SiProtoncalendarHex = "50B0E9";
export const SiProtoncalendarTitle = "Proton Calendar";
export const SiProtoncalendarSlug = "protoncalendar";

export function SiProtoncalendar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtoncalendarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtoncalendarTitle}
      {...props}
    >
