...
export const SiElectronfiddleHex = "E79537";
export const SiElectronfiddleTitle = "Electron Fiddle";
export const SiElectronfiddleSlug = "electronfiddle";

export function SiElectronfiddle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElectronfiddleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElectronfiddleTitle}
      {...props}
    >
