...
export const SiLinkfireHex = "FF3850";
export const SiLinkfireTitle = "Linkfire";
export const SiLinkfireSlug = "linkfire";

export function SiLinkfire({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinkfireHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLinkfireTitle}
      {...props}
    >
