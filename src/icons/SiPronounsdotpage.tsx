...
export const SiPronounsdotpageHex = "C71585";
export const SiPronounsdotpageTitle = "Pronouns.page";
export const SiPronounsdotpageSlug = "pronounsdotpage";

export function SiPronounsdotpage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPronounsdotpageHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPronounsdotpageTitle}
      {...props}
    >
