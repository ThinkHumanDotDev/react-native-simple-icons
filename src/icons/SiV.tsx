...
export const SiVHex = "5D87BF";
export const SiVTitle = "V";
export const SiVSlug = "v";
...
export function SiV({
  ...
  const resolvedColor = color === "default" ? `#${SiVHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVTitle}
      {...props}
    >
