...
export const SiAppsignalHex = "21375A";
export const SiAppsignalTitle = "AppSignal";
export const SiAppsignalSlug = "appsignal";

export function SiAppsignal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAppsignalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAppsignalTitle}
      {...props}
    >
