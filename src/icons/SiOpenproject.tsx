...
export const SiOpenprojectHex = "0770B8";
export const SiOpenprojectTitle = "OpenProject";
export const SiOpenprojectSlug = "openproject";

export function SiOpenproject({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpenprojectHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpenprojectTitle}
      {...props}
    >
