...
export const SiAegisauthenticatorHex = "005E9D";
export const SiAegisauthenticatorTitle = "Aegis Authenticator";
export const SiAegisauthenticatorSlug = "aegisauthenticator";

export function SiAegisauthenticator({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAegisauthenticatorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAegisauthenticatorTitle}
      {...props}
    >
