...
export const SiSourcetreeHex = "0052CC";
export const SiSourcetreeTitle = "Sourcetree";
export const SiSourcetreeSlug = "sourcetree";

export function SiSourcetree({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSourcetreeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSourcetreeTitle}
      {...props}
    >
