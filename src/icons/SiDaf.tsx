...
export const SiDafHex = "00529B";
export const SiDafTitle = "DAF";
export const SiDafSlug = "daf";

export function SiDaf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDafHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDafTitle}
      {...props}
    >
