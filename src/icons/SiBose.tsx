...
export const SiBoseHex = "000000";
export const SiBoseTitle = "Bose";
export const SiBoseSlug = "bose";

export function SiBose({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBoseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBoseTitle}
      {...props}
    >
