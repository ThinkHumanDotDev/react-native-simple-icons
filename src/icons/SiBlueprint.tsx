...
export const SiBlueprintHex = "137CBD";
export const SiBlueprintTitle = "Blueprint";
export const SiBlueprintSlug = "blueprint";

export function SiBlueprint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBlueprintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBlueprintTitle}
      {...props}
    >
