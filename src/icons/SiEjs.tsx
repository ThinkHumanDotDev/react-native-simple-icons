...
export const SiEjsHex = "B4CA65";
export const SiEjsTitle = "EJS";
export const SiEjsSlug = "ejs";

export function SiEjs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEjsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEjsTitle}
      {...props}
    >
