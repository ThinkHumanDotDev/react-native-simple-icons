...
export const SiFizzHex = "00D672";
export const SiFizzTitle = "Fizz";
export const SiFizzSlug = "fizz";

export function SiFizz({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFizzHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFizzTitle}
      {...props}
    >
