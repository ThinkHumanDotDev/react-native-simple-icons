...
export const SiPond5Hex = "000000";
export const SiPond5Title = "Pond5";
export const SiPond5Slug = "pond5";

export function SiPond5({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPond5Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPond5Title}
      {...props}
    >
