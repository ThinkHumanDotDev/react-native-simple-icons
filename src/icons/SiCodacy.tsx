...
export const SiCodacyHex = "222F29";
export const SiCodacyTitle = "Codacy";
export const SiCodacySlug = "codacy";

export function SiCodacy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodacyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodacyTitle}
      {...props}
    >
