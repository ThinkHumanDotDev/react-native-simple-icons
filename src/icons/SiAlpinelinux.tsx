...
export const SiAlpinelinuxHex = "0D597F";
export const SiAlpinelinuxTitle = "Alpine Linux";
export const SiAlpinelinuxSlug = "alpinelinux";

export function SiAlpinelinux({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlpinelinuxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlpinelinuxTitle}
      {...props}
    >
