...
export const SiVfairsHex = "EF4678";
export const SiVfairsTitle = "vFairs";
export const SiVfairsSlug = "vfairs";

export function SiVfairs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVfairsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVfairsTitle}
      {...props}
    >
