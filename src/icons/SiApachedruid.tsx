...
export const SiApachedruidHex = "29F1FB";
export const SiApachedruidTitle = "Apache Druid";
export const SiApachedruidSlug = "apachedruid";

export function SiApachedruid({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachedruidHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachedruidTitle}
      {...props}
    >
