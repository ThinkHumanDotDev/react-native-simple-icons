...
export const SiScalewayHex = "4F0599";
export const SiScalewayTitle = "Scaleway";
export const SiScalewaySlug = "scaleway";

export function SiScaleway({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiScalewayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiScalewayTitle}
      {...props}
    >
