...
export const SiAkauntingHex = "6DA252";
export const SiAkauntingTitle = "Akaunting";
export const SiAkauntingSlug = "akaunting";

export function SiAkaunting({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAkauntingHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAkauntingTitle}
      {...props}
    >
