...
export const SiD3Hex = "F9A03C";
export const SiD3Title = "D3";
export const SiD3Slug = "d3";

export function SiD3({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiD3Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiD3Title}
      {...props}
    >
