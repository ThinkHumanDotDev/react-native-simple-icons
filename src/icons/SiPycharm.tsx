...
export const SiPycharmHex = "000000";
export const SiPycharmTitle = "PyCharm";
export const SiPycharmSlug = "pycharm";

export function SiPycharm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPycharmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPycharmTitle}
      {...props}
    >
