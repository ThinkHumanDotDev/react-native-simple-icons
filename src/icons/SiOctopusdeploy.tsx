...
export const SiOctopusdeployHex = "2F93E0";
export const SiOctopusdeployTitle = "Octopus Deploy";
export const SiOctopusdeploySlug = "octopusdeploy";

export function SiOctopusdeploy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOctopusdeployHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOctopusdeployTitle}
      {...props}
    >
