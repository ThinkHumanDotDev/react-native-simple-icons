...
export const SiPacktHex = "F37143";
export const SiPacktTitle = "Packt";
export const SiPacktSlug = "packt";

export function SiPackt({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPacktHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPacktTitle}
      {...props}
    >
