...
export const SiEyeemHex = "000000";
export const SiEyeemTitle = "EyeEm";
export const SiEyeemSlug = "eyeem";

export function SiEyeem({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEyeemHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEyeemTitle}
      {...props}
    >
