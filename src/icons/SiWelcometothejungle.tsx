...
export const SiWelcometothejungleHex = "FFCD00";
export const SiWelcometothejungleTitle = "Welcome to the Jungle";
export const SiWelcometothejungleSlug = "welcometothejungle";

export function SiWelcometothejungle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWelcometothejungleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWelcometothejungleTitle}
      {...props}
    >
