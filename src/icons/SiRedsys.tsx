...
export const SiRedsysHex = "DC7C26";
export const SiRedsysTitle = "Redsys";
export const SiRedsysSlug = "redsys";

export function SiRedsys({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRedsysHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRedsysTitle}
      {...props}
    >
