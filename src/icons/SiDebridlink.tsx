...
export const SiDebridlinkHex = "264E70";
export const SiDebridlinkTitle = "Debrid-Link";
export const SiDebridlinkSlug = "debridlink";

export function SiDebridlink({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDebridlinkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDebridlinkTitle}
      {...props}
    >
