...
export const SiMedusaHex = "000000";
export const SiMedusaTitle = "Medusa";
export const SiMedusaSlug = "medusa";

export function SiMedusa({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMedusaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMedusaTitle}
      {...props}
    >
