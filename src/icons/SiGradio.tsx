...
export const SiGradioHex = "F97316";
export const SiGradioTitle = "Gradio";
export const SiGradioSlug = "gradio";

export function SiGradio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGradioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGradioTitle}
      {...props}
    >
