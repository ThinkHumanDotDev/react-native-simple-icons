...
export const SiCoronaengineHex = "F96F29";
export const SiCoronaengineTitle = "Corona Engine";
export const SiCoronaengineSlug = "coronaengine";

export function SiCoronaengine({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoronaengineHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoronaengineTitle}
      {...props}
    >
