...
export const SiRyeHex = "000000";
export const SiRyeTitle = "Rye";
export const SiRyeSlug = "rye";

export function SiRye({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRyeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRyeTitle}
      {...props}
    >
