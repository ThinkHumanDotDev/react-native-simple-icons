...
export const SiVyondHex = "D95E26";
export const SiVyondTitle = "Vyond";
export const SiVyondSlug = "vyond";

export function SiVyond({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVyondHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVyondTitle}
      {...props}
    >
