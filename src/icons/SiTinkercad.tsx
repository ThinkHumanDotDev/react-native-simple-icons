...
export const SiTinkercadHex = "1477D1";
export const SiTinkercadTitle = "Tinkercad";
export const SiTinkercadSlug = "tinkercad";

export function SiTinkercad({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTinkercadHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTinkercadTitle}
      {...props}
    >
