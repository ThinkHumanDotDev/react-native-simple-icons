...
export const SiBoxHex = "0061D5";
export const SiBoxTitle = "Box";
export const SiBoxSlug = "box";
...
export function SiBox({
  ...
  const resolvedColor = color === "default" ? `#${SiBoxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBoxTitle}
      {...props}
    >
