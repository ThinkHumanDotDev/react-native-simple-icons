...
export const SiTsnodeHex = "3178C6";
export const SiTsnodeTitle = "ts-node";
export const SiTsnodeSlug = "tsnode";

export function SiTsnode({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTsnodeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTsnodeTitle}
      {...props}
    >
