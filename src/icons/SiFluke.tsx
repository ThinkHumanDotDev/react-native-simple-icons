...
export const SiFlukeHex = "FFC20E";
export const SiFlukeTitle = "Fluke";
export const SiFlukeSlug = "fluke";

export function SiFluke({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFlukeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFlukeTitle}
      {...props}
    >
