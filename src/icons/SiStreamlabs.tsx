...
export const SiStreamlabsHex = "80F5D2";
export const SiStreamlabsTitle = "Streamlabs";
export const SiStreamlabsSlug = "streamlabs";

export function SiStreamlabs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStreamlabsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStreamlabsTitle}
      {...props}
    >
