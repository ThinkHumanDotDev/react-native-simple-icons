...
export const SiUblockoriginHex = "800000";
export const SiUblockoriginTitle = "uBlock Origin";
export const SiUblockoriginSlug = "ublockorigin";

export function SiUblockorigin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUblockoriginHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUblockoriginTitle}
      {...props}
    >
