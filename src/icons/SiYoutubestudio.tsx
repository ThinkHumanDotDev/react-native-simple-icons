...
export const SiYoutubestudioHex = "FF0000";
export const SiYoutubestudioTitle = "YouTube Studio";
export const SiYoutubestudioSlug = "youtubestudio";

export function SiYoutubestudio({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYoutubestudioHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiYoutubestudioTitle}
      {...props}
    >
