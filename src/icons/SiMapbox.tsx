...
export const SiMapboxHex = "000000";
export const SiMapboxTitle = "Mapbox";
export const SiMapboxSlug = "mapbox";

export function SiMapbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMapboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMapboxTitle}
      {...props}
    >
