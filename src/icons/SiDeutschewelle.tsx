...
export const SiDeutschewelleHex = "05B2FC";
export const SiDeutschewelleTitle = "Deutsche Welle";
export const SiDeutschewelleSlug = "deutschewelle";

export function SiDeutschewelle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeutschewelleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeutschewelleTitle}
      {...props}
    >
