...
export const SiGoogleadsHex = "4285F4";
export const SiGoogleadsTitle = "Google Ads";
export const SiGoogleadsSlug = "googleads";

export function SiGoogleads({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogleadsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogleadsTitle}
      {...props}
    >
