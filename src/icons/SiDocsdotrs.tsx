...
export const SiDocsdotrsHex = "000000";
export const SiDocsdotrsTitle = "Docs.rs";
export const SiDocsdotrsSlug = "docsdotrs";

export function SiDocsdotrs({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDocsdotrsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDocsdotrsTitle}
      {...props}
    >
