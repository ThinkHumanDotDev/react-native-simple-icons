...
export const SiUmlHex = "FABD14";
export const SiUmlTitle = "UML";
export const SiUmlSlug = "uml";

export function SiUml({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUmlHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUmlTitle}
      {...props}
    >
