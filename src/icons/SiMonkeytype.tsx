...
export const SiMonkeytypeHex = "E2B714";
export const SiMonkeytypeTitle = "Monkeytype";
export const SiMonkeytypeSlug = "monkeytype";

export function SiMonkeytype({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMonkeytypeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMonkeytypeTitle}
      {...props}
    >
