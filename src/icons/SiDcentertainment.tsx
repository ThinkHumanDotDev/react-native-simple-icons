...
export const SiDcentertainmentHex = "0078F0";
export const SiDcentertainmentTitle = "DC Entertainment";
export const SiDcentertainmentSlug = "dcentertainment";

export function SiDcentertainment({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDcentertainmentHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDcentertainmentTitle}
      {...props}
    >
