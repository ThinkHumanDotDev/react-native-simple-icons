...
export const SiNewbalanceHex = "CF0A2C";
export const SiNewbalanceTitle = "New Balance";
export const SiNewbalanceSlug = "newbalance";

export function SiNewbalance({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNewbalanceHex}` : color;
