...
export const SiCondaforgeHex = "000000";
export const SiCondaforgeTitle = "Conda-Forge";
export const SiCondaforgeSlug = "condaforge";

export function SiCondaforge({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCondaforgeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCondaforgeTitle}
      {...props}
    >
