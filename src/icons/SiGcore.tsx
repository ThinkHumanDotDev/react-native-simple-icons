...
export const SiGcoreHex = "FF4C00";
export const SiGcoreTitle = "Gcore";
export const SiGcoreSlug = "gcore";

export function SiGcore({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGcoreHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGcoreTitle}
      {...props}
    >
