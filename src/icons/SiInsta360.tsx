...
export const SiInsta360Hex = "FFEE00";
export const SiInsta360Title = "Insta360";
export const SiInsta360Slug = "insta360";

export function SiInsta360({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInsta360Hex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInsta360Title}
      {...props}
    >
