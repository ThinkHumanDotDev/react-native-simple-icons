...
export const SiBuyselladsHex = "EB4714";
export const SiBuyselladsTitle = "BuySellAds";
export const SiBuyselladsSlug = "buysellads";

export function SiBuysellads({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBuyselladsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBuyselladsTitle}
      {...props}
    >
