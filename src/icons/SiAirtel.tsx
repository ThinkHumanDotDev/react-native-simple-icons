...
export const SiAirtelHex = "E40000";
export const SiAirtelTitle = "Airtel";
export const SiAirtelSlug = "airtel";

export function SiAirtel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAirtelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAirtelTitle}
      {...props}
    >
