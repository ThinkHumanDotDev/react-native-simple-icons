...
export const SiArmkeilHex = "394049";
export const SiArmkeilTitle = "Arm Keil";
export const SiArmkeilSlug = "armkeil";

export function SiArmkeil({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArmkeilHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArmkeilTitle}
      {...props}
    >
