...
export const SiObservableHex = "353E58";
export const SiObservableTitle = "Observable";
export const SiObservableSlug = "observable";

export function SiObservable({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiObservableHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiObservableTitle}
      {...props}
    >
