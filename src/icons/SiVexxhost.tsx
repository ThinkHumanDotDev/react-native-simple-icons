...
export const SiVexxhostHex = "2A1659";
export const SiVexxhostTitle = "VEXXHOST";
export const SiVexxhostSlug = "vexxhost";

export function SiVexxhost({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVexxhostHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVexxhostTitle}
      {...props}
    >
