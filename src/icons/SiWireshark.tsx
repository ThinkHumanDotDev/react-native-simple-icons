...
export const SiWiresharkHex = "1679A7";
export const SiWiresharkTitle = "Wireshark";
export const SiWiresharkSlug = "wireshark";

export function SiWireshark({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWiresharkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWiresharkTitle}
      {...props}
    >
