...
export const SiProtonHex = "6D4AFF";
export const SiProtonTitle = "Proton";
export const SiProtonSlug = "proton";

export function SiProton({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtonTitle}
      {...props}
    >
