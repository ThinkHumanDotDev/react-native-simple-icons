...
export const SiMediafireHex = "1299F3";
export const SiMediafireTitle = "MediaFire";
export const SiMediafireSlug = "mediafire";

export function SiMediafire({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMediafireHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMediafireTitle}
      {...props}
    >
