...
export const SiNfcHex = "002E5F";
export const SiNfcTitle = "NFC";
export const SiNfcSlug = "nfc";

export function SiNfc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNfcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNfcTitle}
      {...props}
    >
