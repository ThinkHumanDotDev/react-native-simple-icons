...
export const SiOyoHex = "EE2E24";
export const SiOyoTitle = "OYO";
export const SiOyoSlug = "oyo";

export function SiOyo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOyoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOyoTitle}
      {...props}
    >
