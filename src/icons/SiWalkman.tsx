...
export const SiWalkmanHex = "000000";
export const SiWalkmanTitle = "WALKMAN";
export const SiWalkmanSlug = "walkman";

export function SiWalkman({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWalkmanHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWalkmanTitle}
      {...props}
    >
