...
export const SiRockwellautomationHex = "CD163F";
export const SiRockwellautomationTitle = "Rockwell Automation";
export const SiRockwellautomationSlug = "rockwellautomation";

export function SiRockwellautomation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRockwellautomationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRockwellautomationTitle}
      {...props}
    >
