...
export const SiChefHex = "F09820";
export const SiChefTitle = "Chef";
export const SiChefSlug = "chef";

export function SiChef({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiChefHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiChefTitle}
      {...props}
    >
