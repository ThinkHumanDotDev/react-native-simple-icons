...
export const SiLaragonHex = "0E83CD";
export const SiLaragonTitle = "Laragon";
export const SiLaragonSlug = "laragon";

export function SiLaragon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLaragonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLaragonTitle}
      {...props}
    >
