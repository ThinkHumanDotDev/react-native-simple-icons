...
export const SiSemanticreleaseHex = "494949";
export const SiSemanticreleaseTitle = "semantic-release";
export const SiSemanticreleaseSlug = "semanticrelease";

export function SiSemanticrelease({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSemanticreleaseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSemanticreleaseTitle}
      {...props}
    >
