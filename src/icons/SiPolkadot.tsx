...
export const SiPolkadotHex = "E6007A";
export const SiPolkadotTitle = "Polkadot";
export const SiPolkadotSlug = "polkadot";

export function SiPolkadot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPolkadotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPolkadotTitle}
      {...props}
    >
