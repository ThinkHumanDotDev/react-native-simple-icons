...
export const SiNextdnsHex = "007BFF";
export const SiNextdnsTitle = "NextDNS";
export const SiNextdnsSlug = "nextdns";

export function SiNextdns({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNextdnsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNextdnsTitle}
      {...props}
    >
