...
export const SiRapidHex = "0055DA";
export const SiRapidTitle = "Rapid";
export const SiRapidSlug = "rapid";

export function SiRapid({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRapidHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRapidTitle}
      {...props}
    >
