...
export const SiAlamyHex = "00FF7B";
export const SiAlamyTitle = "Alamy";
export const SiAlamySlug = "alamy";

export function SiAlamy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlamyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlamyTitle}
      {...props}
    >
