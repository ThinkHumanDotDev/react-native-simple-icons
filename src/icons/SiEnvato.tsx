...
export const SiEnvatoHex = "87E64B";
export const SiEnvatoTitle = "Envato";
export const SiEnvatoSlug = "envato";

export function SiEnvato({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEnvatoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEnvatoTitle}
      {...props}
    >
