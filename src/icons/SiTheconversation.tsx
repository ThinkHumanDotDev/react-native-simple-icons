...
export const SiTheconversationHex = "D8352A";
export const SiTheconversationTitle = "The Conversation";
export const SiTheconversationSlug = "theconversation";

export function SiTheconversation({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTheconversationHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTheconversationTitle}
      {...props}
    >
