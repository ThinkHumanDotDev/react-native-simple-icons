...
export const SiSlidesHex = "E4637C";
export const SiSlidesTitle = "Slides";
export const SiSlidesSlug = "slides";

export function SiSlides({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSlidesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSlidesTitle}
      {...props}
    >
