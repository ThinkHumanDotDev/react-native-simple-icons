...
export const SiAbstractHex = "191A1B";
export const SiAbstractTitle = "Abstract";
export const SiAbstractSlug = "abstract";

export function SiAbstract({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAbstractHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAbstractTitle}
      {...props}
    >
