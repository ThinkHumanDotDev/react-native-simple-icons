...
export const SiCartoHex = "EB1510";
export const SiCartoTitle = "Carto";
export const SiCartoSlug = "carto";

export function SiCarto({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCartoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCartoTitle}
      {...props}
    >
