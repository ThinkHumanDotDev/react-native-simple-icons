...
export const SiWebmoneyHex = "036CB5";
export const SiWebmoneyTitle = "WebMoney";
export const SiWebmoneySlug = "webmoney";

export function SiWebmoney({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWebmoneyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWebmoneyTitle}
      {...props}
    >
