...
export const SiTalenthouseHex = "000000";
export const SiTalenthouseTitle = "Talenthouse";
export const SiTalenthouseSlug = "talenthouse";

export function SiTalenthouse({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTalenthouseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTalenthouseTitle}
      {...props}
    >
