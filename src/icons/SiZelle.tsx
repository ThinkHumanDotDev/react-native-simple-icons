...
export const SiZelleHex = "6D1ED4";
export const SiZelleTitle = "Zelle";
export const SiZelleSlug = "zelle";

export function SiZelle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZelleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZelleTitle}
      {...props}
    >
