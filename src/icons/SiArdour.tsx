...
export const SiArdourHex = "C61C3E";
export const SiArdourTitle = "Ardour";
export const SiArdourSlug = "ardour";

export function SiArdour({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArdourHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArdourTitle}
      {...props}
    >
