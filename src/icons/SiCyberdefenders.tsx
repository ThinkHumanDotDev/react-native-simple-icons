...
export const SiCyberdefendersHex = "335EEA";
export const SiCyberdefendersTitle = "CyberDefenders";
export const SiCyberdefendersSlug = "cyberdefenders";

export function SiCyberdefenders({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCyberdefendersHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCyberdefendersTitle}
      {...props}
    >
