...
export const SiFyleHex = "FF2E63";
export const SiFyleTitle = "Fyle";
export const SiFyleSlug = "fyle";

export function SiFyle({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFyleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFyleTitle}
      {...props}
    >
