...
export const SiWereadHex = "37A7FF";
export const SiWereadTitle = "WeRead";
export const SiWereadSlug = "weread";

export function SiWeread({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWereadHex}` : color;
