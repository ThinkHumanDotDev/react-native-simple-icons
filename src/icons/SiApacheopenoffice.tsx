...
export const SiApacheopenofficeHex = "0E85CD";
export const SiApacheopenofficeTitle = "Apache OpenOffice";
export const SiApacheopenofficeSlug = "apacheopenoffice";

export function SiApacheopenoffice({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApacheopenofficeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApacheopenofficeTitle}
      {...props}
    >
