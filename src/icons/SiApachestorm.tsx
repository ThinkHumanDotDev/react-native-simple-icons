...
export const SiApachestormHex = "225593";
export const SiApachestormTitle = "Apache Storm";
export const SiApachestormSlug = "apachestorm";

export function SiApachestorm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachestormHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachestormTitle}
      {...props}
    >
