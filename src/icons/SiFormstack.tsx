...
export const SiFormstackHex = "21B573";
export const SiFormstackTitle = "Formstack";
export const SiFormstackSlug = "formstack";

export function SiFormstack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFormstackHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFormstackTitle}
      {...props}
    >
