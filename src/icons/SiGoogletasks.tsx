...
export const SiGoogletasksHex = "2684FC";
export const SiGoogletasksTitle = "Google Tasks";
export const SiGoogletasksSlug = "googletasks";

export function SiGoogletasks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGoogletasksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGoogletasksTitle}
      {...props}
    >
