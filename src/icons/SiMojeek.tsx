...
export const SiMojeekHex = "7AB93C";
export const SiMojeekTitle = "Mojeek";
export const SiMojeekSlug = "mojeek";

export function SiMojeek({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMojeekHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMojeekTitle}
      {...props}
    >
