...
export const SiTanstackHex = "ECE8D1";
export const SiTanstackTitle = "TanStack";
export const SiTanstackSlug = "tanstack";

export function SiTanstack({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTanstackHex}` : color;
