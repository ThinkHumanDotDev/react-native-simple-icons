...
export const SiTildapublishingHex = "FFA282";
export const SiTildapublishingTitle = "Tilda Publishing";
export const SiTildapublishingSlug = "tildapublishing";

export function SiTildapublishing({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTildapublishingHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTildapublishingTitle}
      {...props}
    >
