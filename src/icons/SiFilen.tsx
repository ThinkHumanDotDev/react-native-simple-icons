...
export const SiFilenHex = "000000";
export const SiFilenTitle = "Filen";
export const SiFilenSlug = "filen";

export function SiFilen({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFilenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFilenTitle}
      {...props}
    >
