...
export const SiThymeleafHex = "005F0F";
export const SiThymeleafTitle = "Thymeleaf";
export const SiThymeleafSlug = "thymeleaf";

export function SiThymeleaf({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiThymeleafHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiThymeleafTitle}
      {...props}
    >
