...
export const SiVivinoHex = "A61A30";
export const SiVivinoTitle = "Vivino";
export const SiVivinoSlug = "vivino";

export function SiVivino({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVivinoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVivinoTitle}
      {...props}
    >
