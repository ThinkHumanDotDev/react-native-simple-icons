...
export const SiLotpolishairlinesHex = "11397E";
export const SiLotpolishairlinesTitle = "LOT Polish Airlines";
export const SiLotpolishairlinesSlug = "lotpolishairlines";

export function SiLotpolishairlines({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLotpolishairlinesHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLotpolishairlinesTitle}
      {...props}
    >
