...
export const SiQuicktypeHex = "159588";
export const SiQuicktypeTitle = "quicktype";
export const SiQuicktypeSlug = "quicktype";

export function SiQuicktype({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiQuicktypeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiQuicktypeTitle}
      {...props}
    >
