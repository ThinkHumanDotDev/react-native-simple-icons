...
export const SiSketchupHex = "005F9E";
export const SiSketchupTitle = "SketchUp";
export const SiSketchupSlug = "sketchup";

export function SiSketchup({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSketchupHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSketchupTitle}
      {...props}
    >
