...
export const SiAntdesignHex = "0170FE";
export const SiAntdesignTitle = "Ant Design";
export const SiAntdesignSlug = "antdesign";

export function SiAntdesign({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAntdesignHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAntdesignTitle}
      {...props}
    >
