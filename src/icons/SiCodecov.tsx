...
export const SiCodecovHex = "F01F7A";
export const SiCodecovTitle = "Codecov";
export const SiCodecovSlug = "codecov";

export function SiCodecov({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodecovHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodecovTitle}
      {...props}
    >
