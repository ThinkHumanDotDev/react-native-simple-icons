...
export const SiTuiHex = "D40E14";
export const SiTuiTitle = "TUI";
export const SiTuiSlug = "tui";

export function SiTui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTuiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTuiTitle}
      {...props}
    >
