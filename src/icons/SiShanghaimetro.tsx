...
export const SiShanghaimetroHex = "EC1C24";
export const SiShanghaimetroTitle = "Shanghai Metro";
export const SiShanghaimetroSlug = "shanghaimetro";

export function SiShanghaimetro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiShanghaimetroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiShanghaimetroTitle}
      {...props}
    >
