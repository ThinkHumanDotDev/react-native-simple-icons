...
export const SiInstatusHex = "4EE3C2";
export const SiInstatusTitle = "Instatus";
export const SiInstatusSlug = "instatus";

export function SiInstatus({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInstatusHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInstatusTitle}
      {...props}
    >
