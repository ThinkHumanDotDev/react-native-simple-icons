...
export const SiLiberapayHex = "F6C915";
export const SiLiberapayTitle = "Liberapay";
export const SiLiberapaySlug = "liberapay";

export function SiLiberapay({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLiberapayHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLiberapayTitle}
      {...props}
    >
