...
export const SiDeeplHex = "0F2B46";
export const SiDeeplTitle = "DeepL";
export const SiDeeplSlug = "deepl";

export function SiDeepl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDeeplHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDeeplTitle}
      {...props}
    >
