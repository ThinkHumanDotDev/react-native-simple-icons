...
export const SiDvcHex = "13ADC7";
export const SiDvcTitle = "DVC";
export const SiDvcSlug = "dvc";

export function SiDvc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDvcHex}` : color;
