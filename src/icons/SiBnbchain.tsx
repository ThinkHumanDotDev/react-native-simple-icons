...
export const SiBnbchainHex = "F0B90B";
export const SiBnbchainTitle = "BNB Chain";
export const SiBnbchainSlug = "bnbchain";

export function SiBnbchain({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBnbchainHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBnbchainTitle}
      {...props}
    >
