...
export const SiSegaHex = "0089CF";
export const SiSegaTitle = "Sega";
export const SiSegaSlug = "sega";

export function SiSega({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSegaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSegaTitle}
      {...props}
    >
