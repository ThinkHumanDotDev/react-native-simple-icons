...
export const SiAnichartHex = "41B1EA";
export const SiAnichartTitle = "AniChart";
export const SiAnichartSlug = "anichart";

export function SiAnichart({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAnichartHex}` : color;
