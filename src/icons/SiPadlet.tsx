...
export const SiPadletHex = "FF4081";
export const SiPadletTitle = "Padlet";
export const SiPadletSlug = "padlet";

export function SiPadlet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPadletHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPadletTitle}
      {...props}
    >
