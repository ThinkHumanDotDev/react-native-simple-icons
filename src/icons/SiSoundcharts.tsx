...
export const SiSoundchartsHex = "0C1528";
export const SiSoundchartsTitle = "Soundcharts";
export const SiSoundchartsSlug = "soundcharts";

export function SiSoundcharts({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSoundchartsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSoundchartsTitle}
      {...props}
    >
