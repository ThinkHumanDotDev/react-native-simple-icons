...
export const SiNordicsemiconductorHex = "00A9CE";
export const SiNordicsemiconductorTitle = "Nordic Semiconductor";
export const SiNordicsemiconductorSlug = "nordicsemiconductor";

export function SiNordicsemiconductor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiNordicsemiconductorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiNordicsemiconductorTitle}
      {...props}
    >
