...
export const SiHypothesisHex = "BD1C2B";
export const SiHypothesisTitle = "Hypothesis";
export const SiHypothesisSlug = "hypothesis";

export function SiHypothesis({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHypothesisHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHypothesisTitle}
      {...props}
    >
