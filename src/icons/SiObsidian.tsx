...
export const SiObsidianHex = "7C3AED";
export const SiObsidianTitle = "Obsidian";
export const SiObsidianSlug = "obsidian";

export function SiObsidian({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiObsidianHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiObsidianTitle}
      {...props}
    >
