...
export const SiCommerzbankHex = "FFCC33";
export const SiCommerzbankTitle = "Commerzbank";
export const SiCommerzbankSlug = "commerzbank";

export function SiCommerzbank({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCommerzbankHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCommerzbankTitle}
      {...props}
    >
