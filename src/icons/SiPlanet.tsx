...
export const SiPlanetHex = "009DB1";
export const SiPlanetTitle = "Planet";
export const SiPlanetSlug = "planet";

export function SiPlanet({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPlanetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPlanetTitle}
      {...props}
    >
