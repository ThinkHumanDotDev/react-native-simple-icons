...
export const SiGskHex = "F36633";
export const SiGskTitle = "GSK";
export const SiGskSlug = "gsk";

export function SiGsk({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGskHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGskTitle}
      {...props}
    >
