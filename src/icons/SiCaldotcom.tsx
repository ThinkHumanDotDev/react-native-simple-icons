...
export const SiCaldotcomHex = "292929";
export const SiCaldotcomTitle = "Cal.com";
export const SiCaldotcomSlug = "caldotcom";

export function SiCaldotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCaldotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCaldotcomTitle}
      {...props}
    >
