...
export const SiIvecoHex = "1554FF";
export const SiIvecoTitle = "IVECO";
export const SiIvecoSlug = "iveco";

export function SiIveco({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIvecoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIvecoTitle}
      {...props}
    >
