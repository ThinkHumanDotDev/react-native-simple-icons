...
export const SiKagiHex = "FFB319";
export const SiKagiTitle = "Kagi";
export const SiKagiSlug = "kagi";

export function SiKagi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKagiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKagiTitle}
      {...props}
    >
