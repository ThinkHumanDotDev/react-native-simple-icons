...
export const SiTraccarHex = "000000";
export const SiTraccarTitle = "Traccar";
export const SiTraccarSlug = "traccar";

export function SiTraccar({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTraccarHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTraccarTitle}
      {...props}
    >
