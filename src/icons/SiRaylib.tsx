...
export const SiRaylibHex = "000000";
export const SiRaylibTitle = "Raylib";
export const SiRaylibSlug = "raylib";

export function SiRaylib({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRaylibHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRaylibTitle}
      {...props}
    >
