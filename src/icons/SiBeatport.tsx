...
export const SiBeatportHex = "01FF95";
export const SiBeatportTitle = "Beatport";
export const SiBeatportSlug = "beatport";

export function SiBeatport({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBeatportHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBeatportTitle}
      {...props}
    >
