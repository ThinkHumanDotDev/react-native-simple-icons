...
export const SiYaakHex = "814EDF";
export const SiYaakTitle = "Yaak";
export const SiYaakSlug = "yaak";

export function SiYaak({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiYaakHex}` : color;
