...
export const SiGooglecampaignmanager360Hex = "1E8E3E";
export const SiGooglecampaignmanager360Title = "Google Campaign Manager 360";
export const SiGooglecampaignmanager360Slug = "googlecampaignmanager360";

export function SiGooglecampaignmanager360({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglecampaignmanager360Hex}` : color;
