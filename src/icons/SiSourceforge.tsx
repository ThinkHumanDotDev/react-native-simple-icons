...
export const SiSourceforgeHex = "FF6600";
export const SiSourceforgeTitle = "SourceForge";
export const SiSourceforgeSlug = "sourceforge";

export function SiSourceforge({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSourceforgeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSourceforgeTitle}
      {...props}
    >
