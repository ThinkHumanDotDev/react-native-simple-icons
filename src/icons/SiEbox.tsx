...
export const SiEboxHex = "BE2323";
export const SiEboxTitle = "EBOX";
export const SiEboxSlug = "ebox";

export function SiEbox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEboxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEboxTitle}
      {...props}
    >
