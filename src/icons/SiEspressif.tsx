...
export const SiEspressifHex = "E7352C";
export const SiEspressifTitle = "Espressif";
export const SiEspressifSlug = "espressif";

export function SiEspressif({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEspressifHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEspressifTitle}
      {...props}
    >
