...
export const SiStackoverflowHex = "F58025";
export const SiStackoverflowTitle = "Stack Overflow";
export const SiStackoverflowSlug = "stackoverflow";

export function SiStackoverflow({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStackoverflowHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStackoverflowTitle}
      {...props}
    >
