...
export const SiFloatplaneHex = "00AEEF";
export const SiFloatplaneTitle = "Floatplane";
export const SiFloatplaneSlug = "floatplane";

export function SiFloatplane({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFloatplaneHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFloatplaneTitle}
      {...props}
    >
