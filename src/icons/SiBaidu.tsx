...
export const SiBaiduHex = "2932E1";
export const SiBaiduTitle = "Baidu";
export const SiBaiduSlug = "baidu";

export function SiBaidu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBaiduHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBaiduTitle}
      {...props}
    >
