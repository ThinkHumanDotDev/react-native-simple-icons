...
export const SiKenticoHex = "F05A22";
export const SiKenticoTitle = "Kentico";
export const SiKenticoSlug = "kentico";

export function SiKentico({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKenticoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKenticoTitle}
      {...props}
    >
