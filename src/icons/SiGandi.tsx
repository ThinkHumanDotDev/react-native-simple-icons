...
export const SiGandiHex = "6640FE";
export const SiGandiTitle = "Gandi";
export const SiGandiSlug = "gandi";

export function SiGandi({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGandiHex}` : color;
