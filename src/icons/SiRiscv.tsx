...
export const SiRiscvHex = "283272";
export const SiRiscvTitle = "RISC-V";
export const SiRiscvSlug = "riscv";

export function SiRiscv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRiscvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRiscvTitle}
      {...props}
    >
