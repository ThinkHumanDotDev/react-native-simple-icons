...
export const SiElavonHex = "0C2074";
export const SiElavonTitle = "Elavon";
export const SiElavonSlug = "elavon";

export function SiElavon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiElavonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiElavonTitle}
      {...props}
    >
