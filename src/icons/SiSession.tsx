...
export const SiSessionHex = "000000";
export const SiSessionTitle = "Session";
export const SiSessionSlug = "session";

export function SiSession({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSessionHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSessionTitle}
      {...props}
    >
