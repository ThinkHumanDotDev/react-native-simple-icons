...
export const SiAquaHex = "1904DA";
export const SiAquaTitle = "Aqua";
export const SiAquaSlug = "aqua";

export function SiAqua({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAquaHex}` : color;
