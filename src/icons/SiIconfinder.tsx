...
export const SiIconfinderHex = "1A1B1F";
export const SiIconfinderTitle = "Iconfinder";
export const SiIconfinderSlug = "iconfinder";

export function SiIconfinder({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIconfinderHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIconfinderTitle}
      {...props}
    >
