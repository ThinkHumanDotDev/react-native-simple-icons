...
export const SiCodecademyHex = "1F4056";
export const SiCodecademyTitle = "Codecademy";
export const SiCodecademySlug = "codecademy";

export function SiCodecademy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodecademyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodecademyTitle}
      {...props}
    >
