...
export const SiDenonHex = "0B131A";
export const SiDenonTitle = "Denon";
export const SiDenonSlug = "denon";

export function SiDenon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDenonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDenonTitle}
      {...props}
    >
