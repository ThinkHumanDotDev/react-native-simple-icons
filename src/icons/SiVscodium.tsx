...
export const SiVscodiumHex = "2F80ED";
export const SiVscodiumTitle = "VSCodium";
export const SiVscodiumSlug = "vscodium";

export function SiVscodium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVscodiumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVscodiumTitle}
      {...props}
    >
