...
export const SiProtondriveHex = "EB508D";
export const SiProtondriveTitle = "Proton Drive";
export const SiProtondriveSlug = "protondrive";

export function SiProtondrive({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProtondriveHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProtondriveTitle}
      {...props}
    >
