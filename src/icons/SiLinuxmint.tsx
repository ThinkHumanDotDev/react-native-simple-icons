...
export const SiLinuxmintHex = "86BE43";
export const SiLinuxmintTitle = "Linux Mint";
export const SiLinuxmintSlug = "linuxmint";

export function SiLinuxmint({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLinuxmintHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLinuxmintTitle}
      {...props}
    >
