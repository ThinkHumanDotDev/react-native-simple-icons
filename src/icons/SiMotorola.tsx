...
export const SiMotorolaHex = "E1140A";
export const SiMotorolaTitle = "Motorola";
export const SiMotorolaSlug = "motorola";

export function SiMotorola({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMotorolaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMotorolaTitle}
      {...props}
    >
