...
export const SiWikiquoteHex = "006699";
export const SiWikiquoteTitle = "Wikiquote";
export const SiWikiquoteSlug = "wikiquote";

export function SiWikiquote({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWikiquoteHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWikiquoteTitle}
      {...props}
    >
