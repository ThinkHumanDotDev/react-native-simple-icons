...
export const SiGooglesearchconsoleHex = "458CF5";
export const SiGooglesearchconsoleTitle = "Google Search Console";
export const SiGooglesearchconsoleSlug = "googlesearchconsole";

export function SiGooglesearchconsole({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglesearchconsoleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglesearchconsoleTitle}
      {...props}
    >
