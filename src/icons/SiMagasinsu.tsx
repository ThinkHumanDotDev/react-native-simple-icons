...
export const SiMagasinsuHex = "E71B34";
export const SiMagasinsuTitle = "Magasins U";
export const SiMagasinsuSlug = "magasinsu";

export function SiMagasinsu({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMagasinsuHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMagasinsuTitle}
      {...props}
    >
