...
export const SiAbbvieHex = "071D49";
export const SiAbbvieTitle = "Abbvie";
export const SiAbbvieSlug = "abbvie";

export function SiAbbvie({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAbbvieHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAbbvieTitle}
      {...props}
    >
