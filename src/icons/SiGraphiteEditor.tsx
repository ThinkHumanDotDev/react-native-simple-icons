...
export const SiGraphiteEditorHex = "473A3A";
export const SiGraphiteEditorTitle = "Graphite";
export const SiGraphiteEditorSlug = "graphite_editor";

export function SiGraphiteEditor({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGraphiteEditorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGraphiteEditorTitle}
      {...props}
    >
