...
export const SiAlibabadotcomHex = "FF6A00";
export const SiAlibabadotcomTitle = "Alibaba.com";
export const SiAlibabadotcomSlug = "alibabadotcom";

export function SiAlibabadotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAlibabadotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAlibabadotcomTitle}
      {...props}
    >
