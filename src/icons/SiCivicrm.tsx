...
export const SiCivicrmHex = "81C459";
export const SiCivicrmTitle = "CiviCRM";
export const SiCivicrmSlug = "civicrm";

export function SiCivicrm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCivicrmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCivicrmTitle}
      {...props}
    >
