...
export const SiAureliaHex = "ED2B88";
export const SiAureliaTitle = "Aurelia";
export const SiAureliaSlug = "aurelia";

export function SiAurelia({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAureliaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAureliaTitle}
      {...props}
    >
