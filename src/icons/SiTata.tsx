...
export const SiTataHex = "486AAE";
export const SiTataTitle = "Tata";
export const SiTataSlug = "tata";

export function SiTata({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTataHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTataTitle}
      {...props}
    >
