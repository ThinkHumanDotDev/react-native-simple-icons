...
export const SiPluralsightHex = "F15B2A";
export const SiPluralsightTitle = "Pluralsight";
export const SiPluralsightSlug = "pluralsight";

export function SiPluralsight({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPluralsightHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPluralsightTitle}
      {...props}
    >
