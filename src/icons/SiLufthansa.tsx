...
export const SiLufthansaHex = "05164D";
export const SiLufthansaTitle = "Lufthansa";
export const SiLufthansaSlug = "lufthansa";

export function SiLufthansa({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLufthansaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLufthansaTitle}
      {...props}
    >
