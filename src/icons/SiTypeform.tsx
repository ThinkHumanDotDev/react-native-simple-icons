...
export const SiTypeformHex = "262627";
export const SiTypeformTitle = "Typeform";
export const SiTypeformSlug = "typeform";

export function SiTypeform({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTypeformHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTypeformTitle}
      {...props}
    >
