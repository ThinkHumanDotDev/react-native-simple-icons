...
export const SiHelmHex = "0F1689";
export const SiHelmTitle = "Helm";
export const SiHelmSlug = "helm";

export function SiHelm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHelmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHelmTitle}
      {...props}
    >
