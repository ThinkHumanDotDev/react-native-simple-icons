...
export const SiVlcmediaplayerHex = "FF8800";
export const SiVlcmediaplayerTitle = "VLC media player";
export const SiVlcmediaplayerSlug = "vlcmediaplayer";

export function SiVlcmediaplayer({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiVlcmediaplayerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiVlcmediaplayerTitle}
      {...props}
    >
