...
export const SiRobotframeworkHex = "000000";
export const SiRobotframeworkTitle = "Robot Framework";
export const SiRobotframeworkSlug = "robotframework";

export function SiRobotframework({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRobotframeworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRobotframeworkTitle}
      {...props}
    >
