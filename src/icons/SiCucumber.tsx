...
export const SiCucumberHex = "23D96C";
export const SiCucumberTitle = "Cucumber";
export const SiCucumberSlug = "cucumber";

export function SiCucumber({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCucumberHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCucumberTitle}
      {...props}
    >
