...
export const SiCodersrankHex = "67A4AC";
export const SiCodersrankTitle = "CodersRank";
export const SiCodersrankSlug = "codersrank";

export function SiCodersrank({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCodersrankHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCodersrankTitle}
      {...props}
    >
