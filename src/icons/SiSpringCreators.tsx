...
export const SiSpringCreatorsHex = "000000";
export const SiSpringCreatorsTitle = "Spring";
export const SiSpringCreatorsSlug = "spring_creators";

export function SiSpringCreators({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSpringCreatorsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSpringCreatorsTitle}
      {...props}
    >
