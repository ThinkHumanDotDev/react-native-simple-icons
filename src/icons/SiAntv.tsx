...
export const SiAntvHex = "8B5DFF";
export const SiAntvTitle = "AntV";
export const SiAntvSlug = "antv";

export function SiAntv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAntvHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAntvTitle}
      {...props}
    >
