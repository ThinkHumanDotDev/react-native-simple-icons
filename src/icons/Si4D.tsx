...
export const Si4DHex = "004088";
export const Si4DTitle = "4D";
export const Si4DSlug = "4d";

export function Si4D({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${Si4DHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? Si4DTitle}
      {...props}
    >
