...
export const SiFujifilmHex = "FB0020";
export const SiFujifilmTitle = "Fujifilm";
export const SiFujifilmSlug = "fujifilm";

export function SiFujifilm({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFujifilmHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFujifilmTitle}
      {...props}
    >
