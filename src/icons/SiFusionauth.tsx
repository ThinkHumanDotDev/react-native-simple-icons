...
export const SiFusionauthHex = "F58320";
export const SiFusionauthTitle = "FusionAuth";
export const SiFusionauthSlug = "fusionauth";

export function SiFusionauth({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFusionauthHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFusionauthTitle}
      {...props}
    >
