...
export const SiAudiotechnicaHex = "000000";
export const SiAudiotechnicaTitle = "Audio-Technica";
export const SiAudiotechnicaSlug = "audiotechnica";

export function SiAudiotechnica({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAudiotechnicaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAudiotechnicaTitle}
      {...props}
    >
