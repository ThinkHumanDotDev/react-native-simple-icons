...
export const SiApachesupersetHex = "20A6C9";
export const SiApachesupersetTitle = "Apache Superset";
export const SiApachesupersetSlug = "apachesuperset";

export function SiApachesuperset({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApachesupersetHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApachesupersetTitle}
      {...props}
    >
