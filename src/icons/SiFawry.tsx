...
export const SiFawryHex = "FFD300";
export const SiFawryTitle = "Fawry";
export const SiFawrySlug = "fawry";

export function SiFawry({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFawryHex}` : color;
