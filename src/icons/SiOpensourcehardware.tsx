...
export const SiOpensourcehardwareHex = "0099B0";
export const SiOpensourcehardwareTitle = "Open Source Hardware";
export const SiOpensourcehardwareSlug = "opensourcehardware";

export function SiOpensourcehardware({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOpensourcehardwareHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOpensourcehardwareTitle}
      {...props}
    >
