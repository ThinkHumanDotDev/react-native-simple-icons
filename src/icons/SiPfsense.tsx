...
export const SiPfsenseHex = "212121";
export const SiPfsenseTitle = "pfSense";
export const SiPfsenseSlug = "pfsense";

export function SiPfsense({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPfsenseHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPfsenseTitle}
      {...props}
    >
