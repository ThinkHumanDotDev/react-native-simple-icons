...
export const SiHandshakeProtocolHex = "000000";
export const SiHandshakeProtocolTitle = "Handshake";
export const SiHandshakeProtocolSlug = "handshake_protocol";

export function SiHandshakeProtocol({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHandshakeProtocolHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHandshakeProtocolTitle}
      {...props}
    >
