...
export const SiOsmandHex = "FF8800";
export const SiOsmandTitle = "OsmAnd";
export const SiOsmandSlug = "osmand";

export function SiOsmand({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiOsmandHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiOsmandTitle}
      {...props}
    >
