...
export const SiFavroHex = "512DA8";
export const SiFavroTitle = "Favro";
export const SiFavroSlug = "favro";

export function SiFavro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiFavroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiFavroTitle}
      {...props}
    >
