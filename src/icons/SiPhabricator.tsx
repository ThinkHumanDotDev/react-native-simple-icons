...
export const SiPhabricatorHex = "4A5F88";
export const SiPhabricatorTitle = "Phabricator";
export const SiPhabricatorSlug = "phabricator";

export function SiPhabricator({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPhabricatorHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPhabricatorTitle}
      {...props}
    >
