...
export const SiIndeedHex = "003A9B";
export const SiIndeedTitle = "Indeed";
export const SiIndeedSlug = "indeed";

export function SiIndeed({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiIndeedHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiIndeedTitle}
      {...props}
    >
