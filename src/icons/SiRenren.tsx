...
export const SiRenrenHex = "217DC6";
export const SiRenrenTitle = "Renren";
export const SiRenrenSlug = "renren";

export function SiRenren({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRenrenHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRenrenTitle}
      {...props}
    >
