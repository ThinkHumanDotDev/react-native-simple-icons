...
export const SiApacheavroHex = "30638E";
export const SiApacheavroTitle = "Apache Avro";
export const SiApacheavroSlug = "apacheavro";

export function SiApacheavro({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiApacheavroHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiApacheavroTitle}
      {...props}
    >
