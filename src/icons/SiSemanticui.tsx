...
export const SiSemanticuiHex = "00B5AD";
export const SiSemanticuiTitle = "Semantic UI";
export const SiSemanticuiSlug = "semanticui";

export function SiSemanticui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSemanticuiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSemanticuiTitle}
      {...props}
    >
