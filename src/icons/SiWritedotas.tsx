...
export const SiWritedotasHex = "5AC4EE";
export const SiWritedotasTitle = "Write.as";
export const SiWritedotasSlug = "writedotas";

export function SiWritedotas({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiWritedotasHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiWritedotasTitle}
      {...props}
    >
