...
export const SiDictionarydotcomHex = "0049D7";
export const SiDictionarydotcomTitle = "Dictionary.com";
export const SiDictionarydotcomSlug = "dictionarydotcom";

export function SiDictionarydotcom({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDictionarydotcomHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDictionarydotcomTitle}
      {...props}
    >
