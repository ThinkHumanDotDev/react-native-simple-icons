...
export const SiUmbracoHex = "3544B1";
export const SiUmbracoTitle = "Umbraco";
export const SiUmbracoSlug = "umbraco";

export function SiUmbraco({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUmbracoHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUmbracoTitle}
      {...props}
    >
