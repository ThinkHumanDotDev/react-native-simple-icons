...
export const SiReadmeHex = "018EF5";
export const SiReadmeTitle = "ReadMe";
export const SiReadmeSlug = "readme";

export function SiReadme({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiReadmeHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiReadmeTitle}
      {...props}
    >
