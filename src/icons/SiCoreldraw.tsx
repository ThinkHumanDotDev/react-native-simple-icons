...
export const SiCoreldrawHex = "000000";
export const SiCoreldrawTitle = "CorelDRAW";
export const SiCoreldrawSlug = "coreldraw";

export function SiCoreldraw({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoreldrawHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCoreldrawTitle}
      {...props}
    >
