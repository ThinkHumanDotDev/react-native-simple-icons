...
export const SiLvglHex = "343839";
export const SiLvglTitle = "LVGL";
export const SiLvglSlug = "lvgl";

export function SiLvgl({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLvglHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLvglTitle}
      {...props}
    >
