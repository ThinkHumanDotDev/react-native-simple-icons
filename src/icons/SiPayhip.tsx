...
export const SiPayhipHex = "5C6AC4";
export const SiPayhipTitle = "Payhip";
export const SiPayhipSlug = "payhip";

export function SiPayhip({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPayhipHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPayhipTitle}
      {...props}
    >
