...
export const SiProxmoxHex = "E57000";
export const SiProxmoxTitle = "Proxmox";
export const SiProxmoxSlug = "proxmox";

export function SiProxmox({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiProxmoxHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiProxmoxTitle}
      {...props}
    >
