...
export const SiObtainiumHex = "D2BCFD";
export const SiObtainiumTitle = "Obtainium";
export const SiObtainiumSlug = "obtainium";

export function SiObtainium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiObtainiumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiObtainiumTitle}
      {...props}
    >
