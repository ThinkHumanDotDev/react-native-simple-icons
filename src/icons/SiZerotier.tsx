...
export const SiZerotierHex = "FFB441";
export const SiZerotierTitle = "ZeroTier";
export const SiZerotierSlug = "zerotier";

export function SiZerotier({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZerotierHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiZerotierTitle}
      {...props}
    >
