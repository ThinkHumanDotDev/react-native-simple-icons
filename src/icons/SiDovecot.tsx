...
export const SiDovecotHex = "54BCAB";
export const SiDovecotTitle = "Dovecot";
export const SiDovecotSlug = "dovecot";

export function SiDovecot({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDovecotHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDovecotTitle}
      {...props}
    >
