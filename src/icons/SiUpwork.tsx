...
export const SiUpworkHex = "6FDA44";
export const SiUpworkTitle = "Upwork";
export const SiUpworkSlug = "upwork";

export function SiUpwork({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUpworkHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUpworkTitle}
      {...props}
    >
