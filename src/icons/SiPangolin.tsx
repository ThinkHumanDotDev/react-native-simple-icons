...
export const SiPangolinHex = "F36118";
export const SiPangolinTitle = "Pangolin";
export const SiPangolinSlug = "pangolin";

export function SiPangolin({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPangolinHex}` : color;
