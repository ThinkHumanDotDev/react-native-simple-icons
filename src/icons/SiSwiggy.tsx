...
export const SiSwiggyHex = "FC8019";
export const SiSwiggyTitle = "Swiggy";
export const SiSwiggySlug = "swiggy";

export function SiSwiggy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSwiggyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSwiggyTitle}
      {...props}
    >
