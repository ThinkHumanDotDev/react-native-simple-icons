...
export const SiHtcHex = "A5CF4C";
export const SiHtcTitle = "HTC";
export const SiHtcSlug = "htc";

export function SiHtc({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHtcHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHtcTitle}
      {...props}
    >
