...
export const SiStardockHex = "004B8D";
export const SiStardockTitle = "Stardock";
export const SiStardockSlug = "stardock";

export function SiStardock({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiStardockHex}` : color;
