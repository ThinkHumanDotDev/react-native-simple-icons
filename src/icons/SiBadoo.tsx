...
export const SiBadooHex = "783BF9";
export const SiBadooTitle = "Badoo";
export const SiBadooSlug = "badoo";

export function SiBadoo({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiBadooHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiBadooTitle}
      {...props}
    >
