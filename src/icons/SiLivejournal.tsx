...
export const SiLivejournalHex = "00B0EA";
export const SiLivejournalTitle = "LiveJournal";
export const SiLivejournalSlug = "livejournal";

export function SiLivejournal({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLivejournalHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLivejournalTitle}
      {...props}
    >
