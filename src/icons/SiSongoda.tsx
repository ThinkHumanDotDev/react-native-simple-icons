...
export const SiSongodaHex = "FC494A";
export const SiSongodaTitle = "Songoda";
export const SiSongodaSlug = "songoda";

export function SiSongoda({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSongodaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSongodaTitle}
      {...props}
    >
