...
export const SiZapHex = "00549E";
export const SiZapTitle = "ZAP";
export const SiZapSlug = "zap";

export function SiZap({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiZapHex}` : color;
