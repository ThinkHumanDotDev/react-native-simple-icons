...
export const SiAutohotkeyHex = "334455";
export const SiAutohotkeyTitle = "AutoHotkey";
export const SiAutohotkeySlug = "autohotkey";

export function SiAutohotkey({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAutohotkeyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAutohotkeyTitle}
      {...props}
    >
