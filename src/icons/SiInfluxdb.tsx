...
export const SiInfluxdbHex = "22ADF6";
export const SiInfluxdbTitle = "InfluxDB";
export const SiInfluxdbSlug = "influxdb";

export function SiInfluxdb({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiInfluxdbHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiInfluxdbTitle}
      {...props}
    >
