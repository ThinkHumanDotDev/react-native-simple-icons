...
export const SiTiddlywikiHex = "111111";
export const SiTiddlywikiTitle = "TiddlyWiki";
export const SiTiddlywikiSlug = "tiddlywiki";

export function SiTiddlywiki({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiTiddlywikiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiTiddlywikiTitle}
      {...props}
    >
