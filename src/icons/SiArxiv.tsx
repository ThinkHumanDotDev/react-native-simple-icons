...
export const SiArxivHex = "B31B1B";
export const SiArxivTitle = "arXiv";
export const SiArxivSlug = "arxiv";

export function SiArxiv({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiArxivHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiArxivTitle}
      {...props}
    >
