...
export const SiAldinordHex = "2490D7";
export const SiAldinordTitle = "Aldi Nord";
export const SiAldinordSlug = "aldinord";

export function SiAldinord({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiAldinordHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiAldinordTitle}
      {...props}
    >
