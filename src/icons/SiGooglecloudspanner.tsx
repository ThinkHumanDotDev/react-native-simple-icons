...
export const SiGooglecloudspannerHex = "4285F4";
export const SiGooglecloudspannerTitle = "Google Cloud Spanner";
export const SiGooglecloudspannerSlug = "googlecloudspanner";

export function SiGooglecloudspanner({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglecloudspannerHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglecloudspannerTitle}
      {...props}
    >
