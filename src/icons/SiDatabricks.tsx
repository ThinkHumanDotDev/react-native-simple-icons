...
export const SiDatabricksHex = "FF3621";
export const SiDatabricksTitle = "Databricks";
export const SiDatabricksSlug = "databricks";

export function SiDatabricks({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiDatabricksHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiDatabricksTitle}
      {...props}
    >
