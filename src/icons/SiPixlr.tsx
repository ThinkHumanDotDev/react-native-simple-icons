...
export const SiPixlrHex = "3EBBDF";
export const SiPixlrTitle = "Pixlr";
export const SiPixlrSlug = "pixlr";

export function SiPixlr({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPixlrHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPixlrTitle}
      {...props}
    >
