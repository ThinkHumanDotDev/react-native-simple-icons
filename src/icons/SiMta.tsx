...
export const SiMtaHex = "0039A6";
export const SiMtaTitle = "MTA";
export const SiMtaSlug = "mta";

export function SiMta({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiMtaHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiMtaTitle}
      {...props}
    >
