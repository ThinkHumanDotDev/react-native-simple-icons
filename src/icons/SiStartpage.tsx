...
export const SiStartpageHex = "6563FF";
export const SiStartpageTitle = "Startpage";
export const SiStartpageSlug = "startpage";
...
export function SiStartpage({
  ...
  const resolvedColor = color === "default" ? `#${SiStartpageHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiStartpageTitle}
      {...props}
    >
