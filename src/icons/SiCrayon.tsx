...
export const SiCrayonHex = "FF6A4C";
export const SiCrayonTitle = "Crayon";
export const SiCrayonSlug = "crayon";

export function SiCrayon({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCrayonHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiCrayonTitle}
      {...props}
    >
