...
export const SiLogseqHex = "85C8C8";
export const SiLogseqTitle = "Logseq";
export const SiLogseqSlug = "logseq";

export function SiLogseq({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiLogseqHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiLogseqTitle}
      {...props}
    >
