...
export const SiHomepageHex = "009BD5";
export const SiHomepageTitle = "Homepage";
export const SiHomepageSlug = "homepage";

export function SiHomepage({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHomepageHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHomepageTitle}
      {...props}
    >
