...
export const SiRubyonrailsHex = "D30001";
export const SiRubyonrailsTitle = "Ruby on Rails";
export const SiRubyonrailsSlug = "rubyonrails";

export function SiRubyonrails({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiRubyonrailsHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiRubyonrailsTitle}
      {...props}
    >
