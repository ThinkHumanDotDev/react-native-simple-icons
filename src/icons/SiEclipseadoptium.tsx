...
export const SiEclipseadoptiumHex = "FF1464";
export const SiEclipseadoptiumTitle = "Eclipse Adoptium";
export const SiEclipseadoptiumSlug = "eclipseadoptium";

export function SiEclipseadoptium({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiEclipseadoptiumHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiEclipseadoptiumTitle}
      {...props}
    >
