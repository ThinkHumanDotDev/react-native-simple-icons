...
export const SiCoderHex = "090B0B";
export const SiCoderTitle = "Coder";
export const SiCoderSlug = "coder";

export function SiCoder({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiCoderHex}` : color;
