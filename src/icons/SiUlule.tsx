...
export const SiUluleHex = "18A5D6";
export const SiUluleTitle = "Ulule";
export const SiUluleSlug = "ulule";

export function SiUlule({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiUluleHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiUluleTitle}
      {...props}
    >
