...
export const SiHeadlessuiHex = "66E3FF";
export const SiHeadlessuiTitle = "Headless UI";
export const SiHeadlessuiSlug = "headlessui";

export function SiHeadlessui({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiHeadlessuiHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiHeadlessuiTitle}
      {...props}
    >
