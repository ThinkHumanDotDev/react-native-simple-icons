...
export const SiJpegHex = "8A8A8A";
export const SiJpegTitle = "JPEG";
export const SiJpegSlug = "jpeg";

export function SiJpeg({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiJpegHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiJpegTitle}
      {...props}
    >
