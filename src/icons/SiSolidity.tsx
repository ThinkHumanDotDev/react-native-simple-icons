...
export const SiSolidityHex = "363636";
export const SiSolidityTitle = "Solidity";
export const SiSoliditySlug = "solidity";

export function SiSolidity({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiSolidityHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiSolidityTitle}
      {...props}
    >
