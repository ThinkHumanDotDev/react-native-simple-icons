...
export const SiGooglebigqueryHex = "669DF6";
export const SiGooglebigqueryTitle = "Google BigQuery";
export const SiGooglebigquerySlug = "googlebigquery";

export function SiGooglebigquery({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiGooglebigqueryHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiGooglebigqueryTitle}
      {...props}
    >
