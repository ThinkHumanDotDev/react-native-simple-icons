...
export const SiKhanacademyHex = "14BF96";
export const SiKhanacademyTitle = "Khan Academy";
export const SiKhanacademySlug = "khanacademy";

export function SiKhanacademy({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiKhanacademyHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiKhanacademyTitle}
      {...props}
    >
