...
export const SiPretzelHex = "1BB3A4";
export const SiPretzelTitle = "Pretzel";
export const SiPretzelSlug = "pretzel";

export function SiPretzel({
  size = 24,
  color = "black",
  title,
  ...props
}: IconProps): React.ReactElement {
  const resolvedColor = color === "default" ? `#${SiPretzelHex}` : color;
  ...
  return (
    <Svg
      ...
      height={size}
      viewBox="0 0 24 24"
      accessibilityLabel={title ?? SiPretzelTitle}
      {...props}
    >
